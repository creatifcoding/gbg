...
- RFC 896 (small-packet coalescing / latency-throughput tradeoff):
  - https://www.rfc-editor.org/rfc/rfc896.html
- vIC (adaptive interrupt coalescing):
  - https://www.usenix.org/legacy/event/atc11/tech/final_files/Ahmad.pdf
- Kafka dual-trigger analytical batching (truncated Erlang/Poisson):
  - https://qed.usc.edu/paolieri/papers/2025_mascots_arrivals_batching_simulation.pdf
- Serverless adaptive batching under SLO (SC20 BATCH):
  - https://www2.cs.uh.edu/~fyan/Paper/Feng-SC20-BATCH.pdf
- Browser frame-aligned coalescing patterns:
  - https://nolanlawson.com/2019/08/11/high-performance-input-handling-on-the-web/
- Fair queueing baseline (DRR):
  - https://courses.cs.duke.edu/fall24/compsci514/readings/drr.pdf
- Priority + rate limits for tail SLO robustness:
  - https://www.pdl.cmu.edu/PDL-FTP/CloudComputing/pmeister-SoCC14.pdf
