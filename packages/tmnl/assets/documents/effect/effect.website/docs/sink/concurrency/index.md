...
# Sink Concurrency {#_top .astro-np5lzwrf}
:::
::::
...
::::::::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
::::: sl-markdown-content
This section covers concurrent operations that allow multiple sinks to
run simultaneously. These can be valuable for enhancing task performance
when concurrent execution is desired.
...
aria-hidden="true"}](index.html#combining-results-with-concurrent-zipping){.anchor-link
aria-labelledby="combining-results-with-concurrent-zipping"}
:::

To run two sinks concurrently and combine their results, use
`Sink.zip`{dir="auto"}. This operation executes both sinks concurrently
and combines their outcomes into a tuple.

**Example** (Running Two Sinks Concurrently and Combining Results)

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>1import { import Sink</code></pre>
</figure>
:::
:::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"5\"]{style="--0:#032F62;--1:#9ECBFF"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Stream.Stream&lt;string, never, never&gt;, Stream.Stream&lt;string, never, never&gt;&gt;(this: Stream.Stream&lt;string, never, never&gt;, ab: (_: Stream.Stream&lt;string, never, never&gt;) =&gt; Stream.Stream&lt;string, never, never&gt;): Stream.Stream&lt;string, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const schedule: &lt;number, string, never, string&gt;(schedule: Schedule.Schedule&lt;number, string, never&gt;) =&gt; &lt;E, R&gt;(self: Stream.Stream&lt;string, E, R&gt;) =&gt; Stream.Stream&lt;string, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[spaced]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"10
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const sink1: Sink.Sink&lt;number, string, never, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const forEach: &lt;string, void, never, never&gt;(f: (input: string) =&gt; Effect.Effect&lt;void, never, never&gt;) =&gt; Sink.Sink&lt;void, string, never, never, never&gt;</code></pre>
</figure>
:::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`sink
1: \${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Sink.Sink&lt;void, string, never, never, never&gt;, Sink.Sink&lt;number, string, never, never, never&gt;&gt;(this: Sink.Sink&lt;void, string, never, never, never&gt;, ab: (_: Sink.Sink&lt;void, string, never, never, never&gt;) =&gt; Sink.Sink&lt;number, string, never, never, never&gt;): Sink.Sink&lt;number, string, never, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const as: &lt;number&gt;(a: number) =&gt; &lt;A, In, L, E, R&gt;(self: Sink.Sink&lt;A, In, L, E, R&gt;) =&gt; Sink.Sink&lt;number, In, L, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const sink2: Sink.Sink&lt;number, string, never, never, never&gt;</code></pre>
</figure>
:::
::::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`sink
2: \${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Combine the two sinks to run concurrently and collect results in a
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const sink: Sink.Sink&lt;[number, number], string, never, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const zip: &lt;number, string, never, never, never, number, string, never, never, never&gt;(self: Sink.Sink&lt;number, string, never, never, never&gt;, that: Sink.Sink&lt;number, string, never, never, never&gt;, options?: {    readonly concurrent?: boolean | undefined;} | undefined) =&gt; Sink.Sink&lt;[number, number], string, never, never, never&gt; (+1 overload)</code></pre>
</figure>
:::

::: twoslash-popup-docs
Feeds inputs to this sink until it yields a result, then switches over
to the provided sink until it yields a result, finally combining the two
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runPromise: &lt;[number, number], never&gt;(effect: Effect.Effect&lt;[number, number], never, never&gt;, options?: {    readonly signal?: AbortSignal | undefined;} | undefined) =&gt; Promise&lt;[number, number]&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const run: &lt;string, never, never, [number, number], never, never&gt;(self: Stream.Stream&lt;string, never, never&gt;, sink: Sink.Sink&lt;[number, number], string, unknown, never, never&gt;) =&gt; Effect.Effect&lt;[number, number], never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Promise&lt;[number, number]&gt;.then&lt;void, never&gt;(onfulfilled?: ((value: [number, number]) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined, onrejected?: ((reason: any) =&gt; PromiseLike&lt;never&gt;) | null | undefined): Promise&lt;void&gt;</code></pre>
</figure>
:::
...
::: code
[sink 1: 1]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 2: 1]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 1: 2]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 2: 2]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 1: 3]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 2: 3]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 1: 4]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 2: 4]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 1: 5]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[sink 2: 5]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#racing-sinks-first-completion-wins){.anchor-link
aria-labelledby="racing-sinks-first-completion-wins"}
:::

The `Sink.race`{dir="auto"} operation allows multiple sinks to compete
for completion. The first sink to finish provides the result.
...
::: code
[// Race the two sinks, the result will be from the first to
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const sink: Sink.Sink&lt;number, string, never, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const race: &lt;number, string, never, never, never, number, string, never, never, never&gt;(self: Sink.Sink&lt;number, string, never, never, never&gt;, that: Sink.Sink&lt;number, string, never, never, never&gt;) =&gt; Sink.Sink&lt;number, string, never, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[sink2]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::
::::::::::::::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/sink/concurrency.mdx){.sl-flex
...
.astro-4rgy7crp} [ Next\
[Leftovers]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../leftovers/index.html){.astro-u5aomj4k rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
