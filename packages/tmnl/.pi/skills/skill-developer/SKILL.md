...
description: Meta-skill for creating and managing pi skills
allowed-tools: [Bash, Read, Write, Edit]
---

# Skill Developer

Meta-skill for creating new pi skills, including skills that wrap MCP pipelines.
...
Skills live in `.pi/skills/<skill-name>/`:
...
```bash
cat $CLAUDE_PROJECT_DIR/.pi/skills/multi-tool-pipeline/SKILL.md
...
Create `.pi/skills/my-pipeline/SKILL.md`:
...
Add to `.pi/skills/skill-rules.json`:
...
```bash
ls $CLAUDE_PROJECT_DIR/.pi/skills/
cat $CLAUDE_PROJECT_DIR/.pi/skills/commit/SKILL.md
cat $CLAUDE_PROJECT_DIR/.pi/skills/firecrawl-scrape/SKILL.md
```
