...
import type { VariableId, WorkspaceId, EditorId, ValueSource, VariableChangeEvent } from '../types'
 ...
 * Source: 'user'
 */
export const userValuesAtom = Atom.make<ReadonlyMap<string, StoredValue>>(new Map())
 ...
 * Source: 'workspace'
 */
export const workspaceValuesAtom = Atom.make<ReadonlyMap<string, ReadonlyMap<string, StoredValue>>>(
  new Map()
)
 ...
 * Source: 'editor'
 */
export const editorValuesAtom = Atom.make<ReadonlyMap<string, ReadonlyMap<string, StoredValue>>>(
  new Map()
)
 ...
 */
export function removeWorkspaceValue(workspaceId: WorkspaceId, variableId: string): void {
  Atom.update(workspaceValuesAtom, (outer) => {
 ...
 */
export function setEditorValue(editorId: EditorId, variableId: string, value: unknown): void {
  const stored: StoredValue = {
    value,
    source: 'editor',
    updatedAt: new Date(),
 ...
 */
export function removeEditorValue(editorId: EditorId, variableId: string): void {
  Atom.update(editorValuesAtom, (outer) => {
