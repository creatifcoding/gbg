defmodule Maiden.SiteRuntime.Actions.SeasonalShutdown do
  @moduledoc """
  Explicit transition action: operational -> seasonal_shutdown.
  """

  use Jido.Action,
    name: "seasonal_shutdown",
    description: "Set site status to seasonal_shutdown",
    schema: [
  ...
  def run(params, context) when is_map(params) do
    ...
    cond do
      from != "operational" or to != "seasonal_shutdown" ->
        {:error, "SeasonalShutdown requires from=operational and to=seasonal_shutdown"}
