# Decision: Effect Schema Integration with json-render

> **Date**: 2026-01-15
> **Status**: DECIDED
> **Decision**: Fork json-render to accept generic schema interface

## Context

We need json-render (Vercel Labs' guardrailed UI generation library) to work with Effect Schema instead of Zod for the Generative Entity Card smoke test.
...
- json-render specifically uses Zod's internal APIs for schema composition

## Options Evaluated

| Option | Effort | Risk | Maintainability |
|--------|--------|------|-----------------|
| Fork json-render | Medium | Low | Good |
...
1. Fork `submodules/json-render` to `packages/json-render` (or modify in place)
...
- Test file: `src/lib/json-render/__tests__/effect-catalog.test.ts`
- Adapter: `src/lib/json-render/effect-adapter.ts`
- json-render catalog: `submodules/json-render/packages/core/src/catalog.ts`
