defmodule Maiden.EquipmentStateRuntime do
  @moduledoc """
  Equipment-state runtime contract namespace for Effect ↔ Elixir/Jido interop.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_equipment_state_runtime]}
  ...
  @doc """
  Restore an EquipmentStateRuntime agent by id from snapshot storage.
