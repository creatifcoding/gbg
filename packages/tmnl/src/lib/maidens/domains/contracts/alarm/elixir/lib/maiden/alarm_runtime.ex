defmodule Maiden.AlarmRuntime do
  @moduledoc """
  Alarm-domain runtime contract namespace for Effect ↔ Elixir/Jido interop.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_alarm_runtime]}
  ...
  @doc """
  Restore an AlarmRuntime agent by id from snapshot storage.
