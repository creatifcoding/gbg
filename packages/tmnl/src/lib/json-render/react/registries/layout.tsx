/**
 * @fileoverview Layout component registry for json-render
 *
 * Wires the layout module components (Grid, Stack, Flex, etc.) to the
 * json-render ComponentRegistry interface.
 *
 * @module json-render/react/registries/layout
 */
...
/**
 * Layout component registry for json-render
 *
 * @example
 * ```tsx
 * import { layoutRegistry } from '@/lib/json-render/react/registries/layout'
 * import { Renderer } from '@/lib/json-render'
 *
