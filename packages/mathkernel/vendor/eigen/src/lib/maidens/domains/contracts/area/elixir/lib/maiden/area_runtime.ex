defmodule Maiden.AreaRuntime do
  @moduledoc """
  Area runtime contract namespace for Effect ↔ Elixir/Jido interop.

  ISA-95 alignment:
  - Area models L3 manufacturing-operations scope under Site directly,
    or under Plant when lane topology includes Plant between Site and Area.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_area_runtime]}
