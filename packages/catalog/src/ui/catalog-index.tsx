  ...
  return (
    <div className="vanta-empty">
      ...
      <p className="vanta-muted mt-2 max-w-xl text-[16px]">
        Intake is one screen. A dump becomes a Specimen: this leaf, this foot, this slide, this photo. Taxon and structure can wait. Body waits until after the specimen exists.
      </p>
