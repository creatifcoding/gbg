defmodule Maiden.MachineAssetRuntime do
  @moduledoc """
  Machine-asset runtime contract namespace for Effect ↔ Elixir/Jido interop.

  ISA-95 alignment:
  - Machine asset models equipment-module lifecycle behavior under L3 operations.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_machine_asset_runtime]}
