defmodule Maiden.PlantRuntime do
  @moduledoc """
  Plant runtime contract namespace for Effect ↔ Elixir/Jido interop.

  ISA-95 alignment:
  - Plant models Site/Area operational scope at L3 (MES/MOM), parent of Line.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_plant_runtime]}
