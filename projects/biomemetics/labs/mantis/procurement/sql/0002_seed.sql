...
INSERT INTO part (balloon_id, name, qty_text, class, notes) VALUES ($bom$B25$bom$, $bom$normally locked carriage spring$bom$, $bom$1/carriage$bom$, $bom$UNVERIFIED$bom$, $bom$UNVERIFIED rate/PN. CAD miss this pass (no spring catalog page in this CAD pass). EE candidate remains: Lee Spring LC032C08M, dry/external carriage, not animal-side. B20 holds. Later CAD catalog page printed: Standard Compression Series (inch); Music Wire ASTM A228; OD 0.24 in / 6.10 mm; free 0.750 in / 19.05 mm; solid 0.329 in / 8.36 mm; rate 22.00 lb/in / 3.85 N/mm; load at solid 10.00 lb / 44.48 N; squared and ground; zinc plate ASTM B633. Arithmetic vs 15-25 N / 5 mm TARGET is ours, not a vendor claim. Pocket / normally-locked path UNVERIFIED. Not a buy. No price landed from any spring page. Source: https://www.leespring.com/product/compression-spring-lc032c08m-music-wire$bom$) ON CONFLICT (balloon_id) DO NOTHING;
...
INSERT INTO part (balloon_id, name, qty_text, class, notes) VALUES ($bom$B48$bom$, $bom$local supervisor, normally-open S1 carriage-mate switch, normally-open S2 binder-mate switch, per-carriage Q1 current-limited load switch, discharge, and bus isolation$bom$, $bom$1/carriage$bom$, NULL, $bom$exact parts, mate order, timeout, polarity, and timing `UNVERIFIED`; P08 is not safety authority. CAD miss this pass on supervisor / discharge / bus isolation / AND timing: rejected stop. No MPN. 3.3 V monitors opened were not used. Do not file TPS25221. EE candidates remain. S1/S2 logic detect only, one MPN not assigned S1 vs S2: D2FS-F-N Aratas (formerly Omron), SPST-NO, 100 mA DC, 6 V DC, Off-Mom. Not a 12 V interrupt. Fit UNVERIFIED. D2FS: https://www.digikey.com/en/products/detail/omron-electronics-inc-emc-div/D2FS-F-N/4753384 EE candidate Q1 remains: TPS259830LNRGER TI, 2.7-26 V, programmable current limit, 18 A max, Auto Retry, OVP, 24-VQFN. Page does not print a 2 A factory limit. Enable from S1 AND S2 / discharge / isolation UNVERIFIED. TPS259830: https://www.digikey.com/en/products/detail/texas-instruments/TPS259830LNRGER/22106807 Not a buy.$bom$) ON CONFLICT (balloon_id) DO NOTHING;
