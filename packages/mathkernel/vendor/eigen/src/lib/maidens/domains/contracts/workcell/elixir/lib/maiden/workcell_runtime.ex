defmodule Maiden.WorkcellRuntime do
  @moduledoc """
  Workcell runtime contract namespace for Effect ↔ Elixir/Jido interop.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_workcell_runtime]}
