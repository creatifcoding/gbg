defmodule Maiden.LineRuntime do
  @moduledoc """
  Line runtime contract namespace for Effect ↔ Elixir/Jido interop.

  ISA-95 alignment:
  - Line models production-line (work-center) behavior under L3 manufacturing operations.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_line_runtime]}
