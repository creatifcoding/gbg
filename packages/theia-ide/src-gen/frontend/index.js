...
async function preload(container) {
    try {
        ...
        await load(container, require('@theia/core/lib/browser-only/preload/frontend-only-preload-module'));
...
module.exports = (async () => {
    ...
    try {
        await load(container, require('@theia/core/lib/browser-only/i18n/i18n-frontend-only-module'));
        ...
        await load(container, require('@theia/filesystem/lib/browser-only/browser-only-filesystem-frontend-module'));
        ...
        await load(container, require('@theia/workspace/lib/browser-only/workspace-frontend-only-module'));
