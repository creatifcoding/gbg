defmodule Maiden.SiteRuntime do
  @moduledoc """
  Site runtime contract namespace for Effect ↔ Elixir/Jido interop.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_site_runtime]}
