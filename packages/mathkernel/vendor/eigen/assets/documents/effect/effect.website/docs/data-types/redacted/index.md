...
::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
::::: sl-markdown-content
The Redacted module provides functionality for handling sensitive
information securely within your application. By using the
`Redacted`{dir="auto"} data type, you can ensure that sensitive values
are not accidentally exposed in logs or error messages.
...
The `Redacted.make`{dir="auto"} function creates a
`Redacted<A>`{dir="auto"} instance from a given value `A`{dir="auto"},
ensuring the content is securely hidden.

**Example** (Hiding Sensitive Information from Logs)

Using `Redacted.make`{dir="auto"} helps prevent sensitive information,
such as API keys, from being accidentally exposed in logs or error
messages.

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>1import { import Redacted</code></pre>
</figure>
:::
:::::

[Redacted]{style="--0:#24292E;--1:#E1E4E8"}[,
...
::: code
[// Create a redacted API key]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const API_KEY: Redacted.Redacted&lt;string&gt;</code></pre>
</figure>
:::
::::

[API_KEY]{style="--0:#005CC5;--1:#79B8FF"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import Redacted</code></pre>
</figure>
:::
::::

[Redacted]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;string&gt;(value: string) =&gt; Redacted.Redacted&lt;string&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import { Redacted } from &quot;effect&quot;
const API_KEY = Redacted.make(&quot;1234567890&quot;)</code></pre>
</figure>
:::

[\@since]{.twoslash-popup-docs-tag-name} ―
[3.3.0]{.twoslash-popup-docs-tag-value}
::::
:::::::

[make]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"1234567890\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
[API_KEY]{style="--0:#005CC5;--1:#79B8FF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::
:::::::::::::::::::
...
::: code
[// Output: \<redacted\>]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// Output: timestamp=\... level=INFO fiber=#0
message=\"\\\"\<redacted\>\\\"\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#value){.anchor-link
aria-labelledby="value"}
:::

The `Redacted.value`{dir="auto"} function retrieves the original value
from a `Redacted`{dir="auto"} instance. Use this function carefully, as
it exposes the sensitive data, potentially making it visible in logs or
accessible in unintended ways.
...
::: code
[// Expose the redacted value]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const value: &lt;string&gt;(self: Redacted.Redacted&lt;string&gt;) =&gt; string</code></pre>
</figure>
:::

::: twoslash-popup-docs
Retrieves the original value from a `Redacted` instance. Use this
function with caution, as it exposes the sensitive data.
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import * as assert from &quot;node:assert&quot;import { Redacted } from &quot;effect&quot;
const API_KEY = Redacted.make(&quot;1234567890&quot;)
assert.equal(Redacted.value(API_KEY), &quot;1234567890&quot;)</code></pre>
</figure>
:::
...
::: code
[// Output: \"1234567890\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#unsafewipe){.anchor-link
aria-labelledby="unsafewipe"}
:::

The `Redacted.unsafeWipe`{dir="auto"} function erases the underlying
value of a `Redacted`{dir="auto"} instance, making it inaccessible. This
helps ensure that sensitive data does not remain in memory longer than
needed.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const unsafeWipe: &lt;string&gt;(self: Redacted.Redacted&lt;string&gt;) =&gt; boolean</code></pre>
</figure>
:::

::: twoslash-popup-docs
Erases the underlying value of a `Redacted` instance, rendering it
unusable. This function is intended to ensure that sensitive data does
...
assert.throws(() =&gt; Redacted.value(API_KEY), new Error(&quot;Unable to get redacted value&quot;))</code></pre>
</figure>
:::
...
[unsafeWipe]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#005CC5;--1:#79B8FF"}
...
::: code
[Error: Unable to get redacted value]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#getequivalence){.anchor-link
aria-labelledby="getequivalence"}
:::

The `Redacted.getEquivalence`{dir="auto"} function generates an
[Equivalence](../../behaviour/equivalence/index.html) for
`Redacted<A>`{dir="auto"} values using an Equivalence for the underlying
values of type `A`{dir="auto"}. This allows you to compare
`Redacted`{dir="auto"} values securely without revealing their content.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const API_KEY1: Redacted.Redacted&lt;string&gt;</code></pre>
</figure>
:::
::::

[API_KEY1]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const API_KEY2: Redacted.Redacted&lt;string&gt;</code></pre>
</figure>
:::
::::

[API_KEY2]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[make]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"1-34567890\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const API_KEY3: Redacted.Redacted&lt;string&gt;</code></pre>
</figure>
:::
::::

[API_KEY3]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const equivalence: Equivalence.Equivalence&lt;Redacted.Redacted&lt;string&gt;&gt;</code></pre>
</figure>
:::
::::

[equivalence]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const getEquivalence: &lt;string&gt;(isEquivalent: Equivalence.Equivalence&lt;string&gt;) =&gt; Equivalence.Equivalence&lt;Redacted.Redacted&lt;string&gt;&gt;</code></pre>
</figure>
:::

::: twoslash-popup-docs
Generates an equivalence relation for `Redacted<A>` values based on an
equivalence relation for the underlying values `A`. This function is
useful for comparing `Redacted` instances without exposing their
contents.
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import * as assert from &quot;node:assert&quot;import { Redacted, Equivalence } from &quot;effect&quot;
...
assert.equal(equivalence(API_KEY1, API_KEY2), false)assert.equal(equivalence(API_KEY1, API_KEY3), true)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const string: Equivalence.Equivalence&lt;string&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const equivalence: Equivalence.Equivalence(self: Redacted.Redacted&lt;string&gt;, that: Redacted.Redacted&lt;string&gt;) =&gt; boolean</code></pre>
</figure>
:::
::::

[equivalence]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#005CC5;--1:#79B8FF"}
...
[API_KEY2]{style="--0:#005CC5;--1:#79B8FF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::
:::::::::::::::::::::::
...
[API_KEY3]{style="--0:#005CC5;--1:#79B8FF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::
:::::::::::::::::::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/data-types/redacted.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../option/index.html){.astro-u5aomj4k rel="prev"}
...
]{.astro-u5aomj4k}](../../trait/equal/index.html){.astro-u5aomj4k
rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
