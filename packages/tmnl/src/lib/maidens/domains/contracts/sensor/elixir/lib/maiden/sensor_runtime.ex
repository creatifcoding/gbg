defmodule Maiden.SensorRuntime do
  @moduledoc """
  Sensor runtime contract namespace for Effect ↔ Elixir/Jido interop.

  ISA-95 alignment:
  - Sensor is a control-module lane that feeds L3 operations via validated
    transition signals.

  Persistence lane:
  - `snapshot/2` stores agent checkpoints through `Jido.Persist.hibernate/2`.
  - `thaw/2` restores checkpoints through `Jido.Persist.thaw/3`.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_sensor_runtime]}
