...
::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::::: sl-markdown-content
This page explains various techniques for handling failures and creating
fallback mechanisms in the Effect library.
...
`Effect.orElse`{dir="auto"} allows you to attempt to run an effect, and
if it fails, you can provide a fallback effect to run instead.

This is useful for handling failures gracefully by defining an
alternative effect to execute if the first one encounters an error.

**Example** (Handling Fallback with `Effect.orElse`{dir="auto"})
...
[succeed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"success\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
[fail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"failure\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fallback: Effect.Effect&lt;string, never, never&gt;</code></pre>
</figure>
:::
::::

[fallback]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Try the success effect first, fallback is not
used]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const orElse: &lt;string, never, never, string, never, never&gt;(self: Effect.Effect&lt;string, never, never&gt;, that: LazyArg&lt;Effect.Effect&lt;string, never, never&gt;&gt;) =&gt; Effect.Effect&lt;string, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[fallback]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::
::::::::::::::::::::
...
::: code
[// Output: \"success\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// Try the failure effect first, fallback is
used]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const orElse: &lt;never, string, never, string, never, never&gt;(self: Effect.Effect&lt;never, string, never&gt;, that: LazyArg&lt;Effect.Effect&lt;string, never, never&gt;&gt;) =&gt; Effect.Effect&lt;string, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#orelsefail){.anchor-link
aria-labelledby="orelsefail"}
:::

`Effect.orElseFail`{dir="auto"} allows you to replace the failure from
one effect with a custom failure value. If the effect fails, you can
provide a new failure to be returned instead of the original one.

This function only applies to failed effects. If the effect succeeds, it
will remain unaffected.

**Example** (Replacing Failure with `Effect.orElseFail`{dir="auto"})
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const validate: (age: number) =&gt; Effect.Effect&lt;number, string&gt;</code></pre>
</figure>
:::
::::

[validate]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
...
[fail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"NegativeAgeError\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[if]{style="--0:#BF3441;--1:#F97583"}[
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[fail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"IllegalAgeError\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const orElseFail: &lt;number, string, never, string&gt;(self: Effect.Effect&lt;number, string, never&gt;, evaluate: LazyArg&lt;string&gt;) =&gt; Effect.Effect&lt;number, string, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
This function allows you to handle the failure of an effect by replacing
it with a predefined failure value. If the effect fails, the new failure
value provided by the `evaluate` function will be returned instead of
the original failure. If the effect succeeds, the original success value
is returned unchanged.

**When to Use**

This is particularly useful when you want to standardize error handling
or provide a consistent failure value for specific operations. It
simplifies error management by ensuring that all failures are replaced
with a controlled alternative.
...
console.log(Effect.runSyncExit(program))// Output:// {//   _id: &#39;Exit&#39;,//   _tag: &#39;Failure&#39;,//   cause: { _id: &#39;Cause&#39;, _tag: &#39;Fail&#39;, failure: &#39;invalid age&#39; }// }</code></pre>
</figure>
:::
::::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [mapError if you need to access
the error to transform it.]{.twoslash-popup-docs-tag-value}
...
[orElseFail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[validate]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[-]{style="--0:#BF3441;--1:#F97583"}[1]{style="--0:#005CC5;--1:#79B8FF"}[),
()
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[\"invalid
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runSyncExit: &lt;number, string&gt;(effect: Effect.Effect&lt;number, string, never&gt;) =&gt; Exit&lt;number, string&gt;</code></pre>
</figure>
:::
...
This function executes the provided effect synchronously and returns an
`Exit` type that encapsulates the outcome of the effect:

- If the effect succeeds, the result is wrapped in a `Success`.
- If the effect fails, it returns a `Failure` containing a `Cause` that
  explains the failure.

If the effect involves asynchronous operations, this function will
return a `Failure` with a `Die` cause, indicating that it cannot resolve
the effect synchronously. This makes the function suitable for use only
with effects that are synchronous in nature.

**When to Use**

Use this function when:

- You want to handle both success and failure outcomes in a structured
  way using the `Exit` type.
- You are working with effects that are purely synchronous and do not
  involve asynchronous operations.
- You need to debug or inspect failures, including their causes, in a
  detailed manner.

Avoid using this function for effects that involve asynchronous
operations, as it will fail with a `Die` cause.
...
console.log(Effect.runSyncExit(Effect.fail(&quot;my error&quot;)))// Output:// {//   _id: &quot;Exit&quot;,//   _tag: &quot;Failure&quot;,//   cause: {//     _id: &quot;Cause&quot;,//     _tag: &quot;Fail&quot;,//     failure: &quot;my error&quot;//   }// }</code></pre>
</figure>
:::
...
<figure class="frame">
<pre data-language="ts"><code>import { Effect } from &quot;effect&quot;
console.log(Effect.runSyncExit(Effect.promise(() =&gt; Promise.resolve(1))))// Output:// {//   _id: &#39;Exit&#39;,//   _tag: &#39;Failure&#39;,//   cause: {//     _id: &#39;Cause&#39;,//     _tag: &#39;Die&#39;,//     defect: [Fiber #0 cannot be resolved synchronously. This is caused by using runSync on an effect that performs async work] {//       fiber: [FiberRuntime],//       _tag: &#39;AsyncFiberException&#39;,//       name: &#39;AsyncFiberException&#39;//     }//   }// }</code></pre>
</figure>
:::
:::::
...
\'Cause\', \_tag: \'Fail\', failure: \'invalid age\'
}]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#orelsesucceed){.anchor-link
aria-labelledby="orelsesucceed"}
:::

`Effect.orElseSucceed`{dir="auto"} allows you to replace the failure of
an effect with a success value. If the effect fails, it will instead
succeed with the provided value, ensuring the effect always completes
successfully.

This is useful when you want to guarantee a successful result regardless
of whether the original effect failed.

The function ensures that any failure is effectively "swallowed" and
replaced by a successful value, which can be helpful for providing
default values in case of failure.

This function only applies to failed effects. If the effect already
succeeds, it will remain unchanged.

**Example** (Replacing Failure with Success using
`Effect.orElseSucceed`{dir="auto"})
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const orElseSucceed: &lt;number, string, never, number&gt;(self: Effect.Effect&lt;number, string, never&gt;, evaluate: LazyArg&lt;number&gt;) =&gt; Effect.Effect&lt;number, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[orElseSucceed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
]{style="--0:#24292E;--1:#E1E4E8"}[18]{style="--0:#005CC5;--1:#79B8FF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::
::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runSyncExit: &lt;number, never&gt;(effect: Effect.Effect&lt;number, never, never&gt;) =&gt; Exit&lt;number, never&gt;</code></pre>
</figure>
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#firstsuccessof){.anchor-link
aria-labelledby="firstsuccessof"}
:::

`Effect.firstSuccessOf`{dir="auto"} allows you to try multiple effects
in sequence, and as soon as one of them succeeds, it returns that
result. If all effects fail, it returns the error of the last effect in
the list.

This is useful when you have several potential alternatives and want to
use the first one that works.

This function is sequential, meaning that the `Effect`{dir="auto"}
values in the iterable will be executed in sequence, and the first one
that succeeds will determine the outcome of the resulting
`Effect`{dir="auto"} value.
...
.astro-4rgy7crp} Empty Collection Error

::: starlight-aside__content
If the collection provided to the `Effect.firstSuccessOf`{dir="auto"}
function is empty, it will throw an
`IllegalArgumentException`{dir="auto"} error.
:::

**Example** (Finding Configuration with Fallbacks)

In this example, we try to retrieve a configuration from different
nodes. If the primary node fails, we fall back to other nodes until we
find a successful configuration.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>interface Config</code></pre>
</figure>
:::
::::

[Config]{style="--0:#6F42C1;--1:#B392F0"}[
{]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Config.host: string</code></pre>
</figure>
:::
::::

[host]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[string]{style="--0:#005CC5;--1:#79B8FF"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Config.port: number</code></pre>
</figure>
:::
::::

[port]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Config.apiKey: string</code></pre>
</figure>
:::
::::

[apiKey]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[string]{style="--0:#005CC5;--1:#79B8FF"}
:::::
::::::::
...
::: code
[// Create a configuration object with sample
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const makeConfig: (name: string) =&gt; Config</code></pre>
</figure>
:::
::::
...
[name]{style="--0:#24292E;--1:#E1E4E8"}[}.example.com\`]{style="--0:#032F62;--1:#9ECBFF"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::::::
::::::::::
...
[port]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[8080]{style="--0:#005CC5;--1:#79B8FF"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"12345-abcde\"]{style="--0:#032F62;--1:#9ECBFF"}
:::::
::::::::
...
::: code
[// Simulate retrieving configuration from a remote
node]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const remoteConfig: (name: string) =&gt; Effect.Effect&lt;Config, Error&gt;</code></pre>
</figure>
:::
::::

[remoteConfig]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;never, Error, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt;, Config&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;never, Error, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt;, Config, never&gt;) =&gt; Effect.Effect&lt;Config, Error, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Simulate node3 being the only one with available
config]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"node3\"]{style="--0:#032F62;--1:#9ECBFF"}[)
{]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Config
for \${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>name: &quot;node3&quot;</code></pre>
</figure>
:::
::::

[name]{style="--0:#24292E;--1:#E1E4E8"}[}
found\`]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
[makeConfig]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Unavailable
config for
...
[name]{style="--0:#24292E;--1:#E1E4E8"}[}\`]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
[Error]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Config
not found for
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Define the master configuration and potential fallback
nodes]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const masterConfig: Effect.Effect&lt;Config, Error, never&gt;</code></pre>
</figure>
:::
::::

[masterConfig]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[remoteConfig]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"master\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::
::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const nodeConfigs: Effect.Effect&lt;Config, Error, never&gt;[]</code></pre>
</figure>
:::
::::

[nodeConfigs]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
\[]{style="--0:#24292E;--1:#E1E4E8"}[\"node1\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"node2\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"node3\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"node4\"]{style="--0:#032F62;--1:#9ECBFF"}[\].]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Array&lt;string&gt;.map&lt;Effect.Effect&lt;Config, Error, never&gt;&gt;(callbackfn: (value: string, index: number, array: string[]) =&gt; Effect.Effect&lt;Config, Error, never&gt;, thisArg?: any): Effect.Effect&lt;Config, Error, never&gt;[]</code></pre>
</figure>
:::
...
[remoteConfig]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: code
[// Attempt to find a working
configuration,]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// starting with the master and then falling back to other
nodes]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const config: Effect.Effect&lt;Config, Error, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const firstSuccessOf: &lt;Effect.Effect&lt;Config, Error, never&gt;&gt;(effects: Iterable&lt;Effect.Effect&lt;Config, Error, never&gt;&gt;) =&gt; Effect.Effect&lt;Config, Error, never&gt;</code></pre>
</figure>
:::

:::: twoslash-popup-docs
Runs a sequence of effects and returns the result of the first
successful one.
...
immediately returned, and no further effects in the sequence are
executed. However, if all the effects fail, the function will return the
error of the last effect.

The execution is sequential, meaning that effects are evaluated one at a
time in the order they are provided. This ensures predictable behavior
and avoids unnecessary computations.

If the collection of effects is empty, an `IllegalArgumentException` is
thrown, indicating that the operation is invalid without any effects to
try.

**When to Use**

This is particularly useful when you have multiple fallback strategies
or alternative sources to obtain a result, such as attempting multiple
APIs, retrieving configurations, or accessing resources in a prioritized
manner.
...
console.log(result)// Output:// Unavailable config for master// Unavailable config for node1// Unavailable config for node2// Config for node3 found// { host: &#39;node3.example.com&#39;, port: 8080, apiKey: &#39;12345-abcde&#39; }</code></pre>
</figure>
:::
::::
...
[firstSuccessOf]{style="--0:#6F42C1;--1:#B392F0"}[(\[]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[masterConfig]{style="--0:#24292E;--1:#E1E4E8"}[,
...
[nodeConfigs]{style="--0:#24292E;--1:#E1E4E8"}[\])]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::
::::::::::::::::::::
...
::: code
[// Run the effect to retrieve the
configuration]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const result: Config</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runSync: &lt;Config, Error&gt;(effect: Effect.Effect&lt;Config, Error, never&gt;) =&gt; Config</code></pre>
</figure>
:::
...
::: code
[Unavailable config for master]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Unavailable config for node1]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Unavailable config for node2]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Config for node3 found]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/error-management/fallback.mdx){.sl-flex
...
.astro-4rgy7crp} [ Next\
[Matching]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../matching/index.html){.astro-u5aomj4k rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
