...
:::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
::::: sl-markdown-content
The Equal module provides a simple and convenient way to define and
check for equality between two values in TypeScript.

Here are some key reasons why Effect exports an Equal module:

1.  **Value-Based Equality**: JavaScript's native equality operators
    (`===`{dir="auto"} and `==`{dir="auto"}) check for equality by
    reference, meaning they compare objects based on their memory
    addresses rather than their content. This behavior can be
    problematic when you want to compare objects with the same values
    but different references. The Equal module offers a solution by
    allowing developers to define custom equality checks based on the
    values of objects.

2.  **Custom Equality**: The Equal module enables developers to
    implement custom equality checks for their data types and classes.
    This is crucial when you have specific requirements for determining
    when two objects should be considered equal. By implementing the
    `Equal`{dir="auto"} interface, developers can define their own
    equality logic.

3.  **Data Integrity**: In some applications, maintaining data integrity
    is crucial. The ability to perform value-based equality checks
    ensures that identical data is not duplicated within collections
    like sets or maps. This can lead to more efficient memory usage and
    more predictable behavior.

4.  **Predictable Behavior**: The Equal module promotes more predictable
    behavior when comparing objects. By explicitly defining equality
    criteria, developers can avoid unexpected results that may occur
    with JavaScript's default reference-based equality checks.
...
aria-hidden="true"}](index.html#how-to-perform-equality-checking-in-effect){.anchor-link
aria-labelledby="how-to-perform-equality-checking-in-effect"}
:::

In Effect it's advisable to **stop using** JavaScript's
`===`{dir="auto"} and `==`{dir="auto"} operators and instead rely on the
`Equal.equals`{dir="auto"} function. This function can work with any
data type that implements the `Equal`{dir="auto"} interface. Some
examples of such data types include
...
When you use `Equal.equals`{dir="auto"} and your objects do not
implement the `Equal`{dir="auto"} interface, it defaults to using the
`===`{dir="auto"} operator for object comparison:

**Example** (Using `Equal.equals`{dir="auto"} with Default Comparison)
...
::: code
[// Two objects with identical properties and
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const a: {    name: string;    age: number;}</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const b: {    name: string;    age: number;}</code></pre>
</figure>
:::
::::
...
::: code
[// Equal.equals falls back to the default \'===\'
comparison]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>function equals&lt;{    name: string;    age: number;}, {    name: string;    age: number;}&gt;(self: {    name: string;    age: number;}, that: {    name: string;    age: number;}): boolean (+1 overload)</code></pre>
</figure>
:::
...
In this example, `a`{dir="auto"} and `b`{dir="auto"} are two separate
objects with the same contents. However, `===`{dir="auto"} considers
them different because they occupy different memory locations. This
behavior can lead to unexpected results when you want to compare values
based on their content.

However, you can configure your models to ensure that
`Equal.equals`{dir="auto"} behaves consistently with your custom
equality checks. There are two alternative approaches:

1.  **Implementing the `Equal`{dir="auto"} Interface**: This method is
    useful when you need to define your custom equality check.

2.  **Using the Data Module**: For simple value equality, the
    [Data](../../data-types/data/index.html) module provides a more
    straightforward solution by automatically generating default
    implementations for `Equal`{dir="auto"}.
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#implementing-the-equal-interface){.anchor-link
aria-labelledby="implementing-the-equal-interface"}
:::

To create custom equality behavior, you can implement the
`Equal`{dir="auto"} interface in your models. This interface extends the
`Hash`{dir="auto"} interface from the [Hash](../hash/index.html) module.
...
In the above code, we define a custom equality function
`[Equal.symbol]`{dir="auto"} and a hash function
`[Hash.symbol]`{dir="auto"} for the `Person`{dir="auto"} class. The
`Hash`{dir="auto"} interface optimizes equality checks by comparing hash
values instead of the objects themselves. When you use the
`Equal.equals`{dir="auto"} function to compare two objects, it first
checks if their hash values are equal. If not, it quickly determines
that the objects are not equal, avoiding the need for a detailed
property-by-property comparison.

Once you've implemented the `Equal`{dir="auto"} interface, you can
utilize the `Equal.equals`{dir="auto"} function to check for equality
using your custom logic.

**Example** (Comparing `Person`{dir="auto"} Instances)
...
]{style="--0:#24292E;--1:#E1E4E8"}[// Unique identifier for each
...
::: code
[ ]{.indent}[// Defines equality based on id, name, and
age]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[ ]{.indent}[// Generates a hash code based primarily on the unique
id]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
In this code, the equality check returns `true`{dir="auto"} when
comparing `alice`{dir="auto"} to a new `Person`{dir="auto"} object with
identical property values and `false`{dir="auto"} when comparing
`alice`{dir="auto"} to `bob`{dir="auto"} due to their differing property
values.
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#simplifying-equality-with-the-data-module){.anchor-link
aria-labelledby="simplifying-equality-with-the-data-module"}
:::

Implementing both `Equal`{dir="auto"} and `Hash`{dir="auto"} can become
cumbersome when all you need is straightforward value equality checks.
Luckily, the [Data](../../data-types/data/index.html) module provides a
simpler solution. It offers APIs that automatically generate default
implementations for both `Equal`{dir="auto"} and `Hash`{dir="auto"}.

**Example** (Using `Data.struct`{dir="auto"} for Equality Checks)
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const alice: {    readonly id: number;    readonly name: string;    readonly age: number;}</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const bob: {    readonly id: number;    readonly name: string;    readonly age: number;}</code></pre>
</figure>
:::
::::
...
[age]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[40]{style="--0:#005CC5;--1:#79B8FF"}[
})]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::
::::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>function equals&lt;{    readonly id: number;    readonly name: string;    readonly age: number;}, {    id: number;    name: string;    age: number;}&gt;(self: {    readonly id: number;    readonly name: string;    readonly age: number;}, that: {    id: number;    name: string;    age: number;}): boolean (+1 overload)</code></pre>
</figure>
:::
...
[Data.struct](../../data-types/data/index.html#struct) function to
create structured data objects and check their equality using
`Equal.equals`{dir="auto"}. The Data module simplifies the process by
providing a default implementation for both `Equal`{dir="auto"} and
`Hash`{dir="auto"}, allowing you to focus on comparing values without
the need for explicit implementations.

The Data module isn't limited to just structs. It can handle various
data types, including tuples, arrays, and records. If you're curious
about how to leverage its full range of features, you can explore the
[Data module
documentation](../../data-types/data/index.html#value-equality).

::: {.autolink-heading-container .level-h2 tabindex="-1"}
## Working with Collections

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#working-with-collections){.anchor-link
aria-labelledby="working-with-collections"}
:::

JavaScript's built-in `Set`{dir="auto"} and `Map`{dir="auto"} can be a
bit tricky when it comes to checking equality:

**Example** (Native `Set`{dir="auto"} with Reference-Based Equality)

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>1const const set: Set&lt;unknown&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>var Set: SetConstructornew &lt;unknown&gt;(iterable?: Iterable&lt;unknown&gt; | null | undefined) =&gt; Set&lt;unknown&gt; (+1 overload)</code></pre>
</figure>
:::
::::

[Set]{style="--0:#6F42C1;--1:#B392F0"}[()]{style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Adding two objects with the same content to the
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const set: Set&lt;unknown&gt;</code></pre>
</figure>
:::
::::

[set]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Set&lt;unknown&gt;.add(value: unknown): Set&lt;unknown&gt;</code></pre>
</figure>
:::
...
::: code
[// Even though the objects have identical values, they are
treated]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// as different elements because JavaScript compares objects by
...
::: code
[// not by value.]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Set&lt;unknown&gt;.size: number</code></pre>
</figure>
:::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@returns]{.twoslash-popup-docs-tag-name} ― [the number of (unique)
elements in Set.]{.twoslash-popup-docs-tag-value}
:::
:::::

[size]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::
::::::::::::::::::::::
...
::: code
[// Output: 2]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
Even though the two elements in the set have the same values, the set
contains two elements. Why? JavaScript's `Set`{dir="auto"} checks for
equality by reference, not by values.

To perform value-based equality checks, you'll need to use the
`Hash*`{dir="auto"} collection types available in the
`effect`{dir="auto"} package. These collection types, such as
[HashSet](https://effect-ts.github.io/effect/effect/HashSet.ts.html) and
[HashMap](https://effect-ts.github.io/effect/effect/HashMap.ts.html),
provide support for the `Equal`{dir="auto"} interface.
...
When you use the `HashSet`{dir="auto"}, it correctly handles value-based
equality checks. In the following example, even though you're adding two
objects with the same values, the `HashSet`{dir="auto"} treats them as a
single element.

**Example** (Using `HashSet`{dir="auto"} for Value-Based Equality)
...
::: code
[// Creating a HashSet with objects that implement the Equal
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const set: HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;HashSet.HashSet&lt;never&gt;, HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt;, HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt;&gt;(this: HashSet.HashSet&lt;never&gt;, ab: (_: HashSet.HashSet&lt;never&gt;) =&gt; HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt;, bc: (_: HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt;) =&gt; HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt;): HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const add: &lt;{    readonly name: string;    readonly age: number;}&gt;(value: {    readonly name: string;    readonly age: number;}) =&gt; (self: HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt;) =&gt; HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[// HashSet recognizes them as equal, so only one element is
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const size: &lt;{    readonly name: string;    readonly age: number;}&gt;(self: HashSet.HashSet&lt;{    readonly name: string;    readonly age: number;}&gt;) =&gt; number</code></pre>
</figure>
:::
...
**Note**: It's crucial to use elements that implement the
`Equal`{dir="auto"} interface, either by implementing custom equality
checks or by using the Data module. This ensures proper functionality
when working with `HashSet`{dir="auto"}. Without this, you'll encounter
the same behavior as the native `Set`{dir="auto"} data type:

**Example** (Reference-Based Equality in `HashSet`{dir="auto"})
...
::: code
[// Creating a HashSet with objects that do NOT
implement]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// the Equal interface]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const set: HashSet.HashSet&lt;{    name: string;    age: number;}&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;HashSet.HashSet&lt;never&gt;, HashSet.HashSet&lt;{    name: string;    age: number;}&gt;, HashSet.HashSet&lt;{    name: string;    age: number;}&gt;&gt;(this: HashSet.HashSet&lt;never&gt;, ab: (_: HashSet.HashSet&lt;never&gt;) =&gt; HashSet.HashSet&lt;{    name: string;    age: number;}&gt;, bc: (_: HashSet.HashSet&lt;{    name: string;    age: number;}&gt;) =&gt; HashSet.HashSet&lt;{    name: string;    age: number;}&gt;): HashSet.HashSet&lt;{    name: string;    age: number;}&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const add: &lt;{    name: string;    age: number;}&gt;(value: {    name: string;    age: number;}) =&gt; (self: HashSet.HashSet&lt;{    name: string;    age: number;}&gt;) =&gt; HashSet.HashSet&lt;{    name: string;    age: number;}&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[// Since these objects are compared by
reference,]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// HashSet considers them different]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const size: &lt;{    name: string;    age: number;}&gt;(self: HashSet.HashSet&lt;{    name: string;    age: number;}&gt;) =&gt; number</code></pre>
</figure>
:::
...
In this case, without using the Data module alongside
`HashSet`{dir="auto"}, you'll experience the same behavior as the native
`Set`{dir="auto"} data type. The set contains two elements because it
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#hashmap){.anchor-link
aria-labelledby="hashmap"}
:::

When working with the `HashMap`{dir="auto"}, you have the advantage of
comparing keys by their values instead of their references. This is
particularly helpful in scenarios where you want to associate values
with keys based on their content.

**Example** (Value-Based Key Comparisons with `HashMap`{dir="auto"})

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>1import { import HashMap</code></pre>
</figure>
:::

[HashMap]{style="--0:#24292E;--1:#E1E4E8"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Adding two objects with identical values as
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const map: HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;</code></pre>
</figure>
:::
::::

[map]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import HashMap</code></pre>
</figure>
:::
::::

[HashMap]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const empty: &lt;never, never&gt;() =&gt; HashMap.HashMap&lt;never, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;HashMap.HashMap&lt;never, never&gt;, HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;, HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;&gt;(this: HashMap.HashMap&lt;never, never&gt;, ab: (_: HashMap.HashMap&lt;never, never&gt;) =&gt; HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;, bc: (_: HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;) =&gt; HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;): HashMap.HashMap&lt;...&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const set: &lt;{    readonly name: string;    readonly age: number;}, number&gt;(key: {    readonly name: string;    readonly age: number;}, value: number) =&gt; (self: HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;) =&gt; HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const size: &lt;{    readonly name: string;    readonly age: number;}, number&gt;(self: HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;) =&gt; number</code></pre>
</figure>
:::
...
[map]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::::
:::::::::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const get: &lt;{    readonly name: string;    readonly age: number;}, {    readonly name: string;    readonly age: number;}, number&gt;(self: HashMap.HashMap&lt;{    readonly name: string;    readonly age: number;}, number&gt;, key: {    readonly name: string;    readonly age: number;}) =&gt; Option&lt;number&gt; (+1 overload)</code></pre>
</figure>
:::
...
In this code snippet, `HashMap`{dir="auto"} is used to create a map
where the keys are objects constructed with `Data.struct`{dir="auto"}.
These objects contain identical values, which would usually create
separate entries in a regular JavaScript `Map`{dir="auto"} because the
default comparison is reference-based.

`HashMap`{dir="auto"}, however, uses value-based comparison, meaning the
two objects with identical content are treated as the same key. Thus,
when we add both objects, the second key-value pair overrides the first,
resulting in a single entry in the map.
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/trait/equal.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../../data-types/redacted/index.html){.astro-u5aomj4k
rel="prev"}
...
.astro-4rgy7crp} [ Next\
[Hash]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../hash/index.html){.astro-u5aomj4k rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
