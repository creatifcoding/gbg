defmodule Maiden.LineRuntime.Validators.LineValidator do
  @moduledoc """
  Cross-runtime payload validator for the Line domain.

  Mirrors TypeScript Effect Schema artifacts generated under `../schemas`.
  """

  @line_schema_path Path.expand("../../../../../schemas/line.schema.json", __DIR__)
  @transition_schema_path Path.expand("../../../../../schemas/line_transition.schema.json", __DIR__)
  @agent_state_schema_path Path.expand("../../../../../schemas/line_agent_state.schema.json", __DIR__)

  @external_resource @line_schema_path
  ...
  @spec line_validate(map(), keyword()) :: :ok | {:error, term()}
  def line_validate(payload, opts \\ []) when is_map(payload) do
    validate(payload, :line, Keyword.get(opts, :engine, :auto))
  end
  ...
  defp validate(payload, :line, :ex_json_schema),
    do: normalize_ex_json_schema(ExJsonSchema.Validator.validate(@line_schema_runtime, payload))
