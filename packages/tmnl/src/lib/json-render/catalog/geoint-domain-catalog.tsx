 ...
 *
 * Full-featured GEOINT dashboard components for json-render.
 * Enables LLMs to generate operational dashboards with map, search, entity panel, and timeline.
 *
 * @module json-render/catalog/geoint-domain-catalog
 */
 ...
 * Maps json-render element props to GeointDashboardPanel props.
 */
