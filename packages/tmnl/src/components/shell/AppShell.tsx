...
type AppShellCompound = ((props: AppShellProps) => React.JSX.Element) & {
  Header: (props: AppShellHeaderProps) => React.JSX.Element
  Sidebar: (props: AppShellSidebarProps) => React.JSX.Element
  Workspace: (props: AppShellWorkspaceProps) => React.JSX.Element
}
