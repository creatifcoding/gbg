...
# Schema to Standard Schema {#_top .astro-np5lzwrf}
:::
::::
...
::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::: sl-markdown-content
The `Schema.standardSchemaV1`{dir="auto"} API allows you to generate a
[Standard Schema v1](https://standardschema.dev/) object from an Effect
`Schema`{dir="auto"}.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const schema: Schema.Struct&lt;{    name: typeof Schema.String;}&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>function Struct&lt;{    name: typeof Schema.String;}&gt;(fields: {    name: typeof Schema.String;}): Schema.Struct&lt;{    name: typeof Schema.String;}&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[// Convert an Effect schema into a Standard Schema V1
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const standardSchema: StandardSchemaV1&lt;{    readonly name: string;}, {    readonly name: string;}&gt; &amp; Schema.SchemaClass&lt;{    readonly name: string;}, {    readonly name: string;}, never&gt;</code></pre>
</figure>
:::
::::

[standardSchema]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const standardSchemaV1: &lt;{    readonly name: string;}, {    readonly name: string;}&gt;(schema: Schema.Schema&lt;{    readonly name: string;}, {    readonly name: string;}, never&gt;, overrideOptions?: ParseOptions) =&gt; StandardSchemaV1&lt;{    readonly name: string;}, {    readonly name: string;}&gt; &amp; Schema.SchemaClass&lt;{    readonly name: string;}, {    readonly name: string;}, never&gt;</code></pre>
</figure>
:::
...
This function creates a schema whose `validate` method attempts to
decode and validate the provided input synchronously. If the underlying
`Schema` includes any asynchronous components (e.g., asynchronous
message resolutions or checks), then validation will necessarily return
a `Promise` instead.
...
//      ┌─── StandardSchemaV1&lt;{ readonly name: string; }&gt;//      ▼const standardSchema = Schema.standardSchemaV1(schema)</code></pre>
</figure>
:::
...
[standardSchemaV1]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
.astro-4rgy7crp} Schema Restrictions

::: starlight-aside__content
Only schemas that do not have dependencies (i.e.,
`R = never`{dir="auto"}) can be converted to a Standard Schema V1
object.
:::
...
aria-hidden="true"}](index.html#sync-vs-async-validation){.anchor-link
aria-labelledby="sync-vs-async-validation"}
:::

The `Schema.standardSchemaV1`{dir="auto"} API creates a schema whose
`validate`{dir="auto"} method attempts to decode and validate the
provided input synchronously. If the underlying `Schema`{dir="auto"}
includes any asynchronous components (e.g., asynchronous message
resolutions or checks), then validation will necessarily return a
`Promise`{dir="auto"} instead.
...
::: code
[// Utility function to display sync and async
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const print: &lt;T&gt;(t: T) =&gt; void | Promise&lt;void&gt;</code></pre>
</figure>
:::
::::

[print]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
\<]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>function (type parameter) T in &lt;T&gt;(t: T): void | Promise&lt;void&gt;</code></pre>
</figure>
:::
::::

[T]{style="--0:#6F42C1;--1:#B392F0"}[\>(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>t: T</code></pre>
</figure>
:::
::::

[t]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>t: T &amp; Promise&lt;any&gt;</code></pre>
</figure>
:::
::::

[t]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Promise&lt;any&gt;.then&lt;void, never&gt;(onfulfilled?: ((value: any) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined, onrejected?: ((reason: any) =&gt; PromiseLike&lt;never&gt;) | null | undefined): Promise&lt;void&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>x: any</code></pre>
</figure>
:::
::::

[x]{style="--0:#AE4B07;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Promise\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#005CC5;--1:#79B8FF"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Value\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#005CC5;--1:#79B8FF"}
...
::: code
[// Define a synchronous schema]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const sync: Schema.Struct&lt;{    name: typeof Schema.String;}&gt;</code></pre>
</figure>
:::
::::

[sync]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const syncStandardSchema: StandardSchemaV1&lt;{    readonly name: string;}, {    readonly name: string;}&gt; &amp; Schema.SchemaClass&lt;{    readonly name: string;}, {    readonly name: string;}, never&gt;</code></pre>
</figure>
:::
::::

[syncStandardSchema]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[sync]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
::: code
[// Validate synchronously]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const print: &lt;StandardSchemaV1&lt;Input = unknown, Output = Input&gt;.Result&lt;{    readonly name: string;}&gt; | Promise&lt;StandardSchemaV1.Result&lt;{    readonly name: string;}&gt;&gt;&gt;(t: StandardSchemaV1.Result&lt;{    readonly name: string;}&gt; | Promise&lt;StandardSchemaV1.Result&lt;{    readonly name: string;}&gt;&gt;) =&gt; void | Promise&lt;void&gt;</code></pre>
</figure>
:::
::::

[print]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[syncStandardSchema]{style="--0:#24292E;--1:#E1E4E8"}[\[]{style="--0:#24292E;--1:#E1E4E8"}[\"\~standard\"]{style="--0:#032F62;--1:#9ECBFF"}[\].]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>StandardSchemaV1&lt;Input = unknown, Output = Input&gt;.Props&lt;{ readonly name: string; }, { readonly name: string; }&gt;.validate: (value: unknown) =&gt; StandardSchemaV1&lt;Input = unknown, Output = Input&gt;.Result&lt;{    readonly name: string;}&gt; | Promise&lt;StandardSchemaV1.Result&lt;{    readonly name: string;}&gt;&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>name: null</code></pre>
</figure>
:::
::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[\"issues\":
\[]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[
]{style="--0:#616972;--1:#99A0A6"}]{.indent}[\"name\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[\"message\": \"Expected
string, actual null\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// Define an asynchronous schema with a
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const async: Schema.transformOrFail&lt;Schema.Struct&lt;{    name: typeof Schema.String;}&gt;, Schema.Struct&lt;{    name: typeof Schema.NonEmptyString;}&gt;, never&gt;</code></pre>
</figure>
:::
::::

[async]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const transformOrFail: &lt;Schema.Struct&lt;{    name: typeof Schema.NonEmptyString;}&gt;, Schema.Struct&lt;{    name: typeof Schema.String;}&gt;, never, never&gt;(from: Schema.Struct&lt;{    name: typeof Schema.String;}&gt;, to: Schema.Struct&lt;{    name: typeof Schema.NonEmptyString;}&gt;, options: {    readonly decode: (fromA: {        readonly name: string;    }, options: ParseOptions, ast: Transformation, fromI: {        readonly name: string;    }) =&gt; Effect.Effect&lt;{        readonly name: string;    }, ParseIssue, never&gt;;    readonly encode: (toI: {        readonly name: string;    }, options: ParseOptions, ast: Transformation, toA: {        ...;    }) =&gt; Effect.Effect&lt;...&gt;;    readonly strict?: true;} | {    ...;}) =&gt; Schema.transformOrFail&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::

::: twoslash-popup-docs
Create a new `Schema` by transforming the input and output of an
existing `Schema` using the provided decoding functions.
:::
...
[transformOrFail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: code
[ ]{.indent}[// Simulate an asynchronous validation
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>decode: (x: {    readonly name: string;}) =&gt; Effect.Effect&lt;{    readonly name: string;}, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>x: {    readonly name: string;}</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;void, never, never&gt;, Effect.Effect&lt;{    readonly name: string;}, never, never&gt;&gt;(this: Effect.Effect&lt;void, never, never&gt;, ab: (_: Effect.Effect&lt;void, never, never&gt;) =&gt; Effect.Effect&lt;{    readonly name: string;}, never, never&gt;): Effect.Effect&lt;{    readonly name: string;}, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const as: &lt;{    readonly name: string;}&gt;(value: {    readonly name: string;}) =&gt; &lt;A, E, R&gt;(self: Effect.Effect&lt;A, E, R&gt;) =&gt; Effect.Effect&lt;{    readonly name: string;}, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[x]{style="--0:#24292E;--1:#E1E4E8"}[)),]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::::::::::
::::::::::::::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>encode: &lt;A&gt;(value: A) =&gt; Effect.Effect&lt;A&gt;</code></pre>
</figure>
:::
::::

[encode]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const succeed: &lt;A&gt;(value: A) =&gt; Effect.Effect&lt;A&gt;</code></pre>
</figure>
:::
...
[succeed]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const asyncStandardSchema: StandardSchemaV1&lt;{    readonly name: string;}, {    readonly name: string;}&gt; &amp; Schema.SchemaClass&lt;{    readonly name: string;}, {    readonly name: string;}, never&gt;</code></pre>
</figure>
:::
::::

[asyncStandardSchema]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[async]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
::: code
[// Validate asynchronously]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[asyncStandardSchema]{style="--0:#24292E;--1:#E1E4E8"}[\[]{style="--0:#24292E;--1:#E1E4E8"}[\"\~standard\"]{style="--0:#032F62;--1:#9ECBFF"}[\].]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: code
[Promise {]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[\"message\": \"Expected
a non empty string, actual \\\"\\\"\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
If an unexpected defect occurs during validation, it is reported as a
single issue without a `path`{dir="auto"}. This ensures that unexpected
errors do not disrupt schema validation but are still captured and
reported.
...
::: code
[// Define a schema with a defect in the decode
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const defect: Schema.transformOrFail&lt;typeof Schema.String, typeof Schema.String, never&gt;</code></pre>
</figure>
:::
::::

[defect]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const transformOrFail: &lt;typeof Schema.String, typeof Schema.String, never, never&gt;(from: typeof Schema.String, to: typeof Schema.String, options: {    readonly decode: (fromA: string, options: ParseOptions, ast: Transformation, fromI: string) =&gt; Effect.Effect&lt;string, ParseIssue, never&gt;;    readonly encode: (toI: string, options: ParseOptions, ast: Transformation, toA: string) =&gt; Effect.Effect&lt;string, ParseIssue, never&gt;;    readonly strict?: true;} | {    ...;}) =&gt; Schema.transformOrFail&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::
...
[transformOrFail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>decode: () =&gt; Effect.Effect&lt;never, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const defectStandardSchema: StandardSchemaV1&lt;string, string&gt; &amp; Schema.SchemaClass&lt;string, string, never&gt;</code></pre>
</figure>
:::
::::

[defectStandardSchema]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const standardSchemaV1: &lt;string, string&gt;(schema: Schema.Schema&lt;string, string, never&gt;, overrideOptions?: ParseOptions) =&gt; StandardSchemaV1&lt;string, string&gt; &amp; Schema.SchemaClass&lt;string, string, never&gt;</code></pre>
</figure>
:::
...
[defectStandardSchema]{style="--0:#24292E;--1:#E1E4E8"}[\[]{style="--0:#24292E;--1:#E1E4E8"}[\"\~standard\"]{style="--0:#032F62;--1:#9ECBFF"}[\].]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>StandardSchemaV1&lt;Input = unknown, Output = Input&gt;.Props&lt;string, string&gt;.validate: (value: unknown) =&gt; StandardSchemaV1&lt;Input = unknown, Output = Input&gt;.Result&lt;string&gt; | Promise&lt;StandardSchemaV1.Result&lt;string&gt;&gt;</code></pre>
</figure>
:::
...
[validate]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"a\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::
::::::::::::::::::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/schema/standard-schema.mdx){.sl-flex
...
.astro-4rgy7crp} [ Next\
[Arbitrary]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../arbitrary/index.html){.astro-u5aomj4k rel="next"}
:::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
