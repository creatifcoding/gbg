...
export interface DomainRegistryShape {
   ...
   */
  readonly register: (name: string, config: DomainConfig) => Effect.Effect<void>

  /**
   * List all registered domains.
   */
  readonly list: () => Effect.Effect<readonly { name: string; config: DomainConfig }[]>
   ...
   */
  readonly getConfig: (ns: string) => Effect.Effect<DomainConfig | null>
}
