...
# Resourceful Streams {#_top .astro-np5lzwrf}
:::
::::
...
::::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
::::: sl-markdown-content
In the Stream module, you'll find that most of the constructors offer a
special variant designed for lifting a scoped resource into a
`Stream`{dir="auto"}. When you use these specific constructors, you're
essentially creating streams that are inherently safe with regards to
resource management. These constructors, before creating the stream,
handle the resource acquisition, and after the stream's usage, they
ensure its proper closure.

Stream also provides us with `Stream.acquireRelease`{dir="auto"} and
`Stream.finalizer`{dir="auto"} constructors that share similarities with
`Effect.acquireRelease`{dir="auto"} and
`Effect.addFinalizer`{dir="auto"}. These tools empower us to perform
cleanup or finalization tasks before the stream concludes its operation.
...
aria-hidden="true"}](index.html#acquire-release){.anchor-link
aria-labelledby="acquire-release"}
:::

In this section, we'll explore an example that demonstrates the use of
`Stream.acquireRelease`{dir="auto"} when working with file operations.
...
::: code
[// Simulating File operations]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const open: (filename: string) =&gt; Effect.Effect&lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never, never&gt;</code></pre>
</figure>
:::
::::

[open]{style="--0:#6F42C1;--1:#B392F0"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>filename: string</code></pre>
</figure>
:::
::::

[filename]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt;, {    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt;, {    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never&gt;) =&gt; Effect.Effect&lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Opening
...
[filename]{style="--0:#24292E;--1:#E1E4E8"}[}\`]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>getLines: Effect.Effect&lt;string[], never, never&gt;</code></pre>
</figure>
:::
::::

[getLines]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[succeed]{style="--0:#6F42C1;--1:#B392F0"}[(\[]{style="--0:#24292E;--1:#E1E4E8"}[\"Line
1\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"Line
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>close: Effect.Effect&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::

[close]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Closing
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const stream: Stream.Stream&lt;string[], never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const acquireRelease: &lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never, never, never, void&gt;(acquire: Effect.Effect&lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never, never&gt;, release: (resource: {    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, exit: Exit&lt;unknown, unknown&gt;) =&gt; Effect.Effect&lt;void, never, never&gt;) =&gt; Stream.Stream&lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never, never&gt;</code></pre>
</figure>
:::
...
// Simulating File operationsconst open = (filename: string) =&gt;  Effect.gen(function*() {    yield* Console.log(`Opening ${filename}`)    return {      getLines: Effect.succeed([&quot;Line 1&quot;, &quot;Line 2&quot;, &quot;Line 3&quot;]),      close: Console.log(`Closing ${filename}`)    }  })
const stream = Stream.acquireRelease(  open(&quot;file.txt&quot;),  (file) =&gt; file.close).pipe(Stream.flatMap((file) =&gt; file.getLines))
Effect.runPromise(Stream.runCollect(stream)).then(console.log)// Opening file.txt// Closing file.txt// { _id: &#39;Chunk&#39;, values: [ [ &#39;Line 1&#39;, &#39;Line 2&#39;, &#39;Line 3&#39; ] ] }</code></pre>
</figure>
:::
...
[acquireRelease]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
[open]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"file.txt\"]{style="--0:#032F62;--1:#9ECBFF"}[),]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>file: {    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}</code></pre>
</figure>
:::
::::

[file]{style="--0:#AE4B07;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[file]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Stream.Stream&lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never, never&gt;, Stream.Stream&lt;string[], never, never&gt;&gt;(this: Stream.Stream&lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never, never&gt;, ab: (_: Stream.Stream&lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, never, never&gt;) =&gt; Stream.Stream&lt;string[], never, never&gt;): Stream.Stream&lt;...&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const flatMap: &lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, string[], never, never&gt;(f: (a: {    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}) =&gt; Stream.Stream&lt;string[], never, never&gt;, options?: {    readonly concurrency?: number | &quot;unbounded&quot; | undefined;    readonly bufferSize?: number | undefined;    readonly switch?: boolean | undefined;} | undefined) =&gt; &lt;E, R&gt;(self: Stream.Stream&lt;{    getLines: Effect.Effect&lt;string[], never, never&gt;;    close: Effect.Effect&lt;void, never, never&gt;;}, E, R&gt;) =&gt; Stream.Stream&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::
...
[getLines]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::
::::::::::::::::::::
...
::: code
[Opening file.txt]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Closing file.txt]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[\[ \"Line 1\", \"Line
2\", \"Line 3\" \]]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
In this code snippet, we're simulating file operations using the
`open`{dir="auto"} function. The `Stream.acquireRelease`{dir="auto"}
function is employed to ensure that the file is correctly opened and
closed, and we then process the lines of the file using the acquired
resource.
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#finalization){.anchor-link
aria-labelledby="finalization"}
:::

In this section, we'll explore the concept of finalization in streams.
Finalization allows us to execute a specific action before a stream
ends. This can be particularly useful when we want to perform cleanup
tasks or add final touches to a stream.

Imagine a scenario where our streaming application needs to clean up a
temporary directory when it completes its execution. We can achieve this
using the `Stream.finalizer`{dir="auto"} function:
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const application: Stream.Stream&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::

[application]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fromEffect: &lt;void, never, never&gt;(effect: Effect.Effect&lt;void, never, never&gt;) =&gt; Stream.Stream&lt;void, never, never&gt;</code></pre>
</figure>
:::
...
Logic.\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::
::::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const deleteDir: (dir: string) =&gt; Effect.Effect&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::

[deleteDir]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>dir: string</code></pre>
</figure>
:::
::::

[dir]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[string]{style="--0:#005CC5;--1:#79B8FF"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Deleting
dir:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[dir]{style="--0:#24292E;--1:#E1E4E8"}[}\`]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const program: Stream.Stream&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::
...
[application]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const concat: &lt;void, never, never&gt;(that: Stream.Stream&lt;void, never, never&gt;) =&gt; &lt;A, E, R&gt;(self: Stream.Stream&lt;A, E, R&gt;) =&gt; Stream.Stream&lt;void | A, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const finalizer: &lt;never, void&gt;(finalizer: Effect.Effect&lt;void, never, never&gt;) =&gt; Stream.Stream&lt;void, never, never&gt;</code></pre>
</figure>
:::
...
const program = application.pipe(  Stream.concat(    Stream.finalizer(      deleteDir(&quot;tmp&quot;).pipe(        Effect.andThen(Console.log(&quot;Temporary directory was deleted.&quot;))      )    )  ))
Effect.runPromise(Stream.runCollect(program)).then(console.log)// Application Logic.// Deleting dir: tmp// Temporary directory was deleted.// { _id: &#39;Chunk&#39;, values: [ undefined, undefined ] }</code></pre>
</figure>
:::
...
[finalizer]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
[deleteDir]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"tmp\"]{style="--0:#032F62;--1:#9ECBFF"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Temporary
directory was
deleted.\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::
::::::::::::::::::::
...
::: code
[Application Logic.]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Deleting dir: tmp]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Temporary directory was deleted.]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
In this code example, we start with our application logic represented by
the `application`{dir="auto"} stream. We then use
`Stream.finalizer`{dir="auto"} to define a finalization step, which
deletes a temporary directory and logs a message. This ensures that the
temporary directory is cleaned up properly when the application
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#ensuring){.anchor-link
aria-labelledby="ensuring"}
:::

In this section, we'll explore a scenario where we need to perform
actions after the finalization of a stream. To achieve this, we can
utilize the `Stream.ensuring`{dir="auto"} operator.

Consider a situation where our application has completed its primary
logic and finalized some resources, but we also need to perform
additional actions afterward. We can use `Stream.ensuring`{dir="auto"}
for this purpose:
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Application
Logic.\"]{style="--0:#032F62;--1:#9ECBFF"}[)).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Stream.Stream&lt;void, never, never&gt;, Stream.Stream&lt;void, never, never&gt;, Stream.Stream&lt;void, never, never&gt;&gt;(this: Stream.Stream&lt;void, never, never&gt;, ab: (_: Stream.Stream&lt;void, never, never&gt;) =&gt; Stream.Stream&lt;void, never, never&gt;, bc: (_: Stream.Stream&lt;void, never, never&gt;) =&gt; Stream.Stream&lt;void, never, never&gt;): Stream.Stream&lt;void, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
[finalizer]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Finalizing
the
stream\"]{style="--0:#032F62;--1:#9ECBFF"}[))),]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::::
:::::::::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const ensuring: &lt;void, never&gt;(finalizer: Effect.Effect&lt;void, never, never&gt;) =&gt; &lt;A, E, R&gt;(self: Stream.Stream&lt;A, E, R&gt;) =&gt; Stream.Stream&lt;A, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
<figure class="frame">
<pre data-language="ts"><code>import { Console, Effect, Stream } from &quot;effect&quot;
const program = Stream.fromEffect(Console.log(&quot;Application Logic.&quot;)).pipe(  Stream.concat(Stream.finalizer(Console.log(&quot;Finalizing the stream&quot;))),  Stream.ensuring(    Console.log(&quot;Doing some other works after stream&#39;s finalization&quot;)  ))
Effect.runPromise(Stream.runCollect(program)).then(console.log)// Application Logic.// Finalizing the stream// Doing some other works after stream&#39;s finalization// { _id: &#39;Chunk&#39;, values: [ undefined, undefined ] }</code></pre>
</figure>
:::
...
[ensuring]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Doing
some other works after stream\'s
finalization\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::
:::::::::::
...
::: code
[Finalizing the stream]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Doing some other works after stream\'s
finalization]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
In this code example, we start with our application logic represented by
the `Application Logic.`{dir="auto"} message. We then use
`Stream.finalizer`{dir="auto"} to specify the finalization step, which
logs `Finalizing the stream`{dir="auto"}. After that, we use
`Stream.ensuring`{dir="auto"} to indicate that we want to perform
additional tasks after the stream's finalization, resulting in the
message
`Performing additional tasks after stream's finalization`{dir="auto"}.
This ensures that our post-finalization actions are executed as
expected.
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/stream/resourceful-streams.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../../sink/introduction/index.html){.astro-u5aomj4k
rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
