...
::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::::: sl-markdown-content
A `Deferred<Success, Error>`{dir="auto"} is a specialized subtype of
`Effect`{dir="auto"} that acts like a one-time variable with some unique
characteristics. It can only be completed once, making it a useful tool
for managing asynchronous operations and synchronization between
different parts of your program.

A deferred is essentially a synchronization primitive that represents a
value that may not be available right away. When you create a deferred,
it starts out empty. Later, it can be completed with either a success
value `Success`{dir="auto"} or an error value `Error`{dir="auto"}:

::: expressive-code
<figure class="frame not-content">
<pre data-language="text"><code>           ┌─── Represents the success type           │        ┌─── Represents the error type           │        │           ▼        ▼Deferred&lt;Success, Error&gt;</code></pre>
<div class="copy">
<div>
...
When a fiber calls `Deferred.await`{dir="auto"}, it will pause until the
deferred is completed. While the fiber is waiting, it doesn't block the
thread, it only blocks semantically. This means other fibers can still
run, ensuring efficient concurrency.

A deferred is conceptually similar to JavaScript's
`Promise`{dir="auto"}. The key difference is that it supports both
success and error types, giving more type safety.
...
aria-hidden="true"}](index.html#creating-a-deferred){.anchor-link
aria-labelledby="creating-a-deferred"}
:::

A deferred can be created using the `Deferred.make`{dir="auto"}
constructor. This returns an effect that represents the creation of the
deferred. Since the creation of a deferred involves memory allocation,
it must be done within an effect to ensure safe management of resources.

**Example** (Creating a Deferred)

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>1import { import Deferred</code></pre>
</figure>
:::
::::::

[Deferred]{style="--0:#24292E;--1:#E1E4E8"}[ }
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const deferred: Effect&lt;Deferred.Deferred&lt;string, Error&gt;, never, never&gt;</code></pre>
</figure>
:::
::::

[deferred]{style="--0:#005CC5;--1:#79B8FF"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import Deferred</code></pre>
</figure>
:::
::::

[Deferred]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;string, Error&gt;() =&gt; Effect&lt;Deferred.Deferred&lt;string, Error&gt;, never, never&gt;</code></pre>
</figure>
:::
...
[make]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[string]{style="--0:#005CC5;--1:#79B8FF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#awaiting){.anchor-link
aria-labelledby="awaiting"}
:::

To retrieve a value from a deferred, you can use
`Deferred.await`{dir="auto"}. This operation suspends the calling fiber
until the deferred is completed with a value or an error.
...
::: code
[// ┌─── Effect\<Deferred\<string, Error\>, never,
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const deferred: Effect.Effect&lt;Deferred.Deferred&lt;string, Error&gt;, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;string, Error&gt;() =&gt; Effect.Effect&lt;Deferred.Deferred&lt;string, Error&gt;, never, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const value: Effect.Effect&lt;string, Error, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;Deferred.Deferred&lt;string, Error&gt;, never, never&gt;, Effect.Effect&lt;string, Error, never&gt;&gt;(this: Effect.Effect&lt;Deferred.Deferred&lt;string, Error&gt;, never, never&gt;, ab: (_: Effect.Effect&lt;Deferred.Deferred&lt;string, Error&gt;, never, never&gt;) =&gt; Effect.Effect&lt;string, Error, never&gt;): Effect.Effect&lt;string, Error, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const andThen: &lt;Deferred.Deferred&lt;string, Error&gt;, Effect.Effect&lt;string, Error, never&gt;&gt;(f: (a: Deferred.Deferred&lt;string, Error&gt;) =&gt; Effect.Effect&lt;string, Error, never&gt;) =&gt; &lt;E, R&gt;(self: Effect.Effect&lt;Deferred.Deferred&lt;string, Error&gt;, E, R&gt;) =&gt; Effect.Effect&lt;string, Error | E, R&gt; (+3 overloads)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const await: &lt;A, E&gt;(self: Deferred.Deferred&lt;A, E&gt;) =&gt; Effect.Effect&lt;A, E&gt;export await</code></pre>
</figure>
:::
...
[await]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::::::
:::::::::::::::::::::::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#completing){.anchor-link
aria-labelledby="completing"}
:::

You can complete a deferred in several ways, depending on whether you
want to succeed, fail, or interrupt the waiting fibers:

  API                                   Description
  ------------------------------------- -----------------------------------------------------------------------------------------------------------------
  `Deferred.succeed`{dir="auto"}        Completes the deferred successfully with a value.
  `Deferred.done`{dir="auto"}           Completes the deferred with an [Exit](../../data-types/exit/index.html) value.
  `Deferred.complete`{dir="auto"}       Completes the deferred with the result of an effect.
  `Deferred.completeWith`{dir="auto"}   Completes the deferred with an effect. This effect will be executed by each waiting fiber, so use it carefully.
  `Deferred.fail`{dir="auto"}           Fails the deferred with an error.
  `Deferred.die`{dir="auto"}            Defects the deferred with a user-defined error.
  `Deferred.failCause`{dir="auto"}      Fails or defects the deferred with a [Cause](../../data-types/cause/index.html).
  `Deferred.interrupt`{dir="auto"}      Interrupts the deferred, forcefully stopping or interrupting the waiting fibers.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const deferred: Deferred.Deferred&lt;number, string&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;number, string&gt;() =&gt; Effect.Effect&lt;Deferred.Deferred&lt;number, string&gt;, never, never&gt;</code></pre>
</figure>
:::
...
[make]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[number]{style="--0:#005CC5;--1:#79B8FF"}[,
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const succeed: &lt;number, string&gt;(self: Deferred.Deferred&lt;number, string&gt;, value: number) =&gt; Effect.Effect&lt;boolean&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Awaiting the Deferred to get its
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>await&lt;number, string&gt;(self: Deferred.Deferred&lt;number, string&gt;): Effect.Effect&lt;number, string, never&gt;export await</code></pre>
</figure>
:::
...
[deferred]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runFork: &lt;void, string&gt;(effect: Effect.Effect&lt;void, string, never&gt;, options?: RunForkOptions) =&gt; RuntimeFiber&lt;void, string&gt;</code></pre>
</figure>
:::
...
Completing a deferred produces an `Effect<boolean>`{dir="auto"}. This
effect returns `true`{dir="auto"} if the deferred was successfully
completed, and `false`{dir="auto"} if it had already been completed
previously. This can be useful for tracking the state of the deferred.
...
::: code
[ ]{.indent}[// Attempt to fail the
Deferred]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const firstAttempt: boolean</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fail: &lt;number, string&gt;(self: Deferred.Deferred&lt;number, string&gt;, error: string) =&gt; Effect.Effect&lt;boolean&gt; (+1 overload)</code></pre>
</figure>
:::

::: twoslash-popup-docs
Fails the `Deferred` with the specified error, which will be propagated
to all fibers waiting on the value of the `Deferred`.
:::
...
::: code
[ ]{.indent}[// Attempt to succeed after it has already been
completed]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const secondAttempt: boolean</code></pre>
</figure>
:::
::::
...
[firstAttempt]{style="--0:#24292E;--1:#E1E4E8"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[secondAttempt]{style="--0:#24292E;--1:#E1E4E8"}[\])]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::
:::::::::::::::::::::
...
::: code
[// Output: \[ true, false \]]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#checking-completion-status){.anchor-link
aria-labelledby="checking-completion-status"}
:::

Sometimes, you might need to check if a deferred has been completed
without suspending the fiber. This can be done using the
`Deferred.poll`{dir="auto"} method. Here's how it works:

- `Deferred.poll`{dir="auto"} returns an
  `Option<Effect<A, E>>`{dir="auto"}:
  - If the `Deferred`{dir="auto"} is incomplete, it returns
    `None`{dir="auto"}.
  - If the `Deferred`{dir="auto"} is complete, it returns
    `Some`{dir="auto"}, which contains the result or error.

Additionally, you can use the `Deferred.isDone`{dir="auto"} function to
check if a deferred has been completed. This method returns an
`Effect<boolean>`{dir="auto"}, which evaluates to `true`{dir="auto"} if
the `Deferred`{dir="auto"} is completed, allowing you to quickly check
its state.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;Deferred.Deferred&lt;number, string&gt;, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;Option&lt;Effect.Effect&lt;number, string, never&gt;&gt;, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;boolean, never, never&gt;&gt;, void&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;Deferred.Deferred&lt;number, string&gt;, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;Option&lt;Effect.Effect&lt;number, string, never&gt;&gt;, never, never&gt;&gt; | YieldWrap&lt;...&gt;, void, never&gt;) =&gt; Effect.Effect&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Polling the Deferred to check if it\'s
completed]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const done1: Option&lt;Effect.Effect&lt;number, string, never&gt;&gt;</code></pre>
</figure>
:::
::::

[done1]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[yield\*]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const poll: &lt;number, string&gt;(self: Deferred.Deferred&lt;number, string&gt;) =&gt; Effect.Effect&lt;Option&lt;Effect.Effect&lt;number, string, never&gt;&gt;, never, never&gt;</code></pre>
</figure>
:::

::: twoslash-popup-docs
Returns a `Some<Effect<A, E, R>>` from the `Deferred` if this `Deferred`
has already been completed, `None` otherwise.
:::
...
::: code
[ ]{.indent}[// Checking if the Deferred has been
completed]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const done2: boolean</code></pre>
</figure>
:::
::::

[done2]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[yield\*]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const isDone: &lt;number, string&gt;(self: Deferred.Deferred&lt;number, string&gt;) =&gt; Effect.Effect&lt;boolean&gt;</code></pre>
</figure>
:::

::: twoslash-popup-docs
Returns `true` if this `Deferred` has already been completed with a
value or an error, `false` otherwise.
:::
...
[isDone]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[done2]{style="--0:#24292E;--1:#E1E4E8"}[\])]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::
:::::::::::::::::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#common-use-cases){.anchor-link
aria-labelledby="common-use-cases"}
:::

`Deferred`{dir="auto"} becomes useful when you need to wait for
something specific to happen in your program. It's ideal for scenarios
where you want one part of your code to signal another part when it's
ready.
...
Here are a few common use cases:
  ...
  **Use Case**               **Description**
  -------------------------- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  **Coordinating Fibers**    When you have multiple concurrent tasks and need to coordinate their actions, `Deferred`{dir="auto"} can help one fiber signal to another when it has completed its task.
  **Synchronization**        Anytime you want to ensure that one piece of code doesn't proceed until another piece of code has finished its work, `Deferred`{dir="auto"} can provide the synchronization you need.
  **Handing Over Work**      You can use `Deferred`{dir="auto"} to hand over work from one fiber to another. For example, one fiber can prepare some data, and then a second fiber can continue processing it.
  **Suspending Execution**   When you want a fiber to pause its execution until some condition is met, a `Deferred`{dir="auto"} can be used to block it until the condition is satisfied.

**Example** (Using Deferred to Coordinate Two Fibers)

In this example, a deferred is used to pass a value between two fibers.

By running both fibers concurrently and using the deferred as a
synchronization point, we can ensure that `fiberB`{dir="auto"} only
proceeds after `fiberA`{dir="auto"} has completed its task.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;Deferred.Deferred&lt;string, string&gt;, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;Fiber.RuntimeFiber&lt;boolean, never&gt;, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;Fiber.RuntimeFiber&lt;string, string&gt;, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;[boolean, string], string, never&gt;&gt;, void&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;Deferred.Deferred&lt;string, string&gt;, never, never&gt;&gt; | YieldWrap&lt;...&gt; | YieldWrap&lt;...&gt; | YieldWrap&lt;...&gt;, void, never&gt;) =&gt; Effect.Effect&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const deferred: Deferred.Deferred&lt;string, string&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;string, string&gt;() =&gt; Effect.Effect&lt;Deferred.Deferred&lt;string, string&gt;, never, never&gt;</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Completes the Deferred with a value after a
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const taskA: Effect.Effect&lt;boolean, never, never&gt;</code></pre>
</figure>
:::
::::

[taskA]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Starting
task to complete the
Deferred\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Completing
the
Deferred\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const succeed: &lt;string, string&gt;(self: Deferred.Deferred&lt;string, string&gt;, value: string) =&gt; Effect.Effect&lt;boolean&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Waits for the Deferred and prints the
value]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const taskB: Effect.Effect&lt;string, string, never&gt;</code></pre>
</figure>
:::
::::

[taskB]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;string, string, never&gt;&gt;, string&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;string, string, never&gt;&gt;, string, never&gt;) =&gt; Effect.Effect&lt;string, string, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Starting
task to get the value from the
Deferred\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>await&lt;string, string&gt;(self: Deferred.Deferred&lt;string, string&gt;): Effect.Effect&lt;string, string, never&gt;export await</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Run both fibers
concurrently]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fiberA: Fiber.RuntimeFiber&lt;boolean, never&gt;</code></pre>
</figure>
:::
::::

[fiberA]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[yield\*]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[taskA]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::
::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fiberB: Fiber.RuntimeFiber&lt;string, string&gt;</code></pre>
</figure>
:::
::::

[fiberB]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[yield\*]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fork: &lt;string, string, never&gt;(self: Effect.Effect&lt;string, string, never&gt;) =&gt; Effect.Effect&lt;Fiber.RuntimeFiber&lt;string, string&gt;, never, never&gt;</code></pre>
</figure>
:::
...
[taskB]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::
::::::::::::::::::
...
::: code
[ ]{.indent}[// Wait for both fibers to
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const both: [boolean, string]</code></pre>
</figure>
:::
::::

[both]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[yield\*]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const join: &lt;[boolean, string], string&gt;(self: Fiber.Fiber&lt;[boolean, string], string&gt;) =&gt; Effect.Effect&lt;[boolean, string], string, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const zip: &lt;boolean, never, string, string&gt;(self: Fiber.Fiber&lt;boolean, never&gt;, that: Fiber.Fiber&lt;string, string&gt;) =&gt; Fiber.Fiber&lt;[boolean, string], string&gt; (+1 overload)</code></pre>
</figure>
:::
...
[fiberA]{style="--0:#24292E;--1:#E1E4E8"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[fiberB]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::::
::::::::::::::::::::::::
...
[both]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::
:::::::::::::::::::
...
::: code
[Starting task to get the value from the
Deferred]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Completing the Deferred]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Got the value from the Deferred]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[\[ true, \'hello world\' \]]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/concurrency/deferred.mdx){.sl-flex
...
[Fibers]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../fibers/index.html){.astro-u5aomj4k rel="prev"}
...
.astro-4rgy7crp} [ Next\
[Queue]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../queue/index.html){.astro-u5aomj4k rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
