...
# Expected Errors {#_top .astro-np5lzwrf}
:::
::::
...
::::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::::: sl-markdown-content
Expected errors are tracked at the type level by the [Effect data
type](../../getting-started/the-effect-type.html) in the "Error
channel":
...
This means that the `Effect`{dir="auto"} type captures not only what the
program returns on success but also what type of error it might produce.

**Example** (Creating an Effect That Can Fail)

In this example, we define a program that might randomly fail with an
`HttpError`{dir="auto"}.
...
::: code
[// Define a custom error type using
Data.TaggedError]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>class HttpError</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const TaggedError: &lt;&quot;HttpError&quot;&gt;(tag: &quot;HttpError&quot;) =&gt; new &lt;A&gt;(args: Equals&lt;A, {}&gt; extends true ? void : { readonly [P in keyof A as P extends &quot;_tag&quot; ? never : P]: A[P]; }) =&gt; YieldableError &amp; {    readonly _tag: &quot;HttpError&quot;;} &amp; Readonly&lt;A&gt;</code></pre>
</figure>
:::
...
[TaggedError]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"HttpError\"]{style="--0:#032F62;--1:#9ECBFF"}[)\<{}\>
{}]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const program: Effect.Effect&lt;string, HttpError, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;never, HttpError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;number, never, never&gt;&gt;, string&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;never, HttpError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;number, never, never&gt;&gt;, string, never&gt;) =&gt; Effect.Effect&lt;string, HttpError, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Generate a random number between 0 and
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const next: Effect.Effect&lt;number, never, never&gt;</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Simulate an HTTP error]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fail: &lt;HttpError&gt;(error: HttpError) =&gt; Effect.Effect&lt;never, HttpError, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>constructor HttpError&lt;{}&gt;(args: void): HttpError</code></pre>
</figure>
:::
::::

[HttpError]{style="--0:#6F42C1;--1:#B392F0"}[())]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
The type of `program`{dir="auto"} tells us that it can either return a
`string`{dir="auto"} or fail with an `HttpError`{dir="auto"}:

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>const program: Effect&lt;string, HttpError, never&gt;</code></pre>
<div class="copy">
<div>
...
In this case, we use a class to represent the `HttpError`{dir="auto"}
type, which allows us to define both the error type and a constructor.

When using `Data.TaggedError`{dir="auto"}, a `_tag`{dir="auto"} field is
automatically added to the class

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>// This field serves as a discriminant for the errorconsole.log(new HttpError()._tag)// Output: &quot;HttpError&quot;</code></pre>
<div class="copy">
<div>
...
This discriminant field will be useful when we discuss APIs like
[Effect.catchTag](index.html#catchtag), which help in handling specific
error types.
...
.astro-4rgy7crp} Why Tagged Errors Are Useful

::: starlight-aside__content
Adding a discriminant field, such as `_tag`{dir="auto"}, can be
beneficial for distinguishing between different types of errors during
error handling. It also prevents TypeScript from unifying types,
ensuring that each error is treated uniquely based on its discriminant
value.

For more information on constructing tagged errors, see
[Data.TaggedError](../yieldable-errors/index.html#datataggederror).
:::
...
aria-hidden="true"}](index.html#error-tracking){.anchor-link
aria-labelledby="error-tracking"}
:::

In Effect, if a program can fail with multiple types of errors, they are
automatically tracked as a union of those error types. This allows you
to know exactly what errors can occur during execution, making error
handling more precise and predictable.

The example below illustrates how errors are automatically tracked for
you.
...
[TaggedError]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"ValidationError\"]{style="--0:#032F62;--1:#9ECBFF"}[)\<{}\>
{}]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
::: code
[// ┌─── Effect\<string, HttpError \| ValidationError,
never\>]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const program: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;never, HttpError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, ValidationError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;number, never, never&gt;&gt;, string&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;never, HttpError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, ValidationError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;number, never, never&gt;&gt;, string, never&gt;) =&gt; Effect.Effect&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Generate two random numbers between 0 and
1]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fail: &lt;ValidationError&gt;(error: ValidationError) =&gt; Effect.Effect&lt;never, ValidationError, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>constructor ValidationError&lt;{}&gt;(args: void): ValidationError</code></pre>
</figure>
:::
::::

[ValidationError]{style="--0:#6F42C1;--1:#B392F0"}[())]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
Effect automatically keeps track of the possible errors that can occur
during the execution of the program as a union:

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>const program: Effect&lt;string, HttpError | ValidationError, never&gt;</code></pre>
<div class="copy">
<div>
...
indicating that it can potentially fail with either a
`HttpError`{dir="auto"} or a `ValidationError`{dir="auto"}.

::: {.autolink-heading-container .level-h2 tabindex="-1"}
## Short-Circuiting

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#short-circuiting){.anchor-link
aria-labelledby="short-circuiting"}
:::

When working with APIs like
...
[Effect.flatMap](../../getting-started/building-pipelines/index.html#flatmap),
and
[Effect.andThen](../../getting-started/building-pipelines/index.html#andthen),
it's important to understand how they handle errors. These APIs are
designed to **short-circuit the execution** upon encountering the
**first error**.

What does this mean for you as a developer? Well, let's say you have a
chain of operations or a collection of effects to be executed in
sequence. If any error occurs during the execution of one of these
effects, the remaining computations will be skipped, and the error will
be propagated to the final result.

In simpler terms, the short-circuiting behavior ensures that if
something goes wrong at any step of your program, it won't waste time
executing unnecessary computations. Instead, it will immediately stop
and return the error to let you know that something went wrong.
...
::: code
[// Define three effects representing different
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const task3: Effect.Effect&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: code
[// Compose the three tasks to run them in
sequence.]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// If one of the tasks fails, the subsequent tasks won\'t be
executed.]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, string, never&gt;&gt;, void&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, string, never&gt;&gt;, void, never&gt;) =&gt; Effect.Effect&lt;void, string, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// After task1, task2 is executed, but it fails with an
error]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[ ]{.indent}[// This computation won\'t be executed because the previous
one fails]{style="--0:#494f56;--1:#b4b9be"}
:::
::::::
...
\'Cause\', \_tag: \'Fail\', failure: \'Something went wrong!\'
}]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
This code snippet demonstrates the short-circuiting behavior when an
error occurs. Each operation depends on the successful execution of the
previous one. If any error occurs, the execution is short-circuited, and
the error is propagated. In this specific example, `task3`{dir="auto"}
is never executed because an error occurs in `task2`{dir="auto"}.

::: {.autolink-heading-container .level-h2 tabindex="-1"}
## Catching All Errors

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#catching-all-errors){.anchor-link
aria-labelledby="catching-all-errors"}
:::
...
By yielding an `Either`{dir="auto"}, we gain the ability to "pattern
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const recovered: Effect.Effect&lt;string, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;Either.Either&lt;string, HttpError | ValidationError&gt;, never, never&gt;&gt;, string&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;Either.Either&lt;string, HttpError | ValidationError&gt;, never, never&gt;&gt;, string, never&gt;) =&gt; Effect.Effect&lt;string, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// ┌─── Either\<string, HttpError \|
ValidationError\>]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failureOrSuccess: Either.Either&lt;string, HttpError | ValidationError&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const either: &lt;string, HttpError | ValidationError, never&gt;(self: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;) =&gt; Effect.Effect&lt;Either.Either&lt;string, HttpError | ValidationError&gt;, never, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const isLeft: &lt;string, HttpError | ValidationError&gt;(self: Either.Either&lt;string, HttpError | ValidationError&gt;) =&gt; self is Either.Left&lt;HttpError | ValidationError, string&gt;</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Failure case: you can extract the error from the
\`left\` property]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const error: HttpError | ValidationError</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failureOrSuccess: Either.Left&lt;HttpError | ValidationError, string&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Left&lt;HttpError | ValidationError, string&gt;.left: HttpError | ValidationError</code></pre>
</figure>
:::
::::
...
::::::: code
[ ]{.indent}[return]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[\`Recovering from
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>_tag: &quot;HttpError&quot; | &quot;ValidationError&quot;</code></pre>
</figure>
:::
::::

[\_tag]{style="--0:#24292E;--1:#E1E4E8"}[}\`]{style="--0:#032F62;--1:#9ECBFF"}
:::::::
::::::::::
...
::: code
[ ]{.indent}[// Success case: you can extract the value from the
\`right\` property]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failureOrSuccess: Either.Right&lt;HttpError | ValidationError, string&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Right&lt;HttpError | ValidationError, string&gt;.right: string</code></pre>
</figure>
:::
::::
...
As you can see since all errors are handled, the error type of the
resulting effect `recovered`{dir="auto"} is `never`{dir="auto"}:

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>const recovered: Effect&lt;string, never, never&gt;</code></pre>
<div class="copy">
<div>
...
We can make the code less verbose by using the
`Either.match`{dir="auto"} function, which directly accepts the two
callback functions for handling errors and successful values:

**Example** (Simplifying with `Either.match`{dir="auto"})
...
::: code
[]{.expand}[]{.collapse}[17 collapsed lines]{.text}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const match: &lt;string, HttpError | ValidationError, string, string&gt;(self: Either.Either&lt;string, HttpError | ValidationError&gt;, options: {    readonly onLeft: (left: HttpError | ValidationError) =&gt; string;    readonly onRight: (right: string) =&gt; string;}) =&gt; string (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onLeft: (left: HttpError | ValidationError) =&gt; string</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>error: HttpError | ValidationError</code></pre>
</figure>
:::
::::
...
[\_tag]{style="--0:#24292E;--1:#E1E4E8"}[}\`]{style="--0:#032F62;--1:#9ECBFF"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onRight: (right: string) =&gt; string</code></pre>
</figure>
:::
::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[// Do nothing in case of
...
[Option](../../data-types/option/index.html) data type.

The `Effect.option`{dir="auto"} function wraps the success or failure of
an effect within the `Option`{dir="auto"} type, making both cases
explicit. If the original effect succeeds, its value is wrapped in
`Option.some`{dir="auto"}. If it fails, the failure is mapped to
`Option.none`{dir="auto"}.

The resulting effect cannot fail directly, as the error type is set to
`never`{dir="auto"}. However, fatal errors like defects are not
encapsulated.

**Example** (Using `Effect.option`{dir="auto"} to Handle Errors)
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const maybe1: Effect.Effect&lt;Option&lt;number&gt;, never, never&gt;</code></pre>
</figure>
:::
::::

[maybe1]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const option: &lt;number, never, never&gt;(self: Effect.Effect&lt;number, never, never&gt;) =&gt; Effect.Effect&lt;Option&lt;number&gt;, never, never&gt;</code></pre>
</figure>
:::
...
original effect succeeds, the success value is wrapped in `Option.some`.
If the effect fails, the failure is converted to `Option.none`.

This is particularly useful for scenarios where you want to represent
the absence of a value explicitly, without causing the resulting effect
to fail. The resulting effect has an error type of `never`, meaning it
cannot fail directly. However, unrecoverable errors, also referred to as
defects, are not captured and will still result in failure.
...
Effect.runPromiseExit(maybe3).then(console.log)// Output:// {//   _id: &#39;Exit&#39;,//   _tag: &#39;Failure&#39;,//   cause: { _id: &#39;Cause&#39;, _tag: &#39;Die&#39;, defect: &#39;Boom!&#39; }// }</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runPromiseExit: &lt;Option&lt;number&gt;, never&gt;(effect: Effect.Effect&lt;Option&lt;number&gt;, never, never&gt;, options?: {    readonly signal?: AbortSignal;} | undefined) =&gt; Promise&lt;Exit&lt;Option&lt;number&gt;, never&gt;&gt;</code></pre>
</figure>
:::
...
[maybe1]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Promise&lt;Exit&lt;Option&lt;number&gt;, never&gt;&gt;.then&lt;void, never&gt;(onfulfilled?: ((value: Exit&lt;Option&lt;number&gt;, never&gt;) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined, onrejected?: ((reason: any) =&gt; PromiseLike&lt;never&gt;) | null | undefined): Promise&lt;void&gt;</code></pre>
</figure>
:::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[value: { \_id:
\'Option\', \_tag: \'Some\', value: 1
}]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const maybe2: Effect.Effect&lt;Option&lt;never&gt;, never, never&gt;</code></pre>
</figure>
:::
::::

[maybe2]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const option: &lt;never, string, never&gt;(self: Effect.Effect&lt;never, string, never&gt;) =&gt; Effect.Effect&lt;Option&lt;never&gt;, never, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runPromiseExit: &lt;Option&lt;never&gt;, never&gt;(effect: Effect.Effect&lt;Option&lt;never&gt;, never, never&gt;, options?: {    readonly signal?: AbortSignal;} | undefined) =&gt; Promise&lt;Exit&lt;Option&lt;never&gt;, never&gt;&gt;</code></pre>
</figure>
:::
...
[maybe2]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Promise&lt;Exit&lt;Option&lt;never&gt;, never&gt;&gt;.then&lt;void, never&gt;(onfulfilled?: ((value: Exit&lt;Option&lt;never&gt;, never&gt;) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined, onrejected?: ((reason: any) =&gt; PromiseLike&lt;never&gt;) | null | undefined): Promise&lt;void&gt;</code></pre>
</figure>
:::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[value: { \_id:
\'Option\', \_tag: \'None\' }]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const maybe3: Effect.Effect&lt;Option&lt;never&gt;, never, never&gt;</code></pre>
</figure>
:::
::::

[maybe3]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const option: &lt;never, never, never&gt;(self: Effect.Effect&lt;never, never, never&gt;) =&gt; Effect.Effect&lt;Option&lt;never&gt;, never, never&gt;</code></pre>
</figure>
:::
...
[die]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Boom!\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::::
::::::::::::::::::::::::
...
[maybe3]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#catchall){.anchor-link
aria-labelledby="catchall"}
:::

Handles all errors in an effect by providing a fallback effect.

The `Effect.catchAll`{dir="auto"} function catches any errors that may
occur during the execution of an effect and allows you to handle them by
specifying a fallback effect. This ensures that the program continues
without failing by recovering from errors using the provided fallback
logic.
...
.astro-4rgy7crp} Recoverable Errors Only

::: starlight-aside__content
`Effect.catchAll`{dir="auto"} only handles recoverable errors. It will
not recover from unrecoverable defects. See
[Effect.catchAllCause](index.html#catchallcause) for handling all types
of failures.
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;string, HttpError | ValidationError, never&gt;, Effect.Effect&lt;string, never, never&gt;&gt;(this: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;, ab: (_: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;) =&gt; Effect.Effect&lt;string, never, never&gt;): Effect.Effect&lt;string, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchAll: &lt;HttpError | ValidationError, string, never, never&gt;(f: (e: HttpError | ValidationError) =&gt; Effect.Effect&lt;string, never, never&gt;) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, HttpError | ValidationError, R&gt;) =&gt; Effect.Effect&lt;string | A, never, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[succeed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Recovering
from
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
We can observe that the type in the error channel of our program has
changed to `never`{dir="auto"}:
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#catchallcause){.anchor-link
aria-labelledby="catchallcause"}
:::

Handles both recoverable and unrecoverable errors by providing a
recovery effect.

The `Effect.catchAllCause`{dir="auto"} function allows you to handle all
errors, including unrecoverable defects, by providing a recovery effect.
The recovery logic is based on the `Cause`{dir="auto"} of the error,
...
::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>1import { import Cause</code></pre>
</figure>
:::
...
::: code
[// Define an effect that may fail with a recoverable or unrecoverable
error]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// Recover from all errors by examining the
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;never, string, never&gt;, Effect.Effect&lt;string, never, never&gt;&gt;(this: Effect.Effect&lt;never, string, never&gt;, ab: (_: Effect.Effect&lt;never, string, never&gt;) =&gt; Effect.Effect&lt;string, never, never&gt;): Effect.Effect&lt;string, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchAllCause: &lt;string, string, never, never&gt;(f: (cause: Cause.Cause&lt;string&gt;) =&gt; Effect.Effect&lt;string, never, never&gt;) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, string, R&gt;) =&gt; Effect.Effect&lt;string | A, never, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
unrecoverable defects, by providing a recovery effect. The recovery
logic is based on the `Cause` of the error, which provides detailed
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>cause: Cause.Cause&lt;string&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const isFailType: &lt;string&gt;(self: Cause.Cause&lt;string&gt;) =&gt; self is Cause.Fail&lt;string&gt;</code></pre>
</figure>
:::
...
::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [fail Create a new `Fail`
...
[isFailType]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[succeed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Recovered
from a regular
...
[succeed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Recovered
from a
defect\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: code
[// Output: \"Recovered from a regular
error\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#catching-some-errors){.anchor-link
aria-labelledby="catching-some-errors"}
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#either-1){.anchor-link
aria-labelledby="either-1"}
:::

The [`Effect.either`{dir="auto"}](index.html#either) function, which was
previously shown as a way to catch all errors, can also be used to catch
specific errors.
...
**Example** (Handling Specific Errors with `Effect.either`{dir="auto"})
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const recovered: Effect.Effect&lt;string, ValidationError, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;never, ValidationError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;Either.Either&lt;string, HttpError | ValidationError&gt;, never, never&gt;&gt;, string&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;never, ValidationError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;Either.Either&lt;string, HttpError | ValidationError&gt;, never, never&gt;&gt;, string, never&gt;) =&gt; Effect.Effect&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::
...
HttpError\"]{style="--0:#032F62;--1:#9ECBFF"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const error: ValidationError</code></pre>
</figure>
:::
::::
...
We can observe that the type in the error channel of our program has
changed to only show `ValidationError`{dir="auto"}:

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>const recovered: Effect&lt;string, ValidationError, never&gt;</code></pre>
<div class="copy">
<div>
...
indicating that `HttpError`{dir="auto"} has been handled.

If we also want to handle `ValidationError`{dir="auto"}, we can easily
add another case to our code:
...
::: code
[]{.expand}[]{.collapse}[15 collapsed lines]{.text}
:::
::::::
...
::: code
[ ]{.indent}[// Handle both HttpError and
ValidationError]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#24292E;--1:#E1E4E8"}]{.indent}[}
]{style="--0:#24292E;--1:#E1E4E8"}[else]{style="--0:#8f2731;--1:#fb9fa9"}[
{]{style="--0:#24292E;--1:#E1E4E8"}
:::
::::::
...
::: code
[ ]{.indent}[return]{style="--0:#8f2731;--1:#fb9fa9"}[
]{style="--0:#24292E;--1:#E1E4E8"}[\"Recovering from
ValidationError\"]{style="--0:#032F62;--1:#9ECBFF"}
:::
::::::
...
We can observe that the type in the error channel has changed to
`never`{dir="auto"}:
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#catchsome){.anchor-link
aria-labelledby="catchsome"}
:::

Catches and recovers from specific types of errors, allowing you to
attempt recovery only for certain errors.

`Effect.catchSome`{dir="auto"} lets you selectively catch and handle
errors of certain types by providing a recovery effect for specific
errors. If the error matches a condition, recovery is attempted; if not,
it doesn't affect the program. This function doesn't alter the error
type, meaning the error type remains the same as in the original effect.

**Example** (Handling Specific Errors with
`Effect.catchSome`{dir="auto"})
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const recovered: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;string, HttpError | ValidationError, never&gt;, Effect.Effect&lt;string, HttpError | ValidationError, never&gt;&gt;(this: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;, ab: (_: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;) =&gt; Effect.Effect&lt;string, HttpError | ValidationError, never&gt;): Effect.Effect&lt;string, HttpError | ValidationError, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchSome: &lt;HttpError | ValidationError, string, never, never&gt;(pf: (e: HttpError | ValidationError) =&gt; Option.Option&lt;Effect.Effect&lt;string, never, never&gt;&gt;) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, HttpError | ValidationError, R&gt;) =&gt; Effect.Effect&lt;string | A, HttpError | ValidationError, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
matches a condition, recovery is attempted; if not, it doesn\'t affect
the program. This function doesn\'t alter the error type, meaning the
error type remains the same as in the original effect.

**Example** (Handling Specific Errors with Effect.catchSome)

::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import { Effect, Random, Option } from &quot;effect&quot;
class HttpError {  readonly _tag = &quot;HttpError&quot;}
class ValidationError {  readonly _tag = &quot;ValidationError&quot;}
//      ┌─── Effect&lt;string, HttpError | ValidationError, never&gt;//      ▼const program = Effect.gen(function* () {  const n1 = yield* Random.next  const n2 = yield* Random.next  if (n1 &lt; 0.5) {    yield* Effect.fail(new HttpError())  }  if (n2 &lt; 0.5) {    yield* Effect.fail(new ValidationError())  }  return &quot;some result&quot;})
//      ┌─── Effect&lt;string, HttpError | ValidationError, never&gt;//      ▼const recovered = program.pipe(  Effect.catchSome((error) =&gt; {    // Only handle HttpError errors    if (error._tag === &quot;HttpError&quot;) {      return Option.some(Effect.succeed(&quot;Recovering from HttpError&quot;))    } else {      return Option.none()    }  }))</code></pre>
</figure>
:::
::::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [catchIf for a version that
allows you to recover from errors based on a
predicate.]{.twoslash-popup-docs-tag-value}
...
[catchSome]{style="--0:#6F42C1;--1:#B392F0"}[((]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const some: &lt;Effect.Effect&lt;string, never, never&gt;&gt;(value: Effect.Effect&lt;string, never, never&gt;) =&gt; Option.Option&lt;Effect.Effect&lt;string, never, never&gt;&gt;</code></pre>
</figure>
:::
...
[succeed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Recovering
from
HttpError\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::
::::::::::::::::::::::
...
In the code above, `Effect.catchSome`{dir="auto"} takes a function that
examines the error and decides whether to attempt recovery or not. If
the error matches a specific condition, recovery can be attempted by
returning `Option.some(effect)`{dir="auto"}. If no recovery is possible,
you can simply return `Option.none()`{dir="auto"}.

It's important to note that while `Effect.catchSome`{dir="auto"} lets
you catch specific errors, it doesn't alter the error type itself.
Therefore, the resulting effect will still have the same error type as
the original effect:

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>const recovered: Effect&lt;string, HttpError | ValidationError, never&gt;</code></pre>
<div class="copy">
<div>
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#catchif){.anchor-link
aria-labelledby="catchif"}
:::

Recovers from specific errors based on a predicate.

`Effect.catchIf`{dir="auto"} works similarly to
[`Effect.catchSome`{dir="auto"}](index.html#catchsome), but it allows
you to recover from errors by providing a predicate function. If the
predicate matches the error, the recovery effect is applied. This
function doesn't alter the error type, so the resulting effect still
carries the original error type unless a user-defined type guard is used
to narrow the type.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;string, HttpError | ValidationError, never&gt;, Effect.Effect&lt;string, ValidationError, never&gt;&gt;(this: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;, ab: (_: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;) =&gt; Effect.Effect&lt;string, ValidationError, never&gt;): Effect.Effect&lt;string, ValidationError, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchIf: &lt;HttpError | ValidationError, HttpError, string, never, never&gt;(refinement: Refinement&lt;HttpError | ValidationError, HttpError&gt;, f: (e: HttpError) =&gt; Effect.Effect&lt;string, never, never&gt;) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, HttpError | ValidationError, R&gt;) =&gt; Effect.Effect&lt;string | A, ValidationError, R&gt; (+3 overloads)</code></pre>
</figure>
:::
...
, but it allows you to recover from errors by providing a predicate
function. If the predicate matches the error, the recovery effect is
applied. This function doesn\'t alter the error type, so the resulting
effect still carries the original error type unless a user-defined type
guard is used to narrow the type.
...
class ValidationError {  readonly _tag = &quot;ValidationError&quot;}
//      ┌─── Effect&lt;string, HttpError | ValidationError, never&gt;//      ▼const program = Effect.gen(function* () {  const n1 = yield* Random.next  const n2 = yield* Random.next  if (n1 &lt; 0.5) {    yield* Effect.fail(new HttpError())  }  if (n2 &lt; 0.5) {    yield* Effect.fail(new ValidationError())  }  return &quot;some result&quot;})
//      ┌─── Effect&lt;string, ValidationError, never&gt;//      ▼const recovered = program.pipe(  Effect.catchIf(    // Only handle HttpError errors    (error) =&gt; error._tag === &quot;HttpError&quot;,    () =&gt; Effect.succeed(&quot;Recovering from HttpError&quot;)  ))</code></pre>
</figure>
:::
::::
...
[catchIf]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"HttpError\"]{style="--0:#032F62;--1:#9ECBFF"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::
::::::::::::
...
It's important to note that for TypeScript versions \< 5.5, while
`Effect.catchIf`{dir="auto"} lets you catch specific errors, it
**doesn't alter the error type** itself. Therefore, the resulting effect
will still have the same error type as the original effect:
...
In TypeScript versions \>= 5.5, improved type narrowing causes the
resulting error type to be inferred as `ValidationError`{dir="auto"}.

::: {.autolink-heading-container .level-h4 tabindex="-1"}
#### Workaround For TypeScript versions \< 5.5 {#workaround-for-typescript-versions--55}

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#workaround-for-typescript-versions--55){.anchor-link
aria-labelledby="workaround-for-typescript-versions--55"}
:::

If you provide a [user-defined type
guard](https://www.typescriptlang.org/docs/handbook/2/narrowing.html#using-type-predicates)
instead of a predicate, the resulting error type will be pruned,
returning an `Effect<string, ValidationError, never>`{dir="auto"}:
...
[error]{style="--0:#833805;--1:#FFAB70"}[)]{style="--0:#24292E;--1:#E1E4E8"}[:]{style="--0:#8f2731;--1:#fb9fa9"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#833805;--1:#FFAB70"}
...
[HttpError]{style="--0:#5c37a0;--1:#c5acf4"}[
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#catchtag){.anchor-link
aria-labelledby="catchtag"}
:::

Catches and handles specific errors by their `_tag`{dir="auto"} field,
which is used as a discriminator.

`Effect.catchTag`{dir="auto"} is useful when your errors are tagged with
a `_tag`{dir="auto"} field that identifies the error type. You can use
this function to handle specific error types by matching the
`_tag`{dir="auto"} value. This allows for precise error handling,
ensuring that only specific errors are caught and handled.

The error type must have a `_tag`{dir="auto"} field to use
`Effect.catchTag`{dir="auto"}. This field is used to identify and match
errors.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchTag: &lt;HttpError | ValidationError, [&quot;HttpError&quot;], string, never, never&gt;(args_0: &quot;HttpError&quot;, f: (e: HttpError) =&gt; Effect.Effect&lt;string, never, never&gt;) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, HttpError | ValidationError, R&gt;) =&gt; Effect.Effect&lt;string | A, ValidationError, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[catchTag]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"HttpError\"]{style="--0:#032F62;--1:#9ECBFF"}[,
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>_HttpError: HttpError</code></pre>
</figure>
:::
::::

[\_HttpError]{style="--0:#AE4B07;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}
:::::::::::::
::::::::::::::::
...
In the example above, the `Effect.catchTag`{dir="auto"} function allows
us to handle `HttpError`{dir="auto"} specifically. If a
`HttpError`{dir="auto"} occurs during the execution of the program, the
provided error handler function will be invoked, and the program will
proceed with the recovery logic specified within the handler.
...
If we also wanted to handle `ValidationError`{dir="auto"}, we can simply
add another `catchTag`{dir="auto"}:

**Example** (Handling Multiple Error Types with `catchTag`{dir="auto"})
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;string, HttpError | ValidationError, never&gt;, Effect.Effect&lt;string, ValidationError, never&gt;, Effect.Effect&lt;string, never, never&gt;&gt;(this: Effect.Effect&lt;...&gt;, ab: (_: Effect.Effect&lt;string, HttpError | ValidationError, never&gt;) =&gt; Effect.Effect&lt;string, ValidationError, never&gt;, bc: (_: Effect.Effect&lt;string, ValidationError, never&gt;) =&gt; Effect.Effect&lt;string, never, never&gt;): Effect.Effect&lt;...&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchTag: &lt;ValidationError, [&quot;ValidationError&quot;], string, never, never&gt;(args_0: &quot;ValidationError&quot;, f: (e: ValidationError) =&gt; Effect.Effect&lt;string, never, never&gt;) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, ValidationError, R&gt;) =&gt; Effect.Effect&lt;string | A, never, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[catchTag]{style="--0:#5c37a0;--1:#c5acf4"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"ValidationError\"]{style="--0:#032F62;--1:#9ECBFF"}[,
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#833805;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>_ValidationError: ValidationError</code></pre>
</figure>
:::
::::

[\_ValidationError]{style="--0:#833805;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#8f2731;--1:#fb9fa9"}
:::::::::::::
::::::::::::::::
...
[succeed]{style="--0:#5c37a0;--1:#c5acf4"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Recovering
from
ValidationError\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
.astro-4rgy7crp} Error Type Requirement

::: starlight-aside__content
The error type must have a readonly `_tag`{dir="auto"} field to use
`catchTag`{dir="auto"}. This field is used to identify and match errors.
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#catchtags){.anchor-link
aria-labelledby="catchtags"}
:::

Handles multiple errors in a single block of code using their
`_tag`{dir="auto"} field.

`Effect.catchTags`{dir="auto"} is a convenient way to handle multiple
error types at once. Instead of using
[`Effect.catchTag`{dir="auto"}](index.html#catchtag) multiple times, you
can pass an object where each key is an error type's `_tag`{dir="auto"},
and the value is the handler for that specific error. This allows you to
catch and recover from multiple error types in a single call.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchTags: &lt;HttpError | ValidationError, {    HttpError: (_HttpError: HttpError) =&gt; Effect.Effect&lt;string, never, never&gt;;    ValidationError: (_ValidationError: ValidationError) =&gt; Effect.Effect&lt;string, never, never&gt;;}&gt;(cases: {    HttpError: (_HttpError: HttpError) =&gt; Effect.Effect&lt;string, never, never&gt;;    ValidationError: (_ValidationError: ValidationError) =&gt; Effect.Effect&lt;string, never, never&gt;;}) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, HttpError | ValidationError, R&gt;) =&gt; Effect.Effect&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::
...
`catchTags` is a convenient way to handle multiple error types at once.
Instead of using

catchTag

multiple times, you can pass an object where each key is an error
type\'s `_tag`, and the value is the handler for that specific error.
This allows you to catch and recover from multiple error types in a
single call.
...
class ValidationError {  readonly _tag = &quot;ValidationError&quot;}
//      ┌─── Effect&lt;string, HttpError | ValidationError, never&gt;//      ▼const program = Effect.gen(function* () {  const n1 = yield* Random.next  const n2 = yield* Random.next  if (n1 &lt; 0.5) {    yield* Effect.fail(new HttpError())  }  if (n2 &lt; 0.5) {    yield* Effect.fail(new ValidationError())  }  return &quot;some result&quot;})
//      ┌─── Effect&lt;string, never, never&gt;//      ▼const recovered = program.pipe(  Effect.catchTags({    HttpError: (_HttpError) =&gt;      Effect.succeed(`Recovering from HttpError`),    ValidationError: (_ValidationError) =&gt;      Effect.succeed(`Recovering from ValidationError`)  }))</code></pre>
</figure>
:::
::::
...
[catchTags]{style="--0:#6F42C1;--1:#B392F0"}[({]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>type HttpError: (_HttpError: HttpError) =&gt; Effect.Effect&lt;string, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>type ValidationError: (_ValidationError: ValidationError) =&gt; Effect.Effect&lt;string, never, never&gt;</code></pre>
</figure>
:::
::::
...
[\_ValidationError]{style="--0:#AE4B07;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}
:::::::
::::::::::
...
This function takes an object where each property represents a specific
error `_tag`{dir="auto"} (`"HttpError"`{dir="auto"} and
`"ValidationError"`{dir="auto"} in this case), and the corresponding
value is the error handler function to be executed when that particular
error occurs.
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#effectfn){.anchor-link
aria-labelledby="effectfn"}
:::

The `Effect.fn`{dir="auto"} function allows you to create traced
functions that return an effect. It provides two key features:

- **Stack traces with location details** if an error occurs.
- **Automatic span creation** for
  [tracing](../../observability/tracing/index.html) when a span name is
  provided.

If a span name is passed as the first argument, the function's execution
is tracked using that name. If no name is provided, stack tracing still
works, but spans are not created.

A function can be defined using either:

- A generator function, allowing the use of `yield*`{dir="auto"} for
  effect composition.
- A regular function that returns an `Effect`{dir="auto"}.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const myfunc: &lt;N extends number&gt;(n: N) =&gt; Effect.Effect&lt;void, Error, never&gt;</code></pre>
</figure>
:::
::::

[myfunc]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[fn]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"myspan\"]{style="--0:#032F62;--1:#9ECBFF"}[)(]{style="--0:#24292E;--1:#E1E4E8"}[function\*]{style="--0:#BF3441;--1:#F97583"}[
\<]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>function (type parameter) N in &lt;N extends number&gt;(n: N): Generator&lt;YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, Error, never&gt;&gt;, void, any&gt;</code></pre>
</figure>
:::
::::

[N]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[extends]{style="--0:#BF3441;--1:#F97583"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>n: N extends number</code></pre>
</figure>
:::
::::
...
[annotateCurrentSpan]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"n\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[n]{style="--0:#24292E;--1:#E1E4E8"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[// Attach metadata to the
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`got:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[Error]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Boom!\"]{style="--0:#032F62;--1:#9ECBFF"}[))
]{style="--0:#24292E;--1:#E1E4E8"}[// Simulate
failure]{style="--0:#616972;--1:#99A0A6"}
:::::::::::::
::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const myfunc: &lt;100&gt;(n: 100) =&gt; Effect.Effect&lt;void, Error, never&gt;</code></pre>
</figure>
:::
::::

[myfunc]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[100]{style="--0:#005CC5;--1:#79B8FF"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;void, Error, never&gt;, Effect.Effect&lt;void, never, never&gt;&gt;(this: Effect.Effect&lt;void, Error, never&gt;, ab: (_: Effect.Effect&lt;void, Error, never&gt;) =&gt; Effect.Effect&lt;void, never, never&gt;): Effect.Effect&lt;void, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchAllCause: &lt;Error, void, never, never&gt;(f: (cause: Cause&lt;Error&gt;) =&gt; Effect.Effect&lt;void, never, never&gt;) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, Error, R&gt;) =&gt; Effect.Effect&lt;void | A, never, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[got: 100]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[at \<anonymous\>
(/\.../index.ts:6:22) \<= Raise
location]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[at myspan
(/\.../index.ts:3:23) \<= Definition
location]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#exporting-spans-for-tracing){.anchor-link
aria-labelledby="exporting-spans-for-tracing"}
:::

`Effect.fn`{dir="auto"} automatically creates
[spans](../../observability/tracing/index.html). The spans capture
information about the function execution, including metadata and error
details.
...
[Error]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Boom!\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const program: Effect.Effect&lt;void, Error, never&gt;</code></pre>
</figure>
:::
::::
...
[myfunc]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[100]{style="--0:#005CC5;--1:#79B8FF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::
::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runFork: &lt;void, Error&gt;(effect: Effect.Effect&lt;void, Error, never&gt;, options?: RunForkOptions) =&gt; RuntimeFiber&lt;void, Error&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;void, Error, never&gt;, Effect.Effect&lt;void, Error, never&gt;&gt;(this: Effect.Effect&lt;void, Error, never&gt;, ab: (_: Effect.Effect&lt;void, Error, never&gt;) =&gt; Effect.Effect&lt;void, Error, never&gt;): Effect.Effect&lt;void, Error, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
\'1.30.1\']{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
\'22801570119e57a6e2aacda3dec9665b\',]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
\'7af530c1e01bc0cb\',]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
1741182277518402.2,]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
4300.416,]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[n:
100,]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[\'at \<anonymous\>
(/\.../index.ts:14:17)\']{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[status: { code: 2,
message: \'Boom!\' },]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[time: \[ 1741182277,
522702583 \],]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: {.autolink-heading-container .level-h3 tabindex="-1"}
### Using Effect.fn as a pipe Function {#using-effectfn-as-a-pipe-function}

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#using-effectfn-as-a-pipe-function){.anchor-link
aria-labelledby="using-effectfn-as-a-pipe-function"}
:::

`Effect.fn`{dir="auto"} also acts as a pipe function, allowing you to
create a pipeline after the function definition using the effect
returned by the generator function as the starting value of the
pipeline.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const myfunc: (n: number) =&gt; Effect.Effect.AsEffect&lt;Effect.Effect&lt;void, Error, never&gt;&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fn: &lt;YieldWrap&lt;Effect.Effect&lt;never, Error, never&gt;&gt;, void, [n: number], Effect.Effect&lt;void, Error, never&gt;&gt;(body: (n: number) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;never, Error, never&gt;&gt;, void, never&gt;, a: (_: Effect.Effect&lt;void, Error, never&gt;, n: number) =&gt; Effect.Effect&lt;void, Error, never&gt;) =&gt; (n: number) =&gt; Effect.Effect&lt;out A, out E = never, out R = never&gt;.AsEffect&lt;Effect.Effect&lt;void, Error, never&gt;&gt; (+20 overloads)</code></pre>
</figure>
:::
::::

[fn]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
::::: code
[ ]{.indent}[function\*]{style="--0:#BF3441;--1:#F97583"}[
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: code
[ ]{.indent}[// You can access both the created effect and the original
arguments]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>effect: Effect.Effect&lt;void, Error, never&gt;</code></pre>
</figure>
:::
::::

[effect]{style="--0:#AE4B07;--1:#FFAB70"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const delay: &lt;void, Error, never&gt;(self: Effect.Effect&lt;void, Error, never&gt;, duration: DurationInput) =&gt; Effect.Effect&lt;void, Error, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
]{style="--0:#032F62;--1:#9ECBFF"}[100]{style="--0:#005CC5;--1:#79B8FF"}[}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const myfunc: (n: number) =&gt; Effect.Effect&lt;out A, out E = never, out R = never&gt;.AsEffect&lt;Effect.Effect&lt;void, Error, never&gt;&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;out A, out E = never, out R = never&gt;.AsEffect&lt;Effect.Effect&lt;void, Error, never&gt;&gt;, Effect.Effect&lt;void, never, never&gt;&gt;(this: Effect.Effect.AsEffect&lt;Effect.Effect&lt;void, Error, never&gt;&gt;, ab: (_: Effect.Effect.AsEffect&lt;Effect.Effect&lt;void, Error, never&gt;&gt;) =&gt; Effect.Effect&lt;void, never, never&gt;): Effect.Effect&lt;void, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: code
[timestamp=\... level=ERROR fiber=#0 cause=\"Error: Boom! (\<= after 1
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/error-management/expected-errors.mdx){.sl-flex
...
[Two Types of Errors]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../two-error-types/index.html){.astro-u5aomj4k
rel="prev"}
...
.astro-4rgy7crp} [ Next\
[Unexpected Errors]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../unexpected-errors/index.html){.astro-u5aomj4k
rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
