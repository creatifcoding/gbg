...
Retains the PR40 coupon procedure facts. The #25 `deembed-plan.md` leaf is
absent on `feat/mantis-biomemetics-lab` and is not recreated here. Planes 1 and
6 stay blocked until SerDes pad maps exist.
...
source digests, uncertainty, and deviations. Simulation may reject a
