defmodule Maiden.SiteRuntime.Boundaries do
  @moduledoc """
  Boundary façade for strategy-emitted transition directives.
  """

  alias Maiden.SiteRuntime.Boundaries.{NoopJobQueue, NoopSiteStore}
  ...
  @spec site_store_adapter() :: module()
  def site_store_adapter do
    Application.get_env(@app, :site_store_adapter, NoopSiteStore)
  end
