...
# Sink Operations {#_top .astro-np5lzwrf}
:::
::::
...
::::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
::::: sl-markdown-content
In previous sections, we learned how to create and use sinks. Now, let's
explore some operations that let you transform or filter sink behavior.
...
aria-hidden="true"}](index.html#adapting-sink-input){.anchor-link
aria-labelledby="adapting-sink-input"}
:::

At times, you may have a sink that works with one type of input, but
your current stream uses a different type. The
`Sink.mapInput`{dir="auto"} function helps you adapt your sink to a new
input type by transforming the input values. While
`Sink.map`{dir="auto"} changes the sink's output,
`Sink.mapInput`{dir="auto"} changes the input it accepts.

**Example** (Converting String Input to Numeric for Summing)

Suppose you have a `Sink.sum`{dir="auto"} that calculates the sum of
numbers. If your stream contains strings rather than numbers,
`Sink.mapInput`{dir="auto"} can convert those strings into numbers,
allowing `Sink.sum`{dir="auto"} to work with your stream:
...
::: code
[// A stream of numeric strings]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;[string, string, string, string, string]&gt;(as_0: string, as_1: string, as_2: string, as_3: string, as_4: string) =&gt; Stream.Stream&lt;string, never, never&gt;</code></pre>
</figure>
:::
...
[make]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"1\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"2\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"3\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"4\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"5\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
::: code
[// Define a sink for summing numeric
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const numericSum: Sink.Sink&lt;number, number, never, never, never&gt;</code></pre>
</figure>
:::
::::

[numericSum]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Use mapInput to adapt the sink, converting strings to
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const stringSum: Sink.Sink&lt;number, string, never, never, never&gt;</code></pre>
</figure>
:::
::::

[stringSum]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[numericSum]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Sink.Sink&lt;number, number, never, never, never&gt;, Sink.Sink&lt;number, string, never, never, never&gt;&gt;(this: Sink.Sink&lt;number, number, never, never, never&gt;, ab: (_: Sink.Sink&lt;number, number, never, never, never&gt;) =&gt; Sink.Sink&lt;number, string, never, never, never&gt;): Sink.Sink&lt;number, string, never, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const mapInput: &lt;string, number&gt;(f: (input: string) =&gt; number) =&gt; &lt;A, L, E, R&gt;(self: Sink.Sink&lt;A, number, L, E, R&gt;) =&gt; Sink.Sink&lt;A, string, L, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>NumberConstructor.parseFloat(string: string): number</code></pre>
</figure>
:::
...
::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@param]{.twoslash-popup-docs-tag-name} ― [string A string that
contains a floating-point number.]{.twoslash-popup-docs-tag-value}
:::
::::::

[parseFloat]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const run: &lt;string, never, never, number, never, never&gt;(self: Stream.Stream&lt;string, never, never&gt;, sink: Sink.Sink&lt;number, string, unknown, never, never&gt;) =&gt; Effect.Effect&lt;number, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[stringSum]{style="--0:#24292E;--1:#E1E4E8"}[)).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#transforming-both-input-and-output){.anchor-link
aria-labelledby="transforming-both-input-and-output"}
:::

When you need to transform both the input and output of a sink,
`Sink.dimap`{dir="auto"} provides a flexible solution. It extends
`mapInput`{dir="auto"} by allowing you to transform the input type,
perform the operation, and then transform the output to a new type. This
can be useful for complete conversions between input and output types.

**Example** (Converting Input to Integer, Summing, and Converting Output
to String)
...
::: code
[// Convert string inputs to numbers, sum
them,]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const sumSink: Sink.Sink&lt;string, string, never, never, never&gt;</code></pre>
</figure>
:::
::::

[sumSink]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const dimap: &lt;number, number, never, never, never, string, string&gt;(self: Sink.Sink&lt;number, number, never, never, never&gt;, options: {    readonly onInput: (input: string) =&gt; number;    readonly onDone: (a: number) =&gt; string;}) =&gt; Sink.Sink&lt;string, string, never, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[dimap]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[ ]{.indent}[// Transform input: string to
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onInput: (input: string) =&gt; number</code></pre>
</figure>
:::
::::

[onInput]{style="--0:#6F42C1;--1:#B392F0"}[:
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: code
[ ]{.indent}[// Transform output: number to
string]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onDone: (a: number) =&gt; string</code></pre>
</figure>
:::
::::

[onDone]{style="--0:#6F42C1;--1:#B392F0"}[:
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const run: &lt;string, never, never, string, never, never&gt;(self: Stream.Stream&lt;string, never, never&gt;, sink: Sink.Sink&lt;string, string, unknown, never, never&gt;) =&gt; Effect.Effect&lt;string, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[sumSink]{style="--0:#24292E;--1:#E1E4E8"}[)).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#filtering-input){.anchor-link
aria-labelledby="filtering-input"}
:::

Sinks can also filter incoming elements based on specific conditions
with `Sink.filterInput`{dir="auto"}. This operation allows the sink to
process only elements that meet certain criteria.

**Example** (Filtering Negative Numbers in Chunks of Three)

In the example below, elements are collected in chunks of three, but
...
::: code
[// Define a stream with positive, negative, and zero
values]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const stream: Stream.Stream&lt;Chunk&lt;number&gt;, never, never&gt;</code></pre>
</figure>
:::
::::
...
[fromIterable]{style="--0:#6F42C1;--1:#B392F0"}[(\[]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
::: code
[ ]{.indent}[1]{style="--0:#005CC5;--1:#79B8FF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[-]{style="--0:#BF3441;--1:#F97583"}[2]{style="--0:#005CC5;--1:#79B8FF"}[,
...
]{style="--0:#24292E;--1:#E1E4E8"}[-]{style="--0:#BF3441;--1:#F97583"}[3]{style="--0:#005CC5;--1:#79B8FF"}[,
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Stream.Stream&lt;number, never, never&gt;, Stream.Stream&lt;Chunk&lt;number&gt;, never, never&gt;&gt;(this: Stream.Stream&lt;number, never, never&gt;, ab: (_: Stream.Stream&lt;number, never, never&gt;) =&gt; Stream.Stream&lt;Chunk&lt;number&gt;, never, never&gt;): Stream.Stream&lt;Chunk&lt;number&gt;, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const transduce: &lt;Chunk&lt;number&gt;, number, never, never&gt;(sink: Sink.Sink&lt;Chunk&lt;number&gt;, number, number, never, never&gt;) =&gt; &lt;E, R&gt;(self: Stream.Stream&lt;number, E, R&gt;) =&gt; Stream.Stream&lt;Chunk&lt;number&gt;, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[// Collect chunks of 3, filtering out non-positive
numbers]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[collectAllN]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[number]{style="--0:#005CC5;--1:#79B8FF"}[\>(]{style="--0:#24292E;--1:#E1E4E8"}[3]{style="--0:#005CC5;--1:#79B8FF"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Sink.Sink&lt;Chunk&lt;number&gt;, number, number, never, never&gt;, Sink.Sink&lt;Chunk&lt;number&gt;, number, number, never, never&gt;&gt;(this: Sink.Sink&lt;Chunk&lt;number&gt;, number, number, never, never&gt;, ab: (_: Sink.Sink&lt;Chunk&lt;number&gt;, number, number, never, never&gt;) =&gt; Sink.Sink&lt;Chunk&lt;number&gt;, number, number, never, never&gt;): Sink.Sink&lt;Chunk&lt;number&gt;, number, number, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const filterInput: &lt;number, number&gt;(f: Predicate&lt;number&gt;) =&gt; &lt;A, L, E, R&gt;(self: Sink.Sink&lt;A, number, L, E, R&gt;) =&gt; Sink.Sink&lt;A, number, L, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[filterInput]{style="--0:#6F42C1;--1:#B392F0"}[((]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runCollect: &lt;Chunk&lt;number&gt;, never, never&gt;(self: Stream.Stream&lt;Chunk&lt;number&gt;, never, never&gt;) =&gt; Effect.Effect&lt;Chunk&lt;Chunk&lt;number&gt;&gt;, never, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Promise&lt;Chunk&lt;Chunk&lt;number&gt;&gt;&gt;.then&lt;void, never&gt;(onfulfilled?: ((value: Chunk&lt;Chunk&lt;number&gt;&gt;) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined, onrejected?: ((reason: any) =&gt; PromiseLike&lt;never&gt;) | null | undefined): Promise&lt;void&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>chunk: Chunk&lt;Chunk&lt;number&gt;&gt;</code></pre>
</figure>
:::
::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[{ \_id: \'Chunk\',
values: \[ \[length\]: 0 \] },]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/sink/operations.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../creating/index.html){.astro-u5aomj4k rel="prev"}
...
.astro-4rgy7crp} [ Next\
[Concurrency]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../concurrency/index.html){.astro-u5aomj4k
rel="next"}
:::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
