...
# Schema to Equivalence {#_top .astro-np5lzwrf}
:::
::::
...
::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::: sl-markdown-content
The `Schema.equivalence`{dir="auto"} function allows you to generate an
[Equivalence](index.html) based on a schema definition. This function is
designed to compare data structures for equivalence according to the
...
::: code
[// Generate an equivalence function based on the
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const PersonEquivalence: Equivalence&lt;{    readonly name: string;    readonly age: number;}&gt;</code></pre>
</figure>
:::
::::

[PersonEquivalence]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const equivalence: &lt;{    readonly name: string;    readonly age: number;}, {    readonly name: string;    readonly age: number;}, never&gt;(schema: Schema.Schema&lt;{    readonly name: string;    readonly age: number;}, {    readonly name: string;    readonly age: number;}, never&gt;) =&gt; Equivalence&lt;{    readonly name: string;    readonly age: number;}&gt;</code></pre>
</figure>
:::

::: twoslash-popup-docs
Given a schema `Schema<A, I, R>`, returns an `Equivalence` instance for
`A`.
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const john: {    name: string;    age: number;}</code></pre>
</figure>
:::
::::

[john]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
{ ]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[age]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[23]{style="--0:#005CC5;--1:#79B8FF"}[
}]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::
::::::::::::
...
::: code
[// Use the equivalence function to compare
objects]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const PersonEquivalence: Equivalence(self: {    readonly name: string;    readonly age: number;}, that: {    readonly name: string;    readonly age: number;}) =&gt; boolean</code></pre>
</figure>
:::
::::

[PersonEquivalence]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
aria-hidden="true"}](index.html#equivalence-for-any-unknown-and-object){.anchor-link
aria-labelledby="equivalence-for-any-unknown-and-object"}
:::

When working with the following schemas:

- `Schema.Any`{dir="auto"}
- `Schema.Unknown`{dir="auto"}
- `Schema.Object`{dir="auto"}
- `Schema.Struct({})`{dir="auto"} (representing the broad
  `{}`{dir="auto"} TypeScript type)

the most sensible form of equivalence is to use
`Equal.equals`{dir="auto"} from the
[Equal](../../trait/equal/index.html) module, which defaults to
reference equality (`===`{dir="auto"}). This is because these types can
hold almost any kind of value.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const schema: Schema.Struct&lt;{}&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>function Struct&lt;{}&gt;(fields: {}): Schema.Struct&lt;{}&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const input1: {}</code></pre>
</figure>
:::
::::

[input1]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
{}]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const input2: {}</code></pre>
</figure>
:::
::::

[input2]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
{}]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const equivalence: &lt;{}, {}, never&gt;(schema: Schema.Schema&lt;{}, {}, never&gt;) =&gt; Equivalence&lt;{}&gt;</code></pre>
</figure>
:::
...
[input1]{style="--0:#24292E;--1:#E1E4E8"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[input2]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::::::::
:::::::::::::::::::::::::::::
...
::: code
[// Output: false (because they are different
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#customizing-equivalence-generation){.anchor-link
aria-labelledby="customizing-equivalence-generation"}
:::

You can customize the equivalence logic by providing an
`equivalence`{dir="auto"} annotation in the schema definition.

The `equivalence`{dir="auto"} annotation takes any type parameters
provided (`typeParameters`{dir="auto"}) and two values for comparison,
returning a boolean based on the desired condition of equivalence.
...
::: code
[// Define a schema with a custom equivalence
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Annotations.GenericSchema&lt;string&gt;.equivalence?: (..._: any) =&gt; Equivalence&lt;string&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>s1: string</code></pre>
</figure>
:::
::::

[s1]{style="--0:#AE4B07;--1:#FFAB70"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>s2: string</code></pre>
</figure>
:::
::::

[s2]{style="--0:#AE4B07;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}
:::::::::
::::::::::::
...
::: code
[ ]{.indent}[// Custom rule: Compare only the first character of the
...
[s1]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>String.charAt(pos: number): string</code></pre>
</figure>
:::
...
::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@param]{.twoslash-popup-docs-tag-name} ― [pos The zero-based index of
the desired character.]{.twoslash-popup-docs-tag-value}
:::
::::::

[charAt]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[0]{style="--0:#005CC5;--1:#79B8FF"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[===]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[s2]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[charAt]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[0]{style="--0:#005CC5;--1:#79B8FF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::
::::::::::::::::::
...
::: code
[// Generate the equivalence function]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const customEquivalence: Equivalence&lt;string&gt;</code></pre>
</figure>
:::
::::

[customEquivalence]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const equivalence: &lt;string, string, never&gt;(schema: Schema.Schema&lt;string, string, never&gt;) =&gt; Equivalence&lt;string&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const customEquivalence: Equivalence(self: string, that: string) =&gt; boolean</code></pre>
</figure>
:::
::::

[customEquivalence]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"aaa\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"abb\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::
:::::::::::::::::::
...
[customEquivalence]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"aaa\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"bba\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::
:::::::::::::::::::
...
::: code
[// Output: false (strings start with different
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/schema/equivalence.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../pretty/index.html){.astro-u5aomj4k rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
