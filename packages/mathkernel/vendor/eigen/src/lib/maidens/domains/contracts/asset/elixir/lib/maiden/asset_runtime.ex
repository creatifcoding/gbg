defmodule Maiden.AssetRuntime do
  @moduledoc """
  Asset runtime contract namespace for Effect ↔ Elixir/Jido interop.

  ISA-95 alignment:
  - Asset lane spans enterprise → site → area → plant → line → workcell → machine
    while still supporting sensor/device children under machine.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_asset_runtime]}
