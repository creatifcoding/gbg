...
::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::::::: sl-markdown-content
A `Chunk<A>`{dir="auto"} represents an ordered, immutable collection of
values of type `A`{dir="auto"}. While similar to an array,
`Chunk`{dir="auto"} provides a functional interface, optimizing certain
operations that can be costly with regular arrays, like repeated
concatenation.
...
.astro-4rgy7crp} Use Chunk Only for Repeated Concatenation

::: starlight-aside__content
`Chunk`{dir="auto"} is optimized to manage the performance cost of
repeated array concatenation. For cases that do not involve repeated
concatenation, using `Chunk`{dir="auto"} may introduce unnecessary
overhead, resulting in slower performance.
:::
...
aria-hidden="true"}](index.html#why-use-chunk){.anchor-link
aria-labelledby="why-use-chunk"}
:::

- **Immutability**: Unlike standard JavaScript arrays, which are
  mutable, `Chunk`{dir="auto"} provides a truly immutable collection,
  preventing data from being modified after creation. This is especially
  useful in concurrent programming contexts where immutability can
  enhance data consistency.

- **High Performance**: `Chunk`{dir="auto"} supports specialized
  operations for efficient array manipulation, such as appending single
  elements or concatenating chunks, making these operations faster than
  their regular JavaScript array equivalents.

::: {.autolink-heading-container .level-h2 tabindex="-1"}
## Creating a Chunk

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#creating-a-chunk){.anchor-link
aria-labelledby="creating-a-chunk"}
:::
...
Create an empty `Chunk`{dir="auto"} with `Chunk.empty`{dir="auto"}.
...
::: code
[// ┌─── Chunk\<number\>]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const chunk: Chunk.Chunk&lt;number&gt;</code></pre>
</figure>
:::
::::
...
[empty]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[number]{style="--0:#005CC5;--1:#79B8FF"}[\>()]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
To create a `Chunk`{dir="auto"} with specific values, use
`Chunk.make(...values)`{dir="auto"}. Note that the resulting chunk is
typed as non-empty.
...
::: code
[// ┌─── NonEmptyChunk\<number\>]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const chunk: Chunk.NonEmptyChunk&lt;number&gt;</code></pre>
</figure>
:::
::::
...
You can create a `Chunk`{dir="auto"} by providing a collection, either
from an iterable or directly from an array.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import List</code></pre>
</figure>
:::
::::

[List]{style="--0:#24292E;--1:#E1E4E8"}[ }
]{style="--0:#24292E;--1:#E1E4E8"}[from]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[\"effect\"]{style="--0:#032F62;--1:#9ECBFF"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fromArray: Chunk.Chunk&lt;number&gt;</code></pre>
</figure>
:::
::::

[fromArray]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fromIterable: &lt;number&gt;(self: Iterable&lt;number&gt;) =&gt; Chunk.Chunk&lt;number&gt;</code></pre>
</figure>
:::
...
[fromIterable]{style="--0:#6F42C1;--1:#B392F0"}[(\[]{style="--0:#24292E;--1:#E1E4E8"}[1]{style="--0:#005CC5;--1:#79B8FF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[2]{style="--0:#005CC5;--1:#79B8FF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[3]{style="--0:#005CC5;--1:#79B8FF"}[\])]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fromList: Chunk.Chunk&lt;number&gt;</code></pre>
</figure>
:::
::::

[fromList]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[List]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;[number, number, number]&gt;(elements_0: number, elements_1: number, elements_2: number) =&gt; List.Cons&lt;number&gt;</code></pre>
</figure>
:::
...
![](data:image/svg+xml;base64,){.starlight-aside__icon
.astro-4rgy7crp} Performance Consideration

::: starlight-aside__content
`Chunk.fromIterable`{dir="auto"} creates a new copy of the iterable's
elements. For large data sets or repeated use, this cloning process can
impact performance.
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#unsafefromarray){.anchor-link
aria-labelledby="unsafefromarray"}
:::

`Chunk.unsafeFromArray`{dir="auto"} creates a `Chunk`{dir="auto"}
directly from an array without cloning. This approach can improve
performance by avoiding the overhead of copying data but requires
caution, as it bypasses the usual immutability guarantees.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const unsafeFromArray: &lt;number&gt;(self: readonly number[]) =&gt; Chunk.Chunk&lt;number&gt;</code></pre>
</figure>
:::
...
[unsafeFromArray]{style="--0:#6F42C1;--1:#B392F0"}[(\[]{style="--0:#24292E;--1:#E1E4E8"}[1]{style="--0:#005CC5;--1:#79B8FF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[2]{style="--0:#005CC5;--1:#79B8FF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[3]{style="--0:#005CC5;--1:#79B8FF"}[\])]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
![](data:image/svg+xml;base64,){.starlight-aside__icon
.astro-4rgy7crp} Risk of Mutable Data

::: starlight-aside__content
Using `Chunk.unsafeFromArray`{dir="auto"} can lead to unexpected
behavior if the original array is modified after the chunk is created.
For safer, immutable behavior, use `Chunk.fromIterable`{dir="auto"}
instead.
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#concatenating){.anchor-link
aria-labelledby="concatenating"}
:::

To combine two `Chunk`{dir="auto"} instances into one, use
`Chunk.appendAll`{dir="auto"}.
...
::: code
[// Concatenate two chunks with different types of
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const chunk: Chunk.NonEmptyChunk&lt;string | number&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const appendAll: &lt;number, string&gt;(self: Chunk.Chunk&lt;number&gt;, that: Chunk.NonEmptyChunk&lt;string&gt;) =&gt; Chunk.NonEmptyChunk&lt;string | number&gt; (+3 overloads)</code></pre>
</figure>
:::

:::: twoslash-popup-docs
Concatenates two chunks, combining their elements. If either chunk is
...
console.log(result)// [ 1, 2, &quot;a&quot;, &quot;b&quot; ]</code></pre>
</figure>
:::
::::
...
[appendAll]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;[number, number]&gt;(as_0: number, as_1: number) =&gt; Chunk.NonEmptyChunk&lt;number&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;[string, string]&gt;(as_0: string, as_1: string) =&gt; Chunk.NonEmptyChunk&lt;string&gt;</code></pre>
</figure>
:::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"b\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::::::
:::::::::::::::::::::::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#dropping){.anchor-link
aria-labelledby="dropping"}
:::

To remove elements from the beginning of a `Chunk`{dir="auto"}, use
`Chunk.drop`{dir="auto"}, specifying the number of elements to discard.
...
::: code
[// Drops the first 2 elements from the
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const drop: &lt;number&gt;(self: Chunk.Chunk&lt;number&gt;, n: number) =&gt; Chunk.Chunk&lt;number&gt; (+1 overload)</code></pre>
</figure>
:::
...
[drop]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;[number, number, number, number]&gt;(as_0: number, as_1: number, as_2: number, as_3: number) =&gt; Chunk.NonEmptyChunk&lt;number&gt;</code></pre>
</figure>
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#comparing){.anchor-link
aria-labelledby="comparing"}
:::

To check if two `Chunk`{dir="auto"} instances are equal, use
[`Equal.equals`{dir="auto"}](../../trait/equal/index.html). This
function compares the contents of each `Chunk`{dir="auto"} for
structural equality.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const chunk1: Chunk.NonEmptyChunk&lt;number&gt;</code></pre>
</figure>
:::
::::

[chunk1]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const chunk2: Chunk.NonEmptyChunk&lt;number&gt;</code></pre>
</figure>
:::
::::

[chunk2]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>function equals&lt;Chunk.NonEmptyChunk&lt;number&gt;, Chunk.NonEmptyChunk&lt;number&gt;&gt;(self: Chunk.NonEmptyChunk&lt;number&gt;, that: Chunk.NonEmptyChunk&lt;number&gt;): boolean (+1 overload)</code></pre>
</figure>
:::
...
[chunk1]{style="--0:#24292E;--1:#E1E4E8"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[chunk1]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::::::
::::::::::::::::::::::::::
...
[chunk2]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::::::
::::::::::::::::::::::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#converting){.anchor-link
aria-labelledby="converting"}
:::

Convert a `Chunk`{dir="auto"} to a `ReadonlyArray`{dir="auto"} using
`Chunk.toReadonlyArray`{dir="auto"}. The resulting type varies based on
the `Chunk`{dir="auto"}'s contents, distinguishing between empty,
non-empty, and generic chunks.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const nonEmptyArray: readonly [number, ...number[]]</code></pre>
</figure>
:::
::::

[nonEmptyArray]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const toReadonlyArray: &lt;Chunk.NonEmptyChunk&lt;number&gt;&gt;(self: Chunk.NonEmptyChunk&lt;number&gt;) =&gt; readonly [number, ...number[]]</code></pre>
</figure>
:::
...
[toReadonlyArray]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// ┌─── readonly never\[\]]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const emptyArray: readonly never[]</code></pre>
</figure>
:::
::::

[emptyArray]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const toReadonlyArray: &lt;Chunk.Chunk&lt;never&gt;&gt;(self: Chunk.Chunk&lt;never&gt;) =&gt; readonly never[]</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const empty: &lt;never&gt;() =&gt; Chunk.Chunk&lt;never&gt;</code></pre>
</figure>
:::
...
[chunk]{style="--0:#005CC5;--1:#79B8FF"}[:]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[Chunk]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[number]{style="--0:#005CC5;--1:#79B8FF"}[\>]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const array: readonly number[]</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const toReadonlyArray: &lt;Chunk.Chunk&lt;number&gt;&gt;(self: Chunk.Chunk&lt;number&gt;) =&gt; readonly number[]</code></pre>
</figure>
:::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/data-types/chunk.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../cause/index.html){.astro-u5aomj4k rel="prev"}
...
]{.astro-u5aomj4k}](../data/index.html){.astro-u5aomj4k rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
