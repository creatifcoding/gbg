/**
 * @fileoverview Catalog Atoms for json-render
 *
 ...
 *
 * @module json-render/react/atoms/catalog
 */
 ...
 * @example
 * ```ts
 * import { catalogRegistry, promptAtom } from '@/lib/json-render/react/atoms/catalog'
