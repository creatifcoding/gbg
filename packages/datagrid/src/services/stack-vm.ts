...
const _OP: Record<string, Opcode> = {
  ...
  SQRTPI_OP: { _tag: "SQRTPI_OP" }, BASE_OP: { _tag: "BASE_OP" }, DECIMAL_OP: { _tag: "DECIMAL_OP" }, WEBSERVICE_OP: { _tag: "WEBSERVICE_OP" }, FIELDVALUE_OP: { _tag: "FIELDVALUE_OP" },
