...
| #24/#25 boards absent | power-control / camera-tx / carriage / rail-rx not on lab base; net names frozen only |
...
later admitted leaf plus reviewers. #27 is out of scope and stays held. Do not
admit fab from this leaf.
