...
const CAD_NOTES: Record<string, string> = {
  ...
  B05: [
    ...
    'Sheet candidate Sheet Haus Acrycast A000AN03.0L0GPCTE 2440 x 1220 x 3 mm; tolerance not printed. TAP Chemcast family and Sheet Haus stay as other family/sheet candidates.',
    `Sheet Haus: ${SHEET_HAUS_ACRYCAST}`,
    'First sheet SKU from CAD: ePlastics ACRYCLR0.118CCM48X96, 0.118 in x 48 in x 96 in Clear Cast Acrylic Paper Masked Sheet. Cuts remain not catalog finished parts. No price landed from the ePlastics page. Not a buy.',
  ...
  B41: [
    ...
    'Catalog alternates none selected over the Particle kit. EE/LAPP already queued: LAPP SKINTOP 53111420 M 20 x 1.5 clamp 6-13 mm IP68, bulkhead fit UNVERIFIED.',
    'CAD this pass extra catalog gland, not selected over the kit: Sealcon CD20MA-BK / Hummel HSK-K 1.209.2001.50 M20 x 1.5 nylon, cable 6-12 mm, hole 20 mm; locking nut and O-ring sold separately. No price landed. No moving CSI tether.',
  ...
  B46: [
    'device verified; Tachyon integration UNVERIFIED. Carrier / Tachyon integration UNVERIFIED. None selected.',
    'CAD this pass: device only. analog.com HTML timed out. Do not land GTN/VY+ suffixes from the Farnell PDF.',
    ...
    'Candidate family from earlier CAD ADI dump and EE LCSC, none selected: MAX96724GTN/VY+ (datasheet **Future product); MAX96724FGTN/V+; MAX96724FGTN/VY+; MAX96724RGTN/V+ (datasheet **Future product); MAX96724GTN/VY+T. Tape-and-reel +T twins also listed on the earlier datasheet dump; codes not invented beyond named rows. 6 Gbps MAX96724 rows marked future-product.',
