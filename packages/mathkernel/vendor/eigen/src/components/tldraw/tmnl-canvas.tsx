...
const customComponents: TLComponents = {
  ...
  StylePanel: null,
  Minimap: null,
  // Custom overlays for drag interactions
...
// ============================================ 
interface TmnlCanvasProps {
  className?: string
}

export function TmnlCanvas({ className }: TmnlCanvasProps) {
  ...
  return (
    ...
    >
      {mounted && (
        <Tldraw shapeUtils={tmnlShapeUtils} onMount={handleMount} inferDarkMode components={customComponents} licenseKey="tldraw-2026-03-05/WyJzelY2SUtmSiIsWyIqIl0sMTYsIjIwMjYtMDMtMDUiXQ.O1deyIAW6mfzNKtWH9CbpiFNs2BKJQjYjao3Sd3TuhPVumjRs5U3PiFQS6aAsKv2zNXKnsCgCkKNlF7PabU+A">
          <TmnlCanvasUI />
        </Tldraw>
      )}
      {!mounted && (
