...
INSERT INTO part (balloon_id, name, qty_text, class, notes) VALUES ($bom$B46$bom$, $bom$Analog Devices MAX96724 quad deserializer carrier$bom$, $bom$1$bom$, NULL, $bom$device verified; Tachyon integration UNVERIFIED. Device name MAX96724/F/R Quad Tunneling GMSL2/1 to CSI-2 Deserializer. Farnell PDF is a device-name source, not a suffix pick: https://www.farnell.com/datasheets/4416323.pdf Candidate family, none selected, carrier UNVERIFIED: MAX96724GTN/VY+ (datasheet **Future product); MAX96724FGTN/V+; MAX96724FGTN/VY+; MAX96724RGTN/V+ (datasheet **Future product). Tape-and-reel +T twins also listed on the datasheet; codes not invented beyond named rows. 6 Gbps MAX96724 rows marked future-product. LCSC C27243025 prints MAX96724GTN/VY+T, 1+ $15.1147, 10+ $14.4884, 30+ $13.4064, 100+ $12.4604, in-stock 1466, ships now. Same page alternative MAX96724GTN/VY+ at $18.0866 / 25 avail. Package TQFN-56-EP(8x8), quad GMSL2/1 to CSI-2, 6Gbps. Pinout not in the fetched HTML. Honesty tension: CAD datasheet marked MAX96724GTN/VY+ as **Future product. LCSC prints stock on the +T reel. Both facts stand. Do not pick a buy. Sources: https://www.analog.com/en/products/max96724.html https://www.lcsc.com/product-detail/C27243025.html$bom$) ON CONFLICT (balloon_id) DO NOTHING;
