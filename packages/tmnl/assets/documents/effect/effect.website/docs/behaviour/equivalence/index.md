...
# Equivalence {#_top .astro-np5lzwrf}
:::
::::
...
:::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
::::::: sl-markdown-content
The Equivalence module provides a way to define equivalence relations
between values in TypeScript. An equivalence relation is a binary
relation that is reflexive, symmetric, and transitive, establishing a
formal notion of when two values should be considered equivalent.
...
aria-hidden="true"}](index.html#what-is-equivalence){.anchor-link
aria-labelledby="what-is-equivalence"}
:::

An `Equivalence<A>`{dir="auto"} represents a function that compares two
values of type `A`{dir="auto"} and determines if they are equivalent.
This is more flexible and customizable than simple equality checks using
`===`{dir="auto"}.

Here's the structure of an `Equivalence`{dir="auto"}:

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>interface Equivalence&lt;A&gt; {  (self: A, that: A): boolean}</code></pre>
<div class="copy">
<div>
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#using-built-in-equivalences){.anchor-link
aria-labelledby="using-built-in-equivalences"}
:::

The module provides several built-in equivalence relations for common
data types:

  Equivalence             Description
  ----------------------- ---------------------------------------------------------
  `string`{dir="auto"}    Uses strict equality (`===`{dir="auto"}) for strings
  `number`{dir="auto"}    Uses strict equality (`===`{dir="auto"}) for numbers
  `boolean`{dir="auto"}   Uses strict equality (`===`{dir="auto"}) for booleans
  `symbol`{dir="auto"}    Uses strict equality (`===`{dir="auto"}) for symbols
  `bigint`{dir="auto"}    Uses strict equality (`===`{dir="auto"}) for bigints
  `Date`{dir="auto"}      Compares `Date`{dir="auto"} objects by their timestamps

**Example** (Using Built-in Equivalences)

::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>1import { import Equivalence</code></pre>
</figure>
:::
:::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const string: Equivalence.Equivalence(self: string, that: string) =&gt; boolean</code></pre>
</figure>
:::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"apple\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::
::::::::::::::::::::::
...
[string]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"apple\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"orange\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::
::::::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const Date: Equivalence.Equivalence(self: Date, that: Date) =&gt; boolean</code></pre>
</figure>
:::
...
[Date]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[new]{style="--0:#BF3441;--1:#F97583"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>var Date: DateConstructornew (year: number, monthIndex: number, date?: number, hours?: number, minutes?: number, seconds?: number, ms?: number) =&gt; Date (+3 overloads)</code></pre>
</figure>
:::
...
::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@param]{.twoslash-popup-docs-tag-name} ― [year The full year
designation is required for cross-century date accuracy. If year is
between 0 and 99 is used, then year is assumed to be 1900 +
year.]{.twoslash-popup-docs-tag-value}

[\@param]{.twoslash-popup-docs-tag-name} ― [monthIndex The month as a
number between 0 and 11 (January to
December).]{.twoslash-popup-docs-tag-value}

[\@param]{.twoslash-popup-docs-tag-name} ― [date The date as a number
between 1 and 31.]{.twoslash-popup-docs-tag-value}

[\@param]{.twoslash-popup-docs-tag-name} ― [hours Must be supplied if
minutes is supplied. A number from 0 to 23 (midnight to 11pm) that
specifies the hour.]{.twoslash-popup-docs-tag-value}

[\@param]{.twoslash-popup-docs-tag-name} ― [minutes Must be supplied if
seconds is supplied. A number from 0 to 59 that specifies the
minutes.]{.twoslash-popup-docs-tag-value}

[\@param]{.twoslash-popup-docs-tag-name} ― [seconds Must be supplied if
milliseconds is supplied. A number from 0 to 59 that specifies the
seconds.]{.twoslash-popup-docs-tag-value}

[\@param]{.twoslash-popup-docs-tag-name} ― [ms A number from 0 to 999
that specifies the milliseconds.]{.twoslash-popup-docs-tag-value}
:::
::::::

[Date]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[2023]{style="--0:#005CC5;--1:#79B8FF"}[,
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#deriving-equivalences){.anchor-link
aria-labelledby="deriving-equivalences"}
:::

For more complex data structures, you may need custom equivalences. The
Equivalence module lets you derive new `Equivalence`{dir="auto"}
instances from existing ones with the `Equivalence.mapInput`{dir="auto"}
function.
...
::: code
[// Create an equivalence that compares User objects based only on the
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const equivalence: Equivalence.Equivalence&lt;User&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const mapInput: &lt;number, User&gt;(self: Equivalence.Equivalence&lt;number&gt;, f: (b: User) =&gt; number) =&gt; Equivalence.Equivalence&lt;User&gt; (+1 overload)</code></pre>
</figure>
:::
...
]{style="--0:#24292E;--1:#E1E4E8"}[// Base equivalence for comparing
...
]{style="--0:#24292E;--1:#E1E4E8"}[// Function to extract the id from a
User]{style="--0:#616972;--1:#99A0A6"}
:::::::::::
::::::::::::::
...
::: code
[// Compare two User objects: they are equivalent if their ids are the
same]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const equivalence: Equivalence.Equivalence(self: User, that: User) =&gt; boolean</code></pre>
</figure>
:::
::::

[equivalence]{style="--0:#6F42C1;--1:#B392F0"}[({
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[name]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[\"Al\"]{style="--0:#032F62;--1:#9ECBFF"}[
}))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::::::
:::::::::::::::::::::::::::
...
The `Equivalence.mapInput`{dir="auto"} function takes two arguments:

1.  The existing `Equivalence`{dir="auto"} you want to use as a base
    (`Equivalence.number`{dir="auto"} in this case, for comparing
    numbers).
2.  A function that extracts the value used for the equivalence check
    from your data structure (`(user: User) => user.id`{dir="auto"} in
    this case).
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/behaviour/equivalence.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../../trait/hash/index.html){.astro-u5aomj4k
rel="prev"}
...
]{.astro-u5aomj4k}](../order/index.html){.astro-u5aomj4k rel="next"}
:::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
