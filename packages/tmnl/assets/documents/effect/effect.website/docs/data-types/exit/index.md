...
::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::::: sl-markdown-content
An `Exit<A, E>`{dir="auto"} describes the result of running an
`Effect`{dir="auto"} workflow.

There are two possible states for an `Exit<A, E>`{dir="auto"}:

- `Exit.Success`{dir="auto"}: Contains a success value of type
  `A`{dir="auto"}.
- `Exit.Failure`{dir="auto"}: Contains a failure
  [Cause](../cause/index.html) of type `E`{dir="auto"}.
...
aria-hidden="true"}](index.html#creating-exits){.anchor-link
aria-labelledby="creating-exits"}
:::

The Exit module provides two primary functions for constructing exit
values: `Exit.succeed`{dir="auto"} and `Exit.failCause`{dir="auto"}.
These functions represent the outcomes of an effectful computation in
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#succeed){.anchor-link
aria-labelledby="succeed"}
:::

`Exit.succeed`{dir="auto"} creates an `Exit`{dir="auto"} value that
represents a successful outcome. You use this function when you want to
indicate that a computation completed successfully and to provide the
resulting value.
...
<pre data-language="ts"><code>1import { import Exit</code></pre>
</figure>
:::
::::::
...
::: code
[// Create an Exit representing a successful outcome with the value
...
::: code
[// ┌─── Exit\<number, never\>]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const successExit: Exit.Exit&lt;number, never&gt;</code></pre>
</figure>
:::
::::

[successExit]{style="--0:#005CC5;--1:#79B8FF"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const succeed: &lt;number&gt;(value: number) =&gt; Exit.Exit&lt;number, never&gt;</code></pre>
</figure>
:::

::: twoslash-popup-docs
Constructs a new `Exit.Success` containing the specified value of type
`A`.
:::
...
[successExit]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::
:::::::::::::::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#failcause){.anchor-link
aria-labelledby="failcause"}
:::

`Exit.failCause`{dir="auto"} creates an `Exit`{dir="auto"} value that
represents a failure. The failure is described using a
[Cause](../cause/index.html) object, which can encapsulate expected
errors, defects, interruptions, or even composite errors.
...
::: code
[// Create an Exit representing a failure with an error
...
::: code
[// ┌─── Exit\<never, string\>]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failureExit: Exit.Exit&lt;never, string&gt;</code></pre>
</figure>
:::
::::

[failureExit]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failCause: &lt;string&gt;(cause: Cause.Cause&lt;string&gt;) =&gt; Exit.Exit&lt;never, string&gt;</code></pre>
</figure>
:::
...
[failureExit]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::
:::::::::::::::::::
...
You can handle different outcomes of an `Exit`{dir="auto"} using the
`Exit.match`{dir="auto"} function. This function lets you provide two
separate callbacks to handle both success and failure cases of an
`Effect`{dir="auto"} execution.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const simulatedSuccess: Exit.Exit&lt;number, never&gt;</code></pre>
</figure>
:::
::::

[simulatedSuccess]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runSyncExit: &lt;number, never&gt;(effect: Effect.Effect&lt;number, never, never&gt;) =&gt; Exit.Exit&lt;number, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const match: &lt;number, never, string, string&gt;(self: Exit.Exit&lt;number, never&gt;, options: {    readonly onFailure: (cause: Cause.Cause&lt;never&gt;) =&gt; string;    readonly onSuccess: (a: number) =&gt; string;}) =&gt; string (+1 overload)</code></pre>
</figure>
:::
...
[simulatedSuccess]{style="--0:#24292E;--1:#E1E4E8"}[,
{]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onFailure: (cause: Cause.Cause&lt;never&gt;) =&gt; string</code></pre>
</figure>
:::
::::
...
::::::::::: code
[ ]{.indent}[\`Exited with failure state:
...
[pretty]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[cause]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#032F62;--1:#9ECBFF"}[}\`]{style="--0:#032F62;--1:#9ECBFF"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\`Exited with success value:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Output: \"Exited with success value:
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const simulatedFailure: Exit.Exit&lt;never, string&gt;</code></pre>
</figure>
:::
::::

[simulatedFailure]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runSyncExit: &lt;never, string&gt;(effect: Effect.Effect&lt;never, string, never&gt;) =&gt; Exit.Exit&lt;never, string&gt;</code></pre>
</figure>
:::
...
[runSyncExit]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
[fail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"error\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::
:::::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const match: &lt;never, string, string, string&gt;(self: Exit.Exit&lt;never, string&gt;, options: {    readonly onFailure: (cause: Cause.Cause&lt;string&gt;) =&gt; string;    readonly onSuccess: (a: never) =&gt; string;}) =&gt; string (+1 overload)</code></pre>
</figure>
:::
...
[simulatedFailure]{style="--0:#24292E;--1:#E1E4E8"}[,
{]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onFailure: (cause: Cause.Cause&lt;string&gt;) =&gt; string</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onSuccess: (a: never) =&gt; string</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>value: never</code></pre>
</figure>
:::
::::
...
::: code
[// Output: \"Exited with failure state: Error:
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#exit-vs-either){.anchor-link
aria-labelledby="exit-vs-either"}
:::

Conceptually, `Exit<A, E>`{dir="auto"} can be thought of as
`Either<A, Cause<E>>`{dir="auto"}. However, the
[Cause](../cause/index.html) type represents more than just expected
errors of type `E`{dir="auto"}. It includes:

- Interruption causes
- Defects (unexpected errors)
- The combination of multiple causes

This allows `Cause`{dir="auto"} to capture richer and more complex error
states compared to a simple `Either`{dir="auto"}.

::: {.autolink-heading-container .level-h2 tabindex="-1"}
## Exit vs Effect

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#exit-vs-effect){.anchor-link
aria-labelledby="exit-vs-effect"}
:::

`Exit`{dir="auto"} is actually a subtype of `Effect`{dir="auto"}. This
means that `Exit`{dir="auto"} values can also be considered as
`Effect`{dir="auto"} values.

- An `Exit`{dir="auto"}, in essence, is a "constant computation".
- `Effect.succeed`{dir="auto"} is essentially the same as
  `Exit.succeed`{dir="auto"}.
- `Effect.failCause`{dir="auto"} is the same as
  `Exit.failCause`{dir="auto"}.
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/data-types/exit.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../either/index.html){.astro-u5aomj4k rel="prev"}
...
]{.astro-u5aomj4k}](../hash-set/index.html){.astro-u5aomj4k rel="next"}
:::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
