...
# Schedule Combinators {#_top .astro-np5lzwrf}
:::
::::
...
::::::::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
::::: sl-markdown-content
Schedules define stateful, possibly effectful, recurring schedules of
events, and compose in a variety of ways. Combinators allow us to take
schedules and combine them together to get other schedules.

To demonstrate the functionality of different schedules, we will use the
following helper function that logs each repetition along with the
corresponding delay in milliseconds, formatted as:

::: expressive-code
<figure class="frame not-content">
<pre data-language="text"><code>#&lt;repetition&gt;: &lt;delay in ms&gt;</code></pre>
<div class="copy">
<div>
...
::: expressive-code
<figure class="frame not-content">
<pre data-language="ts"><code>1import { import Array</code></pre>
</figure>
:::
:::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const log: (schedule: Schedule.Schedule&lt;unknown&gt;, delay?: Duration.DurationInput) =&gt; void</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>schedule: Schedule.Schedule&lt;unknown, unknown, never&gt;</code></pre>
</figure>
:::
::::
...
[Schedule]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[unknown]{style="--0:#005CC5;--1:#79B8FF"}[\>,]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>delay: Duration.DurationInput</code></pre>
</figure>
:::
::::
...
[Duration]{style="--0:#6F42C1;--1:#B392F0"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>type DurationInput = number | bigint | Duration.Duration | readonly [seconds: number, nanos: number] | `${number} nano` | `${number} nanos` | `${number} micro` | `${number} micros` | `${number} milli` | `${number} millis` | `${number} second` | `${number} seconds` | `${number} minute` | `${number} minutes` | `${number} hour` | `${number} hours` | `${number} day` | `${number} days` | `${number} week` | `${number} weeks`</code></pre>
</figure>
:::
...
[DurationInput]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const maxRecurs: 10</code></pre>
</figure>
:::
::::

[maxRecurs]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[10]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[// Limit the number of
executions]{style="--0:#616972;--1:#99A0A6"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const delays: Duration.Duration[]</code></pre>
</figure>
:::
::::

[delays]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const toArray: &lt;Chunk.Chunk&lt;Duration.Duration&gt;&gt;(self: Chunk.Chunk&lt;Duration.Duration&gt;) =&gt; Duration.Duration[]</code></pre>
</figure>
:::

::: twoslash-popup-docs
Converts a `Chunk` into an `Array`. If the provided `Chunk` is non-empty
(`NonEmptyChunk`), the function will return a `NonEmptyArray`, ensuring
...
[toArray]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runSync: &lt;Chunk.Chunk&lt;Duration.Duration&gt;, never&gt;(effect: Effect.Effect&lt;Chunk.Chunk&lt;Duration.Duration&gt;, never, never&gt;) =&gt; Chunk.Chunk&lt;Duration.Duration&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const run: &lt;Duration.Duration, number, never&gt;(self: Schedule.Schedule&lt;Duration.Duration, number, never&gt;, now: number, input: Iterable&lt;number&gt;) =&gt; Effect.Effect&lt;Chunk.Chunk&lt;Duration.Duration&gt;, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
This function executes a given schedule with a sequence of input values
and accumulates all outputs into a `Chunk`. The schedule starts
execution at the specified `now` timestamp and proceeds according to its
defined behavior.
...
[run]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::
::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const delays: &lt;unknown, unknown, never&gt;(self: Schedule.Schedule&lt;unknown, unknown, never&gt;) =&gt; Schedule.Schedule&lt;Duration.Duration, unknown, never&gt;</code></pre>
</figure>
:::
...
This function modifies an existing schedule so that instead of producing
its original output, it now returns the delay between each scheduled
execution.
:::
...
[delays]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const addDelay: &lt;unknown, unknown, never&gt;(self: Schedule.Schedule&lt;unknown, unknown, never&gt;, f: (out: unknown) =&gt; Duration.DurationInput) =&gt; Schedule.Schedule&lt;unknown, unknown, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>var Date: DateConstructor</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>DateConstructor.now(): number</code></pre>
</figure>
:::
...
[now]{style="--0:#6F42C1;--1:#B392F0"}[(),]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::
::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const range: (start: number, end: number) =&gt; Array.NonEmptyArray&lt;number&gt;</code></pre>
</figure>
:::

:::: twoslash-popup-docs
Return a `NonEmptyArray` containing a range of integers, including both
endpoints.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import { range } from &quot;effect/Array&quot;
const result = range(1, 3)console.log(result) // [1, 2, 3]</code></pre>
</figure>
:::
::::
...
[range]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[0]{style="--0:#005CC5;--1:#79B8FF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[maxRecurs]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
[delays]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>globalThis.Array&lt;Duration&gt;.forEach(callbackfn: (value: Duration.Duration, index: number, array: Duration.Duration[]) =&gt; void, thisArg?: any): void</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>duration: Duration.Duration</code></pre>
</figure>
:::
::::

[duration]{style="--0:#AE4B07;--1:#FFAB70"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>i: number</code></pre>
</figure>
:::
::::

[i]{style="--0:#AE4B07;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}[
{]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
[maxRecurs]{style="--0:#24292E;--1:#E1E4E8"}
:::::::
::::::::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[// Indicate truncation if there are
more executions]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>globalThis.Array&lt;Duration&gt;.length: number</code></pre>
</figure>
:::
...
::: code
[ ]{.indent}[?]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[\"(end)\"]{style="--0:#032F62;--1:#9ECBFF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[// Mark the last
...
[i]{style="--0:#24292E;--1:#E1E4E8"}[
]{style="--0:#032F62;--1:#9ECBFF"}[+]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#032F62;--1:#9ECBFF"}[1]{style="--0:#005CC5;--1:#79B8FF"}[}:
...
[Duration]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[toMillis]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[duration]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#032F62;--1:#9ECBFF"}[}ms\`]{style="--0:#032F62;--1:#9ECBFF"}
::::::::::::
:::::::::::::::
...
aria-hidden="true"}](index.html#composition){.anchor-link
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#union){.anchor-link
aria-labelledby="union"}
:::

Combines two schedules and recurs if either schedule wants to continue,
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const schedule: Schedule.Schedule&lt;[Duration.Duration, number], unknown, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const union: &lt;Duration.Duration, unknown, never, number, unknown, never&gt;(self: Schedule.Schedule&lt;Duration.Duration, unknown, never&gt;, that: Schedule.Schedule&lt;number, unknown, never&gt;) =&gt; Schedule.Schedule&lt;[Duration.Duration, number], unknown, never&gt; (+1 overload)</code></pre>
</figure>
:::

::: twoslash-popup-docs
Combines two schedules, continuing execution as long as at least one of
them allows it, using the shorter delay.

**Details**

This function combines two schedules into a single schedule that
executes in parallel. If either schedule allows continuation, the merged
schedule continues. When both schedules produce delays, the schedule
selects the shorter delay to determine the next step.

The output of the new schedule is a tuple containing the outputs of both
schedules. The input type is the intersection of both schedules\' input
types.

This is useful for scenarios where multiple scheduling conditions should
be considered, ensuring execution proceeds if at least one schedule
permits it.
:::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [unionWith If you need to use a
custom merge function.]{.twoslash-popup-docs-tag-value}
...
[union]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const exponential: (base: Duration.DurationInput, factor?: number) =&gt; Schedule.Schedule&lt;Duration.Duration&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const spaced: (duration: Duration.DurationInput) =&gt; Schedule.Schedule&lt;number&gt;</code></pre>
</figure>
:::
...
::: code
[#1: 100ms \< exponential]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#2: 200ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#3: 400ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#4: 800ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#5: 1000ms \< spaced]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#6: 1000ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#7: 1000ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#8: 1000ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#9: 1000ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#10: 1000ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
The `Schedule.union`{dir="auto"} operator selects the shortest delay at
each step, so when combining an exponential schedule with a spaced
interval, the initial recurrences will follow the exponential backoff,
then settle into the spaced interval once the delays exceed that value.

::: {.autolink-heading-container .level-h3 tabindex="-1"}
### Intersection

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#intersection){.anchor-link
aria-labelledby="intersection"}
:::

Combines two schedules and recurs only if both schedules want to
continue, using the longer delay.

**Example** (Limiting Exponential Backoff with a Fixed Number of
Retries)
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const intersect: &lt;Duration.Duration, unknown, never, number, unknown, never&gt;(self: Schedule.Schedule&lt;Duration.Duration, unknown, never&gt;, that: Schedule.Schedule&lt;number, unknown, never&gt;) =&gt; Schedule.Schedule&lt;[Duration.Duration, number], unknown, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[intersect]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
[exponential]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"10
millis\"]{style="--0:#032F62;--1:#9ECBFF"}[),]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::
::::::::::::
...
::: code
[#1: 10ms \< exponential]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#2: 20ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#3: 40ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#4: 80ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#5: 160ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[(end) \< recurs]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
The `Schedule.intersect`{dir="auto"} operator enforces both schedules'
constraints. In this example, the schedule follows an exponential
backoff but stops after 5 recurrences due to the
`Schedule.recurs(5)`{dir="auto"} limit.

::: {.autolink-heading-container .level-h3 tabindex="-1"}
### Sequencing

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#sequencing){.anchor-link
aria-labelledby="sequencing"}
:::

Combines two schedules by running the first one fully, then switching to
the second.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const andThen: &lt;number, unknown, never, number, unknown, never&gt;(self: Schedule.Schedule&lt;number, unknown, never&gt;, that: Schedule.Schedule&lt;number, unknown, never&gt;) =&gt; Schedule.Schedule&lt;number, unknown, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
schedule runs to completion, and then the second schedule begins
execution. Unlike

andThenEither

, this function merges the outputs instead of wrapping them in `Either`,
allowing both schedules to contribute their results directly.
...
::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [andThenEither If you need to
keep track of which schedule produced each
result.]{.twoslash-popup-docs-tag-value}
...
[andThen]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: code
[#1: 0ms \< recurs]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#6: 1000ms \< spaced]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
The first schedule runs until completion, after which the second
schedule takes over. In this example, the effect initially executes 5
times with no delay, then continues every 1 second.

::: {.autolink-heading-container .level-h2 tabindex="-1"}
## Adding Randomness to Retry Delays

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#adding-randomness-to-retry-delays){.anchor-link
aria-labelledby="adding-randomness-to-retry-delays"}
:::

The `Schedule.jittered`{dir="auto"} combinator modifies a schedule by
applying a random delay within a specified range.

When a resource is out of service due to overload or contention,
retrying and backing off doesn't help us. If all failed API calls are
backed off to the same point of time, they cause another overload or
contention. Jitter adds some amount of randomness to the delay of the
schedule. This helps us to avoid ending up accidentally synchronizing
and taking the service down by accident.

[Research](https://aws.amazon.com/blogs/architecture/exponential-backoff-and-jitter/)
suggests that `Schedule.jittered(0.0, 1.0)`{dir="auto"} is an effective
way to introduce randomness in retries.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const schedule: Schedule.Schedule&lt;Duration.Duration, unknown, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const jittered: &lt;Duration.Duration, unknown, never&gt;(self: Schedule.Schedule&lt;Duration.Duration, unknown, never&gt;) =&gt; Schedule.Schedule&lt;Duration.Duration, unknown, never&gt;</code></pre>
</figure>
:::
...
This function modifies a schedule so that its delay between executions
is randomly varied within a range. By default, the delay is adjusted
between `80%` (`0.8 * interval`) and `120%` (`1.2 * interval`) of the
original interval size.
...
::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [jitteredWith If you need to
specify custom min/max values.]{.twoslash-popup-docs-tag-value}
...
[jittered]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[#1: 10.448486ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#2: 21.134521ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#3: 47.245117ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#4: 88.263184ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#5: 163.651367ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#6: 335.818848ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#7: 719.126709ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#8: 1266.18457ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#9: 2931.252441ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#10: 6121.593018ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
The `Schedule.jittered`{dir="auto"} combinator introduces randomness to
delays within a range. For example, applying jitter to an exponential
backoff ensures that each retry occurs at a slightly different time,
reducing the risk of overwhelming the system.

::: {.autolink-heading-container .level-h2 tabindex="-1"}
## Controlling Repetitions with Filters

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#controlling-repetitions-with-filters){.anchor-link
aria-labelledby="controlling-repetitions-with-filters"}
:::

You can use `Schedule.whileInput`{dir="auto"} or
`Schedule.whileOutput`{dir="auto"} to limit how long a schedule
continues based on conditions applied to its input or output.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const whileOutput: &lt;number, unknown, never&gt;(self: Schedule.Schedule&lt;number, unknown, never&gt;, f: Predicate&lt;number&gt;) =&gt; Schedule.Schedule&lt;number, unknown, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [whileOutputEffect If you need
to use an effectful predicate.]{.twoslash-popup-docs-tag-value}
...
[whileOutput]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[recurs]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[5]{style="--0:#005CC5;--1:#79B8FF"}[),
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: code
[(end) \< whileOutput]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
`Schedule.whileOutput`{dir="auto"} filters repetitions based on the
output of the schedule. In this example, the schedule stops once the
output exceeds `2`{dir="auto"}, even though
`Schedule.recurs(5)`{dir="auto"} allows up to 5 repetitions.

::: {.autolink-heading-container .level-h2 tabindex="-1"}
## Adjusting Delays Based on Output

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#adjusting-delays-based-on-output){.anchor-link
aria-labelledby="adjusting-delays-based-on-output"}
:::

The `Schedule.modifyDelay`{dir="auto"} combinator allows you to
dynamically change the delay of a schedule based on the number of
repetitions or other output conditions.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const modifyDelay: &lt;number, unknown, never&gt;(self: Schedule.Schedule&lt;number, unknown, never&gt;, f: (out: number, duration: Duration.Duration) =&gt; Duration.DurationInput) =&gt; Schedule.Schedule&lt;number, unknown, never&gt; (+1 overload)</code></pre>
</figure>
:::

::: twoslash-popup-docs
Returns a new schedule that modifies the delay between executions using
a custom function.

**Details**

This function transforms an existing schedule by applying `f` to modify
the delay before each execution. The function receives both the
schedule\'s output (`out`) and the originally computed delay
(`duration`), and returns a new adjusted delay.
:::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [modifyDelayEffect If you need
to use an effectful function.]{.twoslash-popup-docs-tag-value}
...
[modifyDelay]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>out: number</code></pre>
</figure>
:::
::::
...
[out]{style="--0:#24292E;--1:#E1E4E8"}[
]{style="--0:#24292E;--1:#E1E4E8"}[\>]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[2]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[?]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[\"100
...
[duration]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: code
[#1: 1000ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#2: 1000ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#3: 1000ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#4: 100ms \< modifyDelay]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#5: 100ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#6: 100ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#7: 100ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#8: 100ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#9: 100ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[#10: 100ms]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
The delay modification applies dynamically during execution. In this
example, the first three repetitions follow the original
`1-second`{dir="auto"} spacing. After that, the delay drops to
`100 milliseconds`{dir="auto"}, making subsequent repetitions occur more
frequently.
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#tapping){.anchor-link
aria-labelledby="tapping"}
:::

`Schedule.tapInput`{dir="auto"} and `Schedule.tapOutput`{dir="auto"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const tapOutput: &lt;number, unknown, never, void, never&gt;(self: Schedule.Schedule&lt;number, unknown, never&gt;, f: (out: number) =&gt; Effect.Effect&lt;void, never, never&gt;) =&gt; Schedule.Schedule&lt;number, unknown, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
[recurs]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[2]{style="--0:#005CC5;--1:#79B8FF"}[),
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Schedule
Output:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[Schedule Output: 0]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Schedule Output: 1]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Schedule Output: 2]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
`Schedule.tapOutput`{dir="auto"} runs an effect before each recurrence,
using the schedule's current output as input. This can be useful for
logging, debugging, or triggering side effects.
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/scheduling/schedule-combinators.mdx){.sl-flex
...
[Built-In Schedules]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../built-in-schedules/index.html){.astro-u5aomj4k
rel="prev"}
...
]{.astro-u5aomj4k}](../cron/index.html){.astro-u5aomj4k rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
