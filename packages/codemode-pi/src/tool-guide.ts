 ...
 *
 * Bounds: maxLines (500), maxChars (20000), TTL (1 turn). Guide text is truncated
 * at registration and on every setGuide() call. Bounds are a safety net, not policy.
 *
 * Extractable: This module has ZERO dependency on metaskill internals. Any
 * extension can `import { createToolGuide } from './tool-guide.js'` and use it.
 *
 * @module
 */
