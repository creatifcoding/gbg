...
export const MshSpan = {
  ...
  Inner: {
    ...
    Consumers: {
      ...
      consumeMessages: 'msh.inner.consumers.consumeMessages',
      fetch: 'msh.inner.consumers.fetch',
      fetchMessages: 'msh.inner.consumers.fetchMessages',
      next: 'msh.inner.consumers.next',
      nextMessage: 'msh.inner.consumers.nextMessage',
    ...
    KV: {
      ...
      update: 'msh.inner.kv.update',
      delete: 'msh.inner.kv.delete',
      deleteIfRevision: 'msh.inner.kv.deleteIfRevision',
  ...
  KV: {
    get: 'msh.kv.get',
    getEntry: 'msh.kv.getEntry',
    getOrNull: 'msh.kv.getOrNull',
    put: 'msh.kv.put',
    create: 'msh.kv.create',
    updateIfRevision: 'msh.kv.updateIfRevision',
    delete: 'msh.kv.delete',
    deleteIfRevision: 'msh.kv.deleteIfRevision',
    purge: 'msh.kv.purge',
    watch: 'msh.kv.watch',
    keys: 'msh.kv.keys',
    list: 'msh.kv.list',
