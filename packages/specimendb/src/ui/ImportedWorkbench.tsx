/**
 * ImportedWorkbench — mechanical translation of
 * docs/variant/9263d787-0811-440f-8822-f31ee93b56a8.html
 *
 * One HTML, one page. Phase 0: do not extract Status / Locality / Media / Intake.
 * Theater copy is look-only text from the source. Empty wells stay empty.
 *
...
export function ImportedWorkbench() {
  return (
