defmodule Maiden.DeviceRuntime do
  @moduledoc """
  Device runtime contract namespace for Effect ↔ Elixir/Jido interop.

  ISA-95 alignment:
  - Device models control-module behavior under machine/work-cell hierarchy.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_device_runtime]}
