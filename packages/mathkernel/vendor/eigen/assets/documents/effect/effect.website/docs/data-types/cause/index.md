...
type is polymorphic in error type `E`{dir="auto"}, allowing flexibility
in handling any desired error type. However, there is often additional
information about failures that the error type `E`{dir="auto"} alone
does not capture.

To address this, Effect uses the `Cause<E>`{dir="auto"} data type to
...
Effect strictly preserves all failure-related information, storing a
full picture of the error context in the `Cause`{dir="auto"} type. This
comprehensive approach enables precise analysis and handling of
failures, ensuring no data is lost.

Though `Cause`{dir="auto"} values aren't typically manipulated directly,
they underlie errors within Effect workflows, providing access to both
concurrent and sequential error details. This allows for thorough error
...
aria-hidden="true"}](index.html#creating-causes){.anchor-link
aria-labelledby="creating-causes"}
:::

You can intentionally create an effect with a specific cause using
`Effect.failCause`{dir="auto"}.
...
::: code
[// Define an effect that dies with an unexpected
...
::: code
[// ┌─── Effect\<never, never, never\>]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failCause: &lt;never&gt;(cause: Cause.Cause&lt;never&gt;) =&gt; Effect.Effect&lt;never, never, never&gt;</code></pre>
</figure>
:::
...
[failCause]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Define an effect that fails with an expected
error]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failCause: &lt;string&gt;(cause: Cause.Cause&lt;string&gt;) =&gt; Effect.Effect&lt;never, string, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fail: &lt;string&gt;(error: string) =&gt; Cause.Cause&lt;string&gt;</code></pre>
</figure>
:::
...
This function constructs a `Cause` carrying an error of type `E`. It\'s
used when you want to represent a known or anticipated failure in your
effectful computations.
:::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [isFailure Check if a `Cause`
contains a failure]{.twoslash-popup-docs-tag-value}
...
Some causes do not influence the error type of the effect, leading to
`never`{dir="auto"} in the error channel:

::: expressive-code
<figure class="frame not-content">
<pre data-language="text"><code>                ┌─── no error information                ▼Effect&lt;never, never, never&gt;</code></pre>
<div class="copy">
<div>
...
For instance, `Cause.die`{dir="auto"} does not specify an error type for
the effect, while `Cause.fail`{dir="auto"} does, setting the error
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#cause-variations){.anchor-link
aria-labelledby="cause-variations"}
:::

There are several causes for various errors, in this section, we will
describe each of these causes.
...
The `Empty`{dir="auto"} cause signifies the absence of any errors.

::: {.autolink-heading-container .level-h3 tabindex="-1"}
### Fail

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#fail){.anchor-link
aria-labelledby="fail"}
:::

The `Fail<E>`{dir="auto"} cause represents a failure due to an expected
error of type `E`{dir="auto"}.
...
The `Die`{dir="auto"} cause indicates a failure resulting from a defect,
which is an unexpected or unintended error.

::: {.autolink-heading-container .level-h3 tabindex="-1"}
### Interrupt

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#interrupt){.anchor-link
aria-labelledby="interrupt"}
:::

The `Interrupt`{dir="auto"} cause represents a failure due to
`Fiber`{dir="auto"} interruption and contains the `FiberId`{dir="auto"}
of the interrupted `Fiber`{dir="auto"}.

::: {.autolink-heading-container .level-h3 tabindex="-1"}
### Sequential

[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#sequential){.anchor-link
aria-labelledby="sequential"}
:::

The `Sequential`{dir="auto"} cause combines two causes that occurred one
after the other.

For example, in an `Effect.ensuring`{dir="auto"} operation (analogous to
`try-finally`{dir="auto"}), if both the `try`{dir="auto"} and
`finally`{dir="auto"} sections fail, the two errors are represented in
sequence by a `Sequential`{dir="auto"} cause.

**Example** (Capturing Sequential Failures with a
`Sequential`{dir="auto"} Cause)
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#parallel){.anchor-link
aria-labelledby="parallel"}
:::

The `Parallel`{dir="auto"} cause combines two causes that occurred
concurrently.

In Effect programs, two operations may run in parallel, potentially
leading to multiple failures. When both computations fail
simultaneously, a `Parallel`{dir="auto"} cause represents the concurrent
errors within the effect workflow.

**Example** (Capturing Concurrent Failures with a `Parallel`{dir="auto"}
Cause)
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const all: &lt;readonly [Effect.Effect&lt;never, string, never&gt;, Effect.Effect&lt;never, never, never&gt;], {    concurrency: number;}&gt;(arg: readonly [Effect.Effect&lt;never, string, never&gt;, Effect.Effect&lt;never, never, never&gt;], options?: {    concurrency: number;} | undefined) =&gt; Effect.Effect&lt;[never, never], string, never&gt;</code></pre>
</figure>
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#retrieving-the-cause-of-an-effect){.anchor-link
aria-labelledby="retrieving-the-cause-of-an-effect"}
:::

To retrieve the cause of a failed effect, use
`Effect.cause`{dir="auto"}. This allows you to inspect or handle the
exact reason behind the failure.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;Cause&lt;string&gt;, never, never&gt;&gt;, void&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;Cause&lt;string&gt;, never, never&gt;&gt;, void, never&gt;) =&gt; Effect.Effect&lt;void, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const cause: &lt;never, string, never&gt;(self: Effect.Effect&lt;never, string, never&gt;) =&gt; Effect.Effect&lt;Cause&lt;string&gt;, never, never&gt;</code></pre>
</figure>
:::
...
To determine the specific type of a `Cause`{dir="auto"}, use the guards
provided in the Cause module:

- `Cause.isEmpty`{dir="auto"}: Checks if the cause is empty, indicating
  no error.
- `Cause.isFailType`{dir="auto"}: Identifies causes that represent an
  expected failure.
- `Cause.isDie`{dir="auto"}: Identifies causes that represent an
  unexpected defect.
- `Cause.isInterruptType`{dir="auto"}: Identifies causes related to
  fiber interruptions.
- `Cause.isSequentialType`{dir="auto"}: Checks if the cause consists of
  sequential errors.
- `Cause.isParallelType`{dir="auto"}: Checks if the cause contains
  parallel errors.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const cause: Cause.Cause&lt;Error&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fail: &lt;Error&gt;(error: Error) =&gt; Cause.Cause&lt;Error&gt;</code></pre>
</figure>
:::
...
[Error]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"my
message\"]{style="--0:#032F62;--1:#9ECBFF"}[))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const isFailType: &lt;Error&gt;(self: Cause.Cause&lt;Error&gt;) =&gt; self is Cause.Fail&lt;Error&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const cause: Cause.Fail&lt;Error&gt;</code></pre>
</figure>
:::
::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[// Output: my
...
These guards allow you to accurately identify the type of a
`Cause`{dir="auto"}, making it easier to handle various error cases in
your code. Whether dealing with expected failures, unexpected defects,
interruptions, or composite errors, these guards provide a clear method
for assessing and managing error scenarios.
...
The `Cause.match`{dir="auto"} function provides a straightforward way to
handle each case of a `Cause`{dir="auto"}. By defining callbacks for
each possible cause type, you can respond to specific error scenarios
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const parallel: &lt;Error, never&gt;(left: Cause.Cause&lt;Error&gt;, right: Cause.Cause&lt;never&gt;) =&gt; Cause.Cause&lt;Error&gt;</code></pre>
</figure>
:::
...
discarding one error, both are retained, allowing for richer error
reporting and debugging.
:::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [isParallelType Check if a
`Cause` is a `Parallel`]{.twoslash-popup-docs-tag-value}
...
[parallel]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
[die]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"my
die
message\"]{style="--0:#032F62;--1:#9ECBFF"}[)]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::
::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const match: &lt;string, Error&gt;(self: Cause.Cause&lt;Error&gt;, options: {    readonly onEmpty: string;    readonly onFail: (error: Error) =&gt; string;    readonly onDie: (defect: unknown) =&gt; string;    readonly onInterrupt: (fiberId: FiberId) =&gt; string;    readonly onSequential: (left: string, right: string) =&gt; string;    readonly onParallel: (left: string, right: string) =&gt; string;}) =&gt; string (+1 overload)</code></pre>
</figure>
:::
...
This function processes a `Cause` by applying a set of custom handlers
to each possible type of cause: `Empty`, `Fail`, `Die`, `Interrupt`,
`Sequential`, and `Parallel`. The result of this function is a single
value of type `Z`. This function allows you to define exactly how to
handle each part of a `Cause`, whether it\'s a failure, defect,
interruption, or a combination of these.

The options parameter provides handlers for:

- `onEmpty`: Handles the case where the cause is `Empty`, meaning no
  errors occurred.
- `onFail`: Processes a failure with an error of type `E`.
- `onDie`: Processes a defect (unexpected error).
- `onInterrupt`: Handles a fiber interruption, providing the `FiberId`
  of the interruption.
- `onSequential`: Combines two sequential causes into a single value of
  type `Z`.
- `onParallel`: Combines two parallel causes into a single value of type
  `Z`.
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onEmpty: string</code></pre>
</figure>
:::
::::

[onEmpty]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[\"(empty)\"]{style="--0:#032F62;--1:#9ECBFF"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onFail: (error: Error) =&gt; string</code></pre>
</figure>
:::
::::

[onFail]{style="--0:#6F42C1;--1:#B392F0"}[:
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onDie: (defect: unknown) =&gt; string</code></pre>
</figure>
:::
::::

[onDie]{style="--0:#6F42C1;--1:#B392F0"}[:
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
]{style="--0:#24292E;--1:#E1E4E8"}[\`(defect:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onInterrupt: (fiberId: FiberId) =&gt; string</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>fiberId: FiberId</code></pre>
</figure>
:::
::::

[fiberId]{style="--0:#AE4B07;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[\`(fiberId:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[fiberId]{style="--0:#24292E;--1:#E1E4E8"}[})\`]{style="--0:#032F62;--1:#9ECBFF"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::
::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onSequential: (left: string, right: string) =&gt; string</code></pre>
</figure>
:::
::::

[onSequential]{style="--0:#6F42C1;--1:#B392F0"}[:
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>left: string</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>right: string</code></pre>
</figure>
:::
::::
...
[left]{style="--0:#24292E;--1:#E1E4E8"}[}) (right:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>onParallel: (left: string, right: string) =&gt; string</code></pre>
</figure>
:::
::::

[onParallel]{style="--0:#6F42C1;--1:#B392F0"}[:
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: code
[(onParallel (left: (error: my fail message)) (right: (defect: my die
message))]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#pretty-printing){.anchor-link
aria-labelledby="pretty-printing"}
:::

Clear and readable error messages are key for effective debugging. The
`Cause.pretty`{dir="auto"} function helps by formatting error messages
in a structured way, making it easier to understand failure details.

**Example** (Using `Cause.pretty`{dir="auto"} for Readable Error
Messages)
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import FiberId</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const pretty: &lt;never&gt;(cause: Cause.Cause&lt;never&gt;, options?: {    readonly renderErrorCause?: boolean | undefined;}) =&gt; string</code></pre>
</figure>
:::
...
::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [prettyErrors Get a list of
`PrettyError` objects instead of a single
...
[pretty]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const empty: Cause.Cause&lt;never&gt;</code></pre>
</figure>
:::
...
This function returns a cause that signifies \"no error.\" It\'s
commonly used to represent an absence of failure conditions.
:::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [isEmpty Check if a `Cause` is
empty]{.twoslash-popup-docs-tag-value}
...
[empty]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::::::::
:::::::::::::::::::::::::::::
...
::: code
[All fibers interrupted without
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const pretty: &lt;Error&gt;(cause: Cause.Cause&lt;Error&gt;, options?: {    readonly renderErrorCause?: boolean | undefined;}) =&gt; string</code></pre>
</figure>
:::
...
::: code
[Error: my fail message]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Error: my die message]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const interrupt: (fiberId: FiberId.FiberId) =&gt; Cause.Cause&lt;never&gt;</code></pre>
</figure>
:::
...
This function represents a fiber that has been interrupted. It stores
the identifier of the interrupted fiber, enabling precise tracking of
concurrent cancellations.
:::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [isInterrupted Check if a
`Cause` contains an interruption]{.twoslash-popup-docs-tag-value}
...
[FiberId]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: (id: number, startTimeSeconds: number) =&gt; FiberId.FiberId</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const pretty: &lt;string&gt;(cause: Cause.Cause&lt;string&gt;, options?: {    readonly renderErrorCause?: boolean | undefined;}) =&gt; string</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const sequential: &lt;string, string&gt;(left: Cause.Cause&lt;string&gt;, right: Cause.Cause&lt;string&gt;) =&gt; Cause.Cause&lt;string&gt;</code></pre>
</figure>
:::
...
This function merges two errors that occurred in sequence, such as a
main error followed by a finalization error. It preserves both errors
for complete failure information.
:::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [isSequentialType Check if a
`Cause` is a `Sequential`]{.twoslash-popup-docs-tag-value}
...
[sequential]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[fail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"fail1\"]{style="--0:#032F62;--1:#9ECBFF"}[),
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[fail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"fail2\"]{style="--0:#032F62;--1:#9ECBFF"}[)))]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::::::::::::::
::::::::::::::::::::::::::::::
...
::: code
[Error: fail1]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Error: fail2]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#retrieval-of-failures-and-defects){.anchor-link
aria-labelledby="retrieval-of-failures-and-defects"}
:::

To specifically collect failures or defects from a `Cause`{dir="auto"},
you can use `Cause.failures`{dir="auto"} and
`Cause.defects`{dir="auto"}. These functions allow you to inspect only
the errors or unexpected defects that occurred.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;Cause.Cause&lt;string&gt;, never, never&gt;&gt;, void&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;Cause.Cause&lt;string&gt;, never, never&gt;&gt;, void, never&gt;) =&gt; Effect.Effect&lt;void, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const cause: Cause.Cause&lt;string&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const cause: &lt;[never, never, never], string, never&gt;(self: Effect.Effect&lt;[never, never, never], string, never&gt;) =&gt; Effect.Effect&lt;Cause.Cause&lt;string&gt;, never, never&gt;</code></pre>
</figure>
:::
...
[cause]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
[fail]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"error
1\"]{style="--0:#032F62;--1:#9ECBFF"}[),]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
[die]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"defect\"]{style="--0:#032F62;--1:#9ECBFF"}[),]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::
::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failures: &lt;string&gt;(self: Cause.Cause&lt;string&gt;) =&gt; Chunk&lt;string&gt;</code></pre>
</figure>
:::
...
values found in the cause. It\'s useful for collecting all known
failures for logging or combined error handling.
:::
...
[failures]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const defects: &lt;string&gt;(self: Cause.Cause&lt;string&gt;) =&gt; Chunk&lt;unknown&gt;</code></pre>
</figure>
:::
...
(`Die`). It\'s handy for capturing or logging unanticipated failures
that might need special handling, such as bug reports.
:::
...
[defects]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/data-types/cause.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../bigdecimal/index.html){.astro-u5aomj4k
rel="prev"}
...
]{.astro-u5aomj4k}](../chunk/index.html){.astro-u5aomj4k rel="next"}
:::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
