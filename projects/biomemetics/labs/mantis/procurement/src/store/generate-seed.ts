...
const CAD_NOTES: Record<string, string> = {
  ...
  B46: [
    ...
    'Candidate family, none selected, carrier UNVERIFIED: MAX96724GTN/VY+ (datasheet **Future product); MAX96724FGTN/V+; MAX96724FGTN/VY+; MAX96724RGTN/V+ (datasheet **Future product). Tape-and-reel +T twins also listed on the datasheet; codes not invented beyond named rows. 6 Gbps MAX96724 rows marked future-product.',
