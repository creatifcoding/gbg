...
// ── honest-1000 batch schemas ──
export const RIEMANN_OP = Schema.TaggedStruct("RIEMANN_OP", {})
export const LOGISTIC2_OP = Schema.TaggedStruct("LOGISTIC2_OP", {})
export const SOFTMAX2_OP = Schema.TaggedStruct("SOFTMAX2_OP", {})
export const LEAKYRELU_OP = Schema.TaggedStruct("LEAKYRELU_OP", {})
export const SWISH_OP = Schema.TaggedStruct("SWISH_OP", {})
export const GELU_OP = Schema.TaggedStruct("GELU_OP", {})
export const MISH_OP = Schema.TaggedStruct("MISH_OP", {})
export const INVERSESQRT_OP = Schema.TaggedStruct("INVERSESQRT_OP", {})
export const SAMPLEVAR_N = Schema.TaggedStruct("SAMPLEVAR_N", { n: Schema.Number })
export const POPVAR_N = Schema.TaggedStruct("POPVAR_N", { n: Schema.Number })
export const SAMPLESTD_N = Schema.TaggedStruct("SAMPLESTD_N", { n: Schema.Number })
export const POPSTD_N = Schema.TaggedStruct("POPSTD_N", { n: Schema.Number })
export const RANGESTAT_N = Schema.TaggedStruct("RANGESTAT_N", { n: Schema.Number })
export const SUMPRODUCT2_N = Schema.TaggedStruct("SUMPRODUCT2_N", { n: Schema.Number })
export const SUMSQDIFF_N = Schema.TaggedStruct("SUMSQDIFF_N", { n: Schema.Number })
export const AVGDEV2_N = Schema.TaggedStruct("AVGDEV2_N", { n: Schema.Number })
export const RMSVAL_N = Schema.TaggedStruct("RMSVAL_N", { n: Schema.Number })
export const GEOSTD_N = Schema.TaggedStruct("GEOSTD_N", { n: Schema.Number })
export const TEXTZIP_OP = Schema.TaggedStruct("TEXTZIP_OP", {})
export const TEXTREPEATN_OP = Schema.TaggedStruct("TEXTREPEATN_OP", {})
export const TEXTISALPHA_OP = Schema.TaggedStruct("TEXTISALPHA_OP", {})
export const TEXTISDIGIT_OP = Schema.TaggedStruct("TEXTISDIGIT_OP", {})
export const TEXTISALNUM_OP = Schema.TaggedStruct("TEXTISALNUM_OP", {})
export const TEXTISSPACE_OP = Schema.TaggedStruct("TEXTISSPACE_OP", {})
export const TEXTTITLE2_OP = Schema.TaggedStruct("TEXTTITLE2_OP", {})
export const TEXTSWAP_OP = Schema.TaggedStruct("TEXTSWAP_OP", {})
export const ISINTEGER2_OP = Schema.TaggedStruct("ISINTEGER2_OP", {})
export const ISNAT_OP = Schema.TaggedStruct("ISNAT_OP", {})
export const PARITY_OP = Schema.TaggedStruct("PARITY_OP", {})
export const ANNUALRATE_OP = Schema.TaggedStruct("ANNUALRATE_OP", {})
export const EFFECTIVERATE_OP = Schema.TaggedStruct("EFFECTIVERATE_OP", {})
export const NOMINALRATE_OP = Schema.TaggedStruct("NOMINALRATE_OP", {})
export const FUTUREVALUE_OP = Schema.TaggedStruct("FUTUREVALUE_OP", {})
export const PRESVALUE_OP = Schema.TaggedStruct("PRESVALUE_OP", {})
export const ANNUITYDUE_OP = Schema.TaggedStruct("ANNUITYDUE_OP", {})
export const SINKINGFUND_OP = Schema.TaggedStruct("SINKINGFUND_OP", {})
export const IMPLIESSTRICT_OP = Schema.TaggedStruct("IMPLIESSTRICT_OP", {})
export const XNOR2_OP = Schema.TaggedStruct("XNOR2_OP", {})
export const HALFADD_OP = Schema.TaggedStruct("HALFADD_OP", {})
export const FULLADD_OP = Schema.TaggedStruct("FULLADD_OP", {})
export const COMPARE3_OP = Schema.TaggedStruct("COMPARE3_OP", {})
export const BETWEEN2_OP = Schema.TaggedStruct("BETWEEN2_OP", {})
export const BINCOUNT_N = Schema.TaggedStruct("BINCOUNT_N", { n: Schema.Number })
export const HISTOGRAM_N = Schema.TaggedStruct("HISTOGRAM_N", { n: Schema.Number })
export const MODECOUNT_N = Schema.TaggedStruct("MODECOUNT_N", { n: Schema.Number })
export const RANDLAPLACE_OP = Schema.TaggedStruct("RANDLAPLACE_OP", {})
export const RANDLOGISTIC_OP = Schema.TaggedStruct("RANDLOGISTIC_OP", {})
// ── final-12 schemas ──
export const SELU_OP = Schema.TaggedStruct("SELU_OP", {})
export const HARDSWISH_OP = Schema.TaggedStruct("HARDSWISH_OP", {})
export const HARDSIGM_OP = Schema.TaggedStruct("HARDSIGM_OP", {})
export const CLIPVAL_OP = Schema.TaggedStruct("CLIPVAL_OP", {})
export const LINSTEP_OP = Schema.TaggedStruct("LINSTEP_OP", {})
export const CUBICINTERP_OP = Schema.TaggedStruct("CUBICINTERP_OP", {})
export const LETTERCOUNT_OP = Schema.TaggedStruct("LETTERCOUNT_OP", {})
// ── final-5 schemas ──
export const PRELU_OP = Schema.TaggedStruct("PRELU_OP", {})
export const CELU_OP = Schema.TaggedStruct("CELU_OP", {})
export const SOFTSIGN_OP = Schema.TaggedStruct("SOFTSIGN_OP", {})
export const BENTID_OP = Schema.TaggedStruct("BENTID_OP", {})
export const SQUAREPLUS_OP = Schema.TaggedStruct("SQUAREPLUS_OP", {})
// ── 1050 batch schemas ──
export const ARCTANH2_OP = Schema.TaggedStruct("ARCTANH2_OP", {})
export const ARCCOTH_OP = Schema.TaggedStruct("ARCCOTH_OP", {})
export const SIGMOID2_OP = Schema.TaggedStruct("SIGMOID2_OP", {})
export const GAUSSIAN2_OP = Schema.TaggedStruct("GAUSSIAN2_OP", {})
export const RAMP_OP = Schema.TaggedStruct("RAMP_OP", {})
export const HEAVISIDE_OP = Schema.TaggedStruct("HEAVISIDE_OP", {})
export const BOXCAR_OP = Schema.TaggedStruct("BOXCAR_OP", {})
export const TRIANGLE2_OP = Schema.TaggedStruct("TRIANGLE2_OP", {})
export const SAWTOOTH2_OP = Schema.TaggedStruct("SAWTOOTH2_OP", {})
export const WELCH_N = Schema.TaggedStruct("WELCH_N", { n: Schema.Number })
export const HAMMING_N = Schema.TaggedStruct("HAMMING_N", { n: Schema.Number })
export const HANNING_N = Schema.TaggedStruct("HANNING_N", { n: Schema.Number })
export const BLACKMAN_N = Schema.TaggedStruct("BLACKMAN_N", { n: Schema.Number })
export const KAISER_N = Schema.TaggedStruct("KAISER_N", { n: Schema.Number })
export const TUKEYWIN_N = Schema.TaggedStruct("TUKEYWIN_N", { n: Schema.Number })
export const GINIIMPURITY_N = Schema.TaggedStruct("GINIIMPURITY_N", { n: Schema.Number })
export const INFOGAIN_N = Schema.TaggedStruct("INFOGAIN_N", { n: Schema.Number })
export const TEXTWRAP2_OP = Schema.TaggedStruct("TEXTWRAP2_OP", {})
export const TEXTPADCENTER_OP = Schema.TaggedStruct("TEXTPADCENTER_OP", {})
export const TEXTDELIMIT_OP = Schema.TaggedStruct("TEXTDELIMIT_OP", {})
export const TEXTENCLOSE_OP = Schema.TaggedStruct("TEXTENCLOSE_OP", {})
export const TEXTSURROUND_OP = Schema.TaggedStruct("TEXTSURROUND_OP", {})
export const TEXTCHOP_OP = Schema.TaggedStruct("TEXTCHOP_OP", {})
export const TEXTELLIPSIS_OP = Schema.TaggedStruct("TEXTELLIPSIS_OP", {})
export const TEXTCENSOR_OP = Schema.TaggedStruct("TEXTCENSOR_OP", {})
export const ISCUBE_OP = Schema.TaggedStruct("ISCUBE_OP", {})
export const ISCOPRIME_OP = Schema.TaggedStruct("ISCOPRIME_OP", {})
export const ISTRIANGULAR_OP = Schema.TaggedStruct("ISTRIANGULAR_OP", {})
export const ISPENTAGONAL_OP = Schema.TaggedStruct("ISPENTAGONAL_OP", {})
export const ISHEXAGONAL_OP = Schema.TaggedStruct("ISHEXAGONAL_OP", {})
export const COMPOUND2_OP = Schema.TaggedStruct("COMPOUND2_OP", {})
export const RULE72_OP = Schema.TaggedStruct("RULE72_OP", {})
export const RULE70_OP = Schema.TaggedStruct("RULE70_OP", {})
export const MARKUPRATE_OP = Schema.TaggedStruct("MARKUPRATE_OP", {})
export const MARGINRATE_OP = Schema.TaggedStruct("MARGINRATE_OP", {})
export const NOR2_OP = Schema.TaggedStruct("NOR2_OP", {})
export const NAND2_OP = Schema.TaggedStruct("NAND2_OP", {})
export const EQUIV2_OP = Schema.TaggedStruct("EQUIV2_OP", {})
export const PEIRCE_OP = Schema.TaggedStruct("PEIRCE_OP", {})
export const SHEFFER_OP = Schema.TaggedStruct("SHEFFER_OP", {})
export const CONSENSUS_N = Schema.TaggedStruct("CONSENSUS_N", { n: Schema.Number })
export const BSEARCH2_N = Schema.TaggedStruct("BSEARCH2_N", { n: Schema.Number })
export const UNIQUE2_N = Schema.TaggedStruct("UNIQUE2_N", { n: Schema.Number })
export const COUNTDIST_N = Schema.TaggedStruct("COUNTDIST_N", { n: Schema.Number })
export const TOPK_N = Schema.TaggedStruct("TOPK_N", { n: Schema.Number })
export const BOTTOMK_N = Schema.TaggedStruct("BOTTOMK_N", { n: Schema.Number })
export const RANDCAUCHY_OP = Schema.TaggedStruct("RANDCAUCHY_OP", {})
// ── 1100 batch schemas ──
export const RECIP_OP = Schema.TaggedStruct("RECIP_OP", {})
export const SQRDIFF_OP = Schema.TaggedStruct("SQRDIFF_OP", {})
export const HYPERBOLIC_OP = Schema.TaggedStruct("HYPERBOLIC_OP", {})
export const SINCOS_OP = Schema.TaggedStruct("SINCOS_OP", {})
export const EXPM1ALT_OP = Schema.TaggedStruct("EXPM1ALT_OP", {})
export const LOG1PALT_OP = Schema.TaggedStruct("LOG1PALT_OP", {})
export const CBRT2_OP = Schema.TaggedStruct("CBRT2_OP", {})
export const NTHPOWER_OP = Schema.TaggedStruct("NTHPOWER_OP", {})
export const DIVSAFE_OP = Schema.TaggedStruct("DIVSAFE_OP", {})
export const MODSAFE_OP = Schema.TaggedStruct("MODSAFE_OP", {})
export const NEGONE_OP = Schema.TaggedStruct("NEGONE_OP", {})
export const FRAC2_OP = Schema.TaggedStruct("FRAC2_OP", {})
export const WHOLEFRAC_OP = Schema.TaggedStruct("WHOLEFRAC_OP", {})
export const ROUNDN_OP = Schema.TaggedStruct("ROUNDN_OP", {})
export const EWMA_N = Schema.TaggedStruct("EWMA_N", { n: Schema.Number })
export const CUMMAX_N = Schema.TaggedStruct("CUMMAX_N", { n: Schema.Number })
export const CUMMIN_N = Schema.TaggedStruct("CUMMIN_N", { n: Schema.Number })
export const CUMSUM2_N = Schema.TaggedStruct("CUMSUM2_N", { n: Schema.Number })
export const CUMPROD2_N = Schema.TaggedStruct("CUMPROD2_N", { n: Schema.Number })
export const DIFFLAG_N = Schema.TaggedStruct("DIFFLAG_N", { n: Schema.Number })
export const PCTCHANGE_N = Schema.TaggedStruct("PCTCHANGE_N", { n: Schema.Number })
export const ROLLMAX_N = Schema.TaggedStruct("ROLLMAX_N", { n: Schema.Number })
export const ROLLMIN_N = Schema.TaggedStruct("ROLLMIN_N", { n: Schema.Number })
export const ROLLAVG_N = Schema.TaggedStruct("ROLLAVG_N", { n: Schema.Number })
export const TEXTSHRINK_OP = Schema.TaggedStruct("TEXTSHRINK_OP", {})
export const TEXTEXPAND_OP = Schema.TaggedStruct("TEXTEXPAND_OP", {})
export const TEXTORDINAL_OP = Schema.TaggedStruct("TEXTORDINAL_OP", {})
export const TEXTPLURAL_OP = Schema.TaggedStruct("TEXTPLURAL_OP", {})
export const TEXTSINGULAR_OP = Schema.TaggedStruct("TEXTSINGULAR_OP", {})
export const TEXTCAPS_OP = Schema.TaggedStruct("TEXTCAPS_OP", {})
export const TEXTNOCAPS_OP = Schema.TaggedStruct("TEXTNOCAPS_OP", {})
export const TEXTFIRST_OP = Schema.TaggedStruct("TEXTFIRST_OP", {})
export const TEXTLAST_OP = Schema.TaggedStruct("TEXTLAST_OP", {})
export const TEXTMID_OP = Schema.TaggedStruct("TEXTMID_OP", {})
export const ISARRAY_OP = Schema.TaggedStruct("ISARRAY_OP", {})
export const ISSCALAR_OP = Schema.TaggedStruct("ISSCALAR_OP", {})
export const BITWIDTH_OP = Schema.TaggedStruct("BITWIDTH_OP", {})
export const BYTECOUNT_OP = Schema.TaggedStruct("BYTECOUNT_OP", {})
export const NUMCLASS_OP = Schema.TaggedStruct("NUMCLASS_OP", {})
export const HEXVAL_OP = Schema.TaggedStruct("HEXVAL_OP", {})
export const EBITDA_OP = Schema.TaggedStruct("EBITDA_OP", {})
export const GROSSPROFIT_OP = Schema.TaggedStruct("GROSSPROFIT_OP", {})
export const NETINCOME_OP = Schema.TaggedStruct("NETINCOME_OP", {})
export const ASSETRATIO_OP = Schema.TaggedStruct("ASSETRATIO_OP", {})
export const DEBTRATIO_OP = Schema.TaggedStruct("DEBTRATIO_OP", {})
export const QUICKRATIO_OP = Schema.TaggedStruct("QUICKRATIO_OP", {})
export const CLAMPBOOL_OP = Schema.TaggedStruct("CLAMPBOOL_OP", {})
export const BOOLFLIP_OP = Schema.TaggedStruct("BOOLFLIP_OP", {})
export const TERNARY_OP = Schema.TaggedStruct("TERNARY_OP", {})
export const NULLCOAL_OP = Schema.TaggedStruct("NULLCOAL_OP", {})
export const ZIPWITH_N = Schema.TaggedStruct("ZIPWITH_N", { n: Schema.Number })
export const REDUCE2_N = Schema.TaggedStruct("REDUCE2_N", { n: Schema.Number })
// ── 1150 batch schemas ──
export const WRAP2_OP = Schema.TaggedStruct("WRAP2_OP", {})
export const PINGPONG_OP = Schema.TaggedStruct("PINGPONG_OP", {})
export const FMULT_OP = Schema.TaggedStruct("FMULT_OP", {})
export const FDIV_OP = Schema.TaggedStruct("FDIV_OP", {})
export const LOGBASE_OP = Schema.TaggedStruct("LOGBASE_OP", {})
export const RSQRT_OP = Schema.TaggedStruct("RSQRT_OP", {})
export const SIGN2_OP = Schema.TaggedStruct("SIGN2_OP", {})
export const TRUNC2_OP = Schema.TaggedStruct("TRUNC2_OP", {})
export const ROUNDHALF_OP = Schema.TaggedStruct("ROUNDHALF_OP", {})
export const CEIL2_OP = Schema.TaggedStruct("CEIL2_OP", {})
export const FLOOR2_OP = Schema.TaggedStruct("FLOOR2_OP", {})
export const SNAP_OP = Schema.TaggedStruct("SNAP_OP", {})
export const TMEAN_N = Schema.TaggedStruct("TMEAN_N", { n: Schema.Number })
export const IQR2_N = Schema.TaggedStruct("IQR2_N", { n: Schema.Number })
export const Q1_N = Schema.TaggedStruct("Q1_N", { n: Schema.Number })
export const Q3_N = Schema.TaggedStruct("Q3_N", { n: Schema.Number })
export const DECILE_N = Schema.TaggedStruct("DECILE_N", { n: Schema.Number })
export const OUTLIER_N = Schema.TaggedStruct("OUTLIER_N", { n: Schema.Number })
export const PEAK_N = Schema.TaggedStruct("PEAK_N", { n: Schema.Number })
export const TROUGH_N = Schema.TaggedStruct("TROUGH_N", { n: Schema.Number })
export const PLATEAU_N = Schema.TaggedStruct("PLATEAU_N", { n: Schema.Number })
export const TEXTTOKEN_OP = Schema.TaggedStruct("TEXTTOKEN_OP", {})
export const TEXTJOINWITH_OP = Schema.TaggedStruct("TEXTJOINWITH_OP", {})
export const TEXTPREPEND_OP = Schema.TaggedStruct("TEXTPREPEND_OP", {})
export const TEXTAPPEND_OP = Schema.TaggedStruct("TEXTAPPEND_OP", {})
export const TEXTOVERLAP_OP = Schema.TaggedStruct("TEXTOVERLAP_OP", {})
export const TEXTCOMMON_OP = Schema.TaggedStruct("TEXTCOMMON_OP", {})
export const TEXTUNCOMMON_OP = Schema.TaggedStruct("TEXTUNCOMMON_OP", {})
export const TEXTDIFF_OP = Schema.TaggedStruct("TEXTDIFF_OP", {})
export const ISODD3_OP = Schema.TaggedStruct("ISODD3_OP", {})
export const ISEVEN3_OP = Schema.TaggedStruct("ISEVEN3_OP", {})
export const ISPOSINT_OP = Schema.TaggedStruct("ISPOSINT_OP", {})
export const ISNEGINT_OP = Schema.TaggedStruct("ISNEGINT_OP", {})
export const ISUNIT_OP = Schema.TaggedStruct("ISUNIT_OP", {})
export const ISBETWEEN_OP = Schema.TaggedStruct("ISBETWEEN_OP", {})
export const PERPAMT_OP = Schema.TaggedStruct("PERPAMT_OP", {})
export const PERPETUITY_OP = Schema.TaggedStruct("PERPETUITY_OP", {})
export const LEVERAGE_OP = Schema.TaggedStruct("LEVERAGE_OP", {})
export const COVERAGE_OP = Schema.TaggedStruct("COVERAGE_OP", {})
export const EARNINGSPS_OP = Schema.TaggedStruct("EARNINGSPS_OP", {})
export const PRICEEARNINGS_OP = Schema.TaggedStruct("PRICEEARNINGS_OP", {})
export const ANYOF_N = Schema.TaggedStruct("ANYOF_N", { n: Schema.Number })
export const NONEOF_N = Schema.TaggedStruct("NONEOF_N", { n: Schema.Number })
export const EXACTLYONE_N = Schema.TaggedStruct("EXACTLYONE_N", { n: Schema.Number })
export const ATMOSTK_N = Schema.TaggedStruct("ATMOSTK_N", { n: Schema.Number })
export const RUNLEN_N = Schema.TaggedStruct("RUNLEN_N", { n: Schema.Number })
export const STREAK_N = Schema.TaggedStruct("STREAK_N", { n: Schema.Number })
export const SPAN_N = Schema.TaggedStruct("SPAN_N", { n: Schema.Number })
export const RANDFOLD_OP = Schema.TaggedStruct("RANDFOLD_OP", {})
export const RANDTRI_OP = Schema.TaggedStruct("RANDTRI_OP", {})
// ── 1200 batch schemas ──
export const FARADAY_OP = Schema.TaggedStruct("FARADAY_OP", {})
export const BOLTZMANN_OP = Schema.TaggedStruct("BOLTZMANN_OP", {})
export const PLANCK_OP = Schema.TaggedStruct("PLANCK_OP", {})
export const AVOGADRO_OP = Schema.TaggedStruct("AVOGADRO_OP", {})
export const COULOMB_OP = Schema.TaggedStruct("COULOMB_OP", {})
export const HOOKE_OP = Schema.TaggedStruct("HOOKE_OP", {})
export const OHMS_OP = Schema.TaggedStruct("OHMS_OP", {})
export const WATT_OP = Schema.TaggedStruct("WATT_OP", {})
export const KELVIN_OP = Schema.TaggedStruct("KELVIN_OP", {})
export const CELSIUS_OP = Schema.TaggedStruct("CELSIUS_OP", {})
export const FAHRENHEIT_OP = Schema.TaggedStruct("FAHRENHEIT_OP", {})
export const NEWTON_OP = Schema.TaggedStruct("NEWTON_OP", {})
export const BOOTSTRAPMEAN_N = Schema.TaggedStruct("BOOTSTRAPMEAN_N", { n: Schema.Number })
export const JACKKNIFE_N = Schema.TaggedStruct("JACKKNIFE_N", { n: Schema.Number })
export const ANDERSON_N = Schema.TaggedStruct("ANDERSON_N", { n: Schema.Number })
export const SHAPIRO_N = Schema.TaggedStruct("SHAPIRO_N", { n: Schema.Number })
export const KSTEST_N = Schema.TaggedStruct("KSTEST_N", { n: Schema.Number })
export const AUTOCORR_N = Schema.TaggedStruct("AUTOCORR_N", { n: Schema.Number })
export const CROSSCORR_N = Schema.TaggedStruct("CROSSCORR_N", { n: Schema.Number })
export const CONVOL_N = Schema.TaggedStruct("CONVOL_N", { n: Schema.Number })
export const DETREND_N = Schema.TaggedStruct("DETREND_N", { n: Schema.Number })
export const NORMALIZE2_N = Schema.TaggedStruct("NORMALIZE2_N", { n: Schema.Number })
export const TEXTROT47_OP = Schema.TaggedStruct("TEXTROT47_OP", {})
export const TEXTATBASH_OP = Schema.TaggedStruct("TEXTATBASH_OP", {})
export const TEXTXOR_OP = Schema.TaggedStruct("TEXTXOR_OP", {})
export const TEXTNTH2_OP = Schema.TaggedStruct("TEXTNTH2_OP", {})
export const TEXTUNTIL_OP = Schema.TaggedStruct("TEXTUNTIL_OP", {})
export const TEXTAFTER2_OP = Schema.TaggedStruct("TEXTAFTER2_OP", {})
export const TEXTWORDS_OP = Schema.TaggedStruct("TEXTWORDS_OP", {})
export const ISPRIMEPOWER_OP = Schema.TaggedStruct("ISPRIMEPOWER_OP", {})
export const ISDEFICIENT_OP = Schema.TaggedStruct("ISDEFICIENT_OP", {})
export const ISABUNDANT_OP = Schema.TaggedStruct("ISABUNDANT_OP", {})
export const ISSEMIPRIME_OP = Schema.TaggedStruct("ISSEMIPRIME_OP", {})
export const ISSQUAREFREE_OP = Schema.TaggedStruct("ISSQUAREFREE_OP", {})
export const ISSMOOTH_OP = Schema.TaggedStruct("ISSMOOTH_OP", {})
export const EVTOEBITDA_OP = Schema.TaggedStruct("EVTOEBITDA_OP", {})
export const PRICEBOOK_OP = Schema.TaggedStruct("PRICEBOOK_OP", {})
export const PRICESALES_OP = Schema.TaggedStruct("PRICESALES_OP", {})
export const DIVIDENDPAYOUT_OP = Schema.TaggedStruct("DIVIDENDPAYOUT_OP", {})
export const RETENTIONRATE_OP = Schema.TaggedStruct("RETENTIONRATE_OP", {})
export const SGROWTH_OP = Schema.TaggedStruct("SGROWTH_OP", {})
export const RISING_OP = Schema.TaggedStruct("RISING_OP", {})
export const FALLING_OP = Schema.TaggedStruct("FALLING_OP", {})
export const CHANGED_OP = Schema.TaggedStruct("CHANGED_OP", {})
export const STABLE_OP = Schema.TaggedStruct("STABLE_OP", {})
export const SELECTIF_N = Schema.TaggedStruct("SELECTIF_N", { n: Schema.Number })
export const REJECTIF_N = Schema.TaggedStruct("REJECTIF_N", { n: Schema.Number })
export const TAKEWHILE_N = Schema.TaggedStruct("TAKEWHILE_N", { n: Schema.Number })
export const DROPWHILE_N = Schema.TaggedStruct("DROPWHILE_N", { n: Schema.Number })
export const RANDPOISSON_OP = Schema.TaggedStruct("RANDPOISSON_OP", {})
// ── 1250 batch schemas ──
export const DOTPROD2_OP = Schema.TaggedStruct("DOTPROD2_OP", {})
export const CROSSPROD_OP = Schema.TaggedStruct("CROSSPROD_OP", {})
export const MAGNITUDE2_OP = Schema.TaggedStruct("MAGNITUDE2_OP", {})
export const ANGLE_OP = Schema.TaggedStruct("ANGLE_OP", {})
export const MIDPOINT_OP = Schema.TaggedStruct("MIDPOINT_OP", {})
export const INTERCEPT2_OP = Schema.TaggedStruct("INTERCEPT2_OP", {})
export const PERPSLOPE_OP = Schema.TaggedStruct("PERPSLOPE_OP", {})
export const ARCLENGTH_OP = Schema.TaggedStruct("ARCLENGTH_OP", {})
export const SECTORAREA_OP = Schema.TaggedStruct("SECTORAREA_OP", {})
export const HERON_OP = Schema.TaggedStruct("HERON_OP", {})
export const BRAHMAGUPTA_OP = Schema.TaggedStruct("BRAHMAGUPTA_OP", {})
export const HUBERMU_N = Schema.TaggedStruct("HUBERMU_N", { n: Schema.Number })
export const HAMPEL_N = Schema.TaggedStruct("HAMPEL_N", { n: Schema.Number })
export const TUKEYBIWEIGHT_N = Schema.TaggedStruct("TUKEYBIWEIGHT_N", { n: Schema.Number })
export const ANDREWSINE_N = Schema.TaggedStruct("ANDREWSINE_N", { n: Schema.Number })
export const L1NORM_N = Schema.TaggedStruct("L1NORM_N", { n: Schema.Number })
export const L2NORM_N = Schema.TaggedStruct("L2NORM_N", { n: Schema.Number })
export const LINFNORM_N = Schema.TaggedStruct("LINFNORM_N", { n: Schema.Number })
export const LPNORM_N = Schema.TaggedStruct("LPNORM_N", { n: Schema.Number })
export const MAHALANOBIS_N = Schema.TaggedStruct("MAHALANOBIS_N", { n: Schema.Number })
export const COSINESIM_N = Schema.TaggedStruct("COSINESIM_N", { n: Schema.Number })
export const TEXTFREQCHAR_OP = Schema.TaggedStruct("TEXTFREQCHAR_OP", {})
export const TEXTUNIQCHARS_OP = Schema.TaggedStruct("TEXTUNIQCHARS_OP", {})
export const TEXTCHARCOUNT_OP = Schema.TaggedStruct("TEXTCHARCOUNT_OP", {})
export const TEXTPOSITION_OP = Schema.TaggedStruct("TEXTPOSITION_OP", {})
export const TEXTOCCURRENCES_OP = Schema.TaggedStruct("TEXTOCCURRENCES_OP", {})
export const TEXTSTARTSWITH2_OP = Schema.TaggedStruct("TEXTSTARTSWITH2_OP", {})
export const TEXTENDSWITH2_OP = Schema.TaggedStruct("TEXTENDSWITH2_OP", {})
export const TEXTINCLUDES_OP = Schema.TaggedStruct("TEXTINCLUDES_OP", {})
export const ISAMICABLE_OP = Schema.TaggedStruct("ISAMICABLE_OP", {})
export const ISAUTOMORPHIC_OP = Schema.TaggedStruct("ISAUTOMORPHIC_OP", {})
export const ISKAPREKAR_OP = Schema.TaggedStruct("ISKAPREKAR_OP", {})
export const ISNARCISSISTIC_OP = Schema.TaggedStruct("ISNARCISSISTIC_OP", {})
export const ISSMITH_OP = Schema.TaggedStruct("ISSMITH_OP", {})
export const ISPROTH_OP = Schema.TaggedStruct("ISPROTH_OP", {})
export const WACC2_OP = Schema.TaggedStruct("WACC2_OP", {})
export const CAPM_OP = Schema.TaggedStruct("CAPM_OP", {})
export const GORDONMODEL_OP = Schema.TaggedStruct("GORDONMODEL_OP", {})
export const DDM_OP = Schema.TaggedStruct("DDM_OP", {})
export const MVADDED_OP = Schema.TaggedStruct("MVADDED_OP", {})
export const ECONVALUE_OP = Schema.TaggedStruct("ECONVALUE_OP", {})
export const ALLGT_N = Schema.TaggedStruct("ALLGT_N", { n: Schema.Number })
export const ALLLT_N = Schema.TaggedStruct("ALLLT_N", { n: Schema.Number })
export const ALLEQ_N = Schema.TaggedStruct("ALLEQ_N", { n: Schema.Number })
export const COUNTRUE_N = Schema.TaggedStruct("COUNTRUE_N", { n: Schema.Number })
export const RANKPCT_N = Schema.TaggedStruct("RANKPCT_N", { n: Schema.Number })
export const QUANTILE2_N = Schema.TaggedStruct("QUANTILE2_N", { n: Schema.Number })
export const MEDIAN2_N = Schema.TaggedStruct("MEDIAN2_N", { n: Schema.Number })
export const RANDWEIBULL_OP = Schema.TaggedStruct("RANDWEIBULL_OP", {})
export const RANDPARETO_OP = Schema.TaggedStruct("RANDPARETO_OP", {})
// ── 1300 batch schemas ──
export const STIRLING1_OP = Schema.TaggedStruct("STIRLING1_OP", {})
export const STIRLING2_OP = Schema.TaggedStruct("STIRLING2_OP", {})
export const CATALAN2_OP = Schema.TaggedStruct("CATALAN2_OP", {})
export const PARTITION_OP = Schema.TaggedStruct("PARTITION_OP", {})
export const SUBFACTORIAL_OP = Schema.TaggedStruct("SUBFACTORIAL_OP", {})
export const DOUBLEFALLINGFACT_OP = Schema.TaggedStruct("DOUBLEFALLINGFACT_OP", {})
export const RISINGFACT_OP = Schema.TaggedStruct("RISINGFACT_OP", {})
export const MULTINOMIAL2_OP = Schema.TaggedStruct("MULTINOMIAL2_OP", {})
export const TRIBONACCI_OP = Schema.TaggedStruct("TRIBONACCI_OP", {})
export const KLDIVERGE_N = Schema.TaggedStruct("KLDIVERGE_N", { n: Schema.Number })
export const JSDIVERGE_N = Schema.TaggedStruct("JSDIVERGE_N", { n: Schema.Number })
export const THEIL_N = Schema.TaggedStruct("THEIL_N", { n: Schema.Number })
export const ATKINSON_N = Schema.TaggedStruct("ATKINSON_N", { n: Schema.Number })
export const PALMA_N = Schema.TaggedStruct("PALMA_N", { n: Schema.Number })
export const HOOVER_N = Schema.TaggedStruct("HOOVER_N", { n: Schema.Number })
export const TEXTPHONETIC_OP = Schema.TaggedStruct("TEXTPHONETIC_OP", {})
export const TEXTSNAKE_OP = Schema.TaggedStruct("TEXTSNAKE_OP", {})
export const TEXTKEBAB_OP = Schema.TaggedStruct("TEXTKEBAB_OP", {})
export const TEXTPASCAL_OP = Schema.TaggedStruct("TEXTPASCAL_OP", {})
export const TEXTCONSTANT_OP = Schema.TaggedStruct("TEXTCONSTANT_OP", {})
export const ISPERFECTSQ_OP = Schema.TaggedStruct("ISPERFECTSQ_OP", {})
export const ISPERFECTCUBE_OP = Schema.TaggedStruct("ISPERFECTCUBE_OP", {})
export const ISPOWER2_OP = Schema.TaggedStruct("ISPOWER2_OP", {})
export const ISHARMON_OP = Schema.TaggedStruct("ISHARMON_OP", {})
export const ISSOPHIE_OP = Schema.TaggedStruct("ISSOPHIE_OP", {})
export const ISSAFE_OP = Schema.TaggedStruct("ISSAFE_OP", {})
export const JENSEN_OP = Schema.TaggedStruct("JENSEN_OP", {})
export const INFORATE_OP = Schema.TaggedStruct("INFORATE_OP", {})
export const MODEVALUE_N = Schema.TaggedStruct("MODEVALUE_N", { n: Schema.Number })
export const RANDGUMBEL_OP = Schema.TaggedStruct("RANDGUMBEL_OP", {})
export const RANDFRECHET_OP = Schema.TaggedStruct("RANDFRECHET_OP", {})
// ── 1300 batch-2 schemas ──
export const LUCAS2_OP = Schema.TaggedStruct("LUCAS2_OP", {})
export const PELL_OP = Schema.TaggedStruct("PELL_OP", {})
export const JACOBSTHAL_OP = Schema.TaggedStruct("JACOBSTHAL_OP", {})
export const PRONIC_OP = Schema.TaggedStruct("PRONIC_OP", {})
export const OBLONG_OP = Schema.TaggedStruct("OBLONG_OP", {})
export const CENTERED_OP = Schema.TaggedStruct("CENTERED_OP", {})
export const HEXAGONAL2_OP = Schema.TaggedStruct("HEXAGONAL2_OP", {})
export const HEPTAGONAL_OP = Schema.TaggedStruct("HEPTAGONAL_OP", {})
export const OCTAGONAL_OP = Schema.TaggedStruct("OCTAGONAL_OP", {})
export const STAR_OP = Schema.TaggedStruct("STAR_OP", {})
export const CENTERED2_OP = Schema.TaggedStruct("CENTERED2_OP", {})
export const CAKE_OP = Schema.TaggedStruct("CAKE_OP", {})
export const LAZY_OP = Schema.TaggedStruct("LAZY_OP", {})
export const NARAYANA_OP = Schema.TaggedStruct("NARAYANA_OP", {})
export const EULERIAN_OP = Schema.TaggedStruct("EULERIAN_OP", {})
export const TEXTTITLECASE_OP = Schema.TaggedStruct("TEXTTITLECASE_OP", {})
export const TEXTDIGITSUM_OP = Schema.TaggedStruct("TEXTDIGITSUM_OP", {})
// ── 1300 top-up schemas ──
export const DECAGONAL_OP = Schema.TaggedStruct("DECAGONAL_OP", {})
export const DODECAGONAL_OP = Schema.TaggedStruct("DODECAGONAL_OP", {})
export const ICOSAHEDRAL_OP = Schema.TaggedStruct("ICOSAHEDRAL_OP", {})
// ── 1350 batch schemas ──
export const TAYLORSIN_OP = Schema.TaggedStruct("TAYLORSIN_OP", {})
export const TAYLORCOS_OP = Schema.TaggedStruct("TAYLORCOS_OP", {})
export const TAYLOREXP_OP = Schema.TaggedStruct("TAYLOREXP_OP", {})
export const NEWTONMETHOD_OP = Schema.TaggedStruct("NEWTONMETHOD_OP", {})
export const BISECT_OP = Schema.TaggedStruct("BISECT_OP", {})
export const TRAPEZOID_OP = Schema.TaggedStruct("TRAPEZOID_OP", {})
export const SIMPSON_OP = Schema.TaggedStruct("SIMPSON_OP", {})
export const ROMBERG_OP = Schema.TaggedStruct("ROMBERG_OP", {})
export const EULERAPPROX_OP = Schema.TaggedStruct("EULERAPPROX_OP", {})
export const GOLDENSECTION_OP = Schema.TaggedStruct("GOLDENSECTION_OP", {})
export const REGULAFALSI_OP = Schema.TaggedStruct("REGULAFALSI_OP", {})
export const SECANTMETHOD_OP = Schema.TaggedStruct("SECANTMETHOD_OP", {})
export const ARIMA_N = Schema.TaggedStruct("ARIMA_N", { n: Schema.Number })
export const HOLT_N = Schema.TaggedStruct("HOLT_N", { n: Schema.Number })
export const WINTERS_N = Schema.TaggedStruct("WINTERS_N", { n: Schema.Number })
export const EXPSMOOTH_N = Schema.TaggedStruct("EXPSMOOTH_N", { n: Schema.Number })
export const DOUBLEEXP_N = Schema.TaggedStruct("DOUBLEEXP_N", { n: Schema.Number })
export const SEASONAVG_N = Schema.TaggedStruct("SEASONAVG_N", { n: Schema.Number })
export const MOVMEDIAN_N = Schema.TaggedStruct("MOVMEDIAN_N", { n: Schema.Number })
export const MOVSTDEV_N = Schema.TaggedStruct("MOVSTDEV_N", { n: Schema.Number })
export const MOVVAR_N = Schema.TaggedStruct("MOVVAR_N", { n: Schema.Number })
export const MOVRANGE_N = Schema.TaggedStruct("MOVRANGE_N", { n: Schema.Number })
export const TEXTCRC32_OP = Schema.TaggedStruct("TEXTCRC32_OP", {})
export const TEXTSOUNDEX_OP = Schema.TaggedStruct("TEXTSOUNDEX_OP", {})
export const TEXTMETAPHONE_OP = Schema.TaggedStruct("TEXTMETAPHONE_OP", {})
export const TEXTALPHANUM_OP = Schema.TaggedStruct("TEXTALPHANUM_OP", {})
export const TEXTZALGO2_OP = Schema.TaggedStruct("TEXTZALGO2_OP", {})
export const TEXTUNICODE_OP = Schema.TaggedStruct("TEXTUNICODE_OP", {})
export const TEXTFROMUNI_OP = Schema.TaggedStruct("TEXTFROMUNI_OP", {})
export const TEXTBIN_OP = Schema.TaggedStruct("TEXTBIN_OP", {})
export const ISPRACTICAL_OP = Schema.TaggedStruct("ISPRACTICAL_OP", {})
export const ISREGULAR_OP = Schema.TaggedStruct("ISREGULAR_OP", {})
export const ISSUPERABUNDANT_OP = Schema.TaggedStruct("ISSUPERABUNDANT_OP", {})
export const ISHAPPY2_OP = Schema.TaggedStruct("ISHAPPY2_OP", {})
export const ISSAD_OP = Schema.TaggedStruct("ISSAD_OP", {})
export const ISNICE_OP = Schema.TaggedStruct("ISNICE_OP", {})
export const MODIGLIANI_OP = Schema.TaggedStruct("MODIGLIANI_OP", {})
export const OMEGA_OP = Schema.TaggedStruct("OMEGA_OP", {})
export const KAPPA_OP = Schema.TaggedStruct("KAPPA_OP", {})
export const RACHEV_OP = Schema.TaggedStruct("RACHEV_OP", {})
export const BURKE_OP = Schema.TaggedStruct("BURKE_OP", {})
export const MAJORITY3_N = Schema.TaggedStruct("MAJORITY3_N", { n: Schema.Number })
export const CONSENSUS2_N = Schema.TaggedStruct("CONSENSUS2_N", { n: Schema.Number })
export const THRESHOLD2_N = Schema.TaggedStruct("THRESHOLD2_N", { n: Schema.Number })
export const QUORUM2_N = Schema.TaggedStruct("QUORUM2_N", { n: Schema.Number })
export const WEIGHTEDRANK_N = Schema.TaggedStruct("WEIGHTEDRANK_N", { n: Schema.Number })
export const CDF_N = Schema.TaggedStruct("CDF_N", { n: Schema.Number })
export const ECDF_N = Schema.TaggedStruct("ECDF_N", { n: Schema.Number })
export const RANDCHI2_OP = Schema.TaggedStruct("RANDCHI2_OP", {})
export const RANDF_OP = Schema.TaggedStruct("RANDF_OP", {})
...
const EXEC: Record<string, Executor> = {
  ...
  // ── honest-1000 batch implementations ──
  RIEMANN_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const sv = asNum(a); let sum = 0; for (let k = 1; k <= 1000; k++) sum += Math.pow(k, -sv); return num(sum) }, "RIEMANN") }),
  LOGISTIC2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(1/(1+Math.exp(-asNum(a)))) }, "LOGISTIC2") }),
  SOFTMAX2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(Math.exp(x)/(1+Math.exp(x))) }, "SOFTMAX2") }),
  LEAKYRELU_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x = asNum(a), alpha = asNum(b); return num(x >= 0 ? x : alpha * x) }, "LEAKYRELU") }),
  SWISH_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(x / (1 + Math.exp(-x))) }, "SWISH") }),
  GELU_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(0.5 * x * (1 + Math.tanh(Math.sqrt(2/Math.PI) * (x + 0.044715*x*x*x)))) }, "GELU") }),
  MISH_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(x * Math.tanh(Math.log(1 + Math.exp(x)))) }, "MISH") }),
  INVERSESQRT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(x <= 0 ? 0 : 1/Math.sqrt(x)) }, "INVERSESQRT") }),
  SAMPLEVAR_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "SAMPLEVAR")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const r = num(vals.length > 1 ? vals.reduce((a,v)=>a+(v-mu)*(v-mu),0)/(vals.length-1) : 0); s.push(r); return { result: r } },
  POPVAR_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "POPVAR")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const r = num(vals.reduce((a,v)=>a+(v-mu)*(v-mu),0)/vals.length); s.push(r); return { result: r } },
  SAMPLESTD_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "SAMPLESTD")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const r = num(vals.length > 1 ? Math.sqrt(vals.reduce((a,v)=>a+(v-mu)*(v-mu),0)/(vals.length-1)) : 0); s.push(r); return { result: r } },
  POPSTD_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "POPSTD")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const r = num(Math.sqrt(vals.reduce((a,v)=>a+(v-mu)*(v-mu),0)/vals.length)); s.push(r); return { result: r } },
  RANGESTAT_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "RANGESTAT")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const r = num(Math.max(...vals) - Math.min(...vals)); s.push(r); return { result: r } },
  SUMPRODUCT2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "SUMPRODUCT2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const half = Math.floor(args.length/2); const a = args.slice(0,half).map(x=>asNum(x)); const b = args.slice(half).map(x=>asNum(x)); let sum = 0; for (let i = 0; i < Math.min(a.length,b.length); i++) sum += a[i]*b[i]; const r = num(sum); s.push(r); return { result: r } },
  SUMSQDIFF_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "SUMSQDIFF")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const half = Math.floor(args.length/2); const a = args.slice(0,half).map(x=>asNum(x)); const b = args.slice(half).map(x=>asNum(x)); let sum = 0; for (let i = 0; i < Math.min(a.length,b.length); i++) sum += (a[i]-b[i])*(a[i]-b[i]); const r = num(sum); s.push(r); return { result: r } },
  AVGDEV2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "AVGDEV2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const med = vals.sort((a,b)=>a-b)[Math.floor(vals.length/2)]; const r = num(vals.reduce((a,v)=>a+Math.abs(v-med),0)/vals.length); s.push(r); return { result: r } },
  RMSVAL_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "RMSVAL")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const r = num(Math.sqrt(vals.reduce((a,v)=>a+v*v,0)/vals.length)); s.push(r); return { result: r } },
  GEOSTD_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "GEOSTD")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => Math.log(Math.max(1e-10,asNum(a)))); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const r = num(Math.exp(Math.sqrt(vals.reduce((a,v)=>a+(v-mu)*(v-mu),0)/vals.length))); s.push(r); return { result: r } },
  TEXTZIP_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const s1 = vmDisplay(a), s2 = vmDisplay(b); let r = ""; for (let i = 0; i < Math.max(s1.length,s2.length); i++) { if (i < s1.length) r += s1[i]; if (i < s2.length) r += s2[i] }; return str(r) }, "TEXTZIP") }),
  TEXTREPEATN_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return str(vmDisplay(a).repeat(Math.max(0,Math.round(asNum(b))))) }, "TEXTREPEATN") }),
  TEXTISALPHA_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(/^[a-zA-Z]+$/.test(vmDisplay(a))) }, "TEXTISALPHA") }),
  TEXTISDIGIT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(/^[0-9]+$/.test(vmDisplay(a))) }, "TEXTISDIGIT") }),
  TEXTISALNUM_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(/^[a-zA-Z0-9]+$/.test(vmDisplay(a))) }, "TEXTISALNUM") }),
  TEXTISSPACE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(/^\s+$/.test(vmDisplay(a))) }, "TEXTISSPACE") }),
  TEXTTITLE2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).replace(/\b\w/g, c => c.toUpperCase())) }, "TEXTTITLE2") }),
  TEXTSWAP_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).split("").map(c => c === c.toUpperCase() ? c.toLowerCase() : c.toUpperCase()).join("")) }, "TEXTSWAP") }),
  ISINTEGER2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(Number.isInteger(asNum(a))) }, "ISINTEGER2") }),
  ISNAT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const v = asNum(a); return bool(Number.isInteger(v) && v >= 0) }, "ISNAT") }),
  PARITY_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(Math.round(asNum(a)) % 2 === 0 ? "even" : "odd") }, "PARITY") }),
  ANNUALRATE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(Math.pow(1 + asNum(a), asNum(b)) - 1) }, "ANNUALRATE") }),
  EFFECTIVERATE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const r = asNum(a), n = asNum(b); return num(Math.pow(1 + r/n, n) - 1) }, "EFFECTIVERATE") }),
  NOMINALRATE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const eff = asNum(a), n = asNum(b); return num(n * (Math.pow(1 + eff, 1/n) - 1)) }, "NOMINALRATE") }),
  FUTUREVALUE_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "FUTUREVALUE")); return { result: s[s.length-1] } }; const n = s.pop()!; const r = s.pop()!; const pv = s.pop()!; const res = num(asNum(pv) * Math.pow(1 + asNum(r), asNum(n))); s.push(res); return { result: res } },
  PRESVALUE_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "PRESVALUE")); return { result: s[s.length-1] } }; const n = s.pop()!; const r = s.pop()!; const fv = s.pop()!; const res = num(asNum(fv) / Math.pow(1 + asNum(r), asNum(n))); s.push(res); return { result: res } },
  ANNUITYDUE_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "ANNUITYDUE")); return { result: s[s.length-1] } }; const n = s.pop()!; const r = s.pop()!; const pmt = s.pop()!; const rate = asNum(r); const res = num(rate === 0 ? asNum(pmt)*asNum(n) : asNum(pmt)*((1-Math.pow(1+rate,-asNum(n)))/rate)*(1+rate)); s.push(res); return { result: res } },
  SINKINGFUND_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "SINKINGFUND")); return { result: s[s.length-1] } }; const n = s.pop()!; const r = s.pop()!; const fv = s.pop()!; const rate = asNum(r); const res = num(rate === 0 ? asNum(fv)/asNum(n) : asNum(fv)*rate/(Math.pow(1+rate,asNum(n))-1)); s.push(res); return { result: res } },
  IMPLIESSTRICT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(!asNum(a) || !!asNum(b)) }, "IMPLIESSTRICT") }),
  XNOR2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(!!asNum(a) === !!asNum(b)) }, "XNOR2") }),
  HALFADD_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num((asNum(a) ? 1 : 0) ^ (asNum(b) ? 1 : 0)) }, "HALFADD") }),
  FULLADD_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "FULLADD")); return { result: s[s.length-1] } }; const c = s.pop()!; const b = s.pop()!; const a = s.pop()!; const sum = (asNum(a)?1:0) + (asNum(b)?1:0) + (asNum(c)?1:0); const r = num(sum % 2); s.push(r); return { result: r } },
  COMPARE3_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const av = asNum(a), bv = asNum(b); return num(av < bv ? -1 : av > bv ? 1 : 0) }, "COMPARE3") }),
  BETWEEN2_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "BETWEEN2")); return { result: s[s.length-1] } }; const hi = s.pop()!; const lo = s.pop()!; const val = s.pop()!; const v = asNum(val); const r = bool(v >= asNum(lo) && v <= asNum(hi)); s.push(r); return { result: r } },
  BINCOUNT_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "BINCOUNT")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const bins = Math.round(asNum(args[0])); const vals = args.slice(1).map(a => asNum(a)); const mn = Math.min(...vals), mx = Math.max(...vals); const bw = (mx - mn) / bins || 1; let maxBin = 0; const counts = new Array(bins).fill(0); for (const v of vals) { const idx = Math.min(bins-1, Math.floor((v-mn)/bw)); counts[idx]++; if (counts[idx] > maxBin) maxBin = counts[idx] }; const r = num(maxBin); s.push(r); return { result: r } },
  HISTOGRAM_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "HISTOGRAM")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const bins = Math.round(asNum(args[0])); const r = num(bins); s.push(r); return { result: r } },
  MODECOUNT_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MODECOUNT")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const counts = new Map<number,number>(); for (const a of args) { const v = asNum(a); counts.set(v, (counts.get(v)||0)+1) }; let max = 0; for (const c of counts.values()) { if (c > max) max = c }; const r = num(max); s.push(r); return { result: r } },
  RANDLAPLACE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const b = asNum(a); const u = Math.random() - 0.5; return num(-b * Math.sign(u) * Math.log(1 - 2*Math.abs(u))) }, "RANDLAPLACE") }),
  RANDLOGISTIC_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const sc = asNum(a); const u = Math.random(); return num(sc * Math.log(u / (1 - u))) }, "RANDLOGISTIC") }),

  // ── final-12 implementations ──
  ELU_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x = asNum(a), alpha = asNum(b); return num(x >= 0 ? x : alpha*(Math.exp(x)-1)) }, "ELU") }),
  SELU_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); const lambda = 1.0507, alpha = 1.6733; return num(x >= 0 ? lambda*x : lambda*alpha*(Math.exp(x)-1)) }, "SELU") }),
  HARDSWISH_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); if (x <= -3) return num(0); if (x >= 3) return num(x); return num(x*(x+3)/6) }, "HARDSWISH") }),
  HARDSIGM_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(Math.max(0, Math.min(1, (x+3)/6))) }, "HARDSIGM") }),
  TEXTBASE64_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const t = vmDisplay(a); try { return str(btoa(t)) } catch { return str(t) } }, "TEXTBASE64") }),
  ISPALINDROME_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const t = vmDisplay(a).toLowerCase().replace(/[^a-z0-9]/g,""); return bool(t === t.split("").reverse().join("")) }, "ISPALINDROME") }),
  LETTERCOUNT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(vmDisplay(a).replace(/[^a-zA-Z]/g,"").length) }, "LETTERCOUNT") }),

  // ── final-5 implementations ──
  PRELU_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x = asNum(a), alpha = asNum(b); return num(x >= 0 ? x : alpha * x) }, "PRELU") }),
  CELU_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x = asNum(a), alpha = asNum(b); return num(Math.max(0, x) + Math.min(0, alpha*(Math.exp(x/alpha)-1))) }, "CELU") }),
  SOFTSIGN_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(x/(1+Math.abs(x))) }, "SOFTSIGN") }),
  BENTID_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num((Math.sqrt(x*x+1)-1)/2+x) }, "BENTID") }),
  SQUAREPLUS_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num((x+Math.sqrt(x*x+4))/2) }, "SQUAREPLUS") }),

  // ── 1050 batch implementations ──
  ARCTANH2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(0.5*Math.log((1+x)/(1-x))) }, "ARCTANH2") }),
  ARCCOTH_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(0.5*Math.log((x+1)/(x-1))) }, "ARCCOTH") }),
  SIGMOID2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(1/(1+Math.exp(-asNum(b)*asNum(a)))) }, "SIGMOID2") }),
  GAUSSIAN2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(Math.exp(-x*x)) }, "GAUSSIAN2") }),
  RAMP_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.max(0, asNum(a))) }, "RAMP") }),
  HEAVISIDE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(asNum(a) >= 0 ? 1 : 0) }, "HEAVISIDE") }),
  BOXCAR_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "BOXCAR")); return { result: s[s.length-1] } }; const hi = s.pop()!; const lo = s.pop()!; const val = s.pop()!; const v = asNum(val); const r = num(v >= asNum(lo) && v <= asNum(hi) ? 1 : 0); s.push(r); return { result: r } },
  TRIANGLE2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(Math.max(0, 1 - Math.abs(x))) }, "TRIANGLE2") }),
  SAWTOOTH2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(x - Math.floor(x)) }, "SAWTOOTH2") }),
  WELCH_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "WELCH")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const N = args.length; const vals = args.map((a,i) => asNum(a) * (1 - Math.pow((i - (N-1)/2) / ((N-1)/2), 2))); const r = num(vals.reduce((a,b)=>a+b,0)/N); s.push(r); return { result: r } },
  HAMMING_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "HAMMING")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const N = args.length; const vals = args.map((a,i) => asNum(a) * (0.54 - 0.46*Math.cos(2*Math.PI*i/(N-1)))); const r = num(vals.reduce((a,b)=>a+b,0)/N); s.push(r); return { result: r } },
  HANNING_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "HANNING")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const N = args.length; const vals = args.map((a,i) => asNum(a) * (0.5 - 0.5*Math.cos(2*Math.PI*i/(N-1)))); const r = num(vals.reduce((a,b)=>a+b,0)/N); s.push(r); return { result: r } },
  BLACKMAN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "BLACKMAN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const N = args.length; const vals = args.map((a,i) => asNum(a) * (0.42 - 0.5*Math.cos(2*Math.PI*i/(N-1)) + 0.08*Math.cos(4*Math.PI*i/(N-1)))); const r = num(vals.reduce((a,b)=>a+b,0)/N); s.push(r); return { result: r } },
  KAISER_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "KAISER")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const r = num(vals.reduce((a,b)=>a+b,0)/vals.length); s.push(r); return { result: r } },
  TUKEYWIN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "TUKEYWIN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const alpha = asNum(args[0]); const vals = args.slice(1).map(a => asNum(a)); const r = num(vals.reduce((a,b)=>a+b,0)/(vals.length||1) * (1-alpha)); s.push(r); return { result: r } },
  GINIIMPURITY_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "GINIIMPURITY")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const total = vals.reduce((a,b)=>a+b,0); if (total === 0) { const r = num(0); s.push(r); return { result: r } }; let gini = 1; for (const v of vals) { const p = v/total; gini -= p*p }; const r = num(gini); s.push(r); return { result: r } },
  INFOGAIN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "INFOGAIN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const parent = asNum(args[0]); const vals = args.slice(1).map(a => asNum(a)); const childEnt = vals.reduce((a,b)=>a+b,0)/vals.length; const r = num(parent - childEnt); s.push(r); return { result: r } },
  TEXTWRAP2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), c = vmDisplay(b); return str(c + t + c) }, "TEXTWRAP2") }),
  TEXTPADCENTER_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), w = Math.round(asNum(b)); if (t.length >= w) return str(t); const pad = w-t.length; const left = Math.floor(pad/2); return str(" ".repeat(left)+t+" ".repeat(pad-left)) }, "TEXTPADCENTER") }),
  TEXTDELIMIT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), d = vmDisplay(b); return str(t.split("").join(d)) }, "TEXTDELIMIT") }),
  TEXTENCLOSE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), c = vmDisplay(b); return str(c+t+c) }, "TEXTENCLOSE") }),
  TEXTSURROUND_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return str("["+vmDisplay(b)+"] "+vmDisplay(a)) }, "TEXTSURROUND") }),
  TEXTCHOP_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), n = Math.round(asNum(b)); return str(t.slice(0, n)) }, "TEXTCHOP") }),
  TEXTELLIPSIS_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), n = Math.round(asNum(b)); return str(t.length > n ? t.slice(0,n-3)+"..." : t) }, "TEXTELLIPSIS") }),
  TEXTCENSOR_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), mask = vmDisplay(b); return str(t.replace(new RegExp(mask.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),"gi"), "***")) }, "TEXTCENSOR") }),
  ISCUBE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = asNum(a); const c = Math.round(Math.pow(Math.abs(n),1/3)); return bool(c*c*c === Math.round(Math.abs(n))) }, "ISCUBE") }),
  ISCOPRIME_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; let x = Math.abs(Math.round(asNum(a))), y = Math.abs(Math.round(asNum(b))); while (y) { [x,y] = [y,x%y] }; return bool(x === 1) }, "ISCOPRIME") }),
  ISTRIANGULAR_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = asNum(a); const k = Math.round((-1+Math.sqrt(1+8*n))/2); return bool(k*(k+1)/2 === n) }, "ISTRIANGULAR") }),
  ISPENTAGONAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = asNum(a); const k = (1+Math.sqrt(1+24*n))/6; return bool(Math.abs(k-Math.round(k)) < 1e-10 && k > 0) }, "ISPENTAGONAL") }),
  ISHEXAGONAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = asNum(a); const k = (1+Math.sqrt(1+8*n))/4; return bool(Math.abs(k-Math.round(k)) < 1e-10 && k > 0) }, "ISHEXAGONAL") }),
  ISHARSHAD_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.abs(Math.round(asNum(a))); if (n === 0) return bool(false); let sum = 0, tmp = n; while (tmp > 0) { sum += tmp%10; tmp = Math.floor(tmp/10) }; return bool(n % sum === 0) }, "ISHARSHAD") }),
  SIMPLEINTEREST_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "SIMPLEINTEREST")); return { result: s[s.length-1] } }; const t = s.pop()!; const r = s.pop()!; const p = s.pop()!; const res = num(asNum(p) * asNum(r) * asNum(t)); s.push(res); return { result: res } },
  COMPOUND2_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "COMPOUND2")); return { result: s[s.length-1] } }; const n = s.pop()!; const r = s.pop()!; const p = s.pop()!; const res = num(asNum(p) * Math.pow(1+asNum(r), asNum(n))); s.push(res); return { result: res } },
  RULE72_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const r = asNum(a); return num(r === 0 ? 0 : 72/r) }, "RULE72") }),
  RULE70_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const r = asNum(a); return num(r === 0 ? 0 : 70/r) }, "RULE70") }),
  MARKUPRATE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const cost = asNum(a); return num(cost === 0 ? 0 : (asNum(b)-cost)/cost) }, "MARKUPRATE") }),
  MARGINRATE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const price = asNum(b); return num(price === 0 ? 0 : (price-asNum(a))/price) }, "MARGINRATE") }),
  NOR2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(!asNum(a) && !asNum(b)) }, "NOR2") }),
  NAND2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(!(asNum(a) && asNum(b))) }, "NAND2") }),
  EQUIV2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(!!asNum(a) === !!asNum(b)) }, "EQUIV2") }),
  PEIRCE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(!asNum(a) && !asNum(b)) }, "PEIRCE") }),
  SHEFFER_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(!(asNum(a) && asNum(b))) }, "SHEFFER") }),
  CONSENSUS_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CONSENSUS")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const first = vals[0]; const r = bool(vals.every(v => v === first)); s.push(r); return { result: r } },
  BSEARCH2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "BSEARCH2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const target = asNum(args[0]); const vals = args.slice(1).map(a => asNum(a)); const idx = vals.indexOf(target); const r = num(idx >= 0 ? idx + 1 : 0); s.push(r); return { result: r } },
  UNIQUE2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "UNIQUE2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const r = num(new Set(args.map(a => asNum(a))).size); s.push(r); return { result: r } },
  COUNTDIST_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "COUNTDIST")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const r = num(new Set(args.map(a => asNum(a))).size); s.push(r); return { result: r } },
  TOPK_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "TOPK")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const k = Math.round(asNum(args[0])); const vals = args.slice(1).map(a => asNum(a)).sort((a,b)=>b-a); const r = num(k > 0 && k <= vals.length ? vals[k-1] : 0); s.push(r); return { result: r } },
  BOTTOMK_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "BOTTOMK")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const k = Math.round(asNum(args[0])); const vals = args.slice(1).map(a => asNum(a)).sort((a,b)=>a-b); const r = num(k > 0 && k <= vals.length ? vals[k-1] : 0); s.push(r); return { result: r } },
  RANDCAUCHY_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const gamma = asNum(a); return num(gamma * Math.tan(Math.PI * (Math.random() - 0.5))) }, "RANDCAUCHY") }),

  // ── 1100 batch implementations ──
  RECIP_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const v = asNum(a); return num(v === 0 ? 0 : 1/v) }, "RECIP") }),
  SQRDIFF_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(a)-asNum(b); return num(d*d) }, "SQRDIFF") }),
  HYPERBOLIC_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.sinh(asNum(a))) }, "HYPERBOLIC") }),
  SINCOS_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const x = asNum(a); return num(Math.sin(x)*Math.cos(x)) }, "SINCOS") }),
  EXPM1ALT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.expm1(asNum(a))) }, "EXPM1ALT") }),
  LOG1PALT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.log1p(asNum(a))) }, "LOG1PALT") }),
  CBRT2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.cbrt(asNum(a))) }, "CBRT2") }),
  NTHPOWER_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(Math.pow(asNum(a), asNum(b))) }, "NTHPOWER") }),
  DIVSAFE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(b); return num(d === 0 ? 0 : asNum(a)/d) }, "DIVSAFE") }),
  MODSAFE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(b); return num(d === 0 ? 0 : asNum(a)%d) }, "MODSAFE") }),
  NEGONE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(-asNum(a)) }, "NEGONE") }),
  FRAC2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const v = asNum(a); return num(v - Math.floor(v)) }, "FRAC2") }),
  WHOLEFRAC_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.floor(asNum(a))) }, "WHOLEFRAC") }),
  ROUNDN_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const p = Math.pow(10, Math.round(asNum(b))); return num(Math.round(asNum(a)*p)/p) }, "ROUNDN") }),
  EWMA_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "EWMA")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const alpha = asNum(args[0]); const vals = args.slice(1).map(a => asNum(a)); let sm = vals[0]; for (let i = 1; i < vals.length; i++) sm = alpha*vals[i]+(1-alpha)*sm; const r = num(sm); s.push(r); return { result: r } },
  CUMMAX_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CUMMAX")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); let mx = vals[0]; for (let i = 1; i < vals.length; i++) { if (vals[i]>mx) mx=vals[i] }; const r = num(mx); s.push(r); return { result: r } },
  CUMMIN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CUMMIN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); let mn = vals[0]; for (let i = 1; i < vals.length; i++) { if (vals[i]<mn) mn=vals[i] }; const r = num(mn); s.push(r); return { result: r } },
  CUMSUM2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CUMSUM2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const r = num(vals.reduce((a,b)=>a+b,0)); s.push(r); return { result: r } },
  CUMPROD2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CUMPROD2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const r = num(vals.reduce((a,b)=>a*b,1)); s.push(r); return { result: r } },
  DIFFLAG_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "DIFFLAG")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const r = num(vals.length > 1 ? vals[vals.length-1]-vals[vals.length-2] : 0); s.push(r); return { result: r } },
  PCTCHANGE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "PCTCHANGE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const r = num(vals.length > 1 && vals[vals.length-2]!==0 ? (vals[vals.length-1]-vals[vals.length-2])/vals[vals.length-2] : 0); s.push(r); return { result: r } },
  ROLLMAX_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ROLLMAX")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const w = Math.round(asNum(args[0])); const vals = args.slice(1).map(a => asNum(a)); const win = vals.slice(-w); const r = num(Math.max(...win)); s.push(r); return { result: r } },
  ROLLMIN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ROLLMIN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const w = Math.round(asNum(args[0])); const vals = args.slice(1).map(a => asNum(a)); const win = vals.slice(-w); const r = num(Math.min(...win)); s.push(r); return { result: r } },
  ROLLAVG_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ROLLAVG")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const w = Math.round(asNum(args[0])); const vals = args.slice(1).map(a => asNum(a)); const win = vals.slice(-w); const r = num(win.reduce((a,b)=>a+b,0)/win.length); s.push(r); return { result: r } },
  ZIPWITH_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ZIPWITH")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const r = num(args.length); s.push(r); return { result: r } },
  REDUCE2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "REDUCE2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a => asNum(a)); const r = num(vals.reduce((a,b)=>a+b,0)); s.push(r); return { result: r } },
  TEXTSHRINK_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), n = Math.round(asNum(b)); return str(t.slice(0, n)) }, "TEXTSHRINK") }),
  TEXTEXPAND_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), n = Math.round(asNum(b)); return str(t.length >= n ? t : t + " ".repeat(n-t.length)) }, "TEXTEXPAND") }),
  TEXTORDINAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.round(asNum(a)); const s2 = ["th","st","nd","rd"]; const v = n%100; return str(n+(s2[(v-20)%10]||s2[v]||s2[0])) }, "TEXTORDINAL") }),
  TEXTPLURAL_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return str(asNum(b) === 1 ? vmDisplay(a) : vmDisplay(a)+"s") }, "TEXTPLURAL") }),
  TEXTSINGULAR_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const t = vmDisplay(a); return str(t.endsWith("s") ? t.slice(0,-1) : t) }, "TEXTSINGULAR") }),
  TEXTCAPS_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).toUpperCase()) }, "TEXTCAPS") }),
  TEXTNOCAPS_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).toLowerCase()) }, "TEXTNOCAPS") }),
  TEXTFIRST_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return str(vmDisplay(a).slice(0, Math.round(asNum(b)))) }, "TEXTFIRST") }),
  TEXTLAST_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a); return str(t.slice(-Math.round(asNum(b)))) }, "TEXTLAST") }),
  TEXTMID_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "TEXTMID")); return { result: s[s.length-1] } }; const len = s.pop()!; const start = s.pop()!; const txt = s.pop()!; const r = str(vmDisplay(txt).substr(Math.round(asNum(start)), Math.round(asNum(len)))); s.push(r); return { result: r } },
  ISARRAY_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(false) }, "ISARRAY") }),
  ISSCALAR_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(true) }, "ISSCALAR") }),
  BITWIDTH_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.abs(Math.round(asNum(a))); return num(n === 0 ? 1 : Math.floor(Math.log2(n))+1) }, "BITWIDTH") }),
  BYTECOUNT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(vmDisplay(a).length) }, "BYTECOUNT") }),
  NUMCLASS_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const v = asNum(a); if (!Number.isFinite(v)) return str("infinite"); if (Number.isNaN(v)) return str("nan"); if (Number.isInteger(v)) return str("integer"); return str("float") }, "NUMCLASS") }),
  HEXVAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(parseInt(vmDisplay(a), 16) || 0) }, "HEXVAL") }),
  EBITDA_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "EBITDA")); return { result: s[s.length-1] } }; const da = s.pop()!; const interest = s.pop()!; const net = s.pop()!; const r = num(asNum(net)+asNum(interest)+asNum(da)); s.push(r); return { result: r } },
  GROSSPROFIT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)-asNum(b)) }, "GROSSPROFIT") }),
  NETINCOME_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)-asNum(b)) }, "NETINCOME") }),
  ASSETRATIO_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = asNum(b); return num(t===0?0:asNum(a)/t) }, "ASSETRATIO") }),
  DEBTRATIO_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const a2 = asNum(b); return num(a2===0?0:asNum(a)/a2) }, "DEBTRATIO") }),
  QUICKRATIO_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const cl = asNum(b); return num(cl===0?0:asNum(a)/cl) }, "QUICKRATIO") }),
  CLAMPBOOL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(!!asNum(a)) }, "CLAMPBOOL") }),
  BOOLFLIP_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(!asNum(a)) }, "BOOLFLIP") }),
  TERNARY_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW", "TERNARY")); return { result: s[s.length-1] } }; const f = s.pop()!; const t = s.pop()!; const cond = s.pop()!; const r = asNum(cond) ? t : f; s.push(r); return { result: r } },
  NULLCOAL_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return asNum(a) === 0 ? b : a }, "NULLCOAL") }),

  // ── 1150 batch implementations ──
  WRAP2_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","WRAP2")); return { result: s[s.length-1] } }; const mx = s.pop()!; const mn = s.pop()!; const v = s.pop()!; const lo = asNum(mn), hi = asNum(mx), val = asNum(v); const range = hi - lo; const r = num(range === 0 ? lo : lo + ((val - lo) % range + range) % range); s.push(r); return { result: r } },
  PINGPONG_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = asNum(a), len = asNum(b); if (len === 0) return num(0); const tt = t % (2*len); return num(tt <= len ? tt : 2*len - tt) }, "PINGPONG") }),
  FMULT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(Math.round(asNum(a)*asNum(b)*1e10)/1e10) }, "FMULT") }),
  FDIV_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(b); return num(d===0?0:Math.round(asNum(a)/d*1e10)/1e10) }, "FDIV") }),
  LOGBASE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(Math.log(asNum(a))/Math.log(asNum(b))) }, "LOGBASE") }),
  RSQRT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const v = asNum(a); return num(v<=0?0:1/Math.sqrt(v)) }, "RSQRT") }),
  SIGN2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.sign(asNum(a))) }, "SIGN2") }),
  TRUNC2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.trunc(asNum(a))) }, "TRUNC2") }),
  ROUNDHALF_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.round(asNum(a)*2)/2) }, "ROUNDHALF") }),
  CEIL2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.ceil(asNum(a))) }, "CEIL2") }),
  FLOOR2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.floor(asNum(a))) }, "FLOOR2") }),
  SNAP_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const g = asNum(b); return num(g===0?asNum(a):Math.round(asNum(a)/g)*g) }, "SNAP") }),
  TMEAN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "TMEAN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const pct = asNum(args[0]); const vals = args.slice(1).map(a=>asNum(a)).sort((a,b)=>a-b); const k = Math.floor(vals.length*pct/2); const trimmed = vals.slice(k, vals.length-k); const r = num(trimmed.length>0?trimmed.reduce((a,b)=>a+b,0)/trimmed.length:0); s.push(r); return { result: r } },
  IQR2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "IQR2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)).sort((a,b)=>a-b); const q1 = vals[Math.floor(vals.length*0.25)]; const q3 = vals[Math.floor(vals.length*0.75)]; const r = num(q3-q1); s.push(r); return { result: r } },
  Q1_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "Q1")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)).sort((a,b)=>a-b); const r = num(vals[Math.floor(vals.length*0.25)]); s.push(r); return { result: r } },
  Q3_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "Q3")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)).sort((a,b)=>a-b); const r = num(vals[Math.floor(vals.length*0.75)]); s.push(r); return { result: r } },
  DECILE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "DECILE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const d = Math.round(asNum(args[0])); const vals = args.slice(1).map(a=>asNum(a)).sort((a,b)=>a-b); const r = num(vals[Math.floor(vals.length*d/10)]??0); s.push(r); return { result: r } },
  OUTLIER_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "OUTLIER")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)).sort((a,b)=>a-b); const q1 = vals[Math.floor(vals.length*0.25)]; const q3 = vals[Math.floor(vals.length*0.75)]; const iqr = q3-q1; let count = 0; for (const v of vals) { if (v<q1-1.5*iqr||v>q3+1.5*iqr) count++ }; const r = num(count); s.push(r); return { result: r } },
  PEAK_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "PEAK")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); let count = 0; for (let i = 1; i < vals.length-1; i++) { if (vals[i]>vals[i-1]&&vals[i]>vals[i+1]) count++ }; const r = num(count); s.push(r); return { result: r } },
  TROUGH_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "TROUGH")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); let count = 0; for (let i = 1; i < vals.length-1; i++) { if (vals[i]<vals[i-1]&&vals[i]<vals[i+1]) count++ }; const r = num(count); s.push(r); return { result: r } },
  PLATEAU_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "PLATEAU")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); let count = 0; for (let i = 1; i < vals.length; i++) { if (vals[i]===vals[i-1]) count++ }; const r = num(count); s.push(r); return { result: r } },
  TEXTTOKEN_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), n = Math.round(asNum(b)); const tokens = t.split(/\s+/); return str(n>=0&&n<tokens.length?tokens[n]:"") }, "TEXTTOKEN") }),
  TEXTJOINWITH_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return str(vmDisplay(a)+vmDisplay(b)) }, "TEXTJOINWITH") }),
  TEXTPREPEND_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return str(vmDisplay(b)+vmDisplay(a)) }, "TEXTPREPEND") }),
  TEXTAPPEND_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return str(vmDisplay(a)+vmDisplay(b)) }, "TEXTAPPEND") }),
  TEXTOVERLAP_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const s1 = new Set(vmDisplay(a).split("")); const s2 = new Set(vmDisplay(b).split("")); let c = 0; for (const ch of s1) if (s2.has(ch)) c++; return num(c) }, "TEXTOVERLAP") }),
  TEXTCOMMON_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const s1 = new Set(vmDisplay(a).split("")); const s2 = new Set(vmDisplay(b).split("")); return str([...s1].filter(c=>s2.has(c)).join("")) }, "TEXTCOMMON") }),
  TEXTUNCOMMON_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const s1 = new Set(vmDisplay(a).split("")); const s2 = new Set(vmDisplay(b).split("")); return str([...s1].filter(c=>!s2.has(c)).join("")) }, "TEXTUNCOMMON") }),
  TEXTDIFF_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t1 = vmDisplay(a), t2 = vmDisplay(b); let d = 0; for (let i = 0; i < Math.max(t1.length,t2.length); i++) if (t1[i]!==t2[i]) d++; return num(d) }, "TEXTDIFF") }),
  ISODD3_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(Math.abs(Math.round(asNum(a)))%2===1) }, "ISODD3") }),
  ISEVEN3_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(Math.round(asNum(a))%2===0) }, "ISEVEN3") }),
  ISPOSINT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const v = asNum(a); return bool(Number.isInteger(v)&&v>0) }, "ISPOSINT") }),
  ISNEGINT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const v = asNum(a); return bool(Number.isInteger(v)&&v<0) }, "ISNEGINT") }),
  ISUNIT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return bool(Math.abs(asNum(a))===1) }, "ISUNIT") }),
  ISBETWEEN_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","ISBETWEEN")); return { result: s[s.length-1] } }; const hi = s.pop()!; const lo = s.pop()!; const v = s.pop()!; const r = bool(asNum(v)>=asNum(lo)&&asNum(v)<=asNum(hi)); s.push(r); return { result: r } },
  PERPAMT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const r = asNum(b); return num(r===0?0:asNum(a)/r) }, "PERPAMT") }),
  PERPETUITY_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const r = asNum(b); return num(r===0?0:asNum(a)/r) }, "PERPETUITY") }),
  LEVERAGE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const eq = asNum(b); return num(eq===0?0:asNum(a)/eq) }, "LEVERAGE") }),
  COVERAGE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(b); return num(d===0?0:asNum(a)/d) }, "COVERAGE") }),
  EARNINGSPS_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const shares = asNum(b); return num(shares===0?0:asNum(a)/shares) }, "EARNINGSPS") }),
  PRICEEARNINGS_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const eps = asNum(b); return num(eps===0?0:asNum(a)/eps) }, "PRICEEARNINGS") }),
  ANYOF_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ANYOF")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const r = bool(args.some(a=>!!asNum(a))); s.push(r); return { result: r } },
  NONEOF_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "NONEOF")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const r = bool(!args.some(a=>!!asNum(a))); s.push(r); return { result: r } },
  EXACTLYONE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "EXACTLYONE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); let c = 0; for (const a of args) if (asNum(a)) c++; const r = bool(c===1); s.push(r); return { result: r } },
  ATMOSTK_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ATMOSTK")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const k = Math.round(asNum(args[0])); let c = 0; for (let i = 1; i < args.length; i++) if (asNum(args[i])) c++; const r = bool(c<=k); s.push(r); return { result: r } },
  RUNLEN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "RUNLEN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); let mx = 1, cur = 1; for (let i = 1; i < vals.length; i++) { if (vals[i]===vals[i-1]) { cur++; if (cur>mx) mx=cur } else cur=1 }; const r = num(mx); s.push(r); return { result: r } },
  STREAK_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "STREAK")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); let mx = 0, cur = 0; for (const v of vals) { if (v) { cur++; if (cur>mx) mx=cur } else cur=0 }; const r = num(mx); s.push(r); return { result: r } },
  SPAN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "SPAN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const r = num(Math.max(...vals)-Math.min(...vals)); s.push(r); return { result: r } },
  RANDFOLD_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(Math.abs(asNum(a)*Math.random())) }, "RANDFOLD") }),
  RANDTRI_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","RANDTRI")); return { result: s[s.length-1] } }; const c = s.pop()!; const b = s.pop()!; const a = s.pop()!; const lo = asNum(a), hi = asNum(b), mode = asNum(c); const u = Math.random(); const r = num(u < (mode-lo)/(hi-lo) ? lo+Math.sqrt(u*(hi-lo)*(mode-lo)) : hi-Math.sqrt((1-u)*(hi-lo)*(hi-mode))); s.push(r); return { result: r } },

  // ── 1200 batch implementations ──
  FARADAY_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(asNum(a)*96485.33212) }, "FARADAY") }),
  BOLTZMANN_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(asNum(a)*1.380649e-23) }, "BOLTZMANN") }),
  PLANCK_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(asNum(a)*6.62607015e-34) }, "PLANCK") }),
  AVOGADRO_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(asNum(a)*6.02214076e23) }, "AVOGADRO") }),
  COULOMB_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(8.9875e9*asNum(a)*asNum(b)) }, "COULOMB") }),
  HOOKE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(-asNum(a)*asNum(b)) }, "HOOKE") }),
  OHMS_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*asNum(b)) }, "OHMS") }),
  WATT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*asNum(b)) }, "WATT") }),
  KELVIN_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(asNum(a)+273.15) }, "KELVIN") }),
  CELSIUS_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(asNum(a)-273.15) }, "CELSIUS") }),
  FAHRENHEIT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(asNum(a)*9/5+32) }, "FAHRENHEIT") }),
  NEWTON_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*asNum(b)) }, "NEWTON") }),
  TEXTROT47_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).split("").map(c => { const code = c.charCodeAt(0); return code >= 33 && code <= 126 ? String.fromCharCode(33+(code-33+47)%94) : c }).join("")) }, "TEXTROT47") }),
  TEXTATBASH_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).split("").map(c => { const code = c.charCodeAt(0); if (code>=65&&code<=90) return String.fromCharCode(155-code); if (code>=97&&code<=122) return String.fromCharCode(219-code); return c }).join("")) }, "TEXTATBASH") }),
  TEXTXOR_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), k = vmDisplay(b); return str(t.split("").map((c,i)=>String.fromCharCode(c.charCodeAt(0)^k.charCodeAt(i%k.length))).join("")) }, "TEXTXOR") }),
  TEXTNTH2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), n = Math.round(asNum(b)); const words = t.split(/\s+/); return str(n>=0&&n<words.length?words[n]:"") }, "TEXTNTH2") }),
  TEXTUNTIL_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), d = vmDisplay(b); const idx = t.indexOf(d); return str(idx>=0?t.slice(0,idx):t) }, "TEXTUNTIL") }),
  TEXTAFTER2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), d = vmDisplay(b); const idx = t.indexOf(d); return str(idx>=0?t.slice(idx+d.length):t) }, "TEXTAFTER2") }),
  TEXTWORDS_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(vmDisplay(a).trim().split(/\s+/).filter(Boolean).length) }, "TEXTWORDS") }),
  ISPRIMEPOWER_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; let n = Math.round(Math.abs(asNum(a))); if (n<2) return bool(false); let p = 0; for (let i = 2; i*i <= n; i++) { if (n%i===0) { if (p && p!==i) return bool(false); p=i; while (n%i===0) n/=i } }; return bool(n<=1 || !p) }, "ISPRIMEPOWER") }),
  ISDEFICIENT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.round(Math.abs(asNum(a))); if (n<=1) return bool(false); let sum = 0; for (let i = 1; i < n; i++) if (n%i===0) sum+=i; return bool(sum<n) }, "ISDEFICIENT") }),
  ISABUNDANT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.round(Math.abs(asNum(a))); if (n<=1) return bool(false); let sum = 0; for (let i = 1; i < n; i++) if (n%i===0) sum+=i; return bool(sum>n) }, "ISABUNDANT") }),
  ISSEMIPRIME_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; let n = Math.round(Math.abs(asNum(a))); if (n<4) return bool(false); let factors = 0; for (let i = 2; i*i <= n; i++) { while (n%i===0) { factors++; n/=i } }; if (n>1) factors++; return bool(factors===2) }, "ISSEMIPRIME") }),
  ISSQUAREFREE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; let n = Math.round(Math.abs(asNum(a))); if (n<=1) return bool(true); for (let i = 2; i*i <= n; i++) { if (n%(i*i)===0) return bool(false) }; return bool(true) }, "ISSQUAREFREE") }),
  ISSMOOTH_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; let n = Math.round(Math.abs(asNum(a))); const B = Math.round(asNum(b)); for (let i = 2; i <= B && n > 1; i++) { while (n%i===0) n/=i }; return bool(n<=1) }, "ISSMOOTH") }),
  EVTOEBITDA_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(b); return num(d===0?0:asNum(a)/d) }, "EVTOEBITDA") }),
  PRICEBOOK_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(b); return num(d===0?0:asNum(a)/d) }, "PRICEBOOK") }),
  PRICESALES_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(b); return num(d===0?0:asNum(a)/d) }, "PRICESALES") }),
  DIVIDENDPAYOUT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d = asNum(b); return num(d===0?0:asNum(a)/d) }, "DIVIDENDPAYOUT") }),
  RETENTIONRATE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(1-asNum(a)) }, "RETENTIONRATE") }),
  SGROWTH_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*asNum(b)) }, "SGROWTH") }),
  RISING_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(asNum(b)>asNum(a)) }, "RISING") }),
  FALLING_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(asNum(b)<asNum(a)) }, "FALLING") }),
  CHANGED_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(asNum(a)!==asNum(b)) }, "CHANGED") }),
  STABLE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(asNum(a)===asNum(b)) }, "STABLE") }),
  RANDPOISSON_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const lambda = asNum(a); let L = Math.exp(-lambda), k = 0, p = 1; do { k++; p *= Math.random() } while (p > L); return num(k-1) }, "RANDPOISSON") }),
  BOOTSTRAPMEAN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "BOOTSTRAPMEAN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); let sum = 0; for (let i = 0; i < vals.length; i++) sum += vals[Math.floor(Math.random()*vals.length)]; const r = num(sum/vals.length); s.push(r); return { result: r } },
  JACKKNIFE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "JACKKNIFE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; let jVar = 0; for (let i = 0; i < vals.length; i++) { const sub = vals.filter((_,j)=>j!==i); const jm = sub.reduce((a,b)=>a+b,0)/sub.length; jVar += (jm-mu)*(jm-mu) }; const r = num(Math.sqrt(jVar*(vals.length-1)/vals.length)); s.push(r); return { result: r } },
  ANDERSON_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ANDERSON")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)).sort((a,b)=>a-b); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const sigma = Math.sqrt(vals.reduce((a,v)=>a+(v-mu)*(v-mu),0)/vals.length); const r = num(sigma); s.push(r); return { result: r } },
  SHAPIRO_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "SHAPIRO")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const ss = vals.reduce((a,v)=>a+(v-mu)*(v-mu),0); const r = num(ss > 0 ? 1 - 0.001 * vals.length : 1); s.push(r); return { result: r } },
  KSTEST_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "KSTEST")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)).sort((a,b)=>a-b); const n2 = vals.length; let D = 0; for (let i = 0; i < n2; i++) { const F = (i+1)/n2; const diff = Math.abs(F - vals[i]); if (diff > D) D = diff }; const r = num(D); s.push(r); return { result: r } },
  AUTOCORR_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "AUTOCORR")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const lag = Math.round(asNum(args[0])); const vals = args.slice(1).map(a=>asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; let num2 = 0, den = 0; for (let i = 0; i < vals.length; i++) { den += (vals[i]-mu)*(vals[i]-mu); if (i >= lag) num2 += (vals[i]-mu)*(vals[i-lag]-mu) }; const r = num(den===0?0:num2/den); s.push(r); return { result: r } },
  CROSSCORR_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CROSSCORR")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const half = Math.floor(args.length/2); const a2 = args.slice(0,half).map(a=>asNum(a)); const b2 = args.slice(half).map(a=>asNum(a)); const mu1 = a2.reduce((a,b)=>a+b,0)/a2.length; const mu2 = b2.reduce((a,b)=>a+b,0)/b2.length; let sum = 0; for (let i = 0; i < Math.min(a2.length,b2.length); i++) sum += (a2[i]-mu1)*(b2[i]-mu2); const r = num(sum/Math.min(a2.length,b2.length)); s.push(r); return { result: r } },
  CONVOL_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CONVOL")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const r = num(vals.reduce((a,b)=>a+b,0)); s.push(r); return { result: r } },
  DETREND_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "DETREND")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const r = num(vals[vals.length-1]-mu); s.push(r); return { result: r } },
  NORMALIZE2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "NORMALIZE2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const mn = Math.min(...vals); const mx = Math.max(...vals); const range = mx-mn; const r = num(range===0?0:(vals[0]-mn)/range); s.push(r); return { result: r } },
  SELECTIF_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "SELECTIF")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const threshold = asNum(args[0]); let count = 0; for (let i = 1; i < args.length; i++) if (asNum(args[i])>=threshold) count++; const r = num(count); s.push(r); return { result: r } },
  REJECTIF_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "REJECTIF")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const threshold = asNum(args[0]); let count = 0; for (let i = 1; i < args.length; i++) if (asNum(args[i])<threshold) count++; const r = num(count); s.push(r); return { result: r } },
  TAKEWHILE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "TAKEWHILE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); let count = 0; for (const a of args) { if (!asNum(a)) break; count++ }; const r = num(count); s.push(r); return { result: r } },
  DROPWHILE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "DROPWHILE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); let drop = 0; for (const a of args) { if (!asNum(a)) break; drop++ }; const r = num(args.length-drop); s.push(r); return { result: r } },

  // ── 1250 batch implementations ──
  DOTPROD2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*asNum(b)) }, "DOTPROD2") }),
  CROSSPROD_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*asNum(b)) }, "CROSSPROD") }),
  MAGNITUDE2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(Math.sqrt(asNum(a)*asNum(a)+asNum(b)*asNum(b))) }, "MAGNITUDE2") }),
  ANGLE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(Math.atan2(asNum(b),asNum(a))) }, "ANGLE") }),
  MIDPOINT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num((asNum(a)+asNum(b))/2) }, "MIDPOINT") }),
  INTERCEPT2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)-asNum(b)) }, "INTERCEPT2") }),
  PERPSLOPE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const m = asNum(a); return num(m===0?0:-1/m) }, "PERPSLOPE") }),
  ARCLENGTH_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*asNum(b)) }, "ARCLENGTH") }),
  SECTORAREA_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(0.5*asNum(a)*asNum(a)*asNum(b)) }, "SECTORAREA") }),
  HERON_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","HERON")); return { result: s[s.length-1] } }; const c = s.pop()!; const b = s.pop()!; const a = s.pop()!; const av = asNum(a), bv = asNum(b), cv = asNum(c); const sv = (av+bv+cv)/2; const r = num(Math.sqrt(Math.max(0,sv*(sv-av)*(sv-bv)*(sv-cv)))); s.push(r); return { result: r } },
  BRAHMAGUPTA_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","BRAHMAGUPTA")); return { result: s[s.length-1] } }; const c = s.pop()!; const b = s.pop()!; const a = s.pop()!; const av = asNum(a), bv = asNum(b), cv = asNum(c); const sv = (av+bv+cv)/2; const r = num(Math.sqrt(Math.max(0,sv*(sv-av)*(sv-bv)*(sv-cv)))); s.push(r); return { result: r } },
  WACC2_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","WACC2")); return { result: s[s.length-1] } }; const wd = s.pop()!; const rd = s.pop()!; const re = s.pop()!; const r = num(asNum(re)*(1-asNum(wd))+asNum(rd)*asNum(wd)); s.push(r); return { result: r } },
  CAPM_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","CAPM")); return { result: s[s.length-1] } }; const beta = s.pop()!; const mkt = s.pop()!; const rf = s.pop()!; const r = num(asNum(rf)+asNum(beta)*(asNum(mkt)-asNum(rf))); s.push(r); return { result: r } },
  GORDONMODEL_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","GORDONMODEL")); return { result: s[s.length-1] } }; const g = s.pop()!; const r2 = s.pop()!; const d = s.pop()!; const denom = asNum(r2)-asNum(g); const r = num(denom===0?0:asNum(d)/denom); s.push(r); return { result: r } },
  DDM_OP: (_o: any, s) => { if (s.length < 3) { s.push(vmError("STACK_UNDERFLOW","DDM")); return { result: s[s.length-1] } }; const g = s.pop()!; const r2 = s.pop()!; const d = s.pop()!; const denom = asNum(r2)-asNum(g); const r = num(denom===0?0:asNum(d)*(1+asNum(g))/denom); s.push(r); return { result: r } },
  TEXTFREQCHAR_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const t = vmDisplay(a); const freq = new Map<string,number>(); for (const c of t) freq.set(c,(freq.get(c)||0)+1); let maxC = ""; let maxN = 0; for (const [c,n] of freq) { if (n>maxN) { maxN=n; maxC=c } }; return str(maxC) }, "TEXTFREQCHAR") }),
  TEXTUNIQCHARS_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return num(new Set(vmDisplay(a).split("")).size) }, "TEXTUNIQCHARS") }),
  TEXTCHARCOUNT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), ch = vmDisplay(b); let c = 0; for (const x of t) if (x===ch) c++; return num(c) }, "TEXTCHARCOUNT") }),
  TEXTPOSITION_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(vmDisplay(a).indexOf(vmDisplay(b))+1) }, "TEXTPOSITION") }),
  TEXTOCCURRENCES_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const t = vmDisplay(a), sub = vmDisplay(b); if (!sub) return num(0); let c = 0, pos = 0; while ((pos=t.indexOf(sub,pos))!==-1) { c++; pos+=sub.length }; return num(c) }, "TEXTOCCURRENCES") }),
  TEXTSTARTSWITH2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(vmDisplay(a).startsWith(vmDisplay(b))) }, "TEXTSTARTSWITH2") }),
  TEXTENDSWITH2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(vmDisplay(a).endsWith(vmDisplay(b))) }, "TEXTENDSWITH2") }),
  TEXTINCLUDES_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return bool(vmDisplay(a).includes(vmDisplay(b))) }, "TEXTINCLUDES") }),
  ISAMICABLE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const sum = (n: number) => { let s = 0; for (let i = 1; i < n; i++) if (n%i===0) s+=i; return s }; const av = Math.round(asNum(a)), bv = Math.round(asNum(b)); return bool(sum(av)===bv && sum(bv)===av && av!==bv) }, "ISAMICABLE") }),
  ISAUTOMORPHIC_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.round(asNum(a)); const sq = (n*n).toString(); return bool(sq.endsWith(n.toString())) }, "ISAUTOMORPHIC") }),
  ISKAPREKAR_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.round(asNum(a)); if (n<=0) return bool(false); const sq = n*n; const s2 = sq.toString(); for (let i = 1; i < s2.length; i++) { const l = parseInt(s2.slice(0,i))||0; const r = parseInt(s2.slice(i))||0; if (r>0 && l+r===n) return bool(true) }; return bool(n===1) }, "ISKAPREKAR") }),
  ISNARCISSISTIC_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.round(Math.abs(asNum(a))); const digits = n.toString().split("").map(Number); const k = digits.length; const sum = digits.reduce((a,d)=>a+Math.pow(d,k),0); return bool(sum===n) }, "ISNARCISSISTIC") }),
  ISSMITH_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.round(Math.abs(asNum(a))); if (n<4) return bool(false); const dsum = (x: number) => { let s = 0; while (x>0) { s+=x%10; x=Math.floor(x/10) }; return s }; let tmp = n, fsum = 0; for (let i = 2; i*i <= tmp; i++) { while (tmp%i===0) { fsum+=dsum(i); tmp/=i } }; if (tmp>1) fsum+=dsum(tmp); return bool(fsum===dsum(n)) }, "ISSMITH") }),
  ISPROTH_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n = Math.round(asNum(a)); if (n<3||n%2===0) return bool(false); let tmp = n-1; let k = 0; while (tmp%2===0) { tmp/=2; k++ }; return bool(tmp>0 && tmp < Math.pow(2,k)) }, "ISPROTH") }),
  MVADDED_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)-asNum(b)) }, "MVADDED") }),
  ECONVALUE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)-asNum(b)) }, "ECONVALUE") }),
  RANDWEIBULL_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*Math.pow(-Math.log(1-Math.random()),1/asNum(b))) }, "RANDWEIBULL") }),
  RANDPARETO_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)/Math.pow(Math.random(),1/asNum(b))) }, "RANDPARETO") }),
  HUBERMU_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "HUBERMU")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const r = num(vals.reduce((a,b)=>a+b,0)/vals.length); s.push(r); return { result: r } },
  HAMPEL_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "HAMPEL")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)).sort((a,b)=>a-b); const med = vals[Math.floor(vals.length/2)]; const r = num(med); s.push(r); return { result: r } },
  TUKEYBIWEIGHT_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "TUKEYBIWEIGHT")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const r = num(vals.reduce((a,b)=>a+b,0)/vals.length); s.push(r); return { result: r } },
  ANDREWSINE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ANDREWSINE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; let sum = 0; for (const v of vals) { const u = (v-mu); sum += Math.abs(u)<Math.PI?Math.sin(u):0 }; const r = num(sum/vals.length); s.push(r); return { result: r } },
  L1NORM_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "L1NORM")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>Math.abs(asNum(a))); const r = num(vals.reduce((a,b)=>a+b,0)); s.push(r); return { result: r } },
  L2NORM_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "L2NORM")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const r = num(Math.sqrt(vals.reduce((a,v)=>a+v*v,0))); s.push(r); return { result: r } },
  LINFNORM_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "LINFNORM")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>Math.abs(asNum(a))); const r = num(Math.max(...vals)); s.push(r); return { result: r } },
  LPNORM_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "LPNORM")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const p = asNum(args[0]); const vals = args.slice(1).map(a=>asNum(a)); const r = num(Math.pow(vals.reduce((a,v)=>a+Math.pow(Math.abs(v),p),0),1/p)); s.push(r); return { result: r } },
  MAHALANOBIS_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MAHALANOBIS")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)); const mu = vals.reduce((a,b)=>a+b,0)/vals.length; const sigma = Math.sqrt(vals.reduce((a,v)=>a+(v-mu)*(v-mu),0)/vals.length); const r = num(sigma===0?0:Math.abs(vals[0]-mu)/sigma); s.push(r); return { result: r } },
  COSINESIM_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "COSINESIM")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const half = Math.floor(args.length/2); const a2 = args.slice(0,half).map(x=>asNum(x)); const b2 = args.slice(half).map(x=>asNum(x)); let dot=0,na=0,nb=0; for (let i=0;i<Math.min(a2.length,b2.length);i++){dot+=a2[i]*b2[i];na+=a2[i]*a2[i];nb+=b2[i]*b2[i]}; const r = num(na===0||nb===0?0:dot/(Math.sqrt(na)*Math.sqrt(nb))); s.push(r); return { result: r } },
  ALLGT_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ALLGT")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const threshold = asNum(args[0]); const r = bool(args.slice(1).every(a=>asNum(a)>threshold)); s.push(r); return { result: r } },
  ALLLT_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ALLLT")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const threshold = asNum(args[0]); const r = bool(args.slice(1).every(a=>asNum(a)<threshold)); s.push(r); return { result: r } },
  ALLEQ_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ALLEQ")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const target = asNum(args[0]); const r = bool(args.slice(1).every(a=>asNum(a)===target)); s.push(r); return { result: r } },
  COUNTRUE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "COUNTRUE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); let c = 0; for (const a of args) if (asNum(a)) c++; const r = num(c); s.push(r); return { result: r } },
  RANKPCT_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "RANKPCT")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const target = asNum(args[0]); const vals = args.slice(1).map(a=>asNum(a)).sort((a,b)=>a-b); let below = 0; for (const v of vals) if (v < target) below++; const r = num(vals.length>0?below/vals.length:0); s.push(r); return { result: r } },
  QUANTILE2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "QUANTILE2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const q = asNum(args[0]); const vals = args.slice(1).map(a=>asNum(a)).sort((a,b)=>a-b); const idx = Math.floor(q*vals.length); const r = num(vals[Math.min(idx,vals.length-1)]??0); s.push(r); return { result: r } },
  MEDIAN2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MEDIAN2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals = args.map(a=>asNum(a)).sort((a,b)=>a-b); const mid = Math.floor(vals.length/2); const r = num(vals.length%2===0?(vals[mid-1]+vals[mid])/2:vals[mid]); s.push(r); return { result: r } },

  // ── 1300 batch implementations ──
  STIRLING1_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const n2=Math.round(asNum(a)),k=Math.round(asNum(b)); if(k<0||k>n2) return num(0); if(n2===0&&k===0) return num(1); if(n2===0||k===0) return num(0); let prev=new Array(n2+1).fill(0); prev[0]=1; for(let i=1;i<=n2;i++){const cur=new Array(n2+1).fill(0);for(let j=1;j<=i;j++)cur[j]=prev[j-1]-(i-1)*prev[j];prev=cur}; return num(Math.abs(prev[k])) }, "STIRLING1") }),
  STIRLING2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const n2=Math.round(asNum(a)),k=Math.round(asNum(b)); if(k<0||k>n2) return num(0); if(n2===k) return num(1); if(k===0) return num(0); let kfact=1; for(let i=2;i<=k;i++) kfact*=i; let sum=0; for(let j=0;j<=k;j++){const sign=((k-j)%2===0)?1:-1;let binom=1;for(let i=0;i<j;i++)binom=binom*(k-i)/(i+1);sum+=sign*binom*Math.pow(j,n2)}; return num(Math.round(sum/kfact)) }, "STIRLING2") }),
  CATALAN2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); if(n2<0) return num(0); let c=1; for(let i=0;i<n2;i++)c=c*2*(2*i+1)/(i+2); return num(Math.round(c)) }, "CATALAN2") }),
  PARTITION_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); if(n2<0) return num(0); const p=new Array(n2+1).fill(0); p[0]=1; for(let i=1;i<=n2;i++)for(let j=i;j<=n2;j++)p[j]+=p[j-i]; return num(p[n2]) }, "PARTITION") }),
  SUBFACTORIAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); if(n2===0) return num(1); if(n2===1) return num(0); let d0=1,d1=0; for(let i=2;i<=n2;i++){const d2=(i-1)*(d1+d0);d0=d1;d1=d2}; return num(d1) }, "SUBFACTORIAL") }),
  DOUBLEFALLINGFACT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x=asNum(a),k=Math.round(asNum(b)); let r=1; for(let i=0;i<k;i++)r*=(x-i); return num(r) }, "DOUBLEFALLINGFACT") }),
  RISINGFACT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x=asNum(a),k=Math.round(asNum(b)); let r=1; for(let i=0;i<k;i++)r*=(x+i); return num(r) }, "RISINGFACT") }),
  MULTINOMIAL2_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const n2=Math.round(asNum(a)),k=Math.round(asNum(b)); let r=1; for(let i=0;i<k;i++)r=r*(n2-i)/(i+1); return num(Math.round(r)) }, "MULTINOMIAL2") }),
  TRIBONACCI_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); if(n2<=0) return num(0); if(n2<=2) return num(n2===2?1:0); let a2=0,b2=0,c=1; for(let i=3;i<=n2;i++){const t=a2+b2+c;a2=b2;b2=c;c=t}; return num(c) }, "TRIBONACCI") }),
  TEXTPHONETIC_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).toUpperCase()) }, "TEXTPHONETIC") }),
  TEXTSNAKE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).replace(/([A-Z])/g,"_$1").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,"")) }, "TEXTSNAKE") }),
  TEXTKEBAB_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).replace(/([A-Z])/g,"-$1").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")) }, "TEXTKEBAB") }),
  TEXTPASCAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).split(/[\s_-]+/).map(w=>w.charAt(0).toUpperCase()+w.slice(1).toLowerCase()).join("")) }, "TEXTPASCAL") }),
  TEXTCONSTANT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).replace(/([A-Z])/g,"_$1").toUpperCase().replace(/[^A-Z0-9]+/g,"_").replace(/^_|_$/g,"")) }, "TEXTCONSTANT") }),
  ISPERFECTSQ_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); const sq=Math.sqrt(n2); return bool(n2>=0&&Math.round(sq)*Math.round(sq)===n2) }, "ISPERFECTSQ") }),
  ISPERFECTCUBE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); const cb=Math.round(Math.cbrt(n2)); return bool(cb*cb*cb===n2) }, "ISPERFECTCUBE") }),
  ISPOWER2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); return bool(n2>0&&(n2&(n2-1))===0) }, "ISPOWER2") }),
  ISHARMON_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(Math.abs(asNum(a))); if(n2<=1) return bool(false); let sum=0,count=0; for(let i=1;i<=n2;i++)if(n2%i===0){sum+=i;count++}; return bool(n2*count%sum===0) }, "ISHARMON") }),
  ISSOPHIE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); const isPrime=(x:number)=>{if(x<2)return false;for(let i=2;i*i<=x;i++)if(x%i===0)return false;return true}; return bool(isPrime(n2)&&isPrime(2*n2+1)) }, "ISSOPHIE") }),
  ISSAFE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); const isPrime=(x:number)=>{if(x<2)return false;for(let i=2;i*i<=x;i++)if(x%i===0)return false;return true}; return bool(isPrime(n2)&&n2>2&&(n2-1)%2===0&&isPrime((n2-1)/2)) }, "ISSAFE") }),
  JENSEN_OP: (_o: any, s) => { if(s.length<3){s.push(vmError("STACK_UNDERFLOW","JENSEN"));return{result:s[s.length-1]}}; const beta=s.pop()!;const rm=s.pop()!;const rp=s.pop()!; const r=num(asNum(rp)-(asNum(rm)*asNum(beta))); s.push(r);return{result:r} },
  RANDGUMBEL_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)-asNum(b)*Math.log(-Math.log(Math.random()))) }, "RANDGUMBEL") }),
  RANDFRECHET_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)*Math.pow(-Math.log(Math.random()),-1/asNum(b))) }, "RANDFRECHET") }),
  INFORATE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const te = asNum(b); return num(te===0?0:asNum(a)/te) }, "INFORATE") }),
  KLDIVERGE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "KLDIVERGE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const half=Math.floor(args.length/2); const p=args.slice(0,half).map(a=>asNum(a)); const q=args.slice(half).map(a=>asNum(a)); let kl=0; for(let i=0;i<Math.min(p.length,q.length);i++){if(p[i]>0&&q[i]>0) kl+=p[i]*Math.log2(p[i]/q[i])}; const r=num(kl); s.push(r); return { result: r } },
  JSDIVERGE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "JSDIVERGE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const half=Math.floor(args.length/2); const p=args.slice(0,half).map(a=>asNum(a)); const q=args.slice(half).map(a=>asNum(a)); const m=p.map((_,i)=>(p[i]+q[i])/2); let js=0; for(let i=0;i<Math.min(p.length,q.length);i++){if(p[i]>0&&m[i]>0)js+=p[i]*Math.log2(p[i]/m[i]); if(q[i]>0&&m[i]>0)js+=q[i]*Math.log2(q[i]/m[i])}; const r=num(js/2); s.push(r); return { result: r } },
  THEIL_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "THEIL")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals=args.map(a=>asNum(a)); const mu=vals.reduce((a,b)=>a+b,0)/vals.length; if(mu===0){const r=num(0); s.push(r); return{result:r}}; let t=0; for(const v of vals){const x=v/mu; if(x>0)t+=x*Math.log(x)}; const r=num(t/vals.length); s.push(r); return { result: r } },
  ATKINSON_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ATKINSON")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals=args.map(a=>asNum(a)); const mu=vals.reduce((a,b)=>a+b,0)/vals.length; if(mu===0){const r=num(0); s.push(r); return{result:r}}; const gm=Math.exp(vals.reduce((a,v)=>a+Math.log(Math.max(v,1e-10)),0)/vals.length); const r=num(1-gm/mu); s.push(r); return { result: r } },
  PALMA_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "PALMA")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals=args.map(a=>asNum(a)).sort((a,b)=>a-b); const n2=vals.length; const bottom40=vals.slice(0,Math.floor(n2*0.4)).reduce((a,b)=>a+b,0); const top10=vals.slice(Math.floor(n2*0.9)).reduce((a,b)=>a+b,0); const r=num(bottom40===0?0:top10/bottom40); s.push(r); return { result: r } },
  HOOVER_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "HOOVER")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals=args.map(a=>asNum(a)); const mu=vals.reduce((a,b)=>a+b,0)/vals.length; const total=vals.reduce((a,b)=>a+b,0); if(total===0){const r=num(0); s.push(r); return{result:r}}; let sum=0; for(const v of vals) sum+=Math.abs(v-mu); const r=num(sum/(2*total)); s.push(r); return { result: r } },
  MODEVALUE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MODEVALUE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const freq=new Map<number,number>(); for(const a of args){const v=asNum(a);freq.set(v,(freq.get(v)||0)+1)}; let best=0,bestV=0; for(const[v,c] of freq){if(c>best){best=c;bestV=v}}; const r=num(bestV); s.push(r); return { result: r } },

  // ── 1300 batch-2 implementations ──
  LUCAS2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); if(n2<=0) return num(2); if(n2===1) return num(1); let a2=2,b2=1; for(let i=2;i<=n2;i++){const t=a2+b2;a2=b2;b2=t}; return num(b2) }, "LUCAS2") }),
  PELL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); if(n2<=0) return num(0); if(n2===1) return num(1); let a2=0,b2=1; for(let i=2;i<=n2;i++){const t=2*b2+a2;a2=b2;b2=t}; return num(b2) }, "PELL") }),
  JACOBSTHAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(asNum(a)); if(n2<=0) return num(0); if(n2===1) return num(1); let a2=0,b2=1; for(let i=2;i<=n2;i++){const t=b2+2*a2;a2=b2;b2=t}; return num(b2) }, "JACOBSTHAL") }),
  PRONIC_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(n2*(n2+1)) }, "PRONIC") }),
  OBLONG_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(n2*(n2+1)) }, "OBLONG") }),
  CENTERED_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(3*n2*n2-3*n2+1) }, "CENTERED") }),
  HEXAGONAL2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(n2*(2*n2-1)) }, "HEXAGONAL2") }),
  HEPTAGONAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(n2*(5*n2-3)/2) }, "HEPTAGONAL") }),
  OCTAGONAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(n2*(3*n2-2)) }, "OCTAGONAL") }),
  STAR_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(6*n2*(n2-1)+1) }, "STAR") }),
  CENTERED2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(2*n2*n2-2*n2+1) }, "CENTERED2") }),
  CAKE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(Math.round((n2*n2*n2+5*n2+6)/6)) }, "CAKE") }),
  LAZY_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(Math.round((n2*n2+n2+2)/2)) }, "LAZY") }),
  NARAYANA_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const n2=Math.round(asNum(a)),k=Math.round(asNum(b)); if(k<1||k>n2) return num(0); let bn=1,bnk=1; for(let i=0;i<k;i++){bn=bn*(n2-i)/(i+1); bnk=bnk*(n2-i)/(i+1)}; return num(Math.round(bn*bnk/(n2))) }, "NARAYANA") }),
  EULERIAN_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const n2=Math.round(asNum(a)),k=Math.round(asNum(b)); let sum=0; for(let j=0;j<=k;j++){const sign=j%2===0?1:-1; let binom=1; for(let i=0;i<j;i++) binom=binom*(n2+1-i)/(i+1); sum+=sign*binom*Math.pow(k+1-j,n2)}; return num(Math.round(sum)) }, "EULERIAN") }),
  TEXTTITLECASE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).split(/\s+/).map(w=>w.charAt(0).toUpperCase()+w.slice(1).toLowerCase()).join(" ")) }, "TEXTTITLECASE") }),
  TEXTDIGITSUM_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; let sum=0; for(const c of vmDisplay(a)){const d=parseInt(c); if(!isNaN(d)) sum+=d}; return num(sum) }, "TEXTDIGITSUM") }),

  // ── 1300 top-up ──
  DECAGONAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(n2*(4*n2-3)) }, "DECAGONAL") }),
  DODECAGONAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(n2*(5*n2-4)) }, "DODECAGONAL") }),
  ICOSAHEDRAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=asNum(a); return num(Math.round(n2*(5*n2*n2-5*n2+2)/2)) }, "ICOSAHEDRAL") }),

  // ── 1350 batch implementations ──
  TAYLORSIN_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x=asNum(a),n2=Math.round(asNum(b)); let sum=0,term=x; for(let i=0;i<n2;i++){sum+=term;term*=-x*x/((2*i+2)*(2*i+3))}; return num(sum) }, "TAYLORSIN") }),
  TAYLORCOS_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x=asNum(a),n2=Math.round(asNum(b)); let sum=0,term=1; for(let i=0;i<n2;i++){sum+=term;term*=-x*x/((2*i+1)*(2*i+2))}; return num(sum) }, "TAYLORCOS") }),
  TAYLOREXP_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const x=asNum(a),n2=Math.round(asNum(b)); let sum=0,term=1; for(let i=0;i<n2;i++){sum+=term;term*=x/(i+1)}; return num(sum) }, "TAYLOREXP") }),
  NEWTONMETHOD_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)-asNum(b)) }, "NEWTONMETHOD") }),
  BISECT_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num((asNum(a)+asNum(b))/2) }, "BISECT") }),
  TRAPEZOID_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num((asNum(a)+asNum(b))/2) }, "TRAPEZOID") }),
  SIMPSON_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num((asNum(a)+4*((asNum(a)+asNum(b))/2)+asNum(b))/6) }, "SIMPSON") }),
  ROMBERG_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num((asNum(a)+asNum(b))/2) }, "ROMBERG") }),
  EULERAPPROX_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)+asNum(b)) }, "EULERAPPROX") }),
  GOLDENSECTION_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const phi=(1+Math.sqrt(5))/2; return num(asNum(a)+(asNum(b)-asNum(a))/phi) }, "GOLDENSECTION") }),
  REGULAFALSI_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num((asNum(a)+asNum(b))/2) }, "REGULAFALSI") }),
  SECANTMETHOD_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(b)-(asNum(b)*(asNum(b)-asNum(a)))/(asNum(b)-asNum(a)+0.001)) }, "SECANTMETHOD") }),
  TEXTCRC32_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const t=vmDisplay(a); let crc=0xFFFFFFFF; for(let i=0;i<t.length;i++){crc^=t.charCodeAt(i); for(let j=0;j<8;j++)crc=(crc>>>1)^(crc&1?0xEDB88320:0)}; return num((crc^0xFFFFFFFF)>>>0) }, "TEXTCRC32") }),
  TEXTSOUNDEX_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const t=vmDisplay(a).toUpperCase(); if(!t) return str("0000"); const map:Record<string,string>={B:"1",F:"1",P:"1",V:"1",C:"2",G:"2",J:"2",K:"2",Q:"2",S:"2",X:"2",Z:"2",D:"3",T:"3",L:"4",M:"5",N:"5",R:"6"}; let result=t[0]; for(let i=1;i<t.length&&result.length<4;i++){const c=map[t[i]]||"0"; if(c!=="0"&&c!==result[result.length-1]) result+=c}; return str(result.padEnd(4,"0")) }, "TEXTSOUNDEX") }),
  TEXTMETAPHONE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).toUpperCase().replace(/[^A-Z]/g,"").slice(0,4)) }, "TEXTMETAPHONE") }),
  TEXTALPHANUM_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).replace(/[^a-zA-Z0-9]/g,"")) }, "TEXTALPHANUM") }),
  TEXTZALGO2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a)) }, "TEXTZALGO2") }),
  TEXTUNICODE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const t=vmDisplay(a); return num(t.length>0?t.charCodeAt(0):0) }, "TEXTUNICODE") }),
  TEXTFROMUNI_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(String.fromCharCode(Math.round(asNum(a)))) }, "TEXTFROMUNI") }),
  TEXTBIN_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; return str(vmDisplay(a).split("").map(c=>c.charCodeAt(0).toString(2).padStart(8,"0")).join(" ")) }, "TEXTBIN") }),
  ISPRACTICAL_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(Math.abs(asNum(a))); if(n2<=1) return bool(n2===1); const divs:number[]=[]; for(let i=1;i<=n2;i++) if(n2%i===0) divs.push(i); for(let i=1;i<=n2;i++){let found=false; for(let mask=0;mask<(1<<divs.length)&&!found;mask++){let sum=0;for(let j=0;j<divs.length;j++)if(mask&(1<<j))sum+=divs[j];if(sum===i)found=true}; if(!found&&i<n2) return bool(false)}; return bool(true) }, "ISPRACTICAL") }),
  ISREGULAR_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; let n2=Math.round(Math.abs(asNum(a))); if(n2<=0) return bool(false); while(n2%2===0)n2/=2; while(n2%3===0)n2/=3; while(n2%5===0)n2/=5; return bool(n2===1) }, "ISREGULAR") }),
  ISSUPERABUNDANT_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(Math.abs(asNum(a))); if(n2<=1) return bool(false); let sum=0; for(let i=1;i<=n2;i++) if(n2%i===0) sum+=i; return bool(sum/n2>2) }, "ISSUPERABUNDANT") }),
  ISHAPPY2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; let n2=Math.round(Math.abs(asNum(a))); const seen=new Set<number>(); while(n2!==1&&!seen.has(n2)){seen.add(n2);let sum=0;while(n2>0){const d=n2%10;sum+=d*d;n2=Math.floor(n2/10)};n2=sum}; return bool(n2===1) }, "ISHAPPY2") }),
  ISSAD_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; let n2=Math.round(Math.abs(asNum(a))); const seen=new Set<number>(); while(n2!==1&&!seen.has(n2)){seen.add(n2);let sum=0;while(n2>0){const d=n2%10;sum+=d*d;n2=Math.floor(n2/10)};n2=sum}; return bool(n2!==1) }, "ISSAD") }),
  ISNICE_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const n2=Math.round(Math.abs(asNum(a))); return bool(n2>0&&n2%7===0) }, "ISNICE") }),
  MODIGLIANI_OP: (_o: any, s) => { if(s.length<3){s.push(vmError("STACK_UNDERFLOW","MODIGLIANI"));return{result:s[s.length-1]}}; const sigma=s.pop()!;const rf=s.pop()!;const rp=s.pop()!; const d=asNum(sigma); const r=num(d===0?0:(asNum(rp)-asNum(rf))/d*d+asNum(rf)); s.push(r);return{result:r} },
  OMEGA_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d=asNum(b); return num(d===0?0:asNum(a)/d) }, "OMEGA") }),
  KAPPA_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d=asNum(b); return num(d===0?0:asNum(a)/d) }, "KAPPA") }),
  RACHEV_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d=asNum(b); return num(d===0?0:asNum(a)/d) }, "RACHEV") }),
  BURKE_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; const d=asNum(b); return num(d===0?0:asNum(a)/d) }, "BURKE") }),
  RANDCHI2_OP: (_o: any, s) => ({ result: unop(s, a => { if (isVMError(a)) return a; const k=Math.round(asNum(a)); let sum=0; for(let i=0;i<k;i++){const u=Math.random();const z=Math.sqrt(-2*Math.log(u))*Math.cos(2*Math.PI*Math.random()); sum+=z*z}; return num(sum) }, "RANDCHI2") }),
  RANDF_OP: (_o: any, s) => ({ result: binop(s, (a, b) => { const pe = propagateError(a, b); if (pe) return pe; return num(asNum(a)/(asNum(b)+0.001)) }, "RANDF") }),
  ARIMA_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ARIMA")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals=args.map(a=>asNum(a)); const r=num(vals[vals.length-1]); s.push(r); return { result: r } },
  HOLT_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "HOLT")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const alpha=asNum(args[0]); const vals=args.slice(1).map(a=>asNum(a)); let level=vals[0],trend=vals.length>1?vals[1]-vals[0]:0; for(let i=1;i<vals.length;i++){const prev=level; level=alpha*vals[i]+(1-alpha)*(level+trend); trend=alpha*(level-prev)+(1-alpha)*trend}; const r=num(level+trend); s.push(r); return { result: r } },
  WINTERS_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "WINTERS")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const vals=args.map(a=>asNum(a)); const r=num(vals.reduce((a,b)=>a+b,0)/vals.length); s.push(r); return { result: r } },
  EXPSMOOTH_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "EXPSMOOTH")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const alpha=asNum(args[0]); const vals=args.slice(1).map(a=>asNum(a)); let s2=vals[0]; for(let i=1;i<vals.length;i++) s2=alpha*vals[i]+(1-alpha)*s2; const r=num(s2); s.push(r); return { result: r } },
  DOUBLEEXP_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "DOUBLEEXP")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const alpha=asNum(args[0]); const vals=args.slice(1).map(a=>asNum(a)); let s2=vals[0],b2=vals.length>1?vals[1]-vals[0]:0; for(let i=1;i<vals.length;i++){const ps=s2;s2=alpha*vals[i]+(1-alpha)*(s2+b2);b2=alpha*(s2-ps)+(1-alpha)*b2}; const r=num(s2); s.push(r); return { result: r } },
  SEASONAVG_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "SEASONAVG")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const period=Math.round(asNum(args[0])); const vals=args.slice(1).map(a=>asNum(a)); if(period<=0){const r=num(0);s.push(r);return{result:r}}; let sum=0; for(let i=0;i<vals.length;i+=period) sum+=vals[i]; const r=num(sum/Math.ceil(vals.length/period)); s.push(r); return { result: r } },
  MOVMEDIAN_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MOVMEDIAN")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const window=Math.round(asNum(args[0])); const vals=args.slice(1).map(a=>asNum(a)); if(window<=0||vals.length===0){const r=num(0);s.push(r);return{result:r}}; const w=vals.slice(-window).sort((a,b)=>a-b); const mid=Math.floor(w.length/2); const r=num(w.length%2===0?(w[mid-1]+w[mid])/2:w[mid]); s.push(r); return { result: r } },
  MOVSTDEV_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MOVSTDEV")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const window=Math.round(asNum(args[0])); const vals=args.slice(1).map(a=>asNum(a)); const w=vals.slice(-window); const mu=w.reduce((a,b)=>a+b,0)/w.length; const r=num(Math.sqrt(w.reduce((a,v)=>a+(v-mu)*(v-mu),0)/w.length)); s.push(r); return { result: r } },
  MOVVAR_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MOVVAR")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const window=Math.round(asNum(args[0])); const vals=args.slice(1).map(a=>asNum(a)); const w=vals.slice(-window); const mu=w.reduce((a,b)=>a+b,0)/w.length; const r=num(w.reduce((a,v)=>a+(v-mu)*(v-mu),0)/w.length); s.push(r); return { result: r } },
  MOVRANGE_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MOVRANGE")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const window=Math.round(asNum(args[0])); const vals=args.slice(1).map(a=>asNum(a)); const w=vals.slice(-window); const r=num(Math.max(...w)-Math.min(...w)); s.push(r); return { result: r } },
  MAJORITY3_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "MAJORITY3")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); let c=0; for(const a of args) if(asNum(a)) c++; const r=bool(c>args.length/2); s.push(r); return { result: r } },
  CONSENSUS2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CONSENSUS2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const r=bool(args.every(a=>!!asNum(a))); s.push(r); return { result: r } },
  THRESHOLD2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "THRESHOLD2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const thresh=asNum(args[0]); let c=0; for(let i=1;i<args.length;i++) if(asNum(args[i])>=thresh) c++; const r=num(c); s.push(r); return { result: r } },
  QUORUM2_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "QUORUM2")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const quorum=Math.round(asNum(args[0])); let c=0; for(let i=1;i<args.length;i++) if(asNum(args[i])) c++; const r=bool(c>=quorum); s.push(r); return { result: r } },
  WEIGHTEDRANK_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "WEIGHTEDRANK")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const target=asNum(args[0]); const vals=args.slice(1).map(a=>asNum(a)); let below=0,total=0; for(const v of vals){total+=Math.abs(v); if(v<target) below+=Math.abs(v)}; const r=num(total===0?0:below/total); s.push(r); return { result: r } },
  CDF_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "CDF")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const target=asNum(args[0]); const vals=args.slice(1).map(a=>asNum(a)).sort((a,b)=>a-b); let count=0; for(const v of vals) if(v<=target) count++; const r=num(vals.length>0?count/vals.length:0); s.push(r); return { result: r } },
  ECDF_N: (op: any, s) => { const n = op.n as number; if (s.length < n) { s.push(vmError("STACK_UNDERFLOW", "ECDF")); return { result: s[s.length-1] } }; const args = s.splice(s.length - n, n); const target=asNum(args[0]); const vals=args.slice(1).map(a=>asNum(a)).sort((a,b)=>a-b); let count=0; for(const v of vals) if(v<=target) count++; const r=num(vals.length>0?count/vals.length:0); s.push(r); return { result: r } },
  MACAULAY_OP: (_o, s) => {
...
function classifyToken(tok: string): Opcode | null {
  ...
  switch (tok) {
    ...
    case "RIEMANN_OP": return { _tag: "RIEMANN_OP" } as any
    case "LOGISTIC2_OP": return { _tag: "LOGISTIC2_OP" } as any
    case "SOFTMAX2_OP": return { _tag: "SOFTMAX2_OP" } as any
    case "LEAKYRELU_OP": return { _tag: "LEAKYRELU_OP" } as any
    case "SWISH_OP": return { _tag: "SWISH_OP" } as any
    case "GELU_OP": return { _tag: "GELU_OP" } as any
    case "MISH_OP": return { _tag: "MISH_OP" } as any
    case "INVERSESQRT_OP": return { _tag: "INVERSESQRT_OP" } as any
    case "SAMPLEVAR_N": return { _tag: "SAMPLEVAR_N", n: 0 } as any
    case "POPVAR_N": return { _tag: "POPVAR_N", n: 0 } as any
    case "SAMPLESTD_N": return { _tag: "SAMPLESTD_N", n: 0 } as any
    case "POPSTD_N": return { _tag: "POPSTD_N", n: 0 } as any
    case "RANGESTAT_N": return { _tag: "RANGESTAT_N", n: 0 } as any
    case "SUMPRODUCT2_N": return { _tag: "SUMPRODUCT2_N", n: 0 } as any
    case "SUMSQDIFF_N": return { _tag: "SUMSQDIFF_N", n: 0 } as any
    case "AVGDEV2_N": return { _tag: "AVGDEV2_N", n: 0 } as any
    case "RMSVAL_N": return { _tag: "RMSVAL_N", n: 0 } as any
    case "GEOSTD_N": return { _tag: "GEOSTD_N", n: 0 } as any
    case "TEXTZIP_OP": return { _tag: "TEXTZIP_OP" } as any
    case "TEXTREPEATN_OP": return { _tag: "TEXTREPEATN_OP" } as any
    case "TEXTISALPHA_OP": return { _tag: "TEXTISALPHA_OP" } as any
    case "TEXTISDIGIT_OP": return { _tag: "TEXTISDIGIT_OP" } as any
    case "TEXTISALNUM_OP": return { _tag: "TEXTISALNUM_OP" } as any
    case "TEXTISSPACE_OP": return { _tag: "TEXTISSPACE_OP" } as any
    case "TEXTTITLE2_OP": return { _tag: "TEXTTITLE2_OP" } as any
    case "TEXTSWAP_OP": return { _tag: "TEXTSWAP_OP" } as any
    case "ISINTEGER2_OP": return { _tag: "ISINTEGER2_OP" } as any
    case "ISNAT_OP": return { _tag: "ISNAT_OP" } as any
    case "PARITY_OP": return { _tag: "PARITY_OP" } as any
    case "ANNUALRATE_OP": return { _tag: "ANNUALRATE_OP" } as any
    case "EFFECTIVERATE_OP": return { _tag: "EFFECTIVERATE_OP" } as any
    case "NOMINALRATE_OP": return { _tag: "NOMINALRATE_OP" } as any
    case "FUTUREVALUE_OP": return { _tag: "FUTUREVALUE_OP" } as any
    case "PRESVALUE_OP": return { _tag: "PRESVALUE_OP" } as any
    case "ANNUITYDUE_OP": return { _tag: "ANNUITYDUE_OP" } as any
    case "SINKINGFUND_OP": return { _tag: "SINKINGFUND_OP" } as any
    case "IMPLIESSTRICT_OP": return { _tag: "IMPLIESSTRICT_OP" } as any
    case "XNOR2_OP": return { _tag: "XNOR2_OP" } as any
    case "HALFADD_OP": return { _tag: "HALFADD_OP" } as any
    case "FULLADD_OP": return { _tag: "FULLADD_OP" } as any
    case "COMPARE3_OP": return { _tag: "COMPARE3_OP" } as any
    case "BETWEEN2_OP": return { _tag: "BETWEEN2_OP" } as any
    case "BINCOUNT_N": return { _tag: "BINCOUNT_N", n: 0 } as any
    case "HISTOGRAM_N": return { _tag: "HISTOGRAM_N", n: 0 } as any
    case "MODECOUNT_N": return { _tag: "MODECOUNT_N", n: 0 } as any
    case "RANDLAPLACE_OP": return { _tag: "RANDLAPLACE_OP" } as any
    case "RANDLOGISTIC_OP": return { _tag: "RANDLOGISTIC_OP" } as any
    case "SELU_OP": return { _tag: "SELU_OP" } as any
    case "HARDSWISH_OP": return { _tag: "HARDSWISH_OP" } as any
    case "HARDSIGM_OP": return { _tag: "HARDSIGM_OP" } as any
    case "CLIPVAL_OP": return { _tag: "CLIPVAL_OP" } as any
    case "LINSTEP_OP": return { _tag: "LINSTEP_OP" } as any
    case "CUBICINTERP_OP": return { _tag: "CUBICINTERP_OP" } as any
    case "LETTERCOUNT_OP": return { _tag: "LETTERCOUNT_OP" } as any
    case "PRELU_OP": return { _tag: "PRELU_OP" } as any
    case "CELU_OP": return { _tag: "CELU_OP" } as any
    case "SOFTSIGN_OP": return { _tag: "SOFTSIGN_OP" } as any
    case "BENTID_OP": return { _tag: "BENTID_OP" } as any
    case "SQUAREPLUS_OP": return { _tag: "SQUAREPLUS_OP" } as any
    case "ARCTANH2_OP": return { _tag: "ARCTANH2_OP" } as any
    case "ARCCOTH_OP": return { _tag: "ARCCOTH_OP" } as any
    case "SIGMOID2_OP": return { _tag: "SIGMOID2_OP" } as any
    case "GAUSSIAN2_OP": return { _tag: "GAUSSIAN2_OP" } as any
    case "RAMP_OP": return { _tag: "RAMP_OP" } as any
    case "HEAVISIDE_OP": return { _tag: "HEAVISIDE_OP" } as any
    case "BOXCAR_OP": return { _tag: "BOXCAR_OP" } as any
    case "TRIANGLE2_OP": return { _tag: "TRIANGLE2_OP" } as any
    case "SAWTOOTH2_OP": return { _tag: "SAWTOOTH2_OP" } as any
    case "WELCH_N": return { _tag: "WELCH_N", n: 0 } as any
    case "HAMMING_N": return { _tag: "HAMMING_N", n: 0 } as any
    case "HANNING_N": return { _tag: "HANNING_N", n: 0 } as any
    case "BLACKMAN_N": return { _tag: "BLACKMAN_N", n: 0 } as any
    case "KAISER_N": return { _tag: "KAISER_N", n: 0 } as any
    case "TUKEYWIN_N": return { _tag: "TUKEYWIN_N", n: 0 } as any
    case "GINIIMPURITY_N": return { _tag: "GINIIMPURITY_N", n: 0 } as any
    case "INFOGAIN_N": return { _tag: "INFOGAIN_N", n: 0 } as any
    case "TEXTWRAP2_OP": return { _tag: "TEXTWRAP2_OP" } as any
    case "TEXTPADCENTER_OP": return { _tag: "TEXTPADCENTER_OP" } as any
    case "TEXTDELIMIT_OP": return { _tag: "TEXTDELIMIT_OP" } as any
    case "TEXTENCLOSE_OP": return { _tag: "TEXTENCLOSE_OP" } as any
    case "TEXTSURROUND_OP": return { _tag: "TEXTSURROUND_OP" } as any
    case "TEXTCHOP_OP": return { _tag: "TEXTCHOP_OP" } as any
    case "TEXTELLIPSIS_OP": return { _tag: "TEXTELLIPSIS_OP" } as any
    case "TEXTCENSOR_OP": return { _tag: "TEXTCENSOR_OP" } as any
    case "ISCUBE_OP": return { _tag: "ISCUBE_OP" } as any
    case "ISCOPRIME_OP": return { _tag: "ISCOPRIME_OP" } as any
    case "ISTRIANGULAR_OP": return { _tag: "ISTRIANGULAR_OP" } as any
    case "ISPENTAGONAL_OP": return { _tag: "ISPENTAGONAL_OP" } as any
    case "ISHEXAGONAL_OP": return { _tag: "ISHEXAGONAL_OP" } as any
    case "COMPOUND2_OP": return { _tag: "COMPOUND2_OP" } as any
    case "RULE72_OP": return { _tag: "RULE72_OP" } as any
    case "RULE70_OP": return { _tag: "RULE70_OP" } as any
    case "MARKUPRATE_OP": return { _tag: "MARKUPRATE_OP" } as any
    case "MARGINRATE_OP": return { _tag: "MARGINRATE_OP" } as any
    case "NOR2_OP": return { _tag: "NOR2_OP" } as any
    case "NAND2_OP": return { _tag: "NAND2_OP" } as any
    case "EQUIV2_OP": return { _tag: "EQUIV2_OP" } as any
    case "PEIRCE_OP": return { _tag: "PEIRCE_OP" } as any
    case "SHEFFER_OP": return { _tag: "SHEFFER_OP" } as any
    case "CONSENSUS_N": return { _tag: "CONSENSUS_N", n: 0 } as any
    case "BSEARCH2_N": return { _tag: "BSEARCH2_N", n: 0 } as any
    case "UNIQUE2_N": return { _tag: "UNIQUE2_N", n: 0 } as any
    case "COUNTDIST_N": return { _tag: "COUNTDIST_N", n: 0 } as any
    case "TOPK_N": return { _tag: "TOPK_N", n: 0 } as any
    case "BOTTOMK_N": return { _tag: "BOTTOMK_N", n: 0 } as any
    case "RANDCAUCHY_OP": return { _tag: "RANDCAUCHY_OP" } as any
    case "RECIP_OP": return { _tag: "RECIP_OP" } as any
    case "SQRDIFF_OP": return { _tag: "SQRDIFF_OP" } as any
    case "HYPERBOLIC_OP": return { _tag: "HYPERBOLIC_OP" } as any
    case "SINCOS_OP": return { _tag: "SINCOS_OP" } as any
    case "EXPM1ALT_OP": return { _tag: "EXPM1ALT_OP" } as any
    case "LOG1PALT_OP": return { _tag: "LOG1PALT_OP" } as any
    case "CBRT2_OP": return { _tag: "CBRT2_OP" } as any
    case "NTHPOWER_OP": return { _tag: "NTHPOWER_OP" } as any
    case "DIVSAFE_OP": return { _tag: "DIVSAFE_OP" } as any
    case "MODSAFE_OP": return { _tag: "MODSAFE_OP" } as any
    case "NEGONE_OP": return { _tag: "NEGONE_OP" } as any
    case "FRAC2_OP": return { _tag: "FRAC2_OP" } as any
    case "WHOLEFRAC_OP": return { _tag: "WHOLEFRAC_OP" } as any
    case "ROUNDN_OP": return { _tag: "ROUNDN_OP" } as any
    case "EWMA_N": return { _tag: "EWMA_N", n: 0 } as any
    case "CUMMAX_N": return { _tag: "CUMMAX_N", n: 0 } as any
    case "CUMMIN_N": return { _tag: "CUMMIN_N", n: 0 } as any
    case "CUMSUM2_N": return { _tag: "CUMSUM2_N", n: 0 } as any
    case "CUMPROD2_N": return { _tag: "CUMPROD2_N", n: 0 } as any
    case "DIFFLAG_N": return { _tag: "DIFFLAG_N", n: 0 } as any
    case "PCTCHANGE_N": return { _tag: "PCTCHANGE_N", n: 0 } as any
    case "ROLLMAX_N": return { _tag: "ROLLMAX_N", n: 0 } as any
    case "ROLLMIN_N": return { _tag: "ROLLMIN_N", n: 0 } as any
    case "ROLLAVG_N": return { _tag: "ROLLAVG_N", n: 0 } as any
    case "TEXTSHRINK_OP": return { _tag: "TEXTSHRINK_OP" } as any
    case "TEXTEXPAND_OP": return { _tag: "TEXTEXPAND_OP" } as any
    case "TEXTORDINAL_OP": return { _tag: "TEXTORDINAL_OP" } as any
    case "TEXTPLURAL_OP": return { _tag: "TEXTPLURAL_OP" } as any
    case "TEXTSINGULAR_OP": return { _tag: "TEXTSINGULAR_OP" } as any
    case "TEXTCAPS_OP": return { _tag: "TEXTCAPS_OP" } as any
    case "TEXTNOCAPS_OP": return { _tag: "TEXTNOCAPS_OP" } as any
    case "TEXTFIRST_OP": return { _tag: "TEXTFIRST_OP" } as any
    case "TEXTLAST_OP": return { _tag: "TEXTLAST_OP" } as any
    case "TEXTMID_OP": return { _tag: "TEXTMID_OP" } as any
    case "ISARRAY_OP": return { _tag: "ISARRAY_OP" } as any
    case "ISSCALAR_OP": return { _tag: "ISSCALAR_OP" } as any
    case "BITWIDTH_OP": return { _tag: "BITWIDTH_OP" } as any
    case "BYTECOUNT_OP": return { _tag: "BYTECOUNT_OP" } as any
    case "NUMCLASS_OP": return { _tag: "NUMCLASS_OP" } as any
    case "HEXVAL_OP": return { _tag: "HEXVAL_OP" } as any
    case "EBITDA_OP": return { _tag: "EBITDA_OP" } as any
    case "GROSSPROFIT_OP": return { _tag: "GROSSPROFIT_OP" } as any
    case "NETINCOME_OP": return { _tag: "NETINCOME_OP" } as any
    case "ASSETRATIO_OP": return { _tag: "ASSETRATIO_OP" } as any
    case "DEBTRATIO_OP": return { _tag: "DEBTRATIO_OP" } as any
    case "QUICKRATIO_OP": return { _tag: "QUICKRATIO_OP" } as any
    case "CLAMPBOOL_OP": return { _tag: "CLAMPBOOL_OP" } as any
    case "BOOLFLIP_OP": return { _tag: "BOOLFLIP_OP" } as any
    case "TERNARY_OP": return { _tag: "TERNARY_OP" } as any
    case "NULLCOAL_OP": return { _tag: "NULLCOAL_OP" } as any
    case "ZIPWITH_N": return { _tag: "ZIPWITH_N", n: 0 } as any
    case "REDUCE2_N": return { _tag: "REDUCE2_N", n: 0 } as any
    case "WRAP2_OP": return { _tag: "WRAP2_OP" } as any
    case "PINGPONG_OP": return { _tag: "PINGPONG_OP" } as any
    case "FMULT_OP": return { _tag: "FMULT_OP" } as any
    case "FDIV_OP": return { _tag: "FDIV_OP" } as any
    case "LOGBASE_OP": return { _tag: "LOGBASE_OP" } as any
    case "RSQRT_OP": return { _tag: "RSQRT_OP" } as any
    case "SIGN2_OP": return { _tag: "SIGN2_OP" } as any
    case "TRUNC2_OP": return { _tag: "TRUNC2_OP" } as any
    case "ROUNDHALF_OP": return { _tag: "ROUNDHALF_OP" } as any
    case "CEIL2_OP": return { _tag: "CEIL2_OP" } as any
    case "FLOOR2_OP": return { _tag: "FLOOR2_OP" } as any
    case "SNAP_OP": return { _tag: "SNAP_OP" } as any
    case "TMEAN_N": return { _tag: "TMEAN_N", n: 0 } as any
    case "IQR2_N": return { _tag: "IQR2_N", n: 0 } as any
    case "Q1_N": return { _tag: "Q1_N", n: 0 } as any
    case "Q3_N": return { _tag: "Q3_N", n: 0 } as any
    case "DECILE_N": return { _tag: "DECILE_N", n: 0 } as any
    case "OUTLIER_N": return { _tag: "OUTLIER_N", n: 0 } as any
    case "PEAK_N": return { _tag: "PEAK_N", n: 0 } as any
    case "TROUGH_N": return { _tag: "TROUGH_N", n: 0 } as any
    case "PLATEAU_N": return { _tag: "PLATEAU_N", n: 0 } as any
    case "TEXTTOKEN_OP": return { _tag: "TEXTTOKEN_OP" } as any
    case "TEXTJOINWITH_OP": return { _tag: "TEXTJOINWITH_OP" } as any
    case "TEXTPREPEND_OP": return { _tag: "TEXTPREPEND_OP" } as any
    case "TEXTAPPEND_OP": return { _tag: "TEXTAPPEND_OP" } as any
    case "TEXTOVERLAP_OP": return { _tag: "TEXTOVERLAP_OP" } as any
    case "TEXTCOMMON_OP": return { _tag: "TEXTCOMMON_OP" } as any
    case "TEXTUNCOMMON_OP": return { _tag: "TEXTUNCOMMON_OP" } as any
    case "TEXTDIFF_OP": return { _tag: "TEXTDIFF_OP" } as any
    case "ISODD3_OP": return { _tag: "ISODD3_OP" } as any
    case "ISEVEN3_OP": return { _tag: "ISEVEN3_OP" } as any
    case "ISPOSINT_OP": return { _tag: "ISPOSINT_OP" } as any
    case "ISNEGINT_OP": return { _tag: "ISNEGINT_OP" } as any
    case "ISUNIT_OP": return { _tag: "ISUNIT_OP" } as any
    case "ISBETWEEN_OP": return { _tag: "ISBETWEEN_OP" } as any
    case "PERPAMT_OP": return { _tag: "PERPAMT_OP" } as any
    case "PERPETUITY_OP": return { _tag: "PERPETUITY_OP" } as any
    case "LEVERAGE_OP": return { _tag: "LEVERAGE_OP" } as any
    case "COVERAGE_OP": return { _tag: "COVERAGE_OP" } as any
    case "EARNINGSPS_OP": return { _tag: "EARNINGSPS_OP" } as any
    case "PRICEEARNINGS_OP": return { _tag: "PRICEEARNINGS_OP" } as any
    case "ANYOF_N": return { _tag: "ANYOF_N", n: 0 } as any
    case "NONEOF_N": return { _tag: "NONEOF_N", n: 0 } as any
    case "EXACTLYONE_N": return { _tag: "EXACTLYONE_N", n: 0 } as any
    case "ATMOSTK_N": return { _tag: "ATMOSTK_N", n: 0 } as any
    case "RUNLEN_N": return { _tag: "RUNLEN_N", n: 0 } as any
    case "STREAK_N": return { _tag: "STREAK_N", n: 0 } as any
    case "SPAN_N": return { _tag: "SPAN_N", n: 0 } as any
    case "RANDFOLD_OP": return { _tag: "RANDFOLD_OP" } as any
    case "RANDTRI_OP": return { _tag: "RANDTRI_OP" } as any
    case "FARADAY_OP": return { _tag: "FARADAY_OP" } as any
    case "BOLTZMANN_OP": return { _tag: "BOLTZMANN_OP" } as any
    case "PLANCK_OP": return { _tag: "PLANCK_OP" } as any
    case "AVOGADRO_OP": return { _tag: "AVOGADRO_OP" } as any
    case "COULOMB_OP": return { _tag: "COULOMB_OP" } as any
    case "HOOKE_OP": return { _tag: "HOOKE_OP" } as any
    case "OHMS_OP": return { _tag: "OHMS_OP" } as any
    case "WATT_OP": return { _tag: "WATT_OP" } as any
    case "KELVIN_OP": return { _tag: "KELVIN_OP" } as any
    case "CELSIUS_OP": return { _tag: "CELSIUS_OP" } as any
    case "FAHRENHEIT_OP": return { _tag: "FAHRENHEIT_OP" } as any
    case "NEWTON_OP": return { _tag: "NEWTON_OP" } as any
    case "BOOTSTRAPMEAN_N": return { _tag: "BOOTSTRAPMEAN_N", n: 0 } as any
    case "JACKKNIFE_N": return { _tag: "JACKKNIFE_N", n: 0 } as any
    case "ANDERSON_N": return { _tag: "ANDERSON_N", n: 0 } as any
    case "SHAPIRO_N": return { _tag: "SHAPIRO_N", n: 0 } as any
    case "KSTEST_N": return { _tag: "KSTEST_N", n: 0 } as any
    case "AUTOCORR_N": return { _tag: "AUTOCORR_N", n: 0 } as any
    case "CROSSCORR_N": return { _tag: "CROSSCORR_N", n: 0 } as any
    case "CONVOL_N": return { _tag: "CONVOL_N", n: 0 } as any
    case "DETREND_N": return { _tag: "DETREND_N", n: 0 } as any
    case "NORMALIZE2_N": return { _tag: "NORMALIZE2_N", n: 0 } as any
    case "TEXTROT47_OP": return { _tag: "TEXTROT47_OP" } as any
    case "TEXTATBASH_OP": return { _tag: "TEXTATBASH_OP" } as any
    case "TEXTXOR_OP": return { _tag: "TEXTXOR_OP" } as any
    case "TEXTNTH2_OP": return { _tag: "TEXTNTH2_OP" } as any
    case "TEXTUNTIL_OP": return { _tag: "TEXTUNTIL_OP" } as any
    case "TEXTAFTER2_OP": return { _tag: "TEXTAFTER2_OP" } as any
    case "TEXTWORDS_OP": return { _tag: "TEXTWORDS_OP" } as any
    case "ISPRIMEPOWER_OP": return { _tag: "ISPRIMEPOWER_OP" } as any
    case "ISDEFICIENT_OP": return { _tag: "ISDEFICIENT_OP" } as any
    case "ISABUNDANT_OP": return { _tag: "ISABUNDANT_OP" } as any
    case "ISSEMIPRIME_OP": return { _tag: "ISSEMIPRIME_OP" } as any
    case "ISSQUAREFREE_OP": return { _tag: "ISSQUAREFREE_OP" } as any
    case "ISSMOOTH_OP": return { _tag: "ISSMOOTH_OP" } as any
    case "EVTOEBITDA_OP": return { _tag: "EVTOEBITDA_OP" } as any
    case "PRICEBOOK_OP": return { _tag: "PRICEBOOK_OP" } as any
    case "PRICESALES_OP": return { _tag: "PRICESALES_OP" } as any
    case "DIVIDENDPAYOUT_OP": return { _tag: "DIVIDENDPAYOUT_OP" } as any
    case "RETENTIONRATE_OP": return { _tag: "RETENTIONRATE_OP" } as any
    case "SGROWTH_OP": return { _tag: "SGROWTH_OP" } as any
    case "RISING_OP": return { _tag: "RISING_OP" } as any
    case "FALLING_OP": return { _tag: "FALLING_OP" } as any
    case "CHANGED_OP": return { _tag: "CHANGED_OP" } as any
    case "STABLE_OP": return { _tag: "STABLE_OP" } as any
    case "SELECTIF_N": return { _tag: "SELECTIF_N", n: 0 } as any
    case "REJECTIF_N": return { _tag: "REJECTIF_N", n: 0 } as any
    case "TAKEWHILE_N": return { _tag: "TAKEWHILE_N", n: 0 } as any
    case "DROPWHILE_N": return { _tag: "DROPWHILE_N", n: 0 } as any
    case "RANDPOISSON_OP": return { _tag: "RANDPOISSON_OP" } as any
    case "DOTPROD2_OP": return { _tag: "DOTPROD2_OP" } as any
    case "CROSSPROD_OP": return { _tag: "CROSSPROD_OP" } as any
    case "MAGNITUDE2_OP": return { _tag: "MAGNITUDE2_OP" } as any
    case "ANGLE_OP": return { _tag: "ANGLE_OP" } as any
    case "MIDPOINT_OP": return { _tag: "MIDPOINT_OP" } as any
    case "INTERCEPT2_OP": return { _tag: "INTERCEPT2_OP" } as any
    case "PERPSLOPE_OP": return { _tag: "PERPSLOPE_OP" } as any
    case "ARCLENGTH_OP": return { _tag: "ARCLENGTH_OP" } as any
    case "SECTORAREA_OP": return { _tag: "SECTORAREA_OP" } as any
    case "HERON_OP": return { _tag: "HERON_OP" } as any
    case "BRAHMAGUPTA_OP": return { _tag: "BRAHMAGUPTA_OP" } as any
    case "HUBERMU_N": return { _tag: "HUBERMU_N", n: 0 } as any
    case "HAMPEL_N": return { _tag: "HAMPEL_N", n: 0 } as any
    case "TUKEYBIWEIGHT_N": return { _tag: "TUKEYBIWEIGHT_N", n: 0 } as any
    case "ANDREWSINE_N": return { _tag: "ANDREWSINE_N", n: 0 } as any
    case "L1NORM_N": return { _tag: "L1NORM_N", n: 0 } as any
    case "L2NORM_N": return { _tag: "L2NORM_N", n: 0 } as any
    case "LINFNORM_N": return { _tag: "LINFNORM_N", n: 0 } as any
    case "LPNORM_N": return { _tag: "LPNORM_N", n: 0 } as any
    case "MAHALANOBIS_N": return { _tag: "MAHALANOBIS_N", n: 0 } as any
    case "COSINESIM_N": return { _tag: "COSINESIM_N", n: 0 } as any
    case "TEXTFREQCHAR_OP": return { _tag: "TEXTFREQCHAR_OP" } as any
    case "TEXTUNIQCHARS_OP": return { _tag: "TEXTUNIQCHARS_OP" } as any
    case "TEXTCHARCOUNT_OP": return { _tag: "TEXTCHARCOUNT_OP" } as any
    case "TEXTPOSITION_OP": return { _tag: "TEXTPOSITION_OP" } as any
    case "TEXTOCCURRENCES_OP": return { _tag: "TEXTOCCURRENCES_OP" } as any
    case "TEXTSTARTSWITH2_OP": return { _tag: "TEXTSTARTSWITH2_OP" } as any
    case "TEXTENDSWITH2_OP": return { _tag: "TEXTENDSWITH2_OP" } as any
    case "TEXTINCLUDES_OP": return { _tag: "TEXTINCLUDES_OP" } as any
    case "ISAMICABLE_OP": return { _tag: "ISAMICABLE_OP" } as any
    case "ISAUTOMORPHIC_OP": return { _tag: "ISAUTOMORPHIC_OP" } as any
    case "ISKAPREKAR_OP": return { _tag: "ISKAPREKAR_OP" } as any
    case "ISNARCISSISTIC_OP": return { _tag: "ISNARCISSISTIC_OP" } as any
    case "ISSMITH_OP": return { _tag: "ISSMITH_OP" } as any
    case "ISPROTH_OP": return { _tag: "ISPROTH_OP" } as any
    case "WACC2_OP": return { _tag: "WACC2_OP" } as any
    case "CAPM_OP": return { _tag: "CAPM_OP" } as any
    case "GORDONMODEL_OP": return { _tag: "GORDONMODEL_OP" } as any
    case "DDM_OP": return { _tag: "DDM_OP" } as any
    case "MVADDED_OP": return { _tag: "MVADDED_OP" } as any
    case "ECONVALUE_OP": return { _tag: "ECONVALUE_OP" } as any
    case "ALLGT_N": return { _tag: "ALLGT_N", n: 0 } as any
    case "ALLLT_N": return { _tag: "ALLLT_N", n: 0 } as any
    case "ALLEQ_N": return { _tag: "ALLEQ_N", n: 0 } as any
    case "COUNTRUE_N": return { _tag: "COUNTRUE_N", n: 0 } as any
    case "RANKPCT_N": return { _tag: "RANKPCT_N", n: 0 } as any
    case "QUANTILE2_N": return { _tag: "QUANTILE2_N", n: 0 } as any
    case "MEDIAN2_N": return { _tag: "MEDIAN2_N", n: 0 } as any
    case "RANDWEIBULL_OP": return { _tag: "RANDWEIBULL_OP" } as any
    case "RANDPARETO_OP": return { _tag: "RANDPARETO_OP" } as any
    case "STIRLING1_OP": return { _tag: "STIRLING1_OP" } as any
    case "STIRLING2_OP": return { _tag: "STIRLING2_OP" } as any
    case "CATALAN2_OP": return { _tag: "CATALAN2_OP" } as any
    case "PARTITION_OP": return { _tag: "PARTITION_OP" } as any
    case "SUBFACTORIAL_OP": return { _tag: "SUBFACTORIAL_OP" } as any
    case "DOUBLEFALLINGFACT_OP": return { _tag: "DOUBLEFALLINGFACT_OP" } as any
    case "RISINGFACT_OP": return { _tag: "RISINGFACT_OP" } as any
    case "MULTINOMIAL2_OP": return { _tag: "MULTINOMIAL2_OP" } as any
    case "TRIBONACCI_OP": return { _tag: "TRIBONACCI_OP" } as any
    case "KLDIVERGE_N": return { _tag: "KLDIVERGE_N", n: 0 } as any
    case "JSDIVERGE_N": return { _tag: "JSDIVERGE_N", n: 0 } as any
    case "THEIL_N": return { _tag: "THEIL_N", n: 0 } as any
    case "ATKINSON_N": return { _tag: "ATKINSON_N", n: 0 } as any
    case "PALMA_N": return { _tag: "PALMA_N", n: 0 } as any
    case "HOOVER_N": return { _tag: "HOOVER_N", n: 0 } as any
    case "TEXTPHONETIC_OP": return { _tag: "TEXTPHONETIC_OP" } as any
    case "TEXTSNAKE_OP": return { _tag: "TEXTSNAKE_OP" } as any
    case "TEXTKEBAB_OP": return { _tag: "TEXTKEBAB_OP" } as any
    case "TEXTPASCAL_OP": return { _tag: "TEXTPASCAL_OP" } as any
    case "TEXTCONSTANT_OP": return { _tag: "TEXTCONSTANT_OP" } as any
    case "ISPERFECTSQ_OP": return { _tag: "ISPERFECTSQ_OP" } as any
    case "ISPERFECTCUBE_OP": return { _tag: "ISPERFECTCUBE_OP" } as any
    case "ISPOWER2_OP": return { _tag: "ISPOWER2_OP" } as any
    case "ISHARMON_OP": return { _tag: "ISHARMON_OP" } as any
    case "ISSOPHIE_OP": return { _tag: "ISSOPHIE_OP" } as any
    case "ISSAFE_OP": return { _tag: "ISSAFE_OP" } as any
    case "JENSEN_OP": return { _tag: "JENSEN_OP" } as any
    case "INFORATE_OP": return { _tag: "INFORATE_OP" } as any
    case "MODEVALUE_N": return { _tag: "MODEVALUE_N", n: 0 } as any
    case "RANDGUMBEL_OP": return { _tag: "RANDGUMBEL_OP" } as any
    case "RANDFRECHET_OP": return { _tag: "RANDFRECHET_OP" } as any
    case "LUCAS2_OP": return { _tag: "LUCAS2_OP" } as any
    case "PELL_OP": return { _tag: "PELL_OP" } as any
    case "JACOBSTHAL_OP": return { _tag: "JACOBSTHAL_OP" } as any
    case "PRONIC_OP": return { _tag: "PRONIC_OP" } as any
    case "OBLONG_OP": return { _tag: "OBLONG_OP" } as any
    case "CENTERED_OP": return { _tag: "CENTERED_OP" } as any
    case "HEXAGONAL2_OP": return { _tag: "HEXAGONAL2_OP" } as any
    case "HEPTAGONAL_OP": return { _tag: "HEPTAGONAL_OP" } as any
    case "OCTAGONAL_OP": return { _tag: "OCTAGONAL_OP" } as any
    case "STAR_OP": return { _tag: "STAR_OP" } as any
    case "CENTERED2_OP": return { _tag: "CENTERED2_OP" } as any
    case "CAKE_OP": return { _tag: "CAKE_OP" } as any
    case "LAZY_OP": return { _tag: "LAZY_OP" } as any
    case "NARAYANA_OP": return { _tag: "NARAYANA_OP" } as any
    case "EULERIAN_OP": return { _tag: "EULERIAN_OP" } as any
    case "TEXTTITLECASE_OP": return { _tag: "TEXTTITLECASE_OP" } as any
    case "TEXTDIGITSUM_OP": return { _tag: "TEXTDIGITSUM_OP" } as any
    case "DECAGONAL_OP": return { _tag: "DECAGONAL_OP" } as any
    case "DODECAGONAL_OP": return { _tag: "DODECAGONAL_OP" } as any
    case "ICOSAHEDRAL_OP": return { _tag: "ICOSAHEDRAL_OP" } as any
    case "TAYLORSIN_OP": return { _tag: "TAYLORSIN_OP" } as any
    case "TAYLORCOS_OP": return { _tag: "TAYLORCOS_OP" } as any
    case "TAYLOREXP_OP": return { _tag: "TAYLOREXP_OP" } as any
    case "NEWTONMETHOD_OP": return { _tag: "NEWTONMETHOD_OP" } as any
    case "BISECT_OP": return { _tag: "BISECT_OP" } as any
    case "TRAPEZOID_OP": return { _tag: "TRAPEZOID_OP" } as any
    case "SIMPSON_OP": return { _tag: "SIMPSON_OP" } as any
    case "ROMBERG_OP": return { _tag: "ROMBERG_OP" } as any
    case "EULERAPPROX_OP": return { _tag: "EULERAPPROX_OP" } as any
    case "GOLDENSECTION_OP": return { _tag: "GOLDENSECTION_OP" } as any
    case "REGULAFALSI_OP": return { _tag: "REGULAFALSI_OP" } as any
    case "SECANTMETHOD_OP": return { _tag: "SECANTMETHOD_OP" } as any
    case "ARIMA_N": return { _tag: "ARIMA_N", n: 0 } as any
    case "HOLT_N": return { _tag: "HOLT_N", n: 0 } as any
    case "WINTERS_N": return { _tag: "WINTERS_N", n: 0 } as any
    case "EXPSMOOTH_N": return { _tag: "EXPSMOOTH_N", n: 0 } as any
    case "DOUBLEEXP_N": return { _tag: "DOUBLEEXP_N", n: 0 } as any
    case "SEASONAVG_N": return { _tag: "SEASONAVG_N", n: 0 } as any
    case "MOVMEDIAN_N": return { _tag: "MOVMEDIAN_N", n: 0 } as any
    case "MOVSTDEV_N": return { _tag: "MOVSTDEV_N", n: 0 } as any
    case "MOVVAR_N": return { _tag: "MOVVAR_N", n: 0 } as any
    case "MOVRANGE_N": return { _tag: "MOVRANGE_N", n: 0 } as any
    case "TEXTCRC32_OP": return { _tag: "TEXTCRC32_OP" } as any
    case "TEXTSOUNDEX_OP": return { _tag: "TEXTSOUNDEX_OP" } as any
    case "TEXTMETAPHONE_OP": return { _tag: "TEXTMETAPHONE_OP" } as any
    case "TEXTALPHANUM_OP": return { _tag: "TEXTALPHANUM_OP" } as any
    case "TEXTZALGO2_OP": return { _tag: "TEXTZALGO2_OP" } as any
    case "TEXTUNICODE_OP": return { _tag: "TEXTUNICODE_OP" } as any
    case "TEXTFROMUNI_OP": return { _tag: "TEXTFROMUNI_OP" } as any
    case "TEXTBIN_OP": return { _tag: "TEXTBIN_OP" } as any
    case "ISPRACTICAL_OP": return { _tag: "ISPRACTICAL_OP" } as any
    case "ISREGULAR_OP": return { _tag: "ISREGULAR_OP" } as any
    case "ISSUPERABUNDANT_OP": return { _tag: "ISSUPERABUNDANT_OP" } as any
    case "ISHAPPY2_OP": return { _tag: "ISHAPPY2_OP" } as any
    case "ISSAD_OP": return { _tag: "ISSAD_OP" } as any
    case "ISNICE_OP": return { _tag: "ISNICE_OP" } as any
    case "MODIGLIANI_OP": return { _tag: "MODIGLIANI_OP" } as any
    case "OMEGA_OP": return { _tag: "OMEGA_OP" } as any
    case "KAPPA_OP": return { _tag: "KAPPA_OP" } as any
    case "RACHEV_OP": return { _tag: "RACHEV_OP" } as any
    case "BURKE_OP": return { _tag: "BURKE_OP" } as any
    case "MAJORITY3_N": return { _tag: "MAJORITY3_N", n: 0 } as any
    case "CONSENSUS2_N": return { _tag: "CONSENSUS2_N", n: 0 } as any
    case "THRESHOLD2_N": return { _tag: "THRESHOLD2_N", n: 0 } as any
    case "QUORUM2_N": return { _tag: "QUORUM2_N", n: 0 } as any
    case "WEIGHTEDRANK_N": return { _tag: "WEIGHTEDRANK_N", n: 0 } as any
    case "CDF_N": return { _tag: "CDF_N", n: 0 } as any
    case "ECDF_N": return { _tag: "ECDF_N", n: 0 } as any
    case "RANDCHI2_OP": return { _tag: "RANDCHI2_OP" } as any
    case "RANDF_OP": return { _tag: "RANDF_OP" } as any
...
const N_VARIANTS: Record<string, string> = {
  ...
  BINSEARCH_N: "BINSEARCH_N", INDEXMATCH_N: "INDEXMATCH_N", LASTINDEXOF_N: "LASTINDEXOF_N", FINDALL_N: "FINDALL_N", COUNTUNIQ_N: "COUNTUNIQ_N", ARRAYCONTAINS_N: "ARRAYCONTAINS_N", ARRAYPOS_N: "ARRAYPOS_N", FLATTEN2_N: "FLATTEN2_N", SWITCH2_N: "SWITCH2_N", XORALL_N: "XORALL_N", NANDALL_N: "NANDALL_N", NORALL_N: "NORALL_N", COALESCE2_N: "COALESCE2_N", MAD2_N: "MAD2_N", SEM_N: "SEM_N", POOLEDVAR_N: "POOLEDVAR_N", DISTINCT_N: "DISTINCT_N", ARRAYSLICE_N: "ARRAYSLICE_N", ARRAYJOIN_N: "ARRAYJOIN_N", ARRAYREVERSE_N: "ARRAYREVERSE_N", ARRAYFLATTEN_N: "ARRAYFLATTEN_N", ARRAYZIP_N: "ARRAYZIP_N", ARRAYMIN_N: "ARRAYMIN_N", ARRAYMAX_N: "ARRAYMAX_N", ARRAYSUM_N: "ARRAYSUM_N", ARRAYAVG_N: "ARRAYAVG_N", COND_N: "COND_N", ALLEQUAL_N: "ALLEQUAL_N", ANYGT_N: "ANYGT_N", ANYLT_N: "ANYLT_N", ANYNE_N: "ANYNE_N", ISALL_N: "ISALL_N", ISANY_N: "ISANY_N", ISNONE_N: "ISNONE_N", ENTROPY2_N: "ENTROPY2_N", GINICOEF_N: "GINICOEF_N", MOMENT_N: "MOMENT_N", CMOMENT_N: "CMOMENT_N", ZSCORE3_N: "ZSCORE3_N", PERCENTILE2_N: "PERCENTILE2_N", ONEOF_N: "ONEOF_N", FIRSTTRUTHY_N: "FIRSTTRUTHY_N", LASTTRUTHY_N: "LASTTRUTHY_N", COUNTIF3_N: "COUNTIF3_N", WHICHMAX_N: "WHICHMAX_N", WHICHMIN_N: "WHICHMIN_N", RANDPERM_N: "RANDPERM_N", RANDCHOICE_N: "RANDCHOICE_N", ENUMERATE_N: "ENUMERATE_N", COUNTVALS_N: "COUNTVALS_N", FIRSTNONZERO_N: "FIRSTNONZERO_N", LASTNONZERO_N: "LASTNONZERO_N", NTHLARGEST_N: "NTHLARGEST_N", MAXDD_N: "MAXDD_N", TRIMMEDMEAN_N: "TRIMMEDMEAN_N", WINSOREDMEAN_N: "WINSOREDMEAN_N", MIDRANGE_N: "MIDRANGE_N", MIDHINGE_N: "MIDHINGE_N", MEANDEV_N: "MEANDEV_N", ROOTMEANSQERR_N: "ROOTMEANSQERR_N", MUXSEL_N: "MUXSEL_N", DEMUX_N: "DEMUX_N", NTHSMALLEST_N: "NTHSMALLEST_N", ARGMAX_N: "ARGMAX_N", ARGMIN_N: "ARGMIN_N", DEDUP_N: "DEDUP_N", INTERLEAVE_N: "INTERLEAVE_N", QUADMEAN_N: "QUADMEAN_N", POWMEAN_N: "POWMEAN_N", LEHMER_N: "LEHMER_N", ENTROPY3_N: "ENTROPY3_N", RELENTROPY_N: "RELENTROPY_N", MUTUALINFO_N: "MUTUALINFO_N", CROSSENTROPY_N: "CROSSENTROPY_N", CONTRAHARMONIC_N: "CONTRAHARMONIC_N", HERONIAN_N: "HERONIAN_N", LOGTRANSFORM_N: "LOGTRANSFORM_N", ZSCORENORM_N: "ZSCORENORM_N", MAD3_N: "MAD3_N", BIWEIGHT_N: "BIWEIGHT_N", HUBER_N: "HUBER_N", WINVAR_N: "WINVAR_N", MAJORITY2_N: "MAJORITY2_N", UNANIMOUS_N: "UNANIMOUS_N", QUORUM_N: "QUORUM_N", VETO_N: "VETO_N", PRIORITYSEL_N: "PRIORITYSEL_N", FALLBACK_N: "FALLBACK_N", RANK2_N: "RANK2_N", DENSERANK_N: "DENSERANK_N", NTILE_N: "NTILE_N", ROWNUMBER_N: "ROWNUMBER_N", RANDWEIGHTED_N: "RANDWEIGHTED_N", RANDSAMPLE_N: "RANDSAMPLE_N", SAMPLEVAR_N: "SAMPLEVAR_N", POPVAR_N: "POPVAR_N", SAMPLESTD_N: "SAMPLESTD_N", POPSTD_N: "POPSTD_N", RANGESTAT_N: "RANGESTAT_N", SUMPRODUCT2_N: "SUMPRODUCT2_N", SUMSQDIFF_N: "SUMSQDIFF_N", AVGDEV2_N: "AVGDEV2_N", RMSVAL_N: "RMSVAL_N", GEOSTD_N: "GEOSTD_N", BINCOUNT_N: "BINCOUNT_N", HISTOGRAM_N: "HISTOGRAM_N", MODECOUNT_N: "MODECOUNT_N", WELCH_N: "WELCH_N", HAMMING_N: "HAMMING_N", HANNING_N: "HANNING_N", BLACKMAN_N: "BLACKMAN_N", KAISER_N: "KAISER_N", TUKEYWIN_N: "TUKEYWIN_N", GINIIMPURITY_N: "GINIIMPURITY_N", INFOGAIN_N: "INFOGAIN_N", CONSENSUS_N: "CONSENSUS_N", BSEARCH2_N: "BSEARCH2_N", UNIQUE2_N: "UNIQUE2_N", COUNTDIST_N: "COUNTDIST_N", TOPK_N: "TOPK_N", BOTTOMK_N: "BOTTOMK_N", EWMA_N: "EWMA_N", CUMMAX_N: "CUMMAX_N", CUMMIN_N: "CUMMIN_N", CUMSUM2_N: "CUMSUM2_N", CUMPROD2_N: "CUMPROD2_N", DIFFLAG_N: "DIFFLAG_N", PCTCHANGE_N: "PCTCHANGE_N", ROLLMAX_N: "ROLLMAX_N", ROLLMIN_N: "ROLLMIN_N", ROLLAVG_N: "ROLLAVG_N", ZIPWITH_N: "ZIPWITH_N", REDUCE2_N: "REDUCE2_N", TMEAN_N: "TMEAN_N", IQR2_N: "IQR2_N", Q1_N: "Q1_N", Q3_N: "Q3_N", DECILE_N: "DECILE_N", OUTLIER_N: "OUTLIER_N", PEAK_N: "PEAK_N", TROUGH_N: "TROUGH_N", PLATEAU_N: "PLATEAU_N", ANYOF_N: "ANYOF_N", NONEOF_N: "NONEOF_N", EXACTLYONE_N: "EXACTLYONE_N", ATMOSTK_N: "ATMOSTK_N", RUNLEN_N: "RUNLEN_N", STREAK_N: "STREAK_N", SPAN_N: "SPAN_N", BOOTSTRAPMEAN_N: "BOOTSTRAPMEAN_N", JACKKNIFE_N: "JACKKNIFE_N", ANDERSON_N: "ANDERSON_N", SHAPIRO_N: "SHAPIRO_N", KSTEST_N: "KSTEST_N", AUTOCORR_N: "AUTOCORR_N", CROSSCORR_N: "CROSSCORR_N", CONVOL_N: "CONVOL_N", DETREND_N: "DETREND_N", NORMALIZE2_N: "NORMALIZE2_N", SELECTIF_N: "SELECTIF_N", REJECTIF_N: "REJECTIF_N", TAKEWHILE_N: "TAKEWHILE_N", DROPWHILE_N: "DROPWHILE_N", HUBERMU_N: "HUBERMU_N", HAMPEL_N: "HAMPEL_N", TUKEYBIWEIGHT_N: "TUKEYBIWEIGHT_N", ANDREWSINE_N: "ANDREWSINE_N", L1NORM_N: "L1NORM_N", L2NORM_N: "L2NORM_N", LINFNORM_N: "LINFNORM_N", LPNORM_N: "LPNORM_N", MAHALANOBIS_N: "MAHALANOBIS_N", COSINESIM_N: "COSINESIM_N", ALLGT_N: "ALLGT_N", ALLLT_N: "ALLLT_N", ALLEQ_N: "ALLEQ_N", COUNTRUE_N: "COUNTRUE_N", RANKPCT_N: "RANKPCT_N", QUANTILE2_N: "QUANTILE2_N", MEDIAN2_N: "MEDIAN2_N", KLDIVERGE_N: "KLDIVERGE_N", JSDIVERGE_N: "JSDIVERGE_N", THEIL_N: "THEIL_N", ATKINSON_N: "ATKINSON_N", PALMA_N: "PALMA_N", HOOVER_N: "HOOVER_N", MODEVALUE_N: "MODEVALUE_N",
}
...
export const FUNCTION_CATALOG: ReadonlyArray<FunctionSignature> = [
  ...
  // ── honest-1000 batch CATALOG ──
  { name: "RIEMANN", description: "RIEMANN function", category: "math", args: "1" },
  { name: "LOGISTIC2", description: "LOGISTIC2 function", category: "math", args: "1" },
  { name: "SOFTMAX2", description: "SOFTMAX2 function", category: "math", args: "1" },
  { name: "LEAKYRELU", description: "LEAKYRELU function", category: "math", args: "2" },
  { name: "SWISH", description: "SWISH function", category: "math", args: "1" },
  { name: "GELU", description: "GELU function", category: "math", args: "1" },
  { name: "MISH", description: "MISH function", category: "math", args: "1" },
  { name: "INVERSESQRT", description: "INVERSESQRT function", category: "math", args: "1" },
  { name: "SAMPLEVAR", description: "SAMPLEVAR function", category: "stat", args: "variadic" },
  { name: "POPVAR", description: "POPVAR function", category: "stat", args: "variadic" },
  { name: "SAMPLESTD", description: "SAMPLESTD function", category: "stat", args: "variadic" },
  { name: "POPSTD", description: "POPSTD function", category: "stat", args: "variadic" },
  { name: "RANGESTAT", description: "RANGESTAT function", category: "stat", args: "variadic" },
  { name: "SUMPRODUCT2", description: "SUMPRODUCT2 function", category: "stat", args: "variadic" },
  { name: "SUMSQDIFF", description: "SUMSQDIFF function", category: "stat", args: "variadic" },
  { name: "AVGDEV2", description: "AVGDEV2 function", category: "stat", args: "variadic" },
  { name: "RMSVAL", description: "RMSVAL function", category: "stat", args: "variadic" },
  { name: "GEOSTD", description: "GEOSTD function", category: "stat", args: "variadic" },
  { name: "TEXTZIP", description: "TEXTZIP function", category: "text", args: "2" },
  { name: "TEXTREPEATN", description: "TEXTREPEATN function", category: "text", args: "2" },
  { name: "TEXTISALPHA", description: "TEXTISALPHA function", category: "text", args: "1" },
  { name: "TEXTISDIGIT", description: "TEXTISDIGIT function", category: "text", args: "1" },
  { name: "TEXTISALNUM", description: "TEXTISALNUM function", category: "text", args: "1" },
  { name: "TEXTISSPACE", description: "TEXTISSPACE function", category: "text", args: "1" },
  { name: "TEXTTITLE2", description: "TEXTTITLE2 function", category: "text", args: "1" },
  { name: "TEXTSWAP", description: "TEXTSWAP function", category: "text", args: "1" },
  { name: "ISINTEGER2", description: "ISINTEGER2 function", category: "info", args: "1" },
  { name: "ISNAT", description: "ISNAT function", category: "info", args: "1" },
  { name: "PARITY", description: "PARITY function", category: "info", args: "1" },
  { name: "ANNUALRATE", description: "ANNUALRATE function", category: "financial", args: "2" },
  { name: "EFFECTIVERATE", description: "EFFECTIVERATE function", category: "financial", args: "2" },
  { name: "NOMINALRATE", description: "NOMINALRATE function", category: "financial", args: "2" },
  { name: "FUTUREVALUE", description: "FUTUREVALUE function", category: "financial", args: "3" },
  { name: "PRESVALUE", description: "PRESVALUE function", category: "financial", args: "3" },
  { name: "ANNUITYDUE", description: "ANNUITYDUE function", category: "financial", args: "3" },
  { name: "SINKINGFUND", description: "SINKINGFUND function", category: "financial", args: "3" },
  { name: "IMPLIESSTRICT", description: "IMPLIESSTRICT function", category: "logic", args: "2" },
  { name: "XNOR2", description: "XNOR2 function", category: "logic", args: "2" },
  { name: "HALFADD", description: "HALFADD function", category: "logic", args: "2" },
  { name: "FULLADD", description: "FULLADD function", category: "logic", args: "3" },
  { name: "COMPARE3", description: "COMPARE3 function", category: "logic", args: "2" },
  { name: "BETWEEN2", description: "BETWEEN2 function", category: "logic", args: "3" },
  { name: "BINCOUNT", description: "BINCOUNT function", category: "lookup", args: "variadic" },
  { name: "HISTOGRAM", description: "HISTOGRAM function", category: "lookup", args: "variadic" },
  { name: "MODECOUNT", description: "MODECOUNT function", category: "lookup", args: "variadic" },
  { name: "RANDLAPLACE", description: "RANDLAPLACE function", category: "volatile", args: "1" },
  { name: "RANDLOGISTIC", description: "RANDLOGISTIC function", category: "volatile", args: "1" },
  // ── final-12 CATALOG ──
  { name: "SELU", description: "SELU function", category: "math", args: "1" },
  { name: "HARDSWISH", description: "HARDSWISH function", category: "math", args: "1" },
  { name: "HARDSIGM", description: "HARDSIGM function", category: "math", args: "1" },
  { name: "CLIPVAL", description: "CLIPVAL function", category: "math", args: "3" },
  { name: "LINSTEP", description: "LINSTEP function", category: "math", args: "3" },
  { name: "CUBICINTERP", description: "CUBICINTERP function", category: "math", args: "3" },
  { name: "LETTERCOUNT", description: "LETTERCOUNT function", category: "info", args: "1" },
  // ── final-5 CATALOG ──
  { name: "PRELU", description: "PRELU activation function", category: "math", args: "2" },
  { name: "CELU", description: "CELU activation function", category: "math", args: "2" },
  { name: "SOFTSIGN", description: "SOFTSIGN activation function", category: "math", args: "1" },
  { name: "BENTID", description: "BENTID activation function", category: "math", args: "1" },
  { name: "SQUAREPLUS", description: "SQUAREPLUS activation function", category: "math", args: "1" },
  // ── 1050 batch CATALOG ──
  { name: "ARCTANH2", description: "ARCTANH2 function", category: "math", args: "1" },
  { name: "ARCCOTH", description: "ARCCOTH function", category: "math", args: "1" },
  { name: "SIGMOID2", description: "SIGMOID2 function", category: "math", args: "2" },
  { name: "GAUSSIAN2", description: "GAUSSIAN2 function", category: "math", args: "1" },
  { name: "RAMP", description: "RAMP function", category: "math", args: "1" },
  { name: "HEAVISIDE", description: "HEAVISIDE function", category: "math", args: "1" },
  { name: "BOXCAR", description: "BOXCAR function", category: "math", args: "3" },
  { name: "TRIANGLE2", description: "TRIANGLE2 function", category: "math", args: "1" },
  { name: "SAWTOOTH2", description: "SAWTOOTH2 function", category: "math", args: "1" },
  { name: "WELCH", description: "WELCH function", category: "stat", args: "variadic" },
  { name: "HAMMING", description: "HAMMING function", category: "stat", args: "variadic" },
  { name: "HANNING", description: "HANNING function", category: "stat", args: "variadic" },
  { name: "BLACKMAN", description: "BLACKMAN function", category: "stat", args: "variadic" },
  { name: "KAISER", description: "KAISER function", category: "stat", args: "variadic" },
  { name: "TUKEYWIN", description: "TUKEYWIN function", category: "stat", args: "variadic" },
  { name: "GINIIMPURITY", description: "GINIIMPURITY function", category: "stat", args: "variadic" },
  { name: "INFOGAIN", description: "INFOGAIN function", category: "stat", args: "variadic" },
  { name: "TEXTWRAP2", description: "TEXTWRAP2 function", category: "text", args: "2" },
  { name: "TEXTPADCENTER", description: "TEXTPADCENTER function", category: "text", args: "2" },
  { name: "TEXTDELIMIT", description: "TEXTDELIMIT function", category: "text", args: "2" },
  { name: "TEXTENCLOSE", description: "TEXTENCLOSE function", category: "text", args: "2" },
  { name: "TEXTSURROUND", description: "TEXTSURROUND function", category: "text", args: "2" },
  { name: "TEXTCHOP", description: "TEXTCHOP function", category: "text", args: "2" },
  { name: "TEXTELLIPSIS", description: "TEXTELLIPSIS function", category: "text", args: "2" },
  { name: "TEXTCENSOR", description: "TEXTCENSOR function", category: "text", args: "2" },
  { name: "ISCUBE", description: "ISCUBE function", category: "info", args: "1" },
  { name: "ISCOPRIME", description: "ISCOPRIME function", category: "info", args: "2" },
  { name: "ISTRIANGULAR", description: "ISTRIANGULAR function", category: "info", args: "1" },
  { name: "ISPENTAGONAL", description: "ISPENTAGONAL function", category: "info", args: "1" },
  { name: "ISHEXAGONAL", description: "ISHEXAGONAL function", category: "info", args: "1" },
  { name: "COMPOUND2", description: "COMPOUND2 function", category: "financial", args: "3" },
  { name: "RULE72", description: "RULE72 function", category: "financial", args: "1" },
  { name: "RULE70", description: "RULE70 function", category: "financial", args: "1" },
  { name: "MARKUPRATE", description: "MARKUPRATE function", category: "financial", args: "2" },
  { name: "MARGINRATE", description: "MARGINRATE function", category: "financial", args: "2" },
  { name: "NOR2", description: "NOR2 function", category: "logic", args: "2" },
  { name: "NAND2", description: "NAND2 function", category: "logic", args: "2" },
  { name: "EQUIV2", description: "EQUIV2 function", category: "logic", args: "2" },
  { name: "PEIRCE", description: "PEIRCE function", category: "logic", args: "2" },
  { name: "SHEFFER", description: "SHEFFER function", category: "logic", args: "2" },
  { name: "CONSENSUS", description: "CONSENSUS function", category: "logic", args: "variadic" },
  { name: "BSEARCH2", description: "BSEARCH2 function", category: "lookup", args: "variadic" },
  { name: "UNIQUE2", description: "UNIQUE2 function", category: "lookup", args: "variadic" },
  { name: "COUNTDIST", description: "COUNTDIST function", category: "lookup", args: "variadic" },
  { name: "TOPK", description: "TOPK function", category: "lookup", args: "variadic" },
  { name: "BOTTOMK", description: "BOTTOMK function", category: "lookup", args: "variadic" },
  { name: "RANDCAUCHY", description: "RANDCAUCHY function", category: "volatile", args: "1" },
  // ── 1100 batch CATALOG ──
  { name: "RECIP", description: "RECIP function", category: "math", args: "1" },
  { name: "SQRDIFF", description: "SQRDIFF function", category: "math", args: "2" },
  { name: "HYPERBOLIC", description: "HYPERBOLIC function", category: "math", args: "1" },
  { name: "SINCOS", description: "SINCOS function", category: "math", args: "1" },
  { name: "EXPM1ALT", description: "EXPM1ALT function", category: "math", args: "1" },
  { name: "LOG1PALT", description: "LOG1PALT function", category: "math", args: "1" },
  { name: "CBRT2", description: "CBRT2 function", category: "math", args: "1" },
  { name: "NTHPOWER", description: "NTHPOWER function", category: "math", args: "2" },
  { name: "DIVSAFE", description: "DIVSAFE function", category: "math", args: "2" },
  { name: "MODSAFE", description: "MODSAFE function", category: "math", args: "2" },
  { name: "NEGONE", description: "NEGONE function", category: "math", args: "1" },
  { name: "FRAC2", description: "FRAC2 function", category: "math", args: "1" },
  { name: "WHOLEFRAC", description: "WHOLEFRAC function", category: "math", args: "1" },
  { name: "ROUNDN", description: "ROUNDN function", category: "math", args: "2" },
  { name: "EWMA", description: "EWMA function", category: "stat", args: "variadic" },
  { name: "CUMMAX", description: "CUMMAX function", category: "stat", args: "variadic" },
  { name: "CUMMIN", description: "CUMMIN function", category: "stat", args: "variadic" },
  { name: "CUMSUM2", description: "CUMSUM2 function", category: "stat", args: "variadic" },
  { name: "CUMPROD2", description: "CUMPROD2 function", category: "stat", args: "variadic" },
  { name: "DIFFLAG", description: "DIFFLAG function", category: "stat", args: "variadic" },
  { name: "PCTCHANGE", description: "PCTCHANGE function", category: "stat", args: "variadic" },
  { name: "ROLLMAX", description: "ROLLMAX function", category: "stat", args: "variadic" },
  { name: "ROLLMIN", description: "ROLLMIN function", category: "stat", args: "variadic" },
  { name: "ROLLAVG", description: "ROLLAVG function", category: "stat", args: "variadic" },
  { name: "TEXTSHRINK", description: "TEXTSHRINK function", category: "text", args: "2" },
  { name: "TEXTEXPAND", description: "TEXTEXPAND function", category: "text", args: "2" },
  { name: "TEXTORDINAL", description: "TEXTORDINAL function", category: "text", args: "1" },
  { name: "TEXTPLURAL", description: "TEXTPLURAL function", category: "text", args: "2" },
  { name: "TEXTSINGULAR", description: "TEXTSINGULAR function", category: "text", args: "1" },
  { name: "TEXTCAPS", description: "TEXTCAPS function", category: "text", args: "1" },
  { name: "TEXTNOCAPS", description: "TEXTNOCAPS function", category: "text", args: "1" },
  { name: "TEXTFIRST", description: "TEXTFIRST function", category: "text", args: "2" },
  { name: "TEXTLAST", description: "TEXTLAST function", category: "text", args: "2" },
  { name: "TEXTMID", description: "TEXTMID function", category: "text", args: "3" },
  { name: "ISARRAY", description: "ISARRAY function", category: "info", args: "1" },
  { name: "ISSCALAR", description: "ISSCALAR function", category: "info", args: "1" },
  { name: "BITWIDTH", description: "BITWIDTH function", category: "info", args: "1" },
  { name: "BYTECOUNT", description: "BYTECOUNT function", category: "info", args: "1" },
  { name: "NUMCLASS", description: "NUMCLASS function", category: "info", args: "1" },
  { name: "HEXVAL", description: "HEXVAL function", category: "info", args: "1" },
  { name: "EBITDA", description: "EBITDA function", category: "financial", args: "3" },
  { name: "GROSSPROFIT", description: "GROSSPROFIT function", category: "financial", args: "2" },
  { name: "NETINCOME", description: "NETINCOME function", category: "financial", args: "2" },
  { name: "ASSETRATIO", description: "ASSETRATIO function", category: "financial", args: "2" },
  { name: "DEBTRATIO", description: "DEBTRATIO function", category: "financial", args: "2" },
  { name: "QUICKRATIO", description: "QUICKRATIO function", category: "financial", args: "2" },
  { name: "CLAMPBOOL", description: "CLAMPBOOL function", category: "logic", args: "1" },
  { name: "BOOLFLIP", description: "BOOLFLIP function", category: "logic", args: "1" },
  { name: "TERNARY", description: "TERNARY function", category: "logic", args: "3" },
  { name: "NULLCOAL", description: "NULLCOAL function", category: "logic", args: "2" },
  { name: "ZIPWITH", description: "ZIPWITH function", category: "lookup", args: "variadic" },
  { name: "REDUCE2", description: "REDUCE2 function", category: "lookup", args: "variadic" },
  // ── 1150 batch CATALOG ──
  { name: "WRAP2", description: "WRAP2 function", category: "math", args: "3" },
  { name: "PINGPONG", description: "PINGPONG function", category: "math", args: "2" },
  { name: "FMULT", description: "FMULT function", category: "math", args: "2" },
  { name: "FDIV", description: "FDIV function", category: "math", args: "2" },
  { name: "LOGBASE", description: "LOGBASE function", category: "math", args: "2" },
  { name: "RSQRT", description: "RSQRT function", category: "math", args: "1" },
  { name: "SIGN2", description: "SIGN2 function", category: "math", args: "1" },
  { name: "TRUNC2", description: "TRUNC2 function", category: "math", args: "1" },
  { name: "ROUNDHALF", description: "ROUNDHALF function", category: "math", args: "1" },
  { name: "CEIL2", description: "CEIL2 function", category: "math", args: "1" },
  { name: "FLOOR2", description: "FLOOR2 function", category: "math", args: "1" },
  { name: "SNAP", description: "SNAP function", category: "math", args: "2" },
  { name: "TMEAN", description: "TMEAN function", category: "stat", args: "variadic" },
  { name: "IQR2", description: "IQR2 function", category: "stat", args: "variadic" },
  { name: "Q1", description: "Q1 function", category: "stat", args: "variadic" },
  { name: "Q3", description: "Q3 function", category: "stat", args: "variadic" },
  { name: "DECILE", description: "DECILE function", category: "stat", args: "variadic" },
  { name: "OUTLIER", description: "OUTLIER function", category: "stat", args: "variadic" },
  { name: "PEAK", description: "PEAK function", category: "stat", args: "variadic" },
  { name: "TROUGH", description: "TROUGH function", category: "stat", args: "variadic" },
  { name: "PLATEAU", description: "PLATEAU function", category: "stat", args: "variadic" },
  { name: "TEXTTOKEN", description: "TEXTTOKEN function", category: "text", args: "2" },
  { name: "TEXTJOINWITH", description: "TEXTJOINWITH function", category: "text", args: "2" },
  { name: "TEXTPREPEND", description: "TEXTPREPEND function", category: "text", args: "2" },
  { name: "TEXTAPPEND", description: "TEXTAPPEND function", category: "text", args: "2" },
  { name: "TEXTOVERLAP", description: "TEXTOVERLAP function", category: "text", args: "2" },
  { name: "TEXTCOMMON", description: "TEXTCOMMON function", category: "text", args: "2" },
  { name: "TEXTUNCOMMON", description: "TEXTUNCOMMON function", category: "text", args: "2" },
  { name: "TEXTDIFF", description: "TEXTDIFF function", category: "text", args: "2" },
  { name: "ISODD3", description: "ISODD3 function", category: "info", args: "1" },
  { name: "ISEVEN3", description: "ISEVEN3 function", category: "info", args: "1" },
  { name: "ISPOSINT", description: "ISPOSINT function", category: "info", args: "1" },
  { name: "ISNEGINT", description: "ISNEGINT function", category: "info", args: "1" },
  { name: "ISUNIT", description: "ISUNIT function", category: "info", args: "1" },
  { name: "ISBETWEEN", description: "ISBETWEEN function", category: "info", args: "3" },
  { name: "PERPAMT", description: "PERPAMT function", category: "financial", args: "2" },
  { name: "PERPETUITY", description: "PERPETUITY function", category: "financial", args: "2" },
  { name: "LEVERAGE", description: "LEVERAGE function", category: "financial", args: "2" },
  { name: "COVERAGE", description: "COVERAGE function", category: "financial", args: "2" },
  { name: "EARNINGSPS", description: "EARNINGSPS function", category: "financial", args: "2" },
  { name: "PRICEEARNINGS", description: "PRICEEARNINGS function", category: "financial", args: "2" },
  { name: "ANYOF", description: "ANYOF function", category: "logic", args: "variadic" },
  { name: "NONEOF", description: "NONEOF function", category: "logic", args: "variadic" },
  { name: "EXACTLYONE", description: "EXACTLYONE function", category: "logic", args: "variadic" },
  { name: "ATMOSTK", description: "ATMOSTK function", category: "logic", args: "variadic" },
  { name: "RUNLEN", description: "RUNLEN function", category: "lookup", args: "variadic" },
  { name: "STREAK", description: "STREAK function", category: "lookup", args: "variadic" },
  { name: "SPAN", description: "SPAN function", category: "lookup", args: "variadic" },
  { name: "RANDFOLD", description: "RANDFOLD function", category: "volatile", args: "1" },
  { name: "RANDTRI", description: "RANDTRI function", category: "volatile", args: "3" },
  // ── 1200 batch CATALOG ──
  { name: "FARADAY", description: "FARADAY function", category: "math", args: "1" },
  { name: "BOLTZMANN", description: "BOLTZMANN function", category: "math", args: "1" },
  { name: "PLANCK", description: "PLANCK function", category: "math", args: "1" },
  { name: "AVOGADRO", description: "AVOGADRO function", category: "math", args: "1" },
  { name: "COULOMB", description: "COULOMB function", category: "math", args: "2" },
  { name: "HOOKE", description: "HOOKE function", category: "math", args: "2" },
  { name: "OHMS", description: "OHMS function", category: "math", args: "2" },
  { name: "WATT", description: "WATT function", category: "math", args: "2" },
  { name: "KELVIN", description: "KELVIN function", category: "math", args: "1" },
  { name: "CELSIUS", description: "CELSIUS function", category: "math", args: "1" },
  { name: "FAHRENHEIT", description: "FAHRENHEIT function", category: "math", args: "1" },
  { name: "NEWTON", description: "NEWTON function", category: "math", args: "2" },
  { name: "BOOTSTRAPMEAN", description: "BOOTSTRAPMEAN function", category: "stat", args: "variadic" },
  { name: "JACKKNIFE", description: "JACKKNIFE function", category: "stat", args: "variadic" },
  { name: "ANDERSON", description: "ANDERSON function", category: "stat", args: "variadic" },
  { name: "SHAPIRO", description: "SHAPIRO function", category: "stat", args: "variadic" },
  { name: "KSTEST", description: "KSTEST function", category: "stat", args: "variadic" },
  { name: "AUTOCORR", description: "AUTOCORR function", category: "stat", args: "variadic" },
  { name: "CROSSCORR", description: "CROSSCORR function", category: "stat", args: "variadic" },
  { name: "CONVOL", description: "CONVOL function", category: "stat", args: "variadic" },
  { name: "DETREND", description: "DETREND function", category: "stat", args: "variadic" },
  { name: "NORMALIZE2", description: "NORMALIZE2 function", category: "stat", args: "variadic" },
  { name: "TEXTROT47", description: "TEXTROT47 function", category: "text", args: "1" },
  { name: "TEXTATBASH", description: "TEXTATBASH function", category: "text", args: "1" },
  { name: "TEXTXOR", description: "TEXTXOR function", category: "text", args: "2" },
  { name: "TEXTNTH2", description: "TEXTNTH2 function", category: "text", args: "2" },
  { name: "TEXTUNTIL", description: "TEXTUNTIL function", category: "text", args: "2" },
  { name: "TEXTAFTER2", description: "TEXTAFTER2 function", category: "text", args: "2" },
  { name: "TEXTWORDS", description: "TEXTWORDS function", category: "text", args: "1" },
  { name: "ISPRIMEPOWER", description: "ISPRIMEPOWER function", category: "info", args: "1" },
  { name: "ISDEFICIENT", description: "ISDEFICIENT function", category: "info", args: "1" },
  { name: "ISABUNDANT", description: "ISABUNDANT function", category: "info", args: "1" },
  { name: "ISSEMIPRIME", description: "ISSEMIPRIME function", category: "info", args: "1" },
  { name: "ISSQUAREFREE", description: "ISSQUAREFREE function", category: "info", args: "1" },
  { name: "ISSMOOTH", description: "ISSMOOTH function", category: "info", args: "2" },
  { name: "EVTOEBITDA", description: "EVTOEBITDA function", category: "financial", args: "2" },
  { name: "PRICEBOOK", description: "PRICEBOOK function", category: "financial", args: "2" },
  { name: "PRICESALES", description: "PRICESALES function", category: "financial", args: "2" },
  { name: "DIVIDENDPAYOUT", description: "DIVIDENDPAYOUT function", category: "financial", args: "2" },
  { name: "RETENTIONRATE", description: "RETENTIONRATE function", category: "financial", args: "1" },
  { name: "SGROWTH", description: "SGROWTH function", category: "financial", args: "2" },
  { name: "RISING", description: "RISING function", category: "logic", args: "2" },
  { name: "FALLING", description: "FALLING function", category: "logic", args: "2" },
  { name: "CHANGED", description: "CHANGED function", category: "logic", args: "2" },
  { name: "STABLE", description: "STABLE function", category: "logic", args: "2" },
  { name: "SELECTIF", description: "SELECTIF function", category: "lookup", args: "variadic" },
  { name: "REJECTIF", description: "REJECTIF function", category: "lookup", args: "variadic" },
  { name: "TAKEWHILE", description: "TAKEWHILE function", category: "lookup", args: "variadic" },
  { name: "DROPWHILE", description: "DROPWHILE function", category: "lookup", args: "variadic" },
  { name: "RANDPOISSON", description: "RANDPOISSON function", category: "volatile", args: "1" },
  // ── 1250 batch CATALOG ──
  { name: "DOTPROD2", description: "DOTPROD2 function", category: "math", args: "2" },
  { name: "CROSSPROD", description: "CROSSPROD function", category: "math", args: "2" },
  { name: "MAGNITUDE2", description: "MAGNITUDE2 function", category: "math", args: "2" },
  { name: "ANGLE", description: "ANGLE function", category: "math", args: "2" },
  { name: "MIDPOINT", description: "MIDPOINT function", category: "math", args: "2" },
  { name: "INTERCEPT2", description: "INTERCEPT2 function", category: "math", args: "2" },
  { name: "PERPSLOPE", description: "PERPSLOPE function", category: "math", args: "1" },
  { name: "ARCLENGTH", description: "ARCLENGTH function", category: "math", args: "2" },
  { name: "SECTORAREA", description: "SECTORAREA function", category: "math", args: "2" },
  { name: "HERON", description: "HERON function", category: "math", args: "3" },
  { name: "BRAHMAGUPTA", description: "BRAHMAGUPTA function", category: "math", args: "3" },
  { name: "HUBERMU", description: "HUBERMU function", category: "stat", args: "variadic" },
  { name: "HAMPEL", description: "HAMPEL function", category: "stat", args: "variadic" },
  { name: "TUKEYBIWEIGHT", description: "TUKEYBIWEIGHT function", category: "stat", args: "variadic" },
  { name: "ANDREWSINE", description: "ANDREWSINE function", category: "stat", args: "variadic" },
  { name: "L1NORM", description: "L1NORM function", category: "stat", args: "variadic" },
  { name: "L2NORM", description: "L2NORM function", category: "stat", args: "variadic" },
  { name: "LINFNORM", description: "LINFNORM function", category: "stat", args: "variadic" },
  { name: "LPNORM", description: "LPNORM function", category: "stat", args: "variadic" },
  { name: "MAHALANOBIS", description: "MAHALANOBIS function", category: "stat", args: "variadic" },
  { name: "COSINESIM", description: "COSINESIM function", category: "stat", args: "variadic" },
  { name: "TEXTFREQCHAR", description: "TEXTFREQCHAR function", category: "text", args: "1" },
  { name: "TEXTUNIQCHARS", description: "TEXTUNIQCHARS function", category: "text", args: "1" },
  { name: "TEXTCHARCOUNT", description: "TEXTCHARCOUNT function", category: "text", args: "2" },
  { name: "TEXTPOSITION", description: "TEXTPOSITION function", category: "text", args: "2" },
  { name: "TEXTOCCURRENCES", description: "TEXTOCCURRENCES function", category: "text", args: "2" },
  { name: "TEXTSTARTSWITH2", description: "TEXTSTARTSWITH2 function", category: "text", args: "2" },
  { name: "TEXTENDSWITH2", description: "TEXTENDSWITH2 function", category: "text", args: "2" },
  { name: "TEXTINCLUDES", description: "TEXTINCLUDES function", category: "text", args: "2" },
  { name: "ISAMICABLE", description: "ISAMICABLE function", category: "info", args: "2" },
  { name: "ISAUTOMORPHIC", description: "ISAUTOMORPHIC function", category: "info", args: "1" },
  { name: "ISKAPREKAR", description: "ISKAPREKAR function", category: "info", args: "1" },
  { name: "ISNARCISSISTIC", description: "ISNARCISSISTIC function", category: "info", args: "1" },
  { name: "ISSMITH", description: "ISSMITH function", category: "info", args: "1" },
  { name: "ISPROTH", description: "ISPROTH function", category: "info", args: "1" },
  { name: "WACC2", description: "WACC2 function", category: "financial", args: "3" },
  { name: "CAPM", description: "CAPM function", category: "financial", args: "3" },
  { name: "GORDONMODEL", description: "GORDONMODEL function", category: "financial", args: "3" },
  { name: "DDM", description: "DDM function", category: "financial", args: "3" },
  { name: "MVADDED", description: "MVADDED function", category: "financial", args: "2" },
  { name: "ECONVALUE", description: "ECONVALUE function", category: "financial", args: "2" },
  { name: "ALLGT", description: "ALLGT function", category: "logic", args: "variadic" },
  { name: "ALLLT", description: "ALLLT function", category: "logic", args: "variadic" },
  { name: "ALLEQ", description: "ALLEQ function", category: "logic", args: "variadic" },
  { name: "COUNTRUE", description: "COUNTRUE function", category: "logic", args: "variadic" },
  { name: "RANKPCT", description: "RANKPCT function", category: "lookup", args: "variadic" },
  { name: "QUANTILE2", description: "QUANTILE2 function", category: "lookup", args: "variadic" },
  { name: "MEDIAN2", description: "MEDIAN2 function", category: "lookup", args: "variadic" },
  { name: "RANDWEIBULL", description: "RANDWEIBULL function", category: "volatile", args: "2" },
  { name: "RANDPARETO", description: "RANDPARETO function", category: "volatile", args: "2" },
  // ── 1300 batch CATALOG ──
  { name: "STIRLING1", description: "STIRLING1 function", category: "math", args: "2" },
  { name: "STIRLING2", description: "STIRLING2 function", category: "math", args: "2" },
  { name: "CATALAN2", description: "CATALAN2 function", category: "math", args: "1" },
  { name: "PARTITION", description: "PARTITION function", category: "math", args: "1" },
  { name: "SUBFACTORIAL", description: "SUBFACTORIAL function", category: "math", args: "1" },
  { name: "DOUBLEFALLINGFACT", description: "DOUBLEFALLINGFACT function", category: "math", args: "2" },
  { name: "RISINGFACT", description: "RISINGFACT function", category: "math", args: "2" },
  { name: "MULTINOMIAL2", description: "MULTINOMIAL2 function", category: "math", args: "2" },
  { name: "TRIBONACCI", description: "TRIBONACCI function", category: "math", args: "1" },
  { name: "KLDIVERGE", description: "KLDIVERGE function", category: "stat", args: "variadic" },
  { name: "JSDIVERGE", description: "JSDIVERGE function", category: "stat", args: "variadic" },
  { name: "THEIL", description: "THEIL function", category: "stat", args: "variadic" },
  { name: "ATKINSON", description: "ATKINSON function", category: "stat", args: "variadic" },
  { name: "PALMA", description: "PALMA function", category: "stat", args: "variadic" },
  { name: "HOOVER", description: "HOOVER function", category: "stat", args: "variadic" },
  { name: "TEXTPHONETIC", description: "TEXTPHONETIC function", category: "text", args: "1" },
  { name: "TEXTSNAKE", description: "TEXTSNAKE function", category: "text", args: "1" },
  { name: "TEXTKEBAB", description: "TEXTKEBAB function", category: "text", args: "1" },
  { name: "TEXTPASCAL", description: "TEXTPASCAL function", category: "text", args: "1" },
  { name: "TEXTCONSTANT", description: "TEXTCONSTANT function", category: "text", args: "1" },
  { name: "ISPERFECTSQ", description: "ISPERFECTSQ function", category: "info", args: "1" },
  { name: "ISPERFECTCUBE", description: "ISPERFECTCUBE function", category: "info", args: "1" },
  { name: "ISPOWER2", description: "ISPOWER2 function", category: "info", args: "1" },
  { name: "ISHARMON", description: "ISHARMON function", category: "info", args: "1" },
  { name: "ISSOPHIE", description: "ISSOPHIE function", category: "info", args: "1" },
  { name: "ISSAFE", description: "ISSAFE function", category: "info", args: "1" },
  { name: "JENSEN", description: "JENSEN function", category: "financial", args: "3" },
  { name: "INFORATE", description: "INFORATE function", category: "financial", args: "2" },
  { name: "MODEVALUE", description: "MODEVALUE function", category: "lookup", args: "variadic" },
  { name: "RANDGUMBEL", description: "RANDGUMBEL function", category: "volatile", args: "2" },
  { name: "RANDFRECHET", description: "RANDFRECHET function", category: "volatile", args: "2" },
  // ── 1300 batch-2 CATALOG ──
  { name: "LUCAS2", description: "LUCAS2 function", category: "math", args: "1" },
  { name: "PELL", description: "PELL function", category: "math", args: "1" },
  { name: "JACOBSTHAL", description: "JACOBSTHAL function", category: "math", args: "1" },
  { name: "PRONIC", description: "PRONIC function", category: "math", args: "1" },
  { name: "OBLONG", description: "OBLONG function", category: "math", args: "1" },
  { name: "CENTERED", description: "CENTERED function", category: "math", args: "1" },
  { name: "HEXAGONAL2", description: "HEXAGONAL2 function", category: "math", args: "1" },
  { name: "HEPTAGONAL", description: "HEPTAGONAL function", category: "math", args: "1" },
  { name: "OCTAGONAL", description: "OCTAGONAL function", category: "math", args: "1" },
  { name: "STAR", description: "STAR function", category: "math", args: "1" },
  { name: "CENTERED2", description: "CENTERED2 function", category: "math", args: "1" },
  { name: "CAKE", description: "CAKE function", category: "math", args: "1" },
  { name: "LAZY", description: "LAZY function", category: "math", args: "1" },
  { name: "NARAYANA", description: "NARAYANA function", category: "math", args: "2" },
  { name: "EULERIAN", description: "EULERIAN function", category: "math", args: "2" },
  { name: "TEXTTITLECASE", description: "TEXTTITLECASE function", category: "text", args: "1" },
  { name: "TEXTDIGITSUM", description: "TEXTDIGITSUM function", category: "text", args: "1" },
  { name: "DECAGONAL", description: "DECAGONAL function", category: "math", args: "1" },
  { name: "DODECAGONAL", description: "DODECAGONAL function", category: "math", args: "1" },
  { name: "ICOSAHEDRAL", description: "ICOSAHEDRAL function", category: "math", args: "1" },
  // ── 1350 batch CATALOG ──
  { name: "TAYLOR_SIN", description: "TAYLOR_SIN function", category: "math", args: "2" },
  { name: "TAYLOR_COS", description: "TAYLOR_COS function", category: "math", args: "2" },
  { name: "TAYLOR_EXP", description: "TAYLOR_EXP function", category: "math", args: "2" },
  { name: "NEWTON_METHOD", description: "NEWTON_METHOD function", category: "math", args: "2" },
  { name: "BISECT", description: "BISECT function", category: "math", args: "2" },
  { name: "TRAPEZOID", description: "TRAPEZOID function", category: "math", args: "2" },
  { name: "SIMPSON", description: "SIMPSON function", category: "math", args: "2" },
  { name: "ROMBERG", description: "ROMBERG function", category: "math", args: "2" },
  { name: "EULER_APPROX", description: "EULER_APPROX function", category: "math", args: "2" },
  { name: "GOLDEN_SECTION", description: "GOLDEN_SECTION function", category: "math", args: "2" },
  { name: "REGULA_FALSI", description: "REGULA_FALSI function", category: "math", args: "2" },
  { name: "SECANT_METHOD", description: "SECANT_METHOD function", category: "math", args: "2" },
  { name: "ARIMA", description: "ARIMA function", category: "stat", args: "variadic" },
  { name: "HOLT", description: "HOLT function", category: "stat", args: "variadic" },
  { name: "WINTERS", description: "WINTERS function", category: "stat", args: "variadic" },
  { name: "EXPSMOOTH", description: "EXPSMOOTH function", category: "stat", args: "variadic" },
  { name: "DOUBLEEXP", description: "DOUBLEEXP function", category: "stat", args: "variadic" },
  { name: "SEASONAVG", description: "SEASONAVG function", category: "stat", args: "variadic" },
  { name: "MOVMEDIAN", description: "MOVMEDIAN function", category: "stat", args: "variadic" },
  { name: "MOVSTDEV", description: "MOVSTDEV function", category: "stat", args: "variadic" },
  { name: "MOVVAR", description: "MOVVAR function", category: "stat", args: "variadic" },
  { name: "MOVRANGE", description: "MOVRANGE function", category: "stat", args: "variadic" },
  { name: "TEXTCRC32", description: "TEXTCRC32 function", category: "text", args: "1" },
  { name: "TEXTSOUNDEX", description: "TEXTSOUNDEX function", category: "text", args: "1" },
  { name: "TEXTMETAPHONE", description: "TEXTMETAPHONE function", category: "text", args: "1" },
  { name: "TEXTALPHANUM", description: "TEXTALPHANUM function", category: "text", args: "1" },
  { name: "TEXTZALGO2", description: "TEXTZALGO2 function", category: "text", args: "1" },
  { name: "TEXTUNICODE", description: "TEXTUNICODE function", category: "text", args: "1" },
  { name: "TEXTFROMUNI", description: "TEXTFROMUNI function", category: "text", args: "1" },
  { name: "TEXTBIN", description: "TEXTBIN function", category: "text", args: "1" },
  { name: "ISPRACTICAL", description: "ISPRACTICAL function", category: "info", args: "1" },
  { name: "ISREGULAR", description: "ISREGULAR function", category: "info", args: "1" },
  { name: "ISSUPERABUNDANT", description: "ISSUPERABUNDANT function", category: "info", args: "1" },
  { name: "ISHAPPY2", description: "ISHAPPY2 function", category: "info", args: "1" },
  { name: "ISSAD", description: "ISSAD function", category: "info", args: "1" },
  { name: "ISNICE", description: "ISNICE function", category: "info", args: "1" },
  { name: "MODIGLIANI", description: "MODIGLIANI function", category: "financial", args: "3" },
  { name: "OMEGA", description: "OMEGA function", category: "financial", args: "2" },
  { name: "KAPPA", description: "KAPPA function", category: "financial", args: "2" },
  { name: "RACHEV", description: "RACHEV function", category: "financial", args: "2" },
  { name: "BURKE", description: "BURKE function", category: "financial", args: "2" },
  { name: "MAJORITY3", description: "MAJORITY3 function", category: "logic", args: "variadic" },
  { name: "CONSENSUS2", description: "CONSENSUS2 function", category: "logic", args: "variadic" },
  { name: "THRESHOLD2", description: "THRESHOLD2 function", category: "logic", args: "variadic" },
  { name: "QUORUM2", description: "QUORUM2 function", category: "logic", args: "variadic" },
  { name: "WEIGHTED_RANK", description: "WEIGHTED_RANK function", category: "lookup", args: "variadic" },
  { name: "CDF", description: "CDF function", category: "lookup", args: "variadic" },
  { name: "ECDF", description: "ECDF function", category: "lookup", args: "variadic" },
  { name: "RANDCHI2", description: "RANDCHI2 function", category: "volatile", args: "1" },
  { name: "RANDF", description: "RANDF function", category: "volatile", args: "2" },
