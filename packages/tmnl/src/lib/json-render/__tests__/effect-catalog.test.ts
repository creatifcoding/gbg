/**
 * Phase 0 Spike: Effect Schema → json-render Catalog Integration
 *
 * This test validates whether Effect Schema can work with json-render's
...
describe('Effect Schema → json-render Catalog', () => {
  ...
  describe('Schema Composition (discriminatedUnion)', () => {
    it('should work with multiple component types', () => {
      // json-render creates a discriminatedUnion on "type" field
