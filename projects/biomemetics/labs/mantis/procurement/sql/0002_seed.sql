...
INSERT INTO part (balloon_id, name, qty_text, class, notes) VALUES ($bom$B38$bom$, $bom$M3 fasteners and heat-set inserts$bom$, $bom$set$bom$, $bom$UNVERIFIED$bom$, $bom$UNVERIFIED selected PN/pocket. Not a release selection. None selected. CAD this pass confirms Adafruit 4255 as extra next to Adafruit 4256 and SPIROL 151284. Pocket UNVERIFIED. Not selected. SPIROL 151284 (brass, M3 x 0.5, overknurl 4.75 mm, L 5.74 mm, headed); Adafruit 4256 M3-threaded inserts 3 mm long, 50-pack, brass heat-set; Adafruit 4255 M3 x 4 mm brass heat-set 50 pack OD 4.2 mm, hole dia not printed. EE McMaster insert candidates remain, not from this CAD pass: 94180A331 and 94180A333 (M3 x 0.5 tapered); 94459A769 / 94459A130 / 94459A140 (straight). Screw 91292A113 not confirmed on a McMaster URL. Do not file Adafruit 4685. Do not file McMaster PNs from this CAD pass. No price landed from these pages. SPIROL: https://shop.spirol.com/viewitems/series-29-30-long-heat-ultrasonic-insert-metric/series-30-l-headed-heat-ultrasonic-insert-metric Adafruit 4256: https://www.adafruit.com/product/4256$bom$) ON CONFLICT (balloon_id) DO NOTHING;
INSERT INTO part (balloon_id, name, qty_text, class, notes) VALUES ($bom$B39$bom$, $bom$optional captured alignment magnets$bom$, $bom$set$bom$, $bom$UNVERIFIED$bom$, $bom$UNVERIFIED; never primary latch. CAD miss this pass. Do not file McMaster PNs from this CAD pass. EE candidates none selected remain: McMaster 3506K21 / 3506K36 / 3506K35 / 5679K88 / 5679K89 / 5679K91.$bom$) ON CONFLICT (balloon_id) DO NOTHING;
