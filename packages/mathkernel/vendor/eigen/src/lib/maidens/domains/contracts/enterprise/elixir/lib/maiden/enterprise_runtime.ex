defmodule Maiden.EnterpriseRuntime do
  @moduledoc """
  Enterprise runtime contract namespace for Effect ↔ Elixir/Jido interop.
  ...
  @default_storage {Jido.Storage.ETS, [table: :maiden_enterprise_runtime]}
