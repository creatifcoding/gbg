...
# Consuming Streams {#_top .astro-np5lzwrf}
:::
::::
...
::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
::::: sl-markdown-content
When working with streams, it's essential to understand how to consume
the data they produce. In this guide, we'll walk through several common
methods for consuming streams.
...
aria-hidden="true"}](index.html#using-runcollect){.anchor-link
aria-labelledby="using-runcollect"}
:::

To gather all the elements from a stream into a single
`Chunk`{dir="auto"}, you can use the `Stream.runCollect`{dir="auto"}
function.
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const collectedData: Effect.Effect&lt;Chunk&lt;number&gt;, never, never&gt;</code></pre>
</figure>
:::
::::

[collectedData]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[collectedData]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[values: \[ 1, 2, 3, 4, 5
\]]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#using-runforeach){.anchor-link
aria-labelledby="using-runforeach"}
:::

Another way to consume elements of a stream is by using
`Stream.runForEach`{dir="auto"}. It takes a callback function that
receives each element of the stream. Here's an example:
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const effect: Effect.Effect&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::

[effect]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Stream.Stream&lt;number, never, never&gt;, Effect.Effect&lt;void, never, never&gt;&gt;(this: Stream.Stream&lt;number, never, never&gt;, ab: (_: Stream.Stream&lt;number, never, never&gt;) =&gt; Effect.Effect&lt;void, never, never&gt;): Effect.Effect&lt;void, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runForEach: &lt;number, void, never, never&gt;(f: (a: number) =&gt; Effect.Effect&lt;void, never, never&gt;) =&gt; &lt;E, R&gt;(self: Stream.Stream&lt;number, E, R&gt;) =&gt; Effect.Effect&lt;void, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[runForEach]{style="--0:#6F42C1;--1:#B392F0"}[((]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
...
In this example, we use `Stream.runForEach`{dir="auto"} to log each
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#using-a-fold-operation){.anchor-link
aria-labelledby="using-a-fold-operation"}
:::

The `Stream.fold`{dir="auto"} function is another way to consume a
stream by performing a fold operation over the stream of values and
returning an effect containing the result. Here are a couple of
examples:
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const foldedStream: Effect.Effect&lt;number, never, never&gt;</code></pre>
</figure>
:::
::::

[foldedStream]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Stream.Stream&lt;number, never, never&gt;, Effect.Effect&lt;number, never, never&gt;&gt;(this: Stream.Stream&lt;number, never, never&gt;, ab: (_: Stream.Stream&lt;number, never, never&gt;) =&gt; Effect.Effect&lt;number, never, never&gt;): Effect.Effect&lt;number, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runFold: &lt;number, number&gt;(s: number, f: (s: number, a: number) =&gt; number) =&gt; &lt;E, R&gt;(self: Stream.Stream&lt;number, E, R&gt;) =&gt; Effect.Effect&lt;number, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[runFold]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[0]{style="--0:#005CC5;--1:#79B8FF"}[,
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
[foldedStream]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const foldedWhileStream: Effect.Effect&lt;number, never, never&gt;</code></pre>
</figure>
:::
::::

[foldedWhileStream]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runFoldWhile: &lt;number, number&gt;(s: number, cont: Predicate&lt;number&gt;, f: (s: number, a: number) =&gt; number) =&gt; &lt;E, R&gt;(self: Stream.Stream&lt;number, E, R&gt;) =&gt; Effect.Effect&lt;number, E, R&gt; (+1 overload)</code></pre>
</figure>
:::

::: twoslash-popup-docs
Reduces the elements in the stream to a value of type `S`. Stops the
fold early when the condition is not fulfilled. Example:
:::
...
[runFoldWhile]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::
::::::::::::
...
::: code
[
]{.indent}[0]{style="--0:#005CC5;--1:#79B8FF"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::
::::::
...
[foldedWhileStream]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
In the first example (`foldedStream`{dir="auto"}), we use
`Stream.runFold`{dir="auto"} to calculate the sum of all elements. In
the second example (`foldedWhileStream`{dir="auto"}), we use
`Stream.runFoldWhile`{dir="auto"} to calculate the sum but only until a
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#using-a-sink){.anchor-link
aria-labelledby="using-a-sink"}
:::

To consume a stream using a Sink, you can pass the `Sink`{dir="auto"} to
the `Stream.run`{dir="auto"} function. Here's an example:
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const effect: Effect.Effect&lt;number, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const run: &lt;number, number, never, never&gt;(sink: Sink.Sink&lt;number, number, unknown, never, never&gt;) =&gt; &lt;E, R&gt;(self: Stream.Stream&lt;number, E, R&gt;) =&gt; Effect.Effect&lt;number, E, Exclude&lt;R, Scope&gt;&gt; (+1 overload)</code></pre>
</figure>
:::
...
[sum]{style="--0:#24292E;--1:#E1E4E8"}[))]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::::::::::::::
:::::::::::::::::::::::::::::
...
In this example, we use a `Sink`{dir="auto"} to calculate the sum of the
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/stream/consuming-streams.mdx){.sl-flex
...
.astro-4rgy7crp} [ Next\
[Error Handling]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../error-handling/index.html){.astro-u5aomj4k
rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
