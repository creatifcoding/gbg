...
import { loadSciChartModule } from './bootstrap';
import {
  appendSeriesBatch,
  appendSeriesPoint,
  setSeriesData,
...
import { createRenderableSeriesForKind } from './series/index';
...
export const makeSciChartInstance = (spec: ChartSpec): ChartInstance => {
