...
- CopilotKit binds locally without a runtime URL. A missing URL is not an empty well.
- Terrarium is an empty telemetry well. Service is hidden unless `?simulator=1`.
