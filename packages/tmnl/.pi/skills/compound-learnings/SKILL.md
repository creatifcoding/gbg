...
**File:** `.claude/rules/[name].md` or `.pi/skills/[name]/SKILL.md`
...
#### For Skills:
Create `.pi/skills/<name>/SKILL.md` with:
...
3. **Does it already exist?** Check `.claude/rules/` and `.pi/skills/` first
...
- Skill triggers: `.pi/skills/skill-rules.json`
