...
# Yieldable Errors {#_top .astro-np5lzwrf}
:::
::::
...
::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::::: sl-markdown-content
Yieldable Errors are special types of errors that can be yielded
directly within a generator function using
[Effect.gen](../../getting-started/using-generators/index.html). These
errors allow you to handle them intuitively, without needing to
explicitly invoke
[Effect.fail](../../getting-started/creating-effects/index.html#fail).
This simplifies how you manage custom errors in your code.
...
aria-hidden="true"}](index.html#dataerror){.anchor-link
aria-labelledby="dataerror"}
:::

The `Data.Error`{dir="auto"} constructor provides a way to define a base
class for yieldable errors.
...
::: code
[// Define a custom error class extending
Data.Error]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[ ]{.indent}[// Yield a custom error (equivalent to failing with
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>constructor MyError&lt;{    message: string;}&gt;(args: {    readonly message: string;}): MyError</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runPromiseExit: &lt;void, MyError&gt;(effect: Effect.Effect&lt;void, MyError, never&gt;, options?: {    readonly signal?: AbortSignal;} | undefined) =&gt; Promise&lt;Exit&lt;void, MyError&gt;&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Promise&lt;Exit&lt;void, MyError&gt;&gt;.then&lt;void, never&gt;(onfulfilled?: ((value: Exit&lt;void, MyError&gt;) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined, onrejected?: ((reason: any) =&gt; PromiseLike&lt;never&gt;) | null | undefined): Promise&lt;void&gt;</code></pre>
</figure>
:::
...
\'Cause\', \_tag: \'Fail\', failure: { message: \'Oh no!\' }
}]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#datataggederror){.anchor-link
aria-labelledby="datataggederror"}
:::

The `Data.TaggedError`{dir="auto"} constructor lets you define custom
yieldable errors with unique tags. Each error has a `_tag`{dir="auto"}
property, allowing you to easily distinguish between different error
types. This makes it convenient to handle specific tagged errors using
functions like [Effect.catchTag](../expected-errors/index.html#catchtag)
or [Effect.catchTags](../expected-errors/index.html#catchtags).
...
::: code
[// An error with \_tag: \"Foo\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>class FooError</code></pre>
</figure>
:::
::::

[FooError]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[extends]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const TaggedError: &lt;&quot;Foo&quot;&gt;(tag: &quot;Foo&quot;) =&gt; new &lt;A&gt;(args: Equals&lt;A, {}&gt; extends true ? void : { readonly [P in keyof A as P extends &quot;_tag&quot; ? never : P]: A[P]; }) =&gt; YieldableError &amp; {    readonly _tag: &quot;Foo&quot;;} &amp; Readonly&lt;A&gt;</code></pre>
</figure>
:::
...
[TaggedError]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Foo\"]{style="--0:#032F62;--1:#9ECBFF"}[)\<{]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
::: code
[// An error with \_tag: \"Bar\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>class BarError</code></pre>
</figure>
:::
::::

[BarError]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[extends]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const TaggedError: &lt;&quot;Bar&quot;&gt;(tag: &quot;Bar&quot;) =&gt; new &lt;A&gt;(args: Equals&lt;A, {}&gt; extends true ? void : { readonly [P in keyof A as P extends &quot;_tag&quot; ? never : P]: A[P]; }) =&gt; YieldableError &amp; {    readonly _tag: &quot;Bar&quot;;} &amp; Readonly&lt;A&gt;</code></pre>
</figure>
:::
...
[TaggedError]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Bar\"]{style="--0:#032F62;--1:#9ECBFF"}[)\<{]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
[randomNumber]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;number, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, FooError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, BarError, never&gt;&gt;, string&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;number, never, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, FooError, never&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;never, BarError, never&gt;&gt;, string, never&gt;) =&gt; Effect.Effect&lt;...&gt; (+1 overload)</code></pre>
</figure>
:::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"yay!\"]{style="--0:#032F62;--1:#9ECBFF"}
:::
::::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[0.2]{style="--0:#005CC5;--1:#79B8FF"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>constructor FooError&lt;{    message: string;}&gt;(args: {    readonly message: string;}): FooError</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>constructor BarError&lt;{    randomNumber: number;}&gt;(args: {    readonly randomNumber: number;}): BarError</code></pre>
</figure>
:::
::::
...
[randomNumber]{style="--0:#24292E;--1:#E1E4E8"}[:
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;string, FooError | BarError, never&gt;, Effect.Effect&lt;string, never, never&gt;&gt;(this: Effect.Effect&lt;string, FooError | BarError, never&gt;, ab: (_: Effect.Effect&lt;string, FooError | BarError, never&gt;) =&gt; Effect.Effect&lt;string, never, never&gt;): Effect.Effect&lt;string, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: code
[ ]{.indent}[// Handle different tagged errors using
catchTags]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const catchTags: &lt;FooError | BarError, {    Foo: (error: FooError) =&gt; Effect.Effect&lt;string, never, never&gt;;    Bar: (error: BarError) =&gt; Effect.Effect&lt;string, never, never&gt;;}&gt;(cases: {    Foo: (error: FooError) =&gt; Effect.Effect&lt;string, never, never&gt;;    Bar: (error: BarError) =&gt; Effect.Effect&lt;string, never, never&gt;;}) =&gt; &lt;A, R&gt;(self: Effect.Effect&lt;A, FooError | BarError, R&gt;) =&gt; Effect.Effect&lt;string | A, never, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>type Foo: (error: FooError) =&gt; Effect.Effect&lt;string, never, never&gt;</code></pre>
</figure>
:::
::::

[Foo]{style="--0:#6F42C1;--1:#B392F0"}[:
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>error: FooError</code></pre>
</figure>
:::
::::
...
[succeed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Foo
error:
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>type Bar: (error: BarError) =&gt; Effect.Effect&lt;string, never, never&gt;</code></pre>
</figure>
:::
::::

[Bar]{style="--0:#6F42C1;--1:#B392F0"}[:
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>error: BarError</code></pre>
</figure>
:::
::::
...
[succeed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`Bar
error:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Promise&lt;string&gt;.then&lt;void, void&gt;(onfulfilled?: ((value: string) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined, onrejected?: ((reason: any) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined): Promise&lt;void&gt;</code></pre>
</figure>
:::
...
::: code
[Example Output (n \< 0.2):]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[Foo error: Oh no!]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/error-management/yieldable-errors.mdx){.sl-flex
...
.astro-4rgy7crp} [ Next\
[Managing Services]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../../requirements-management/services/index.html){.astro-u5aomj4k
rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
