...
Reconstituted onto `feat/mantis-biomemetics-lab` from closed PR 40 @
`a9918b32`. Complete coupon panel + map + planning only. Do not admit fab.
#27 stays held. Gerbers are not claimed while `kicad-cli` is absent.
