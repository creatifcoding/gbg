...
::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::::: sl-markdown-content
When we write programs, it is common to need to keep track of some form
of state during the execution of the program. State refers to any data
that can change as the program runs. For example, in a counter
application, the count value changes as the user increments or
decrements it. Similarly, in a banking application, the account balance
changes as deposits and withdrawals are made. State management is
crucial to building interactive and dynamic applications.

In traditional imperative programming, one common way to store state is
using variables. However, this approach can introduce bugs, especially
when the state is shared between multiple components or functions. As
the program becomes more complex, managing shared state can become
challenging.

To overcome these issues, Effect introduces a powerful data type called
`Ref`{dir="auto"}, which represents a mutable reference. With
`Ref`{dir="auto"}, we can share state between different parts of our
program without relying on mutable variables directly. Instead,
`Ref`{dir="auto"} provides a controlled way to handle mutable state and
safely update it in a concurrent environment.

Effect's `Ref`{dir="auto"} data type enables communication between
different fibers in your program. This capability is crucial in
concurrent programming, where multiple tasks may need to access and
update shared state simultaneously.

In this guide, we will explore how to use the `Ref`{dir="auto"} data
type to manage state in your programs effectively. We will cover simple
examples like counting, as well as more complex scenarios where state is
shared between different parts of the program. Additionally, we will
show how to use `Ref`{dir="auto"} in a concurrent environment, allowing
multiple tasks to interact with shared state safely.

Let's dive in and see how we can leverage `Ref`{dir="auto"} for
effective state management in your Effect programs.
...
aria-hidden="true"}](index.html#using-ref){.anchor-link
aria-labelledby="using-ref"}
:::

Here is a simple example using `Ref`{dir="auto"} to create a counter:

**Example** (Basic Counter with `Ref`{dir="auto"})
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>import Ref</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>class Counter</code></pre>
</figure>
:::
::::

[Counter]{style="--0:#6F42C1;--1:#B392F0"}[
{]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Counter.inc: Effect.Effect&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::

[inc]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[Effect]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[void]{style="--0:#005CC5;--1:#79B8FF"}[\>]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Counter.dec: Effect.Effect&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::

[dec]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Counter.get: Effect.Effect&lt;number, never, never&gt;</code></pre>
</figure>
:::
::::

[get]{style="--0:#AE4B07;--1:#FFAB70"}[:]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[Effect]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[number]{style="--0:#005CC5;--1:#79B8FF"}[\>]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
:::::::::: code
[
]{.indent}[constructor]{style="--0:#BF3441;--1:#F97583"}[(]{style="--0:#24292E;--1:#E1E4E8"}[private]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Counter.value: Ref.Ref&lt;number&gt;</code></pre>
</figure>
:::
::::
...
[Ref]{style="--0:#6F42C1;--1:#B392F0"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>interface Ref&lt;in out A&gt;</code></pre>
</figure>
:::
...
[Ref]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[number]{style="--0:#005CC5;--1:#79B8FF"}[\>)
{]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::
:::::::::::::
...
:::::::::::::::: code
[
]{.indent}[this]{style="--0:#005CC5;--1:#79B8FF"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const update: &lt;number&gt;(self: Ref.Ref&lt;number&gt;, f: (a: number) =&gt; number) =&gt; Effect.Effect&lt;void&gt; (+1 overload)</code></pre>
</figure>
:::
...
[update]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[this]{style="--0:#005CC5;--1:#79B8FF"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const get: &lt;number&gt;(self: Ref.Ref&lt;number&gt;) =&gt; Effect.Effect&lt;number, never, never&gt;</code></pre>
</figure>
:::
...
[get]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[this]{style="--0:#005CC5;--1:#79B8FF"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: Effect.Effect&lt;Counter, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const andThen: &lt;Ref.Ref&lt;number&gt;, never, never, Counter&gt;(self: Effect.Effect&lt;Ref.Ref&lt;number&gt;, never, never&gt;, f: (a: Ref.Ref&lt;number&gt;) =&gt; Counter) =&gt; Effect.Effect&lt;Counter, never, never&gt; (+3 overloads)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;number&gt;(value: number) =&gt; Effect.Effect&lt;Ref.Ref&lt;number&gt;, never, never&gt;</code></pre>
</figure>
:::
...
[make]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[0]{style="--0:#005CC5;--1:#79B8FF"}[),
(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#AE4B07;--1:#FFAB70"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>value: Ref.Ref&lt;number&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>constructor Counter(value: Ref.Ref&lt;number&gt;): Counter</code></pre>
</figure>
:::
::::

[Counter]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const counter: Counter</code></pre>
</figure>
:::
::::
...
[counter]{style="--0:#24292E;--1:#E1E4E8"}[.]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[This counter has a value of 2.]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
.astro-4rgy7crp} Ref Operations Are Effectful

::: starlight-aside__content
All the operations on the `Ref`{dir="auto"} data type are effectful. So
when we are reading from or writing to a `Ref`{dir="auto"}, we are
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#using-ref-in-a-concurrent-environment){.anchor-link
aria-labelledby="using-ref-in-a-concurrent-environment"}
:::

We can also use `Ref`{dir="auto"} in concurrent scenarios, where
multiple tasks might be updating shared state at the same time.
...
::: code
[ ]{.indent}[// Helper to log the counter\'s value before running an
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const logCounter: &lt;R, E, A&gt;(label: string, effect: Effect.Effect&lt;A, E, R&gt;) =&gt; Effect.Effect&lt;A, E, R&gt;</code></pre>
</figure>
:::
::::

[logCounter]{style="--0:#6F42C1;--1:#B392F0"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
\<]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[label]{style="--0:#24292E;--1:#E1E4E8"}[} get:
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const logCounter: &lt;never, never, void&gt;(label: string, effect: Effect.Effect&lt;void, never, never&gt;) =&gt; Effect.Effect&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::

[logCounter]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"task
1\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[inc]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const zip: &lt;void, never, never&gt;(that: Effect.Effect&lt;void, never, never&gt;, options?: {    readonly concurrent?: boolean | undefined;    readonly batching?: boolean | &quot;inherit&quot; | undefined;    readonly concurrentFinalizers?: boolean | undefined;} | undefined) =&gt; &lt;A, E, R&gt;(self: Effect.Effect&lt;A, E, R&gt;) =&gt; Effect.Effect&lt;[A, void], E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>concurrent?: boolean | undefined</code></pre>
</figure>
:::
::::

[concurrent]{style="--0:#24292E;--1:#E1E4E8"}[:
...
::: code
[timestamp=\... fiber=#3 message=\"task 4 get:
...
::: code
[timestamp=\... fiber=#6 message=\"task 3 get:
...
::: code
[timestamp=\... fiber=#8 message=\"task 1 get:
0\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[timestamp=\... fiber=#9 message=\"task 2 get:
1\"]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[timestamp=\... fiber=#0 message=\"This counter has a value of
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#using-ref-as-a-service){.anchor-link
aria-labelledby="using-ref-as-a-service"}
:::

You can pass a `Ref`{dir="auto"} as a
[service](../../requirements-management/services/index.html) to share
state across different parts of your program.

**Example** (Using `Ref`{dir="auto"} as a Service)
...
::: code
[// Create a Tag for our state]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>class MyState</code></pre>
</figure>
:::
::::

[MyState]{style="--0:#6F42C1;--1:#B392F0"}[
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const Tag: &lt;&quot;MyState&quot;&gt;(id: &quot;MyState&quot;) =&gt; &lt;Self, Shape&gt;() =&gt; Context.TagClass&lt;Self, &quot;MyState&quot;, Shape&gt;</code></pre>
</figure>
:::
...
[Tag]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"MyState\"]{style="--0:#032F62;--1:#9ECBFF"}[)\<]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
[MyState]{style="--0:#6F42C1;--1:#B392F0"}[,]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
[Ref]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[number]{style="--0:#005CC5;--1:#79B8FF"}[\>]{style="--0:#24292E;--1:#E1E4E8"}
::::::::
:::::::::::
...
::: code
[// Subprogram 1: Increment the state value
twice]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const subprogram1: Effect.Effect&lt;void, never, MyState&gt;</code></pre>
</figure>
:::
::::

[subprogram1]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Context.Tag&lt;MyState, Ref.Ref&lt;number&gt;&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt;, void&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Context.Tag&lt;MyState, Ref.Ref&lt;number&gt;&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt;, void, never&gt;) =&gt; Effect.Effect&lt;void, never, MyState&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const state: Ref.Ref&lt;number&gt;</code></pre>
</figure>
:::
::::
...
[MyState]{style="--0:#24292E;--1:#E1E4E8"}
:::::::
::::::::::
...
[update]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Subprogram 2: Decrement the state value and then increment
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const subprogram2: Effect.Effect&lt;void, never, MyState&gt;</code></pre>
</figure>
:::
::::

[subprogram2]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Subprogram 3: Read and log the current value of the
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const subprogram3: Effect.Effect&lt;void, never, MyState&gt;</code></pre>
</figure>
:::
::::

[subprogram3]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Context.Tag&lt;MyState, Ref.Ref&lt;number&gt;&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;number, never, never&gt;&gt;, void&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Context.Tag&lt;MyState, Ref.Ref&lt;number&gt;&gt;&gt; | YieldWrap&lt;Effect.Effect&lt;number, never, never&gt;&gt;, void, never&gt;) =&gt; Effect.Effect&lt;void, never, MyState&gt; (+1 overload)</code></pre>
</figure>
:::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\`MyState
has a value of
\${]{style="--0:#032F62;--1:#9ECBFF"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Compose subprograms 1, 2, and 3 to create the main
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const program: Effect.Effect&lt;void, never, MyState&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;void, never, MyState&gt;&gt;, void&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;void, never, MyState&gt;&gt;, void, never&gt;) =&gt; Effect.Effect&lt;void, never, MyState&gt; (+1 overload)</code></pre>
</figure>
:::
...
[subprogram1]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
[subprogram2]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
[subprogram3]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: code
[// Create a Ref instance with an initial value of
0]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const initialState: Effect.Effect&lt;Ref.Ref&lt;number&gt;, never, never&gt;</code></pre>
</figure>
:::
::::

[initialState]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: code
[// Provide the Ref as a service]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runnable: Effect.Effect&lt;void, never, never&gt;</code></pre>
</figure>
:::
::::

[runnable]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;void, never, MyState&gt;, Effect.Effect&lt;void, never, never&gt;&gt;(this: Effect.Effect&lt;void, never, MyState&gt;, ab: (_: Effect.Effect&lt;void, never, MyState&gt;) =&gt; Effect.Effect&lt;void, never, never&gt;): Effect.Effect&lt;void, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const provideServiceEffect: &lt;MyState, Ref.Ref&lt;number&gt;, never, never&gt;(tag: Context.Tag&lt;MyState, Ref.Ref&lt;number&gt;&gt;, effect: Effect.Effect&lt;Ref.Ref&lt;number&gt;, never, never&gt;) =&gt; &lt;A, E, R&gt;(self: Effect.Effect&lt;A, E, R&gt;) =&gt; Effect.Effect&lt;A, E, Exclude&lt;R, MyState&gt;&gt; (+1 overload)</code></pre>
</figure>
:::
...
consuming effect. This is particularly useful when the service
implementation itself requires asynchronous or resource-intensive
initialization.
...
[provideServiceEffect]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
[initialState]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
[runnable]{style="--0:#24292E;--1:#E1E4E8"}[)]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::::
:::::::::::::::::
...
::: code
[MyState has a value of 2.]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
Note that we use `Effect.provideServiceEffect`{dir="auto"} instead of
`Effect.provideService`{dir="auto"} to provide an actual implementation
of the `MyState`{dir="auto"} service because all the operations on the
`Ref`{dir="auto"} data type are effectful, including the creation
`Ref.make(0)`{dir="auto"}.
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#sharing-state-between-fibers){.anchor-link
aria-labelledby="sharing-state-between-fibers"}
:::

You can use `Ref`{dir="auto"} to manage shared state between multiple
fibers in a concurrent environment.

**Example** (Managing Shared State Across Fibers)

Let's look at an example where we continuously read names from user
input until the user enters `"q"`{dir="auto"} to exit.

First, let's introduce a `readLine`{dir="auto"} utility to read user
input (ensure you have `@types/node`{dir="auto"} installed):
...
::: code
[// Utility to read user input]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[]{.expand}[]{.collapse}[14 collapsed lines]{.text}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const getNames: Effect.Effect&lt;Chunk.Chunk&lt;string&gt;, never, never&gt;</code></pre>
</figure>
:::
::::

[getNames]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const gen: &lt;YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt;, Chunk.Chunk&lt;string&gt;&gt;(f: (resume: Effect.Adapter) =&gt; Generator&lt;YieldWrap&lt;Effect.Effect&lt;void, never, never&gt;&gt;, Chunk.Chunk&lt;string&gt;, never&gt;) =&gt; Effect.Effect&lt;Chunk.Chunk&lt;string&gt;, never, never&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const ref: Ref.Ref&lt;Chunk.Chunk&lt;string&gt;&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const make: &lt;Chunk.Chunk&lt;string&gt;&gt;(value: Chunk.Chunk&lt;string&gt;) =&gt; Effect.Effect&lt;Ref.Ref&lt;Chunk.Chunk&lt;string&gt;&gt;, never, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const empty: &lt;string&gt;() =&gt; Chunk.Chunk&lt;string&gt;</code></pre>
</figure>
:::
...
[empty]{style="--0:#6F42C1;--1:#B392F0"}[\<]{style="--0:#24292E;--1:#E1E4E8"}[string]{style="--0:#005CC5;--1:#79B8FF"}[\>())]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::::
::::::::::::::::::
...
::: code
[ ]{.indent}[while]{style="--0:#BF3441;--1:#F97583"}[
(]{style="--0:#24292E;--1:#E1E4E8"}[true]{style="--0:#005CC5;--1:#79B8FF"}[)
{]{style="--0:#24292E;--1:#E1E4E8"}
:::
::::::
...
[readLine]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"Please
enter a name or \`q\` to exit:
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"q\"]{style="--0:#032F62;--1:#9ECBFF"}[)
{]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: code
[ ]{.indent}[break]{style="--0:#BF3441;--1:#F97583"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const update: &lt;Chunk.Chunk&lt;string&gt;&gt;(self: Ref.Ref&lt;Chunk.Chunk&lt;string&gt;&gt;, f: (a: Chunk.Chunk&lt;string&gt;) =&gt; Chunk.Chunk&lt;string&gt;) =&gt; Effect.Effect&lt;void&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>state: Chunk.Chunk&lt;string&gt;</code></pre>
</figure>
:::
::::

[state]{style="--0:#AE4B07;--1:#FFAB70"}[)
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const append: &lt;string, string&gt;(self: Chunk.Chunk&lt;string&gt;, a: string) =&gt; Chunk.NonEmptyChunk&lt;string&gt; (+1 overload)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const get: &lt;Chunk.Chunk&lt;string&gt;&gt;(self: Ref.Ref&lt;Chunk.Chunk&lt;string&gt;&gt;) =&gt; Effect.Effect&lt;Chunk.Chunk&lt;string&gt;, never, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runPromise: &lt;Chunk.Chunk&lt;string&gt;, never&gt;(effect: Effect.Effect&lt;Chunk.Chunk&lt;string&gt;, never, never&gt;, options?: {    readonly signal?: AbortSignal | undefined;} | undefined) =&gt; Promise&lt;Chunk.Chunk&lt;string&gt;&gt;</code></pre>
</figure>
:::
...
[getNames]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[values: \[ \"Alice\",
\"Bob\" \]]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
Now that we have learned how to use the `Ref`{dir="auto"} data type, we
can use it to manage the state concurrently.

For example, assume while we are reading from the console, we have
another fiber that is trying to update the state from a different
source.

Here, one fiber reads names from user input, while another fiber
concurrently adds preset names at regular intervals:
...
::: code
[ ]{.indent}[// Fiber 1: Reading names from user
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fiber1: Fiber.RuntimeFiber&lt;void, never&gt;</code></pre>
</figure>
:::
::::
...
[readLine]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::
::::::::::
...
::: code
[ ]{.indent}[\"Please enter a name or \`q\` to exit:
...
::: code
[ ]{.indent}[// Fiber 2: Updating the state with predefined
names]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const fiber2: Fiber.RuntimeFiber&lt;void, never&gt;</code></pre>
</figure>
:::
::::
...
]{style="--0:#24292E;--1:#E1E4E8"}[\"Jane\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"Joe\"]{style="--0:#032F62;--1:#9ECBFF"}[,
]{style="--0:#24292E;--1:#E1E4E8"}[\"Tom\"]{style="--0:#032F62;--1:#9ECBFF"}[\])
{]{style="--0:#24292E;--1:#E1E4E8"}
:::::
::::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[// Note: the following
result may vary]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[// depending on the
speed of user input]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[[ ]{style="--0:#616972;--1:#99A0A6"}]{.indent}[values: \[ \'John\',
\'Jane\', \'Joe\', \'Tom\', \'Alice\', \'Bob\'
\]]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/state-management/ref.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../../scheduling/examples/index.html){.astro-u5aomj4k
rel="prev"}
...
.astro-4rgy7crp} [ Next\
[SynchronizedRef]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../synchronizedref/index.html){.astro-u5aomj4k
rel="next"}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
