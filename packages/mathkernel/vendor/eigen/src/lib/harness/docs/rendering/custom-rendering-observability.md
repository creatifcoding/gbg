...
The first five measure transport/runtime behavior.
The latter two are renderer/coalescer metrics emitted by overlay reducer integration paths (e.g. PiProvider reducer loop).
