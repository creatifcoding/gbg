/**
 * Effect Schema → genifer Adapter
 *
 * This module attempts to adapt Effect Schema to work with genifer's
 * Zod-based catalog system. genifer expects `z.ZodType<Record<string, unknown>>`.
 *
 * ## Approach
 *
...
/**
 * Minimal interface that genifer needs from a schema
 */
