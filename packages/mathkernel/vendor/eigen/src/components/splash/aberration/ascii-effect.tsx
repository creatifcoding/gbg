  ...
  constructor(options: AsciiEffectOptions) {
    ...
    super("AsciiEffect", fragmentShader, {
      ...
      uniforms: new Map([
        ...
        ["scanlineIntensity", new Uniform((postfx.scanlineIntensity as number) || 1)],
        ["scanlineCount", new Uniform((postfx.scanlineCount as number) || 1000)],
        ["targetFPS", new Uniform((postfx.targetFPS as number) || 0)],
        ["jitterIntensity", new Uniform((postfx.jitterIntensity as number) || 0.18)],
        ["jitterSpeed", new Uniform((postfx.jitterSpeed as number) || 0)],
        ...
        ["vignetteRadius", new Uniform((postfx.vignetteRadius as number) || 0.7)],
        ["colorPalette", new Uniform((postfx.colorPalette as number) || 0)],
        ["curvature", new Uniform((postfx.curvature as number) || 0)],
        ["aberrationStrength", new Uniform((postfx.aberrationStrength as number) || 0.01)],
        ["noiseIntensity", new Uniform((postfx.noiseIntensity as number) || 0.09)],
        ...
        ["waveFrequency", new Uniform((postfx.waveFrequency as number) || 3)],
        ["waveSpeed", new Uniform((postfx.waveSpeed as number) || 0)],
