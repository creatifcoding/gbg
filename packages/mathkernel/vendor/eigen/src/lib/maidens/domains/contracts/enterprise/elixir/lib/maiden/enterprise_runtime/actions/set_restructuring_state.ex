defmodule Maiden.EnterpriseRuntime.Actions.SetRestructuringState do
  @moduledoc """
  Explicit transition action: active -> restructuring.
  """

  use Jido.Action,
    name: "set_restructuring_state",
    description: "Set enterprise status to restructuring",
    schema: [
  ...
  def run(params, context) when is_map(params) do
    ...
    cond do
      from not in @allowed_from or to != "restructuring" ->
        {:error, "SetRestructuringState requires to=restructuring and from=active"}
