...
::::::::: {.sl-container .astro-2wc2n45z style="--borderTop: initial;--pageTitleDisplay: block;"}
:::::: sl-markdown-content
In software development, it's common to encounter situations where an
operation may fail temporarily due to various factors such as network
issues, resource unavailability, or external dependencies. In such
cases, it's often desirable to retry the operation automatically,
allowing it to succeed eventually.

Retrying is a powerful mechanism to handle transient failures and ensure
the successful execution of critical operations. In Effect retrying is
made simple and flexible with built-in functions and scheduling
strategies.

In this guide, we will explore the concept of retrying in Effect and
learn how to use the `retry`{dir="auto"} and `retryOrElse`{dir="auto"}
functions to handle failure scenarios. We'll see how to define retry
policies using schedules, which dictate when and how many times the
operation should be retried.

Whether you're working on network requests, database interactions, or
any other potentially error-prone operations, mastering the retrying
capabilities of effect can significantly enhance the resilience and
...
aria-hidden="true"}](index.html#retry){.anchor-link
aria-labelledby="retry"}
:::

The `Effect.retry`{dir="auto"} function takes an effect and a
[Schedule](../../scheduling/introduction/index.html) policy, and will
automatically retry the effect if it fails, following the rules of the
policy.
...
::: code
[// Simulates an effect with possible
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const task: Effect.Effect&lt;string, Error, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const async: &lt;string, Error, never&gt;(resume: (callback: (_: Effect.Effect&lt;string, Error, never&gt;) =&gt; void, signal: AbortSignal) =&gt; void | Effect.Effect&lt;void, never, never&gt;, blockingOn?: FiberId) =&gt; Effect.Effect&lt;string, Error, never&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>resume: (_: Effect.Effect&lt;string, Error, never&gt;) =&gt; void</code></pre>
</figure>
:::
::::
...
::: code
[// Define a repetition policy using a fixed delay between
...
[fixed]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"100
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const repeated: Effect.Effect&lt;string, Error, never&gt;</code></pre>
</figure>
:::
::::

[repeated]{style="--0:#005CC5;--1:#79B8FF"}[
]{style="--0:#24292E;--1:#E1E4E8"}[=]{style="--0:#BF3441;--1:#F97583"}[
]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#24292E;--1:#E1E4E8"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const retry: &lt;string, Error, never, number, never&gt;(self: Effect.Effect&lt;string, Error, never&gt;, policy: Schedule.Schedule&lt;number, Error, never&gt;) =&gt; Effect.Effect&lt;string, Error, never&gt; (+3 overloads)</code></pre>
</figure>
:::
...
[repeated]{style="--0:#24292E;--1:#E1E4E8"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#retrying-n-times-immediately){.anchor-link
aria-labelledby="retrying-n-times-immediately"}
:::

You can also retry a failing effect a set number of times with a simpler
policy that retries immediately:
...
::: code
[// Retry the task up to 5 times]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const retry: &lt;string, Error, never, {    times: number;}&gt;(self: Effect.Effect&lt;string, Error, never&gt;, options: {    times: number;}) =&gt; Effect.Effect&lt;string, Error, never&gt; (+3 overloads)</code></pre>
</figure>
:::
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#retrying-based-on-a-condition){.anchor-link
aria-labelledby="retrying-based-on-a-condition"}
:::

You can customize how retries are managed by specifying conditions. Use
the `until`{dir="auto"} or `while`{dir="auto"} options to control when
retries stop.
...
::: code
[// Define an effect that simulates varying error on each
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const action: Effect.Effect&lt;never, string, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const failSync: &lt;string&gt;(evaluate: LazyArg&lt;string&gt;) =&gt; Effect.Effect&lt;never, string, never&gt;</code></pre>
</figure>
:::

::: twoslash-popup-docs
Creates an `Effect` that fails with the specified error, evaluated
lazily.
:::
...
[failSync]{style="--0:#6F42C1;--1:#B392F0"}[(()
]{style="--0:#24292E;--1:#E1E4E8"}[=\>]{style="--0:#BF3441;--1:#F97583"}[
{]{style="--0:#24292E;--1:#E1E4E8"}
::::::::::::
:::::::::::::::
...
[count]{style="--0:#24292E;--1:#E1E4E8"}[}\`]{style="--0:#032F62;--1:#9ECBFF"}
:::::
::::::::
...
::: code
[// Retry the action until a specific condition is
met]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const program: Effect.Effect&lt;never, &quot;Error 3&quot;, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const retry: &lt;never, string, never, {    until: (err: string) =&gt; err is &quot;Error 3&quot;;}&gt;(self: Effect.Effect&lt;never, string, never&gt;, options: {    until: (err: string) =&gt; err is &quot;Error 3&quot;;}) =&gt; Effect.Effect&lt;never, &quot;Error 3&quot;, never&gt; (+3 overloads)</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>until: (err: string) =&gt; err is &quot;Error 3&quot;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const runPromiseExit: &lt;never, &quot;Error 3&quot;&gt;(effect: Effect.Effect&lt;never, &quot;Error 3&quot;, never&gt;, options?: {    readonly signal?: AbortSignal;} | undefined) =&gt; Promise&lt;Exit&lt;never, &quot;Error 3&quot;&gt;&gt;</code></pre>
</figure>
:::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Promise&lt;Exit&lt;never, &quot;Error 3&quot;&gt;&gt;.then&lt;void, never&gt;(onfulfilled?: ((value: Exit&lt;never, &quot;Error 3&quot;&gt;) =&gt; void | PromiseLike&lt;void&gt;) | null | undefined, onrejected?: ((reason: any) =&gt; PromiseLike&lt;never&gt;) | null | undefined): Promise&lt;void&gt;</code></pre>
</figure>
:::
...
\'Cause\', \_tag: \'Fail\', failure: \'Error 3\'
}]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
.astro-4rgy7crp} Alternative

::: starlight-aside__content
You can also use
[Effect.repeat](../../scheduling/repetition/index.html#repeating-based-on-a-condition)
...
[[![](data:image/svg+xml;base64,)]{.anchor-icon
aria-hidden="true"}](index.html#retryorelse){.anchor-link
aria-labelledby="retryorelse"}
:::

The `Effect.retryOrElse`{dir="auto"} function attempts to retry a
failing effect multiple times according to a defined
[Schedule](../../scheduling/introduction/index.html) policy.

If the retries are exhausted and the effect still fails, it runs a
fallback effect instead.
...
::: code
[// Retry the task with a delay between retries and a maximum of 2
retries]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
::: code
[// If all retries fail, run the fallback
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const repeated: Effect.Effect&lt;string, never, never&gt;</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const retryOrElse: &lt;string, Error, never, number, never, string, never, never&gt;(self: Effect.Effect&lt;string, Error, never&gt;, policy: Schedule.Schedule&lt;number, Error, never&gt;, orElse: (e: Error, out: number) =&gt; Effect.Effect&lt;string, never, never&gt;) =&gt; Effect.Effect&lt;string, never, never&gt; (+1 overload)</code></pre>
</figure>
:::

:::: twoslash-popup-docs
Retries a failing effect and runs a fallback effect if retries are
exhausted.

**Details**

The `Effect.retryOrElse` function attempts to retry a failing effect
multiple times according to a defined
...
Effect.runPromise(repeated).then(console.log)// Output:// failure// failure// failure// orElse// default value</code></pre>
</figure>
:::
::::

::: {.twoslash-popup-docs .twoslash-popup-docs-tags}
[\@see]{.twoslash-popup-docs-tag-name} ― [retry for a version that does
not run a fallback effect.]{.twoslash-popup-docs-tag-value}
...
[retryOrElse]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}
:::::::::::::
::::::::::::::::
...
::: code
[ ]{.indent}[// fallback]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
[log]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"orElse\"]{style="--0:#032F62;--1:#9ECBFF"}[).]{style="--0:#24292E;--1:#E1E4E8"}[[]{.twoslash-hover}]{.twoslash
style="--0:#6F42C1;--1:#B392F0"}
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>Pipeable.pipe&lt;Effect.Effect&lt;void, never, never&gt;, Effect.Effect&lt;string, never, never&gt;&gt;(this: Effect.Effect&lt;void, never, never&gt;, ab: (_: Effect.Effect&lt;void, never, never&gt;) =&gt; Effect.Effect&lt;string, never, never&gt;): Effect.Effect&lt;string, never, never&gt; (+21 overloads)</code></pre>
</figure>
:::
::::
...
::: expressive-code
<figure class="frame">
<pre data-language="ts"><code>const as: &lt;string&gt;(value: string) =&gt; &lt;A, E, R&gt;(self: Effect.Effect&lt;A, E, R&gt;) =&gt; Effect.Effect&lt;string, E, R&gt; (+1 overload)</code></pre>
</figure>
:::
...
[as]{style="--0:#6F42C1;--1:#B392F0"}[(]{style="--0:#24292E;--1:#E1E4E8"}[\"default
...
::: code
[default value]{style="--0:#616972;--1:#99A0A6"}
:::
::::::
...
.astro-4rgy7crp} Edit
page](https://github.com/Effect-TS/website/edit/main/content/src/content/docs/docs/error-management/retrying.mdx){.sl-flex
...
]{.astro-u5aomj4k}](../matching/index.html){.astro-u5aomj4k rel="prev"}
...
.astro-4rgy7crp} [ Next\
[Timing Out]{.link-title .astro-u5aomj4k}
]{.astro-u5aomj4k}](../timing-out/index.html){.astro-u5aomj4k
rel="next"}
:::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
